...
def Constructor():
    ...
    AddNavmeshFaceFlag(navmesh_id=1503100, navmesh_type=NavmeshFlag.Wall)
    AddNavmeshFaceFlag(navmesh_id=1503110, navmesh_type=NavmeshFlag.FloorBeneathWall)
    AddNavmeshFaceFlag(navmesh_id=1503101, navmesh_type=NavmeshFlag.FloorBeneathWall)
    AddNavmeshFaceFlag(navmesh_id=1503111, navmesh_type=NavmeshFlag.Wall)
    AddNavmeshFaceFlag(navmesh_id=1503102, navmesh_type=NavmeshFlag.FloorBeneathWall)
    AddNavmeshFaceFlag(navmesh_id=1503112, navmesh_type=NavmeshFlag.Wall)
    AddNavmeshFaceFlag(navmesh_id=1503103, navmesh_type=NavmeshFlag.Wall)
    AddNavmeshFaceFlag(navmesh_id=1503113, navmesh_type=NavmeshFlag.FloorBeneathWall)
    EndOfAnimation(obj=1501011, animation_id=12)
    SkipLines(9)
    AddNavmeshFaceFlag(navmesh_id=1503100, navmesh_type=NavmeshFlag.FloorBeneathWall)
    AddNavmeshFaceFlag(navmesh_id=1503110, navmesh_type=NavmeshFlag.Wall)
    AddNavmeshFaceFlag(navmesh_id=1503101, navmesh_type=NavmeshFlag.Wall)
    AddNavmeshFaceFlag(navmesh_id=1503111, navmesh_type=NavmeshFlag.FloorBeneathWall)
    AddNavmeshFaceFlag(navmesh_id=1503102, navmesh_type=NavmeshFlag.Wall)
    AddNavmeshFaceFlag(navmesh_id=1503112, navmesh_type=NavmeshFlag.FloorBeneathWall)
    AddNavmeshFaceFlag(navmesh_id=1503103, navmesh_type=NavmeshFlag.FloorBeneathWall)
    AddNavmeshFaceFlag(navmesh_id=1503113, navmesh_type=NavmeshFlag.Wall)
    EndOfAnimation(obj=1501011, animation_id=11)
    SkipLines(4)
    AddNavmeshFaceFlag(navmesh_id=1503100, navmesh_type=NavmeshFlag.Disable)
    AddNavmeshFaceFlag(navmesh_id=1503101, navmesh_type=NavmeshFlag.Disable)
    AddNavmeshFaceFlag(navmesh_id=1503102, navmesh_type=NavmeshFlag.Disable)
    AddNavmeshFaceFlag(navmesh_id=1503103, navmesh_type=NavmeshFlag.Disable)
    ...
    Event_11505843(0, flag=11, line_intersects=1501990, anchor_entity=1502998, target_entity=1502997)
    Event_11505846(0, flag=11, obj=1501990, vfx_id=1501991)
...
def Preconstructor():
    ...
    Event_11505029()
    Event_11505032()
    Event_11505990(0, flag=11505031, summoned_character=6510)
...
def Event_11500100():
    ...
    RemoveNavmeshFaceFlag(navmesh_id=1503100, navmesh_type=NavmeshFlag.Disable)
    RemoveNavmeshFaceFlag(navmesh_id=1503101, navmesh_type=NavmeshFlag.Disable)
    RemoveNavmeshFaceFlag(navmesh_id=1503102, navmesh_type=NavmeshFlag.Disable)
    RemoveNavmeshFaceFlag(navmesh_id=1503103, navmesh_type=NavmeshFlag.Disable)
    AddNavmeshFaceFlag(navmesh_id=1503100, navmesh_type=NavmeshFlag.Wall)
    AddNavmeshFaceFlag(navmesh_id=1503110, navmesh_type=NavmeshFlag.FloorBeneathWall)
    AddNavmeshFaceFlag(navmesh_id=1503101, navmesh_type=NavmeshFlag.FloorBeneathWall)
    AddNavmeshFaceFlag(navmesh_id=1503111, navmesh_type=NavmeshFlag.Wall)
    ...
    EnableFlag(11500101)
    RemoveNavmeshFaceFlag(navmesh_id=1503100, navmesh_type=NavmeshFlag.Wall)
    RemoveNavmeshFaceFlag(navmesh_id=1503110, navmesh_type=NavmeshFlag.FloorBeneathWall)
    RemoveNavmeshFaceFlag(navmesh_id=1503101, navmesh_type=NavmeshFlag.FloorBeneathWall)
    RemoveNavmeshFaceFlag(navmesh_id=1503111, navmesh_type=NavmeshFlag.Wall)
    RemoveNavmeshFaceFlag(navmesh_id=1503102, navmesh_type=NavmeshFlag.FloorBeneathWall)
    RemoveNavmeshFaceFlag(navmesh_id=1503112, navmesh_type=NavmeshFlag.Wall)
    RemoveNavmeshFaceFlag(navmesh_id=1503103, navmesh_type=NavmeshFlag.Wall)
    RemoveNavmeshFaceFlag(navmesh_id=1503113, navmesh_type=NavmeshFlag.FloorBeneathWall)
    ...
    RemoveNavmeshFaceFlag(navmesh_id=1503100, navmesh_type=NavmeshFlag.FloorBeneathWall)
    RemoveNavmeshFaceFlag(navmesh_id=1503110, navmesh_type=NavmeshFlag.Wall)
    RemoveNavmeshFaceFlag(navmesh_id=1503101, navmesh_type=NavmeshFlag.Wall)
    RemoveNavmeshFaceFlag(navmesh_id=1503111, navmesh_type=NavmeshFlag.FloorBeneathWall)
    RemoveNavmeshFaceFlag(navmesh_id=1503102, navmesh_type=NavmeshFlag.Wall)
    RemoveNavmeshFaceFlag(navmesh_id=1503112, navmesh_type=NavmeshFlag.FloorBeneathWall)
    RemoveNavmeshFaceFlag(navmesh_id=1503103, navmesh_type=NavmeshFlag.FloorBeneathWall)
    RemoveNavmeshFaceFlag(navmesh_id=1503113, navmesh_type=NavmeshFlag.Wall)
...
def Event_11505990(_, flag: int, summoned_character: int):
    """Event 11505990"""
...
def Event_11505843(_, flag: int, line_intersects: int, anchor_entity: int, target_entity: int):
    """Event 11505843"""
    AND_1.Add(Host())
...
def Event_11505846(_, flag: int, obj: int, vfx_id: int):
    """Event 11505846"""
