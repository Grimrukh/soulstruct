...
def Constructor():
    ...
    Event_11415170()
    Event_11405843(0, 9, 1401990, 1402998, 1402997)
...
def Preconstructor():
    ...
    Event_11405035()
    Event_11400901()
    Event_14005990(0, 11405031, 6531)
...
def Event_14005990(_, arg_0_3: int, arg_4_7: int):
    """Event 14005990"""
...
def Event_11405843(_, arg_0_3: int, arg_4_7: int, arg_8_11: int, arg_12_15: int):
    """Event 11405843"""
    IfHost(1)
    IfMultiplayer(1)
...
def Event_11405846(_, arg_0_3: int, arg_4_7: int, arg_8_11: int):
    """Event 11405846"""
    IfMultiplayer(-1)
