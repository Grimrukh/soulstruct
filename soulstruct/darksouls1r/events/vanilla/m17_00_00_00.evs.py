...
def Constructor():
    ...
    Event_11705843(0, 14, 1701990, 1702998, 1702997)
...
def Event_11705843(_, arg_0_3: int, arg_4_7: int, arg_8_11: int, arg_12_15: int):
    """Event 11705843"""
    IfHost(1)
    IfMultiplayer(1)
    IfFlagEnabled(1, arg_0_3)
...
def Event_11705846(_, arg_0_3: int, arg_4_7: int, arg_8_11: int):
    """Event 11705846"""
    IfMultiplayer(-1)
