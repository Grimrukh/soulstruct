...
def Constructor():
    ...
    Event_11315843(0, flag=7, line_intersects=1311990, anchor_entity=1312998, target_entity=1312997)
...
def Event_11315396():
    ...
    Kill(1310110, award_souls=1)
    Kill(1310111, award_souls=1)
    Kill(1310112)
    Kill(1310113)
    Kill(1310114)
    Kill(1310115)
    ...
    Kill(1310110, award_souls=1)
    Kill(1310111, award_souls=1)
    Kill(1310112, award_souls=1)
    Kill(1310113, award_souls=1)
    Kill(1310114)
    Kill(1310115)
    End()
    Kill(1310110, award_souls=1)
    ...
    Kill(1310112, award_souls=1)
    Kill(1310113, award_souls=1)
    Kill(1310114, award_souls=1)
    Kill(1310115, award_souls=1)
...
def Event_11315370(
    ...
    ForceAnimation(1310800, animation_id, wait_for_completion=1)
...
def Event_11315080():
    ...
    ForceAnimation(1310250, 9070, wait_for_completion=1)
...
def Event_11310051():
    ...
    SetObjectActivation(1311300, obj_act_id=-1, state=0)
...
def Event_11315843(_, flag: int, line_intersects: int, anchor_entity: int, target_entity: int):
    """Event 11315843"""
    IfHost(1)
    IfMultiplayer(1)
    IfFlagEnabled(1, flag)
...
def Event_11315846(_, flag: int, obj: int, vfx_id: int):
    """Event 11315846"""
    IfMultiplayer(-1)
