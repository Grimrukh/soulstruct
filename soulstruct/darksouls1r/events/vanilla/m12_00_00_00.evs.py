...
def Constructor():
    ...
    Event_11205843(0, 11200900, 1201890, 1202898, 1202894)
    Event_11205846(0, 11200900, 1201890, 1201891)
    Event_11205843(1, 5, 1201990, 1202998, 1202997)
...
def Preconstructor():
    ...
    Event_11205032()
    Event_11200300()
    Event_11205990(0, 11205031, 6521)
    SkipLinesIfClient(2)
...
def Event_11200000():
    ...
    SkipLines(4)
    SkipLinesIfClient(2)
    PlayCutscene(120000, cutscene_flags=2, player_id=10000, move_to_region=1202801, game_map=DARKROOT_GARDEN)
    SkipLines(1)
...
def Event_11200002():
    ...
    SkipLines(4)
    SkipLinesIfClient(2)
    PlayCutscene(120003, cutscene_flags=2, player_id=10000, move_to_region=1202802, game_map=DARKROOT_GARDEN)
    SkipLines(1)
...
def Event_11205990(_, arg_0_3: int, arg_4_7: int):
    """Event 11205990"""
...
def Event_11205843(_, arg_0_3: int, arg_4_7: int, arg_8_11: int, arg_12_15: int):
    """Event 11205843"""
    IfHost(1)
    IfMultiplayer(1)
    IfFlagEnabled(1, arg_0_3)
...
def Event_11205846(_, arg_0_3: int, arg_4_7: int, arg_8_11: int):
    """Event 11205846"""
    IfMultiplayer(-1)
