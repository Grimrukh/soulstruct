...
def Constructor():
    ...
    Event_11205846(1, flag=5, obj=1201990, vfx_id=1201991)
...
def Preconstructor():
    ...
    Event_11200535(0, character=6310)
...
def Event_11205390():
    ...
    FaceEntity(PLAYER, target_entity=1202997)
    ForceAnimation(PLAYER, 7410)
    Restart()
...
def Event_11205380():
    ...
    FaceEntity(PLAYER, target_entity=1202894)
    ForceAnimation(PLAYER, 7410)
    Restart()
...
def Event_11200100(_, flag: int, obj: int, dummy_id: int, anchor_entity: int, left: int, flag_1: int):
    ...
    EnableFlag(flag)
    EnableFlag(flag_1)
    FaceEntity(PLAYER, target_entity=obj)
...
def Event_11205032():
    ...
    FaceEntity(6521, target_entity=1202894)
