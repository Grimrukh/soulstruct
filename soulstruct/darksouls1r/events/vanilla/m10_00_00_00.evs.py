...
def Constructor():
    ...
    Event_11005150(0, 1000150, 1001100, 11009000, 11009010)
    Event_11005150(1, 1000151, 1001101, 11009001, 11009011)
    Event_11005150(2, 1000152, 1001102, 11009002, 11009012)
    Event_11000850(0, 1000110)
    Event_11000850(1, 1000099)
    Event_11000850(2, 1000090)
    Event_11000850(3, 1000300)
    Event_11005843(0, 2, 1001990, 1002998, 1002997)
...
def Preconstructor():
    ...
    Event_11000810()
    Event_11005333()
    Event_11005990(0, 11005032, 6541)
    Event_11005990(1, 11005035, 6591)
...
def Event_11005150(_, arg_0_3: int, arg_4_7: int, arg_8_11: int, arg_12_15: int):
    """Event 11005150"""
...
def Event_11005030():
    ...
    IfFlagDisabled(1, 11005032)
    IfFlagDisabled(1, 11005037)
...
def Event_11005033():
    ...
    IfFlagDisabled(1, 11005035)
    IfFlagDisabled(1, 11005038)
...
def Event_11005990(_, arg_0_3: int, arg_4_7: int):
    """Event 11005990"""
...
def Event_11005843(_, arg_0_3: int, arg_4_7: int, arg_8_11: int, arg_12_15: int):
    """Event 11005843"""
    IfHost(1)
    IfMultiplayer(1)
...
def Event_11005844(_, arg_0_3: int, arg_4_7: int, arg_8_11: int):
    """Event 11005844"""
    IfMultiplayer(-1)
