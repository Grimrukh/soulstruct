...
def Constructor():
    ...
    Event_11515846(2, flag=11510900, obj=1511890, vfx_id=1511891)
...
def Event_11515386():
    ...
    OR_2.Add(CharacterIsType(PLAYER, character_type=CharacterType.Intruder))
    if OR_2:
        return
...
def Event_11510210():
    ...
    if ThisEventFlagEnabled():
        ...
        End()
    AddNavmeshFaceFlag(navmesh_id=1513200, navmesh_type=NavmeshFlag.Disable)
    ...
    RemoveNavmeshFaceFlag(navmesh_id=1513200, navmesh_type=NavmeshFlag.Disable)
...
def Event_11510340():
    ...
    if FlagEnabled(11515300):
        ...
        AddNavmeshFaceFlag(navmesh_id=1513350, navmesh_type=NavmeshFlag.Disable)
        AddNavmeshFaceFlag(navmesh_id=1513351, navmesh_type=NavmeshFlag.Disable)
        AddNavmeshFaceFlag(navmesh_id=1513352, navmesh_type=NavmeshFlag.Disable)
        AddNavmeshFaceFlag(navmesh_id=1513353, navmesh_type=NavmeshFlag.Disable)
        AddNavmeshFaceFlag(navmesh_id=1513354, navmesh_type=NavmeshFlag.Disable)
    ...
    if FlagEnabled(11510303):
        EnableMapCollision(collision=1513310)
        RemoveNavmeshFaceFlag(navmesh_id=1513350, navmesh_type=NavmeshFlag.Disable)
        AddNavmeshFaceFlag(navmesh_id=1513351, navmesh_type=NavmeshFlag.Disable)
        AddNavmeshFaceFlag(navmesh_id=1513352, navmesh_type=NavmeshFlag.Disable)
        AddNavmeshFaceFlag(navmesh_id=1513353, navmesh_type=NavmeshFlag.Disable)
        AddNavmeshFaceFlag(navmesh_id=1513354, navmesh_type=NavmeshFlag.Disable)
    ...
    if FlagEnabled(11510302):
        ...
        AddNavmeshFaceFlag(navmesh_id=1513350, navmesh_type=NavmeshFlag.Disable)
        RemoveNavmeshFaceFlag(navmesh_id=1513351, navmesh_type=NavmeshFlag.Disable)
        RemoveNavmeshFaceFlag(navmesh_id=1513352, navmesh_type=NavmeshFlag.Disable)
        RemoveNavmeshFaceFlag(navmesh_id=1513353, navmesh_type=NavmeshFlag.Disable)
        AddNavmeshFaceFlag(navmesh_id=1513354, navmesh_type=NavmeshFlag.Disable)
    ...
    if FlagEnabled(11510301):
        ...
        AddNavmeshFaceFlag(navmesh_id=1513352, navmesh_type=NavmeshFlag.Disable)
        RemoveNavmeshFaceFlag(navmesh_id=1513353, navmesh_type=NavmeshFlag.Disable)
        RemoveNavmeshFaceFlag(navmesh_id=1513354, navmesh_type=NavmeshFlag.Disable)
