...
def Event_11210100():
    ...
    EnableFlag(11215220)
    SkipLinesIfLastConditionResultTrue(26, input_condition=AND_2)
    SkipLinesIfLastConditionResultTrue(25, input_condition=AND_4)
    EnableFlag(11210102)
    EnableFlag(11218102)
    SkipLinesIfLastConditionResultTrue(11, input_condition=AND_1)
    ...
    Restart()
    EnableFlag(11218103)
    SkipLinesIfLastConditionResultTrue(11, input_condition=AND_2)
...
def Event_11219100(_, flag: int, obj: int, animation_id: int, state: uchar, anchor_entity: int):
    ...
    CreateTemporaryVFX(vfx_id=120030, anchor_entity=anchor_entity, dummy_id=101, anchor_type=CoordEntityType.Object)
    SetFlagState(11210101, state)
    CreateObjectVFX(obj, vfx_id=191, dummy_id=120029)
...
def Event_11210777(_, flag: int, flag_1: int):
    ...
    if FlagDisabled(flag):
        CreateTemporaryVFX(vfx_id=20176, anchor_entity=PLAYER, dummy_id=220, anchor_type=CoordEntityType.Character)
    else:
        Unknown_2003_48(
            entity=PLAYER,
            unk1=0,
