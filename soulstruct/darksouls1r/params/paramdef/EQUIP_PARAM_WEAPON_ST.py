"""Has one new field, 'LevelSyncCorrectID', over PTDE."""
...
class EQUIP_PARAM_WEAPON_ST(ParamRowData):
    ...
    LevelSyncCorrectID: int = ParamField(
        short, "levelSyncCorrectID", default=0, hide=True,
        tooltip="Level sync ID for DSR.",
    )
    _Pad1: bytes = ParamPad(6, "pad_1[6]")  # shorter pad for DSR
