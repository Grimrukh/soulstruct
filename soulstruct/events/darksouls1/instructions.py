...
def PlayCutsceneAndRandomlyWarpPlayer_WithUnknownEffect1(condition: int, playback_method: CutsceneType,
    ...
    return to_numeric(instruction_info, condition, playback_method, first_region, last_region, area_id,
                      block_id)
...
def Unknown_2003_48(entity: AnimatedInt, arg1: int, model_point: int, magic_id: int, shoot_angle_x: int,
    ...
    return to_numeric(instruction_info, entity, arg1, model_point, magic_id, shoot_angle_x, shoot_angle_y,
                      shoot_angle_z)
