...
def Event11325110(ARG_0_1: short, ARG_2_3: short, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_16: uchar, ARG_17_17: uchar, ARG_20_23: int):
    ...
    Move(ARG_8_11, destination=1320700, destination_type=CoordEntityType.Character, model_point=ARG_12_15, copy_draw_Collision=1320700)
...
def Event11325001():
    ...
    Move(1320801, destination=1320800, destination_type=CoordEntityType.Character, model_point=19, copy_draw_Collision=1320800)
