...
def Event11410095():
    ...
    End()
    EndIfClient()
    IfDialogPromptActivated(0, prompt_text=10010410, anchor_entity=1412660, anchor_type=CoordEntityType.Region, facing_angle=0.0, max_distance=0.0, model_point=0, human_or_hollow_only=True, line_intersects=1411710)
...
def Event11415390():
    ...
    IfFlagOff(1, 10)
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1412998, anchor_type=CoordEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True, line_intersects=1411990, boss_version=True)
    IfConditionTrue(0, input_condition=1)
...
def Event11415391():
    ...
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1412998, anchor_type=CoordEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=False, line_intersects=1411990)
    IfConditionTrue(0, input_condition=1)
    RotateToFaceEntity(PLAYER, 1412997)
    ForceAnimation(PLAYER, 7410)
    Restart()
...
def Event11415370():
    ...
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1412698, anchor_type=CoordEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True, line_intersects=1411790, boss_version=True)
    IfConditionTrue(0, input_condition=1)
...
def Event11415371():
    ...
    IfFlagOn(1, 11415373)
    IfCharacterType(1, PLAYER, CharacterType.WhitePhantom)
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1412698, anchor_type=CoordEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=False, line_intersects=1411790)
    IfConditionTrue(0, input_condition=1)
    RotateToFaceEntity(PLAYER, 1412697)
    ForceAnimation(PLAYER, 7410)
    Restart()
...
def Event11415380():
    ...
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1412898, anchor_type=CoordEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True, line_intersects=1411890, boss_version=True)
    IfConditionTrue(0, input_condition=1)
...
def Event11415381():
    ...
    IfFlagOn(1, 11415383)
    IfCharacterType(1, PLAYER, CharacterType.WhitePhantom)
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1412898, anchor_type=CoordEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=False, line_intersects=1411890)
    IfConditionTrue(0, input_condition=1)
    RotateToFaceEntity(PLAYER, 1412897)
    ForceAnimation(PLAYER, 7410)
    Restart()
...
def Event11415350(ARG_0_3: int, ARG_4_5: short, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int):
    ...
    EnableCharacter(ARG_16_19)
    Move(ARG_16_19, destination=1410700, destination_type=CoordEntityType.Character, model_point=140, copy_draw_Collision=1410700)
...
def Event11415360(ARG_0_3: int, ARG_4_5: short, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int):
    ...
    IfHasTAEEvent(0, 1410700, tae_event_id=400)
    EnableCharacter(ARG_16_19)
    Move(ARG_16_19, destination=1410700, destination_type=CoordEntityType.Character, model_point=141, copy_draw_Collision=1410700)
    ForceAnimation(ARG_16_19, 8100)
    SetDisplayMask(1410700, bit_index=1, switch_type=OnOffChange.On)
    SetCollisionMask(1410700, bit_index=2, switch_type=OnOffChange.Off)
...
def Event11410340():
    ...
    IfFlagOn(1, 11400598)
    IfDialogPromptActivated(1, prompt_text=10010510, anchor_entity=1412201, anchor_type=CoordEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True, line_intersects=1411340)
    IfDialogPromptActivated(2, prompt_text=10010510, anchor_entity=1412200, anchor_type=CoordEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True, line_intersects=1411340)
    IfConditionTrue(-1, input_condition=1)
    IfConditionTrue(-1, input_condition=2)
    IfConditionTrue(0, input_condition=-1)
    EnableFlag(11410340)
...
def Event11410341():
    ...
    IfDialogPromptActivated(-2, prompt_text=10010510, anchor_entity=1412201, anchor_type=CoordEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True, line_intersects=1411340)
    IfConditionTrue(1, input_condition=-2)
    IfFlagOff(2, 11410340)
    IfClient(2)
    IfDialogPromptActivated(-3, prompt_text=10010510, anchor_entity=1412200, anchor_type=CoordEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=False, line_intersects=1411340)
    IfDialogPromptActivated(-3, prompt_text=10010510, anchor_entity=1412201, anchor_type=CoordEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=False, line_intersects=1411340)
...
def Event11410402():
    ...
    IfMultiplayer(-2)
    IfConditionTrue(1, input_condition=-2)
    IfDialogPromptActivated(1, prompt_text=10010510, anchor_entity=1411400, anchor_type=CoordEntityType.Object, facing_angle=180.0, max_distance=1.5, model_point=100, human_or_hollow_only=False)
    IfConditionTrue(0, input_condition=1)
...
def Event11415340():
    ...
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1412411, anchor_type=CoordEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True, line_intersects=1411410, boss_version=True)
    IfConditionTrue(0, input_condition=1)
...
def Event11415341():
    ...
    IfFlagOn(1, 11415343)
    IfCharacterType(1, PLAYER, CharacterType.WhitePhantom)
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1412411, anchor_type=CoordEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=False, line_intersects=1411410)
    IfConditionTrue(0, input_condition=1)
    RotateToFaceEntity(PLAYER, 1412412)
    ForceAnimation(PLAYER, 7410)
    Restart()
...
def Event5202(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int):
    ...
    Move(ARG_8_11, destination=ARG_0_3, destination_type=CoordEntityType.Character, model_point=ARG_16_19, copy_draw_Collision=ARG_0_3)
    Move(ARG_12_15, destination=ARG_0_3, destination_type=CoordEntityType.Character, model_point=ARG_20_23, copy_draw_Collision=ARG_0_3)
...
def Event11415250(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int):
    ...
    Move(ARG_8_11, destination=ARG_0_3, destination_type=CoordEntityType.Character, model_point=101, copy_draw_Collision=ARG_0_3)
    Move(ARG_12_15, destination=ARG_0_3, destination_type=CoordEntityType.Character, model_point=102, copy_draw_Collision=ARG_0_3)
    Move(ARG_16_19, destination=ARG_0_3, destination_type=CoordEntityType.Character, model_point=103, copy_draw_Collision=ARG_0_3)
    Move(ARG_20_23, destination=ARG_0_3, destination_type=CoordEntityType.Character, model_point=104, copy_draw_Collision=ARG_0_3)
...
def Event11410532(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int):
    ...
    DisableFlagRange((ARG_4_7, ARG_8_11))
    EnableFlag(ARG_12_15)
    Move(ARG_0_3, destination=1412500, destination_type=CoordEntityType.Region, model_point=-1, set_draw_Collision=1413000)
    EnableFlag(11410580)
    IfCharacterBackreadEnabled(0, ARG_0_3)
