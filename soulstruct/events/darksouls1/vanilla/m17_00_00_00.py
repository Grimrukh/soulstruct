...
def Preconstructor():
    ...
    Move(6032, destination=1702501, destination_type=CoordEntityType.Region, model_point=-1, set_draw_Collision=1703300)
...
def Event11705397():
    ...
    Move(1700801, destination=1700800, destination_type=CoordEntityType.Character, model_point=150, copy_draw_Collision=1700800)
...
def Event11700532(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int):
    ...
    EnableFlag(11700594)
    EnableCharacter(ARG_0_3)
    Move(ARG_0_3, destination=1702501, destination_type=CoordEntityType.Region, model_point=-1, set_draw_Collision=1703300)
    IfCharacterBackreadEnabled(0, ARG_0_3)
...
def Event11700539(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int):
    ...
    DisableFlagRange((ARG_4_7, ARG_8_11))
    EnableFlag(ARG_12_15)
    Move(ARG_0_3, destination=1700500, destination_type=CoordEntityType.Character, model_point=101, copy_draw_Collision=1700500)
    EnableCharacter(ARG_0_3)
