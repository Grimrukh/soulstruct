...
def Event11305390():
    ...
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1302998, anchor_type=CoordEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True, line_intersects=1301990, boss_version=True)
    IfConditionTrue(0, input_condition=1)
...
def Event11305391():
    ...
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1302998, anchor_type=CoordEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=False, line_intersects=1301990)
    IfConditionTrue(0, input_condition=1)
    RotateToFaceEntity(PLAYER, 1302997)
    ForceAnimation(PLAYER, 7410)
    Restart()
