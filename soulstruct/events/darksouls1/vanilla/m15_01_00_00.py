...
def Event11515080(ARG_0_3: int, ARG_4_7: int):
    ...
    Move(ARG_4_7, destination=ARG_0_3, destination_type=CoordEntityType.Character, model_point=110, copy_draw_Collision=ARG_0_3)
...
def Event11510130():
    ...
    EndIfFlagOn(1034)
    Move(6010, destination=1512450, destination_type=CoordEntityType.Region, model_point=-1, copy_draw_Collision=1510452)
...
def Event11515200(ARG_0_3: int):
    ...
    IfConditionTrue(0, input_condition=1)
    Move(PLAYER, destination=ARG_0_3, destination_type=CoordEntityType.Character, model_point=100, copy_draw_Collision=ARG_0_3)
