...
def Event11015397(ARG_0_3: int, ARG_4_5: short, ARG_8_11: int, ARG_12_15: int):
    ...
    Move(ARG_12_15, destination=ARG_0_3, destination_type=CoordEntityType.Character, model_point=130, copy_draw_parent=ARG_0_3)
...
def Event11015301():
    ...
    SetDisplayMask(1010300, bit_index=0, switch_type=OnOffChange.On)
    SetCollisionMask(1010300, bit_index=1, switch_type=OnOffChange.Off)
    Move(1010301, destination=1010300, destination_type=CoordEntityType.Character, model_point=66, copy_draw_parent=1010300)
...
def Event11010782():
    ...
    DisableCharacter(1010300)
    Move(1010300, destination=1012310, destination_type=CoordEntityType.Region, model_point=-1, set_draw_Collision=1013210)
...
def Event11010531(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int):
    ...
    DisableFlagRange((ARG_4_7, ARG_8_11))
    EnableFlag(ARG_12_15)
    Move(ARG_0_3, destination=1012530, destination_type=CoordEntityType.Region, model_point=-1, set_draw_Collision=1013050)
