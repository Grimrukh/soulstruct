...
def Event11215000():
    ...
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1212888, anchor_type=CoordEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True, line_intersects=1211790, boss_version=True)
    IfConditionTrue(0, input_condition=1)
...
def Event11215001():
    ...
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1212888, anchor_type=CoordEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=False, line_intersects=1211790)
    IfConditionTrue(0, input_condition=1)
    RotateToFaceEntity(PLAYER, 1212887)
    ForceAnimation(PLAYER, 7410)
    Restart()
...
def Event11215006(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int):
    ...
    Move(ARG_0_3, destination=ARG_4_7, destination_type=CoordEntityType.Character, model_point=150, copy_draw_Collision=ARG_4_7)
...
def Event11215009():
    ...
    Move(1210801, destination=1212007, destination_type=CoordEntityType.Region, model_point=-1, copy_draw_Collision=1210800)
    Move(1210802, destination=1212008, destination_type=CoordEntityType.Region, model_point=-1, copy_draw_Collision=1210800)
    SetNest(1210801, 1212007)
    SetNest(1210802, 1212008)
    IfCharacterInsideRegion(0, PLAYER, region=1212009)
    Move(1210801, destination=1212010, destination_type=CoordEntityType.Region, model_point=-1, copy_draw_Collision=1210800)
    Move(1210802, destination=1212011, destination_type=CoordEntityType.Region, model_point=-1, copy_draw_Collision=1210800)
    SetNest(1210801, 1212010)
    SetNest(1210802, 1212011)
    Restart()
...
def Event11215010():
    ...
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1212898, anchor_type=CoordEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True, line_intersects=1211890, boss_version=True)
    IfConditionTrue(0, input_condition=1)
...
def Event11215011():
    ...
    IfFlagOn(1, 11215013)
    IfCharacterType(1, PLAYER, CharacterType.WhitePhantom)
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1212898, anchor_type=CoordEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=False, line_intersects=1211890)
    IfConditionTrue(0, input_condition=1)
    RotateToFaceEntity(PLAYER, 1212897)
    ForceAnimation(PLAYER, 7410)
    Restart()
...
def Event11215020():
    ...
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1212998, anchor_type=CoordEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True, line_intersects=1211990, boss_version=True)
    IfConditionTrue(0, input_condition=1)
...
def Event11215021():
    ...
    IfFlagOn(1, 11215023)
    IfCharacterType(1, PLAYER, CharacterType.WhitePhantom)
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1212998, anchor_type=CoordEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=False, line_intersects=1211990)
    IfConditionTrue(0, input_condition=1)
    RotateToFaceEntity(PLAYER, 1212997)
    ForceAnimation(PLAYER, 7410)
    Restart()
...
def Event11215060():
    ...
    IfFlagOn(1, 11210592)
    IfFlagOff(1, 11210004)
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1212908, anchor_type=CoordEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True, line_intersects=1211690, boss_version=True)
    IfConditionTrue(0, input_condition=1)
...
def Event11215061():
    ...
    IfFlagOn(1, 11215062)
    IfCharacterType(1, PLAYER, CharacterType.WhitePhantom)
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1212908, anchor_type=CoordEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=False, line_intersects=1211690)
    IfConditionTrue(0, input_condition=1)
    RotateToFaceEntity(PLAYER, 1212907)
    ForceAnimation(PLAYER, 7410)
    Restart()
...
def Event11210340():
    ...
    Move(6760, destination=1212331, destination_type=CoordEntityType.Region, model_point=-1, copy_draw_Collision=6760)
    End()
    IfHost(1)
...
def Event11210341():
    ...
    Move(6760, destination=1212332, destination_type=CoordEntityType.Region, model_point=-1, copy_draw_Collision=6760)
    End()
    IfHost(1)
    IfFlagOn(1, 11210340)
...
def Event11215040():
    ...
    IfDialogPromptActivated(1, prompt_text=50000000, anchor_entity=1212300, anchor_type=CoordEntityType.Region, facing_angle=0.0, max_distance=0.0, model_point=0, human_or_hollow_only=True)
    IfConditionTrue(0, input_condition=1)
...
def Event11210150():
    ...
    Move(1210350, destination=1212143, destination_type=CoordEntityType.Region, model_point=-1, set_draw_Collision=1213040)
    Move(1210350, destination=1212150, destination_type=CoordEntityType.Region, model_point=-1, set_draw_Collision=1213040)
...
def Event11210050():
    ...
    Move(1210400, destination=1212051, destination_type=CoordEntityType.Region, model_point=-1, set_draw_Collision=1213000)
...
def Event11215051():
    ...
    EnableFlag(11215054)
    Restart()
    Move(1210410, destination=1210401, destination_type=CoordEntityType.Character, model_point=150, copy_draw_Collision=1210401)
...
def Event11210540():
    ...
    DisableFlag(1127)
    EnableFlag(1128)
    Move(6700, destination=1210840, destination_type=CoordEntityType.Character, model_point=30, copy_draw_Collision=1210840)
...
def Event11210905(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int):
    ...
    WaitFrames(80)
    DisableCharacter(ARG_0_3)
    Move(ARG_0_3, destination=ARG_8_11, destination_type=CoordEntityType.Region, model_point=-1, set_draw_Collision=ARG_12_15)
...
def Event11210710(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int):
    ...
    IfDialogPromptActivated(0, prompt_text=ARG_8_11, anchor_entity=ARG_0_3, anchor_type=CoordEntityType.Object, facing_angle=180.0, max_distance=2.0, model_point=100, human_or_hollow_only=True)
    EnableFlag(11215341)
    EnableFlag(11210709)
