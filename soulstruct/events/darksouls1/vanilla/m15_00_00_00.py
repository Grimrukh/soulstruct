...
def Preconstructor():
    ...
    SkipLines(1)
    Move(6280, destination=1502510, destination_type=CoordEntityType.Region, model_point=-1, set_draw_Collision=1503300)
...
def Event11505010():
    ...
    IfConditionTrue(0, input_condition=1)
    Move(PLAYER, destination=1500010, destination_type=CoordEntityType.Character, model_point=100, copy_draw_Collision=1500010)
...
def Event11500534(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int):
    ...
    DisableFlagRange((ARG_4_7, ARG_8_11))
    EnableFlag(ARG_12_15)
    Move(ARG_0_3, destination=1502510, destination_type=CoordEntityType.Region, model_point=-1, set_draw_Collision=1503300)
