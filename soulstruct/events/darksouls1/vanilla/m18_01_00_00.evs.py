...
def Constructor():
    ...
    PlayCutscene(
        180101, skippable=True, fade_out=True, player_id=PLAYER, move_to_region=1812011, move_to_map=UNDEAD_ASYLUM
    )
    EnableFlag(11810002)
...
def Event11815390():
    ...
    IfFlagOff(1, 16)
    IfActionButton(
        1, prompt_text=10010403, anchor_entity=1812998, anchor_type=CoordEntityType.Region, line_intersects=1811990
    )
    IfConditionTrue(0, input_condition=1)
...
def Event11810000():
    ...
    PlayCutscene(
        100225, skippable=True, fade_out=False, player_id=PLAYER, move_to_region=1022100, move_to_map=FIRELINK_SHRINE
    )
    WaitFrames(1)
...
def Event11810150():
    ...
    IfActionButton(
        0, prompt_text=10010506, anchor_entity=1812001, anchor_type=CoordEntityType.Region, trigger_attribute=255
    )
    ...
    PlayCutscene(
        180126, skippable=True, fade_out=False, player_id=PLAYER, move_to_region=1022121, move_to_map=FIRELINK_SHRINE
    )
    ...
    Restart()
    IfActionButton(
        1, prompt_text=10010507, anchor_entity=1812001, anchor_type=CoordEntityType.Region, trigger_attribute=255
    )
