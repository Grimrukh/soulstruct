...
def Event11205300(ARG_0_1: short, ARG_2_3: short, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_16: uchar, ARG_17_17: uchar, ARG_20_23: int):
    ...
    Move(ARG_8_11, destination=1200010, destination_type=CoordEntityType.Character, model_point=ARG_12_15, copy_draw_Collision=1200010)
...
def Event11200530(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int):
    ...
    DisableFlagRange((ARG_4_7, ARG_8_11))
    EnableFlag(ARG_12_15)
    Move(ARG_0_3, destination=1200200, destination_type=CoordEntityType.Character, model_point=101, copy_draw_Collision=1200200)
    EnableCharacter(ARG_0_3)
    Wait(0.5)
...
def Event11205040(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int):
    ...
    Move(6051, destination=ARG_4_7, destination_type=CoordEntityType.Region, model_point=-1, set_draw_Collision=1203150)
    Wait(5.0)
    EnableCharacter(6051)
