...
def Event11315370(ARG_0_3: int, ARG_4_5: short, ARG_6_7: short, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int, ARG_24_27: int):
    ...
    Move(ARG_16_19, destination=1310800, destination_type=CoordEntityType.Character, model_point=50, copy_draw_parent=1310800)
    ForceAnimation(ARG_16_19, 7000)
    EnableCharacter(ARG_20_23)
    Move(ARG_20_23, destination=1310800, destination_type=CoordEntityType.Character, model_point=51, copy_draw_parent=1310800)
