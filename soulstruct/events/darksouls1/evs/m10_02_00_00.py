...
def Event11020020():
    ...
    IfDialogPromptActivated(0, prompt_text=10010506, anchor_entity=1022120, anchor_type=CoordEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True)
    SetStandbyAnimationSettings(PLAYER, standby_animation=7816)
    ForceAnimation(PLAYER, 7815, wait_for_completion=True)
    EnableFlag(11025060)
    WaitFrames(3)
    IfDialogPromptActivated(1, prompt_text=10010507, anchor_entity=1022120, anchor_type=CoordEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True)
...
def Event11020106():
    ...
    IfDialogPromptActivated(1, prompt_text=10010182, anchor_entity=1021960, anchor_type=CoordEntityType.Object, facing_angle=180.0, max_distance=3.4000000953674316, human_or_hollow_only=True)
    IfConditionTrue(0, input_condition=1)
