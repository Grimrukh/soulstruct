...
def Event11310095():
    ...
    End()
    EndIfClient()
    IfDialogPromptActivated(0, prompt_text=10010410, anchor_entity=1312610, anchor_type=CoordEntityType.Region, facing_angle=0.0, max_distance=0.0, model_point=0, human_or_hollow_only=True, line_intersects=1311710)
...
def Event11315390():
    ...
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1312998, anchor_type=CoordEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True, line_intersects=1311990, boss_version=True)
    IfConditionTrue(0, input_condition=1)
...
def Event11315391():
    ...
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1312998, anchor_type=CoordEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=False, line_intersects=1311990)
    IfConditionTrue(0, input_condition=1)
    RotateToFaceEntity(PLAYER, 1312997)
    ForceAnimation(PLAYER, 7410)
    Restart()
...
def Event11315370(ARG_0_3: int, ARG_4_5: short, ARG_6_7: short, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int, ARG_24_27: int):
    ...
    Move(ARG_16_19, destination=1310800, destination_type=CoordEntityType.Character, model_point=50, copy_draw_hitbox=1310800)
    ForceAnimation(ARG_16_19, 7000)
    EnableCharacter(ARG_20_23)
    Move(ARG_20_23, destination=1310800, destination_type=CoordEntityType.Character, model_point=51, copy_draw_hitbox=1310800)
