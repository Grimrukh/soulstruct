...
def Event11805390():
    ...
    IfFlagOff(1, 15)
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1802998, anchor_type=CoordEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True, line_intersects=1801990, boss_version=True)
    IfConditionTrue(0, input_condition=1)
...
def Event11805391():
    ...
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1802998, anchor_type=CoordEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=False, line_intersects=1801990)
    IfConditionTrue(0, input_condition=1)
    RotateToFaceEntity(PLAYER, 1802997)
    ForceAnimation(PLAYER, 7410)
    Restart()
...
def Event20():
    ...
    EndIfClient()
    IfFlagOn(1, 15)
    IfDialogPromptActivated(1, prompt_text=10010108, anchor_entity=1801950, anchor_type=CoordEntityType.Object, facing_angle=180.0, max_distance=1.5, human_or_hollow_only=True)
    IfConditionTrue(0, input_condition=1)
...
def Event11800100():
    ...
    IfDialogPromptActivated(1, prompt_text=10010105, anchor_entity=1801960, anchor_type=CoordEntityType.Object, facing_angle=180.0, max_distance=2.0, model_point=150, human_or_hollow_only=True)
    IfConditionTrue(0, input_condition=1)
...
def Event11800101():
    ...
    IfDialogPromptActivated(1, prompt_text=10010105, anchor_entity=1801960, anchor_type=CoordEntityType.Object, facing_angle=180.0, max_distance=2.0, model_point=150, human_or_hollow_only=False)
    IfFlagOn(2, 11800100)
    IfConditionTrue(-1, input_condition=1)
...
def Event11800220():
    ...
    IfDialogPromptActivated(1, prompt_text=10010400, anchor_entity=1802100, anchor_type=CoordEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=False, line_intersects=1801101)
    IfFlagOn(2, 11805110)
    IfConditionTrue(-1, input_condition=1)
    IfConditionTrue(-1, input_condition=2)
    IfConditionTrue(0, input_condition=-1)
