...
def Event11515380():
    ...
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1512898, anchor_type=CoordEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True, line_intersects=1511890, boss_version=True)
    IfConditionTrue(0, input_condition=1)
    EnableFlag(743)
...
def Event11515381():
    ...
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1512898, anchor_type=CoordEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=False, line_intersects=1511890)
    IfConditionTrue(0, input_condition=1)
    RotateToFaceEntity(PLAYER, 1512897)
...
def Event11515390():
    ...
    IfFlagOff(1, 12)
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1512998, anchor_type=CoordEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True, line_intersects=1511990, boss_version=True)
    IfConditionTrue(0, input_condition=1)
...
def Event11515391():
    ...
    IfFlagOn(1, 11515393)
    IfCharacterType(1, PLAYER, CharacterType.WhitePhantom)
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1512998, anchor_type=CoordEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=False, line_intersects=1511990)
    IfConditionTrue(0, input_condition=1)
    RotateToFaceEntity(PLAYER, 1512997)
    ForceAnimation(PLAYER, 7410)
    Restart()
...
def Event11515080(ARG_0_3: int, ARG_4_7: int):
    ...
    Move(ARG_4_7, destination=ARG_0_3, destination_type=CoordEntityType.Character, model_point=110, copy_draw_hitbox=ARG_0_3)
...
def Event11510110():
    ...
    End()
    IfDialogPromptActivated(0, prompt_text=10010400, anchor_entity=1511010, anchor_type=CoordEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=100, human_or_hollow_only=False)
...
def Event11510200():
    ...
    IfDialogPromptActivated(1, prompt_text=10010502, anchor_entity=1511001, anchor_type=CoordEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=102, human_or_hollow_only=False)
    IfConditionTrue(0, input_condition=1)
...
def Event11510201():
    ...
    IfDialogPromptActivated(1, prompt_text=10010400, anchor_entity=1512000, anchor_type=CoordEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=False, line_intersects=1511000)
    IfConditionTrue(0, input_condition=1)
...
def Event11510210():
    ...
    IfDialogPromptActivated(0, prompt_text=10010400, anchor_entity=1511200, anchor_type=CoordEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=101, human_or_hollow_only=False)
...
def Event11510211():
    ...
    IfDialogPromptActivated(1, prompt_text=10010400, anchor_entity=1511200, anchor_type=CoordEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=100, human_or_hollow_only=False)
    IfConditionTrue(0, input_condition=1)
...
def Event11510300():
    ...
    IfDialogPromptActivated(1, prompt_text=10010502, anchor_entity=1511300, anchor_type=CoordEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=102, human_or_hollow_only=False)
    IfFlagOff(2, 11510303)
    IfDialogPromptActivated(2, prompt_text=10010502, anchor_entity=1511300, anchor_type=CoordEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=104, human_or_hollow_only=False)
    IfFlagOn(3, 11510305)
    IfFlagOff(3, 11510303)
    IfDialogPromptActivated(3, prompt_text=10010501, anchor_entity=1511301, anchor_type=CoordEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=192, human_or_hollow_only=False)
    IfFlagOn(4, 11510305)
    IfFlagOn(4, 11510303)
    IfDialogPromptActivated(4, prompt_text=10010501, anchor_entity=1511302, anchor_type=CoordEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=192, human_or_hollow_only=False)
    IfFlagOn(5, 11510305)
    IfFlagOff(5, 11510301)
    IfDialogPromptActivated(5, prompt_text=10010501, anchor_entity=1511303, anchor_type=CoordEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=192, human_or_hollow_only=False)
    IfFlagOn(6, 11510305)
    IfFlagOff(6, 11510302)
    IfDialogPromptActivated(6, prompt_text=10010501, anchor_entity=1511304, anchor_type=CoordEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=192, human_or_hollow_only=False)
    IfConditionTrue(-1, input_condition=1)
    IfConditionTrue(-1, input_condition=2)
    IfConditionTrue(-1, input_condition=3)
...
def Event11510230():
    ...
    IfDialogPromptActivated(0, prompt_text=10010100, anchor_entity=1512510, anchor_type=CoordEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True)
    IfSingleplayer(1)
    IfHost(1)
...
def Event11510240():
    ...
    IfDialogPromptActivated(2, prompt_text=10010200, anchor_entity=1510100, anchor_type=CoordEntityType.Character, facing_angle=180.0, max_distance=7.0, human_or_hollow_only=True)
...
def Event11510130():
    ...
    EndIfFlagOn(1034)
    Move(6010, destination=1512450, destination_type=CoordEntityType.Region, model_point=-1, copy_draw_hitbox=1510452)
...
def Event11510460():
    ...
    IfFlagOff(1, 743)
    IfFlagOn(1, 1240)
    IfDialogPromptActivated(1, prompt_text=10010210, anchor_entity=1512410, anchor_type=CoordEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True)
...
def Event151():
    ...
    DisableNetworkSync()
    IfThisEventOn(1)
    IfDialogPromptActivated(1, prompt_text=10010182, anchor_entity=1511960, anchor_type=CoordEntityType.Object, facing_angle=180.0, max_distance=3.4000000953674316, human_or_hollow_only=True)
    IfConditionTrue(0, input_condition=1)
