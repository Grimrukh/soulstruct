...
def Event730():
    ...
    EndIfPlayerNotInOwnWorld()
    IfPlayerInOwnWorld(1)
    IfCharacterHasSpecialEffect(1, character=PLAYER, special_effect=100)
    IfConditionTrue(0, input_condition=1)
...
def Event9520(_, arg_0_3: int, arg_4_5: ushort, arg_8_11: int, arg_12_15: int):
    ...
    ReplanAI(3300194)
    IfCharacterHasSpecialEffect(0, character=3300194, special_effect=arg_0_3)
...
def Event9525(_, arg_0_3: int, arg_4_5: ushort, arg_8_11: int, arg_12_15: int):
    ...
    ReplanAI(4100190)
    IfCharacterHasSpecialEffect(-2, character=3300195, special_effect=arg_0_3)
    IfCharacterHasSpecialEffect(-2, character=3700192, special_effect=arg_0_3)
    IfCharacterHasSpecialEffect(-2, character=4100191, special_effect=arg_0_3)
    IfConditionTrue(0, input_condition=-2)
    SkipLinesIfFlagOff(2, 13304195)
...
def Event9530(_, arg_0_3: int, arg_4_5: ushort, arg_8_11: int, arg_12_15: int):
    ...
    ReplanAI(3700191)
    IfCharacterHasSpecialEffect(-2, character=3300193, special_effect=arg_0_3)
    IfCharacterHasSpecialEffect(-2, character=3700191, special_effect=arg_0_3)
    IfConditionTrue(0, input_condition=-2)
    SkipLinesIfFlagOff(2, 13304913)
...
def Event9540(_, arg_0_1: ushort, arg_4_7: int, arg_8_11: int):
    ...
    IfHasAIStatus(2, character=3800198, ai_status=AIStatusType.Battle)
    IfEntityWithinDistance(2, PLAYER, 3800198, radius=20.0)
    IfPlayerInOwnWorld(3)
    IfHealthComparison(3, character=PLAYER, comparison_type=ComparisonType.LessThanOrEqual, value=0.0)
    IfConditionTrue(-1, input_condition=1)
