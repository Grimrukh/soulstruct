...
def Event13415351(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int, ARG_24_27: int, ARG_28_31: int, ARG_32_35: int, ARG_36_39: int):
    ...
    Label(0)
    Move(ARG_0_3, destination=ARG_24_27, destination_type=CoordEntityType.Region, model_point=-1, copy_draw_Collision=ARG_24_27)
    SetAIParamID(ARG_0_3, 132051)
    Goto(Label.L4)
    Label(1)
    Move(ARG_0_3, destination=ARG_32_35, destination_type=CoordEntityType.Region, model_point=-1, copy_draw_Collision=ARG_32_35)
    SetAIParamID(ARG_0_3, 132052)
    Goto(Label.L4)
    Label(2)
    Move(ARG_0_3, destination=ARG_28_31, destination_type=CoordEntityType.Region, model_point=-1, copy_draw_Collision=ARG_28_31)
    SetAIParamID(ARG_0_3, 132052)
    Goto(Label.L4)
    Label(3)
    Move(ARG_0_3, destination=ARG_36_39, destination_type=CoordEntityType.Region, model_point=-1, copy_draw_Collision=ARG_36_39)
    SetAIParamID(ARG_0_3, 132052)
    Goto(Label.L4)
    Label(4)
...
def Event13415830():
    ...
    EnableCharacter(3410832)
    EnableAnimations(3410832)
    Move(3410832, destination=3412841, destination_type=CoordEntityType.Region, model_point=-1, copy_draw_Collision=3412841)
    Goto(Label.L1)
    Label(0)
...
def Event13415831():
    ...
    WaitFrames(1)
    Move(3410830, destination=3410832, destination_type=CoordEntityType.Character, model_point=-1, copy_draw_Collision=3410832)
    DisableCharacter(3410832)
    DisableAnimations(3410832)
    DisableAI(3410832)
...
def Event13415841():
    ...
    IfFlagOn(0, 13415842)
    Move(3410831, destination=3410830, destination_type=CoordEntityType.Character, model_point=50, copy_draw_Collision=3410830)
    Restart()
