...
def Event13005200(ARG_0_3: int, ARG_4_7: int, ARG_8_11: float, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int, ARG_24_27: int, ARG_28_31: int):
    ...
    EndIfThisEventSlotOn()
    Wait(1.0)
    IfDamageType(-1, attacked_entity=ARG_12_15, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
    IfDamageType(-1, attacked_entity=ARG_16_19, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
    IfDamageType(-1, attacked_entity=ARG_20_23, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
    IfDamageType(-1, attacked_entity=ARG_24_27, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
    IfDamageType(-1, attacked_entity=ARG_28_31, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
...
def Event13005280(ARG_0_3: int, ARG_4_7: int):
    ...
    CreateTemporaryFX(ARG_4_7, anchor_entity=ARG_0_3, anchor_type=CoordEntityType.Object, model_point=200)
...
def Event13005480():
    ...
    Move(3000850, destination=3002600, destination_type=CoordEntityType.Region, model_point=-1, short_move=True)
...
def Event13005493():
    ...
    EndIfFlagOn(13000481)
    EndIfFlagOn(9420)
    IfDamageType(1, attacked_entity=3000850, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
...
def Event13005530():
    ...
    EndIfThisEventSlotOn()
    Wait(5.0)
    Move(3000496, destination=3002500, destination_type=CoordEntityType.Region, model_point=-1, short_move=True)
    Move(3000580, destination=3002501, destination_type=CoordEntityType.Region, model_point=-1, short_move=True)
    Move(3000526, destination=3002502, destination_type=CoordEntityType.Region, model_point=-1, short_move=True)
    Move(3000522, destination=3002503, destination_type=CoordEntityType.Region, model_point=-1, short_move=True)
...
def Event13005810():
    ...
    Move(3000800, destination=3002811, destination_type=CoordEntityType.Region, model_point=-1, short_move=True, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
...
def Event13005890():
    ...
    Move(3000899, destination=3002893, destination_type=CoordEntityType.Region, model_point=-1, short_move=True)
...
def Event13005600(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int):
    ...
    Move(ARG_0_3, destination=3002705, destination_type=CoordEntityType.Region, model_point=-1, short_move=True)
    ...
    DisableGravity(ARG_0_3)
    DisableCollision(ARG_0_3)
    Move(ARG_0_3, destination=3002710, destination_type=CoordEntityType.Region, model_point=-1, short_move=True)
    DisableObject(ARG_4_7)
    GotoIfFlagOn(Label.L10, 1438)
