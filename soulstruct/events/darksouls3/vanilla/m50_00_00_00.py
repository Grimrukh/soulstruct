...
def Event15005300(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int):
    ...
    MakeEnemyAppear(ARG_8_11)
    WaitFrames(1)
    Move(ARG_4_7, destination=ARG_0_3, destination_type=CoordEntityType.Character, model_point=8, copy_draw_parent=ARG_0_3)
    Restart()
...
def Event15005340(ARG_0_3: int, ARG_4_7: int):
    ...
    EnableAI(ARG_4_7)
    Move(ARG_4_7, destination=ARG_0_3, destination_type=CoordEntityType.Character, model_point=50, copy_draw_parent=ARG_0_3)
    WaitFrames(1)
    ReplanAI(ARG_4_7)
...
def Event15005360(ARG_0_3: int, ARG_4_7: int):
    ...
    IfCharacterHasSpecialEffect(0, character=ARG_0_3, special_effect=16249)
    Move(ARG_0_3, destination=5002390, destination_type=CoordEntityType.Region, model_point=-1, copy_draw_parent=ARG_0_3)
...
def Event15005825(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int, ARG_24_27: int):
    ...
    Move(ARG_4_7, destination=ARG_0_3, destination_type=CoordEntityType.Character, model_point=ARG_20_23, copy_draw_Collision=ARG_0_3)
    SetNetworkConnectedFlagState(flag=ARG_8_11, state=FlagState.On)
    ReplanAI(ARG_4_7)
