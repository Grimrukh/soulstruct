...
def RunCommonEvent(event_id: int, args=(0,), arg_types=None):
    ...
    return to_numeric(instruction_info, event_id, *args, arg_types=format_string)
...
def IfCharacterInvadeType(condition: int, character: CharacterInt, invade_type: int,
                          target_comparison_type: ComparisonType = ComparisonType.Equal, target_count: float = 1.0):
    """ 'invade_type' has an unknown type in the EMEDF. Probably refers to the invader's covenant. """
    instruction_info = (4, 27)
    return to_numeric(instruction_info, condition, character, invade_type,
                      target_comparison_type, target_count)
...
def IfObjectBurnState(condition: int, obj: ObjectInt, comparison_type: ComparisonType, state: bool,
                      target_comparison_type: ComparisonType = ComparisonType.Equal, target_count: float = 1.0):
    ...
    return to_numeric(instruction_info, condition, obj, comparison_type, state,
                      target_comparison_type, target_count)


def IfObjectBackreadState(condition: int, obj: ObjectInt, state: bool,
                          target_comparison_type: ComparisonType = ComparisonType.Equal, target_count: float = 1.0):
    instruction_info = (5, 10)
    return to_numeric(instruction_info, condition, obj, state,
                      target_comparison_type, target_count)
...
def IfObjectBackreadState_Alternate(condition: int, obj: ObjectInt, state: bool,
                                    target_comparison_type: ComparisonType = ComparisonType.Equal,
                                    target_count: float = 1.0):
...
def GotoIfCharacterSpecialEffectState(label: Label, character: CharacterInt, special_effect: int, state: bool,
                                      target_comparison_type: ComparisonType = ComparisonType.Equal,
                                      target_count: int = 1):
    """ Note that 'target_count' is now an integer again... """
    instruction_info = (1003, 11)
    return to_numeric(instruction_info, label, character, special_effect, state,
                      target_comparison_type, target_count)


def GotoIfCharacterHasSpecialEffect(label: Label, character: CharacterInt, special_effect: int,
                                    target_comparison_type: ComparisonType = ComparisonType.Equal,
                                    target_count: int = 1):
...
def GotoIfCharacterDoesNotHaveSpecialEffect(label: Label, character: CharacterInt, special_effect: int,
                                            target_comparison_type: ComparisonType = ComparisonType.Equal,
                                            target_count: int = 1):
...
def TerminateIfPlayerOwnWorldState(event_end_type: EventEndType, not_in_own_world: bool):
    ...
    return to_numeric(instruction_info, event_end_type, not_in_own_world)
...
def TerminateIfCharacterSpecialEffectState(event_end_type: EventEndType, character: CharacterInt,
                                           special_effect: int, state: bool,
                                           target_comparison_type: ComparisonType = ComparisonType.Equal,
                                           target_count: int = 1):
    instruction_info = (1003, 111)
    return to_numeric(instruction_info, event_end_type, character, special_effect, state,
                      target_comparison_type, target_count)
...
def SkipLinesIfCharacterSpecialEffectState(line_count: int, character: CharacterInt,
                                           special_effect: int, state: bool,
                                           target_comparison_type: ComparisonType = ComparisonType.Equal,
                                           target_count: int = 1):
    instruction_info = (1003, 112, [0, 0, -1, 0, 0, 0])
    return to_numeric(instruction_info, line_count, character, special_effect, state,
                      target_comparison_type, target_count)
...
def PlayCutsceneAndMovePlayerAndSetTimePeriod(cutscene: int, cutscene_type: CutsceneType, region: RegionInt,
                                              game_map: MapOrSequence, player_id: int, time_period_id: int):
    ...
    area_id, block_id = tuple(game_map)
    return to_numeric(instruction_info, cutscene, cutscene_type, region, area_id, block_id, player_id,
                      time_period_id)
...
def PlayCutsceneAndMovePlayerAndSetMapCeremony(cutscene: int, cutscene_type: CutsceneType, ceremony_id: int,
                                               unknown: int, region: RegionInt, game_map: MapOrSequence,
                                               player_id: int):
    ...
    area_id, block_id = tuple(game_map)
    return to_numeric(instruction_info, cutscene, cutscene_type, ceremony_id, unknown, region, area_id,
                      block_id, player_id)
...
def PlayCutsceneAndMovePlayer_WithUnknowns(cutscene: int, cutscene_type: CutsceneType, region: RegionInt,
                                           game_map: MapOrSequence, player_id: int, unknown1: int, unknown2: int):
...
def PlayCutsceneAndMovePlayer_WithSecondRegion(cutscene: int, cutscene_type: CutsceneType, region: RegionInt,
                                               game_map: MapOrSequence, player_id: int, other_region: RegionInt):
...
def EventValueOperation(source_flag: FlagInt, source_flag_bit_count: int, operand: int, target_flag: FlagInt,
    ...
    return to_numeric(instruction_info, source_flag, source_flag_bit_count, operand, target_flag,
...
def InitializeCrowTrade(item_type: ItemType, item_id: ItemInt, item_lot_id: ItemLotInt,
                        trade_completed_flag: FlagInt, crow_response_flag: FlagInt):
    instruction_info = (2003, 66)
    return to_numeric(instruction_info, item_type, item_id, item_lot_id, trade_completed_flag,
                      crow_response_flag)
...
def SetDecoratedBossHealthBarState(state: bool, character: CharacterInt, slot: int, name: EventTextInt,
                                   decoration: int):
...
def RotateToFaceEntity(character: CharacterInt, target_entity: CoordEntityInt, animation: int,
...
def Test_RequestRagdollRestraint(recipient_character: CharacterInt, recipient_target_rigid_index: int,
    ...
    return to_numeric(instruction_info, recipient_character, recipient_target_rigid_index,
...
def DisplayDialogAndSetFlags(message: EventTextInt, button_type: ButtonType, number_buttons: NumberButtons,
                             anchor_entity: CoordEntityInt, display_distance: float, left_flag: FlagInt,
    ...
    return to_numeric(instruction_info, message, button_type, number_buttons, anchor_entity, display_distance,
...
def RegisterHealingFountain(flag: FlagInt, obj: ObjectInt, reaction_distance: float, reaction_angle: float,
    ...
    return to_numeric(instruction_info, flag, obj, reaction_distance, reaction_angle, initial_sword_number,
                      sword_level)
...
def PlayLogParameterOutput(category: PlayerPlayLogParameter, name: StringOffsetInt,
