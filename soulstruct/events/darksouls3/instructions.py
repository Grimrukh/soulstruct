...
def TerminateIfCharacterSpecialEffectState(
    ...
    return to_numeric(
        instruction_info, event_end_type, character, special_effect, state, target_comparison_type, target_count
    )
...
def PlayCutsceneAndMovePlayerAndSetMapCeremony(
    ...
    area_id, block_id = tuple(game_map)
    return to_numeric(
        instruction_info, cutscene, cutscene_type, ceremony_id, unknown, region, area_id, block_id, player_id
    )
...
def PlayCutsceneAndMovePlayer_WithUnknowns(
    ...
    area_id, block_id = tuple(game_map)
    return to_numeric(
        instruction_info, cutscene, cutscene_type, region, area_id, block_id, player_id, unknown1, unknown2
    )
...
def PlayCutsceneAndMovePlayer_WithSecondRegion(
    ...
    area_id, block_id = tuple(game_map)
    return to_numeric(instruction_info, cutscene, cutscene_type, region, area_id, block_id, player_id, other_region)
