...
def IsAttackedWithDamageType(attacked_entity: CharacterTyping, attacking_character: CharacterTyping, damage_type): ...
def ActionButtonInRegion(action_button_id: int, region: RegionTyping): ...
