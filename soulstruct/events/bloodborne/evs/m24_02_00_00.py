...
def Event12424790():
    ...
    WaitFrames(5)
    DisableCharacter(2420810)
    Move(2420811, destination=2420810, destination_type=CoordEntityType.Character, model_point=203, copy_draw_hitbox=2420810)
...
def Event12424791():
    ...
    WaitFrames(135)
    Move(2420750, destination=2420811, destination_type=CoordEntityType.Character, model_point=40, copy_draw_hitbox=2420811)
    Move(2420751, destination=2420811, destination_type=CoordEntityType.Character, model_point=41, copy_draw_hitbox=2420811)
    Restart()
...
def Event12420320():
    ...
    Move(2420200, destination=2422200, destination_type=CoordEntityType.Region, model_point=-1, set_draw_hitbox=2420203)
    Move(2420201, destination=2422201, destination_type=CoordEntityType.Region, model_point=-1, set_draw_hitbox=2420203)
    Move(2420202, destination=2422202, destination_type=CoordEntityType.Region, model_point=-1, set_draw_hitbox=2420203)
