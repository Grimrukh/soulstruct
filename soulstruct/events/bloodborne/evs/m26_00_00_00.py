...
268: PC情報_トラップロード到達時
300: N:\\SPRJ\\data\\Param\\event\\common.events
376: 
378: 
380: 
382: 
...
def Event12604830(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int):
    ...
    Move(ARG_0_3, destination=ARG_8_11, destination_type=CoordEntityType.Region, model_point=-1, set_draw_hitbox=0)
    SkipLines(2)
    DisableCharacter(ARG_0_3)
    Move(ARG_0_3, destination=ARG_12_15, destination_type=CoordEntityType.Region, model_point=-1, set_draw_hitbox=0)
    Wait(2.0)
...
def Event12604840():
    ...
    Label(4)
    WaitFrames(1)
    CreateTemporaryFX(655105, anchor_entity=2600801, anchor_type=CoordEntityType.Character, model_point=220)
    ReplanAI(2600801)
    ...
    IfDamageType(-1, attacked_entity=2600801, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
    IfConditionTrue(0, input_condition=-1)
    CreateTemporaryFX(655105, anchor_entity=2600801, anchor_type=CoordEntityType.Character, model_point=220)
    WaitFrames(10)
    DisableCharacter(2600801)
...
def Event12604856():
    ...
    IfFlagOn(0, 12604986)
    EnableBossHealthBar(2600850, name=899000, slot=0)
    Move(2600850, destination=2602062, destination_type=CoordEntityType.Region, model_point=-1, set_draw_hitbox=2604810)
...
def Event12604878():
    ...
    CreateTemporaryFX(926201, anchor_entity=2601853, anchor_type=CoordEntityType.Object, model_point=800)
    ForceAnimation(2600850, 103122, wait_for_completion=True)
    SkipLines(2)
    CreateTemporaryFX(926201, anchor_entity=2601854, anchor_type=CoordEntityType.Object, model_point=800)
    ForceAnimation(2600850, 103122, wait_for_completion=True)
    Move(2600850, destination=2602073, destination_type=CoordEntityType.Region, model_point=-1, set_draw_hitbox=2604811)
    SetNest(2600850, 2602065)
    WaitFrames(5)
    CreateTemporaryFX(926201, anchor_entity=2601855, anchor_type=CoordEntityType.Object, model_point=800)
...
def Event12604880(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int, ARG_24_27: int, ARG_28_31: int):
    ...
    IfDamageType(6, attacked_entity=2600850, attacking_character=-1, damage_type=DamageType.Unspecified)
    IfConditionTrue(-2, input_condition=1)
...
def Event12604888():
    ...
    EndIfFlagOn(12601850)
    IfCharacterHuman(1, PLAYER)
    IfDamageType(1, attacked_entity=2600850, attacking_character=-1, damage_type=DamageType.Unspecified)
    IfFlagOff(1, 12604946)
    IfFlagOff(1, 12604856)
    ...
    ForceAnimation(2600850, 103120)
    CreateTemporaryFX(926210, anchor_entity=2600850, anchor_type=CoordEntityType.Character, model_point=200)
    ...
    Restart()
    Label(0)
    Move(2600850, destination=2602040, destination_type=CoordEntityType.Region, model_point=-1, set_draw_hitbox=2604800)
    Restart()
    Label(1)
    Move(2600850, destination=2602041, destination_type=CoordEntityType.Region, model_point=-1, set_draw_hitbox=2604800)
    Restart()
    Label(2)
    Move(2600850, destination=2602042, destination_type=CoordEntityType.Region, model_point=-1, set_draw_hitbox=2604801)
    Restart()
    Label(3)
    Move(2600850, destination=2602043, destination_type=CoordEntityType.Region, model_point=-1, set_draw_hitbox=2604801)
    Restart()
    Label(4)
    Move(2600850, destination=2602044, destination_type=CoordEntityType.Region, model_point=-1, set_draw_hitbox=2604802)
    Restart()
    Label(5)
    Move(2600850, destination=2602045, destination_type=CoordEntityType.Region, model_point=-1, set_draw_hitbox=2604802)
    Restart()
...
def Event12604889():
    ...
    Move(2600850, destination=2602059, destination_type=CoordEntityType.Region, model_point=-1, set_draw_hitbox=2604810)
    Restart()
    Move(2600850, destination=2602060, destination_type=CoordEntityType.Region, model_point=-1, set_draw_hitbox=2604812)
    Restart()
    Move(2600850, destination=2602061, destination_type=CoordEntityType.Region, model_point=-1, set_draw_hitbox=2604812)
    Restart()
    Move(2600850, destination=2602062, destination_type=CoordEntityType.Region, model_point=-1, set_draw_hitbox=2604810)
    Restart()
    Move(2600850, destination=2602063, destination_type=CoordEntityType.Region, model_point=-1, set_draw_hitbox=2604810)
    Restart()
    Move(2600850, destination=2602077, destination_type=CoordEntityType.Region, model_point=-1, set_draw_hitbox=2604810)
    Restart()
    Move(2600850, destination=2602065, destination_type=CoordEntityType.Region, model_point=-1, set_draw_hitbox=2604811)
    Restart()
    Move(2600850, destination=2602066, destination_type=CoordEntityType.Region, model_point=-1, set_draw_hitbox=2604813)
    Restart()
    Move(2600850, destination=2602067, destination_type=CoordEntityType.Region, model_point=-1, set_draw_hitbox=2604811)
    Restart()
    Move(2600850, destination=2602068, destination_type=CoordEntityType.Region, model_point=-1, set_draw_hitbox=2604811)
    Restart()
    Move(2600850, destination=2602078, destination_type=CoordEntityType.Region, model_point=-1, set_draw_hitbox=2604811)
    Restart()
...
def Event12604930():
    ...
    IfDamageType(-1, attacked_entity=2600850, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
    IfConditionTrue(0, input_condition=-1)
    EnableAI(2600850)
...
def Event12604931(ARG_0_3: int, ARG_4_7: int):
    ...
    WaitFrames(1)
    IfFlagOn(2, ARG_0_3)
    IfDamageType(2, attacked_entity=2600850, attacking_character=-1, damage_type=DamageType.Unspecified)
    IfConditionTrue(0, input_condition=2)
    WaitFrames(1)
    IfFlagOn(3, ARG_0_3)
    IfDamageType(3, attacked_entity=2600850, attacking_character=-1, damage_type=DamageType.Unspecified)
...
def Event12600021():
    ...
    Move(2600100, destination=2602019, destination_type=CoordEntityType.Region, model_point=-1, short_move=True)
    IfAllPlayersOutsideRegion(0, region=2602017)
    Move(2600100, destination=2602018, destination_type=CoordEntityType.Region, model_point=-1, short_move=True)
    Restart()
...
def Event12600029():
    ...
    IfDamageType(1, attacked_entity=2600129, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
    IfConditionTrue(0, input_condition=1)
...
def Event12600031():
    ...
    IfDamageType(0, attacked_entity=2600500, attacking_character=-1, damage_type=DamageType.Unspecified)
...
def Event12600110(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int):
    ...
    WaitFrames(5)
    Move(ARG_4_7, destination=ARG_0_3, destination_type=CoordEntityType.Character, model_point=30, copy_draw_hitbox=ARG_0_3)
    EnableCharacter(ARG_4_7)
    ForceAnimation(ARG_4_7, 7000)
    WaitFrames(15)
    Move(ARG_8_11, destination=ARG_0_3, destination_type=CoordEntityType.Character, model_point=30, copy_draw_hitbox=ARG_0_3)
