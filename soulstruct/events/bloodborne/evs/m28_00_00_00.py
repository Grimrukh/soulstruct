...
254: ボス戦_撃破時間
272: PC情報_生贄の街到達時
298: N:\\SPRJ\\data\\Param\\event\\common.events
374: 
376: 
378: 
380: 
...
def Event12804806():
    ...
    Wait(1.0)
    Label(0)
    Move(2800801, destination=2800800, destination_type=CoordEntityType.Character, model_point=100, set_draw_hitbox=2800801)
    Restart()
