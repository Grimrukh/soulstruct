...
92: PC情報_ボス撃破_白痴の蜘蛛
124: ボス_戦闘開始
140: N:\\SPRJ\\data\\Param\\event\\common.events
216: 
218: 
220: 
222: 
...
def Event13200102():
    ...
    Move(3200101, destination=3202852, destination_type=CoordEntityType.Region, model_point=-1, short_move=True)
    ...
    Move(3200101, destination=3202851, destination_type=CoordEntityType.Region, model_point=-1, short_move=True)
...
def Event13200103():
    ...
    IfFlagOn(1, 1420)
    IfFlagOn(1, 73200327)
    IfDamageType(2, attacked_entity=3200101, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
    IfConditionTrue(-1, input_condition=1)
    IfConditionTrue(-1, input_condition=2)
    IfConditionTrue(0, input_condition=-1)
...
def Event13201802():
    ...
    IfThisEventOff(1)
    IfDamageType(1, attacked_entity=3200800, attacking_character=-1, damage_type=DamageType.Unspecified)
    IfConditionTrue(0, input_condition=1)
    EnableFlag(13204800)
    EndIfFlagOn(9303)
    RunEvent(9350, slot=0, args=(2,))
...
def Event13201803():
    ...
    Move(3200801, destination=3202815, destination_type=CoordEntityType.Region, model_point=-1, short_move=True)
    Goto(Label.L1)
    Move(3200801, destination=3202816, destination_type=CoordEntityType.Region, model_point=-1, short_move=True)
    Goto(Label.L1)
    Move(3200801, destination=3202817, destination_type=CoordEntityType.Region, model_point=-1, short_move=True)
    Goto(Label.L1)
    Move(3200801, destination=3202818, destination_type=CoordEntityType.Region, model_point=-1, short_move=True)
    Label(1)
...
def Event13204807():
    ...
    DisableCharacter(3200800)
    Wait(3.0)
    Move(3200800, destination=3202806, destination_type=CoordEntityType.Region, model_point=-1, short_move=True)
    ...
    DisableCharacter(3200800)
    Wait(3.0)
    Move(3200800, destination=3202807, destination_type=CoordEntityType.Region, model_point=-1, short_move=True)
    EnableCharacter(3200800)
    ForceAnimation(3200800, 3021)
...
def Event13204820():
    ...
    CreateTemporaryFX(932210, anchor_entity=10000, anchor_type=CoordEntityType.Character, model_point=246)
    Label(0)
    Wait(5.0)
...
def Event13205200():
    ...
    IfConditionTrue(0, input_condition=1)
    Move(3200621, destination=3200620, destination_type=CoordEntityType.Character, model_point=90, copy_draw_hitbox=3200620)
