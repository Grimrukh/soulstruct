...
def PlayBloodStarvedBeastDeathSound():
    ...
    IfFlagOn(1, Flags.BloodStarvedBeastDead)
...
def EnterBloodStarvedBeastFog():
    ...
    IfFlagOff(2, Flags.BloodStarvedBeastDead)
    IfFlagOn(3, Flags.BloodStarvedBeastDead)
    IfConditionTrue(-1, input_condition=2)
...
def Event12304805():
    ...
    DisableNetworkSync()
    EndIfFlagOn(Flags.BloodStarvedBeastDead)
    IfFlagOn(0, Flags.BloodStarvedBeastDead)
    DisableBossMusic(2303802)
...
def Event12304807():
    ...
    IfHasTAEEvent(0, Characters.BloodStarvedBeast, tae_event_id=10)
...
def Event12304808():
    ...
    ReplanAI(Characters.BloodStarvedBeast)
    IfHasTAEEvent(0, Characters.BloodStarvedBeast, tae_event_id=20)
    AICommand(Characters.BloodStarvedBeast, command_id=-1, slot=0)
    ReplanAI(Characters.BloodStarvedBeast)
...
def PlayDarkbeastPaarlDeathSound():
    ...
    IfFlagOn(1, Flags.DarkbeastPaarlDead)
...
def Event12304730():
    ...
    EndIfFlagOn(Flags.DarkbeastPaarlDead)
    GotoIfFlagOn(Label.L0, Flags.DarkbeastPaarlFirstTimeDone)
    SkipLinesIfClient(2)
    DisableObject(2301810)
    DeleteFX(2303810, erase_root_only=False)
    DisableObject(2301811)
    DeleteFX(2303811, erase_root_only=False)
    IfFlagOff(1, Flags.DarkbeastPaarlDead)
    IfFlagOn(1, Flags.DarkbeastPaarlFirstTimeDone)
    IfConditionTrue(0, input_condition=1)
    ...
    IfFlagOff(2, Flags.DarkbeastPaarlDead)
    IfFlagOn(3, Flags.DarkbeastPaarlDead)
    IfConditionTrue(-1, input_condition=2)
    IfConditionTrue(-1, input_condition=3)
    IfConditionTrue(0, input_condition=-1)
    EndIfFinishedConditionTrue(3)
...
def Event12304703():
    ...
    IfHasTAEEvent(2, Characters.DarkbeastPaarl, tae_event_id=20)
...
def Event12304705():
    ...
    DisableNetworkSync()
    EndIfFlagOn(Flags.DarkbeastPaarlDead)
    IfFlagOn(0, Flags.DarkbeastPaarlDead)
    DisableBossMusic(2303812)
...
def Event12304707():
    ...
    IfHasTAEEvent(0, Characters.DarkbeastPaarl, tae_event_id=20)
...
def Event12304715(
    ...
    SetNPCPartEffects(Characters.DarkbeastPaarl, npc_part_id=arg_4_7, material_special_effect_id=77, material_fx_id=77)
    ...
    ReplanAI(Characters.DarkbeastPaarl)
    IfHasTAEEvent(0, Characters.DarkbeastPaarl, tae_event_id=300)
    SetNPCPartHealth(Characters.DarkbeastPaarl, npc_part_id=arg_4_7, desired_hp=-1, overwrite_max=True)
...
def Event12300100():
    ...
    Move(2300204, destination=2302300, destination_type=CoordEntityType.Region, model_point=-1, set_draw_parent=2306000)
    ...
    IfAttackedWithDamageType(-3, attacked_entity=2300204, attacking_character=-1)
    IfConditionTrue(0, input_condition=-3)
...
def Event12305000():
    ...
    IfAttackedWithDamageType(-2, attacked_entity=2300250, attacking_character=-1)
    IfConditionTrue(0, input_condition=-2)
...
def Event12305070():
    ...
    IfConditionTrue(1, input_condition=-2)
    IfConditionTrue(-3, input_condition=1)
    IfAttackedWithDamageType(-3, attacked_entity=2300520, attacking_character=-1)
    IfConditionTrue(0, input_condition=-3)
...
def Event12305080():
    ...
    IfConditionTrue(-3, input_condition=1)
    IfConditionTrue(-3, input_condition=2)
    IfAttackedWithDamageType(-3, attacked_entity=2300314, attacking_character=-1)
    IfConditionTrue(0, input_condition=-3)
    EndIfFinishedConditionTrue(2)
...
def Event12305130():
    ...
    IfConditionTrue(1, input_condition=-2)
    IfConditionTrue(-3, input_condition=1)
    IfAttackedWithDamageType(-3, attacked_entity=2300203, attacking_character=-1)
    IfConditionTrue(0, input_condition=-3)
...
def Event12305480():
    ...
    IfConditionTrue(-3, input_condition=1)
    IfConditionTrue(-3, input_condition=2)
    IfAttackedWithDamageType(-3, attacked_entity=2300406, attacking_character=-1)
    IfConditionTrue(0, input_condition=-3)
    EndIfFinishedConditionTrue(2)
...
def Event12305481():
    ...
    IfAttackedWithDamageType(-2, attacked_entity=2300406, attacking_character=-1)
    IfConditionTrue(0, input_condition=-2)
...
def Event12300703():
    ...
    IfConditionTrue(1, input_condition=-1)
    IfFlagOn(1, 1320)
    IfAttackedWithDamageType(1, attacked_entity=2300710, attacking_character=PLAYER)
    IfConditionTrue(2, input_condition=-1)
    IfFlagOn(2, 1325)
    IfAttackedWithDamageType(2, attacked_entity=2300710, attacking_character=PLAYER)
    IfFlagOn(3, 1325)
