...
def EbrietasDies():
    ...
    DeleteFX(FX.EbrietasFog, erase_root_only=False)
    End()
    ...
    DisableObject(Objects.EbrietasFog)
    DeleteFX(FX.EbrietasFog, erase_root_only=True)
...
def Event12421801():
    ...
    DisableNetworkSync()
    EndIfFlagOn(Flags.EbrietasDead)
    IfFlagOn(1, Flags.EbrietasDead)
...
def EbrietasFirstTime():
    ...
    IfThisEventOff(1)
    IfCharacterHuman(1, PLAYER)
    IfAttackedWithDamageType(1, attacked_entity=Characters.Ebrietas, attacking_character=PLAYER)
    IfConditionTrue(0, input_condition=1)
...
def SummonStartEbrietasBattle():
    ...
    IfCharacterHuman(1, PLAYER)
    IfFlagOn(1, Flags.EbrietasFogEntered)
    IfConditionTrue(0, input_condition=1)
    EndIfHost()
    EnableFlag(Flags.EbrietasFogEntered)
...
def EnterEbrietasFog():
    ...
    CreateFX(FX.EbrietasFog)

    # --- 0 --- #
    DefineLabel(0)
    IfFlagOff(2, Flags.EbrietasDead)
    IfCharacterHuman(2, PLAYER)
    IfActionButtonParam(2, action_button_id=2420800, entity=Objects.EbrietasFog)
    IfFlagOn(3, Flags.EbrietasDead)
    IfConditionTrue(-1, input_condition=2)
...
def ControlEbrietasMusic():
    ...
    DisableSoundEvent(2423803)
    IfFlagOff(1, Flags.EbrietasDead)
    IfFlagOn(1, Flags.EbrietasBattleStarted)
    SkipLinesIfHost(1)
    IfFlagOn(1, 12424801)
    ...
    EnableFlag(12425246)
    IfHasTAEEvent(2, Characters.Ebrietas, tae_event_id=100)

    # --- 0 --- #
    DefineLabel(0)
    IfFlagOff(2, Flags.EbrietasDead)
    IfFlagOn(2, Flags.EbrietasBattleStarted)
    SkipLinesIfHost(1)
    IfFlagOn(2, 12424801)
...
def ControlEbrietasCamera():
    ...
    DisableNetworkSync()
    EndIfFlagOn(Flags.EbrietasDead)
    IfHasTAEEvent(0, Characters.Ebrietas, tae_event_id=10)
    SetLockedCameraSlot(game_map=UPPER_CATHEDRAL_WARD, camera_slot=1)
    IfHasTAEEvent(0, Characters.Ebrietas, tae_event_id=20)
    SetLockedCameraSlot(game_map=UPPER_CATHEDRAL_WARD, camera_slot=0)
    Restart()
...
def EbrietasHeadDamage(
    ...
    SetNPCPartEffects(Characters.Ebrietas, npc_part_id=arg_4_7, material_special_effect_id=75, material_fx_id=75)
    ...
    IfHasTAEEvent(0, Characters.Ebrietas, tae_event_id=100)
    SetNPCPartHealth(Characters.Ebrietas, npc_part_id=arg_4_7, desired_hp=-1, overwrite_max=True)
...
def EbrietasLimbDamage(
    ...
    SetNPCPartEffects(Characters.Ebrietas, npc_part_id=arg_4_7, material_special_effect_id=74, material_fx_id=74)
    IfCharacterPartHealthLessThanOrEqual(2, Characters.Ebrietas, npc_part_id=arg_4_7, value=0)
    IfHealthLessThanOrEqual(3, Characters.Ebrietas, 0.0)
    IfConditionTrue(-1, input_condition=2)
    IfConditionTrue(-1, input_condition=3)
...
def CelestialEmissaryDies():
    ...
    DeleteFX(FX.CelestialEmissaryEntranceFog, erase_root_only=False)
    DeleteFX(FX.CelestialEmissaryExitFog, erase_root_only=False)
    End()
    ...
    DisableObject(Objects.CelestialEmissaryFog)
    DisableObject(Objects.CelestialEmissaryExitFog)
    DeleteFX(FX.CelestialEmissaryEntranceFog, erase_root_only=True)
    DeleteFX(FX.CelestialEmissaryExitFog, erase_root_only=True)
    SetLockedCameraSlot(game_map=UPPER_CATHEDRAL_WARD, camera_slot=0)
    DisableCharacter(2420750)
    DisableCharacter(2420751)
    Wait(3.0)
...
def CelestialEmissaryFirstTime():
    ...
    EndIfFlagOn(Flags.CelestialEmissaryDead)
    EndIfThisEventOn()
    DisableCharacter(Characters.CelestialEmissarySmall)
    DisableCharacter(Characters.CelestialMinion1)
    DisableCharacter(Characters.CelestialMinion2)
...
def SummonStartCelestialEmissaryBattle():
    ...
    IfCharacterHuman(1, PLAYER)
    IfFlagOn(1, Flags.CelestialEmissaryFogEntered)
    IfConditionTrue(0, input_condition=1)
    EndIfHost()
    EnableFlag(Flags.CelestialEmissaryFogEntered)
    EnableFlag(Flags.CelestialEmissaryFirstTimeDone)
...
def EnterCelestialEmissaryFog():
    ...
    CreateFX(FX.CelestialEmissaryEntranceFog)
    CreateFX(FX.CelestialEmissaryExitFog)
    ...
    IfFlagOn(3, Flags.CelestialEmissaryDead)
    IfConditionTrue(-1, input_condition=2)
    IfConditionTrue(-1, input_condition=3)
    IfConditionTrue(0, input_condition=-1)
    EndIfFinishedConditionTrue(3)
...
def StartCelestialEmissaryBattle():
    ...
    EndIfFlagOff(Flags.CelestialEmissaryFirstTimeDone)
    IfCharacterInsideRegion(-1, PLAYER, region=2422817)
    IfAttackedWithDamageType(-1, attacked_entity=Characters.CelestialEmissarySmall, attacking_character=PLAYER)
    IfAttackedWithDamageType(-1, attacked_entity=Characters.CelestialMinion1, attacking_character=PLAYER)
    IfAttackedWithDamageType(-1, attacked_entity=Characters.CelestialMinion2, attacking_character=PLAYER)
    IfAttackedWithDamageType(-1, attacked_entity=Characters.CelestialMinion3, attacking_character=PLAYER)
    IfAttackedWithDamageType(-1, attacked_entity=Characters.CelestialMinion4, attacking_character=PLAYER)
    IfAttackedWithDamageType(-1, attacked_entity=Characters.CelestialMinion5, attacking_character=PLAYER)
    IfAttackedWithDamageType(-1, attacked_entity=Characters.CelestialMinion6, attacking_character=PLAYER)
    IfAttackedWithDamageType(-1, attacked_entity=Characters.CelestialMinion7, attacking_character=PLAYER)
    IfConditionTrue(0, input_condition=-1)
    EnableAI(Characters.CelestialEmissarySmall)
    EnableAI(Characters.CelestialMinion1)
    EnableAI(Characters.CelestialMinion2)
...
def ControlCelestialEmissaryMusic():
    ...
    IfFlagOff(1, Flags.CelestialEmissaryDead)
    IfFlagOn(1, Flags.CelestialEmissaryBattleStarted)
    SkipLinesIfHost(1)
    IfFlagOn(1, 12424701)
    ...
    EnableFlag(12425246)
    IfFlagOn(0, Flags.CelestialEmissaryPhaseTwo)

    # --- 0 --- #
    DefineLabel(0)
    IfFlagOff(2, Flags.CelestialEmissaryDead)
    IfFlagOn(2, Flags.CelestialEmissaryBattleStarted)
    SkipLinesIfHost(1)
    IfFlagOn(2, 12424701)
...
def StopCelestialEmissaryMusic():
    ...
    DisableNetworkSync()
    EndIfFlagOn(Flags.CelestialEmissaryDead)
    IfFlagOn(0, Flags.CelestialEmissaryDead)
    DisableBossMusic(2423812)
...
def ApplyCelestialEmissaryAura():
    ...
    IfHasTAEEvent(0, Characters.CelestialEmissaryGiant, tae_event_id=40)
...
def CelestialEmissaryPhaseTwoTrigger():
    ...
    IfHasTAEEvent(0, Characters.CelestialEmissarySmall, tae_event_id=30)
...
def Event12424795():
    ...
    IfAttackedWithDamageType(1, attacked_entity=Characters.CelestialEmissaryGiant, attacking_character=PLAYER)
    IfConditionTrue(0, input_condition=1)
...
def Event12425225():
    ...
    IfAttackedWithDamageType(-3, attacked_entity=2420253, attacking_character=-1)
    IfConditionTrue(0, input_condition=-3)
