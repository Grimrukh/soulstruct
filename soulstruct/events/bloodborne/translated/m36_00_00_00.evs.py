...
def OrphanDies():
    ...
    DeleteFX(FX.OrphanFog1, erase_root_only=True)
    End()
    ...
    DeleteFX(FX.OrphanFog1, erase_root_only=True)
    DeleteFX(FX.OrphanFog2, erase_root_only=True)
...
def StartOrphanBattle():
    ...
    IfAttackedWithDamageType(-2, attacked_entity=Characters.Orphan, attacking_character=-1)
    IfConditionTrue(1, input_condition=-2)
    IfConditionTrue(0, input_condition=1)
...
def Event13605752():
    ...
    IfAttackedWithDamageType(2, attacked_entity=3600315, attacking_character=-1)
    IfConditionTrue(-2, input_condition=1)
    IfConditionTrue(-2, input_condition=2)
    IfConditionTrue(0, input_condition=-2)
...
def Event13605761():
    ...
    IfAttackedWithDamageType(3, attacked_entity=3600303, attacking_character=-1)
    IfConditionTrue(-2, input_condition=1)
    IfConditionTrue(-2, input_condition=2)
    IfConditionTrue(-2, input_condition=3)
    IfConditionTrue(0, input_condition=-2)
