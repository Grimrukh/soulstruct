...
def TriggerEnemyAI(_, enemy: CharacterTyping, trigger_region_1: RegionTyping, trigger_region_2: RegionTyping,
    ...
    IfAttackedWithDamageType(2, attacked_entity=enemy, attacking_character=PLAYER)
...
def Event12415080(
    ...
    IfAttackedWithDamageType(3, attacked_entity=enemy, attacking_character=PLAYER)
    IfConditionTrue(-3, input_condition=1)
    IfConditionTrue(-3, input_condition=2)
...
def Event12410200(_, arg_0_3: int, arg_4_7: int, arg_8_11: int):
    ...
    IfActionButtonParam(0, action_button_id=7100, entity=arg_4_7)
    DisplayDialog(
        10010172,
        anchor_entity=-1,
        display_distance=3.0,
...
def Event12415420(_, arg_0_3: int, arg_4_7: int, arg_8_11: int):
    ...
    IfAttackedWithDamageType(2, attacked_entity=arg_0_3, attacking_character=PLAYER)
...
def Event12415430(_, arg_0_3: int, arg_4_7: int, arg_8_11: float, arg_12_15: float):
    ...
    IfAttackedWithDamageType(2, attacked_entity=arg_4_7, attacking_character=PLAYER)
...
def Event12415460(
    ...
    IfAttackedWithDamageType(3, attacked_entity=arg_0_3, attacking_character=PLAYER)
    IfConditionTrue(-3, input_condition=1)
    IfConditionTrue(-3, input_condition=2)
    IfConditionTrue(-3, input_condition=3)
    IfConditionTrue(0, input_condition=-3)
...
def Event12415476(_, arg_0_3: int, arg_4_7: int):
    ...
    EndIfThisEventSlotOn()
    IfAttackedWithDamageType(0, attacked_entity=arg_0_3, attacking_character=PLAYER)
    ForceAnimation(2411202, 0, loop=True)
...
def EnableFlag2410IfBossesDead():
    ...
    EndIfThisEventOn()
    IfFlagOn(1, Flags.GascoigneDead)
    IfFlagOn(1, Flags.ClericBeastDead)
    IfConditionTrue(0, input_condition=1)
    EnableFlag(2410)
...
def ClericBeastDies():
    ...
    DeleteFX(FX.ClericBeastFog, erase_root_only=False)
    End()
    ...
    DisableObject(Objects.ClericBeastFog)
    DeleteFX(FX.ClericBeastFog, erase_root_only=True)
...
def PlayClericBeastDeathSound():
    ...
    DisableNetworkSync()
    EndIfFlagOn(Flags.ClericBeastDead)
    IfFlagOn(1, Flags.ClericBeastDead)
...
def ClericBeastFirstTime():
    ...
    IfConditionTrue(0, input_condition=1)
    Move(Characters.ClericBeast, destination=2412831, destination_type=CoordEntityType.Region, model_point=-1,
         short_move=True)
    EnableFlag(72410511)
...
def EnterClericBeastFog():
    ...
    CreateFX(FX.ClericBeastFog)

    # --- 0 --- #
    DefineLabel(0)
    IfFlagOff(2, Flags.ClericBeastDead)
    IfCharacterHuman(2, PLAYER)
    IfActionButtonParam(2, action_button_id=2410040, entity=Objects.ClericBeastFog)
    IfFlagOn(3, Flags.ClericBeastDead)
    IfConditionTrue(-1, input_condition=2)
...
def EnterClericBeastFogAsSummon():
    ...
    IfFlagOn(1, Flags.ClericBeastFogEntered)
    IfCharacterType(1, PLAYER, CharacterType.WhitePhantom)
    IfActionButtonParam(1, action_button_id=2410040, entity=Objects.ClericBeastFog)
    IfConditionTrue(0, input_condition=1)
    RotateToFaceEntity(PLAYER, 2412800, animation=101130, wait_for_completion=False)
...
def ControlClericBeastMusic():
    ...
    DisableSoundEvent(2413803)
    IfFlagOff(1, Flags.ClericBeastDead)
    IfFlagOn(1, Flags.ClericBeastBattleStarted)
    SkipLinesIfHost(1)
    IfFlagOn(1, 12414701)
    IfCharacterInsideRegion(1, PLAYER, region=2412801)
    IfConditionTrue(0, input_condition=1)
    EnableBossMusic(2413802)
    IfHasTAEEvent(2, Characters.ClericBeast, tae_event_id=100)

    # --- 0 --- #
    DefineLabel(0)
    IfFlagOff(2, Flags.ClericBeastDead)
    IfFlagOn(2, Flags.ClericBeastBattleStarted)
    SkipLinesIfHost(1)
    IfFlagOn(2, 12414701)
    IfCharacterInsideRegion(2, PLAYER, region=2412801)
    IfConditionTrue(0, input_condition=2)
...
def StopClericBeastMusic():
    ...
    DisableNetworkSync()
    EndIfFlagOn(Flags.ClericBeastDead)
    IfFlagOn(0, Flags.ClericBeastDead)
    DisableBossMusic(2413802)
...
def ClericBeastPhaseTwoTrigger():
    ...
    IfHasTAEEvent(0, Characters.ClericBeast, tae_event_id=100)
    AICommand(Characters.ClericBeast, command_id=-1, slot=1)
    ReplanAI(Characters.ClericBeast)
...
def ClericBeastLimbDamage(
    ...
    SetNPCPartEffects(Characters.ClericBeast, npc_part_id=arg_4_7, material_special_effect_id=72, material_fx_id=72)
    ...
    SetNPCPartEffects(Characters.ClericBeast, npc_part_id=arg_4_7, material_special_effect_id=73, material_fx_id=73)
    ...
    CancelSpecialEffect(Characters.ClericBeast, arg_20_23)
    ReplanAI(Characters.ClericBeast)
    Wait(30.0)
    AICommand(Characters.ClericBeast, command_id=1, slot=0)
    ReplanAI(Characters.ClericBeast)
    IfHasTAEEvent(0, Characters.ClericBeast, tae_event_id=300)
    SetNPCPartHealth(Characters.ClericBeast, npc_part_id=arg_4_7, desired_hp=-1, overwrite_max=True)
    AddSpecialEffect(Characters.ClericBeast, arg_20_23, affect_npc_part_hp=False)
    CancelSpecialEffect(Characters.ClericBeast, arg_16_19)
    AICommand(Characters.ClericBeast, command_id=-1, slot=0)
    ReplanAI(Characters.ClericBeast)
    WaitFrames(10)
    Restart()
...
def PlayFatherGascoigneDeathSound():
    ...
    DisableNetworkSync()
    EndIfFlagOn(Flags.GascoigneDead)
    IfFlagOn(1, Flags.GascoigneDead)
...
def FatherGascoigneFirstTime():
    ...
    EndIfThisEventOn()
    DisableCharacter(Characters.GascoigneHuman)
    IfFlagOff(1, Flags.GascoigneDead)
    IfThisEventOff(1)
    IfCharacterHuman(1, PLAYER)
    ...
    WaitFrames(1)
    DisableFlag(CommonFlags.CutsceneActive)
    Move(Characters.GascoigneHuman, destination=2412830, destination_type=CoordEntityType.Region, model_point=-1,
         short_move=True)
...
def SummonStartFatherGascoigneBattle():
    ...
    IfCharacterHuman(1, PLAYER)
    IfFlagOn(1, Flags.GascoigneFogEntered)
    IfConditionTrue(0, input_condition=1)
    EndIfHost()
    EnableCharacter(Characters.GascoigneHuman)
    EnableFlag(Flags.GascoigneFogEntered)
...
def EnterFatherGascoigneFog():
    ...
    EndIfFlagOn(Flags.GascoigneDead)
    GotoIfFlagOn(Label.L0, Flags.GascoigneFirstTimeDone)
    SkipLinesIfClient(2)
    DisableObject(2411810)
    DeleteFX(2413810, erase_root_only=False)
    IfFlagOff(1, Flags.GascoigneDead)
    IfFlagOn(1, Flags.GascoigneFirstTimeDone)
    IfConditionTrue(0, input_condition=1)
    ...
    # --- 0 --- #
    DefineLabel(0)
    IfFlagOff(2, Flags.GascoigneDead)
    IfCharacterHuman(2, PLAYER)
    IfActionButtonParam(2, action_button_id=2410041, entity=2411810)
    IfFlagOn(3, Flags.GascoigneDead)
    IfConditionTrue(-1, input_condition=2)
    IfConditionTrue(-1, input_condition=3)
    IfConditionTrue(0, input_condition=-1)
    EndIfFinishedConditionTrue(3)
...
def EnterFatherGascoigneFogAsSummon():
    ...
    IfFlagOn(1, Flags.GascoigneFogEntered)
    IfCharacterType(1, PLAYER, CharacterType.WhitePhantom)
    IfActionButtonParam(1, action_button_id=2410041, entity=2411810)
    IfConditionTrue(0, input_condition=1)
    RotateToFaceEntity(PLAYER, 2412810, animation=101130, wait_for_completion=False)
    IfCharacterType(2, PLAYER, CharacterType.WhitePhantom)
...
def StartFatherGascoigneBattle():
    ...
    GotoIfFlagOn(Label.L5, Flags.GascoignePhaseTwo)
...
def ControlFatherGascoigneMusic():
    ...
    IfFlagOn(1, 12414802)
    SkipLinesIfHost(1)
    IfFlagOn(1, Flags.GascoigneFogEnteredAsSummon)
    IfCharacterInsideRegion(1, PLAYER, region=2412812)
    IfConditionTrue(0, input_condition=1)
    EnableBossMusic(2413812)
    IfFlagOn(2, Flags.GascoignePhaseTwo)
    ...
    IfFlagOn(2, 12414802)
    SkipLinesIfHost(1)
    IfFlagOn(2, Flags.GascoigneFogEnteredAsSummon)
...
def ControlFatherGascoigneCamera():
    ...
    DisableNetworkSync()
    EndIfFlagOn(Flags.GascoigneDead)
    GotoIfFlagOn(Label.L0, Flags.GascoignePhaseTwo)
...
def FatherGascoignePhaseTwoTrigger():
    ...
    IfHasTAEEvent(2, Characters.GascoigneHuman, tae_event_id=30)
    IfConditionTrue(-1, input_condition=1)
    IfConditionTrue(-1, input_condition=2)
    IfConditionTrue(0, input_condition=-1)
    AICommand(Characters.GascoigneHuman, command_id=40, slot=0)
    SkipLinesIfFinishedConditionTrue(1, 2)
    IfHasTAEEvent(0, Characters.GascoigneHuman, tae_event_id=30)
    WaitFrames(5)
    DisableCharacter(Characters.GascoigneHuman)
...
def GascoigneHumanAffectedByMusicBox():
    ...
    IfHasTAEEvent(0, Characters.GascoigneHuman, tae_event_id=10)
...
def GascoigneBeastAffectedByMusicBox():
    ...
    IfFlagOn(0, Flags.GascoignePhaseTwo)
    Wait(3.0)
    ...
    IfHasTAEEvent(0, Characters.GascoigneBeast, tae_event_id=20)
...
def PlayerOnRoofInGascoigneBattle(_, on_roof: int, gascoigne: int, below_roof: int, on_stairs: int, off_roof: int):
    ...
    IfAttackedWithDamageType(-1, attacked_entity=gascoigne, attacking_character=PLAYER)
    IfConditionTrue(0, input_condition=-1)
...
def Event12415340(_, arg_0_3: int, arg_4_7: int, arg_8_11: float, arg_12_15: int):
    ...
    IfConditionTrue(-2, input_condition=3)
    IfConditionTrue(1, input_condition=-2)
    IfAttackedWithDamageType(4, attacked_entity=arg_0_3, attacking_character=-1)
    IfConditionTrue(-3, input_condition=1)
    IfConditionTrue(-3, input_condition=4)
    IfConditionTrue(0, input_condition=-3)
    GotoIfFinishedConditionTrue(Label.L1, input_condition=3)
...
def Event12415345(
    ...
    IfFlagOn(1, arg_0_3)
    IfCharacterInsideRegion(2, arg_4_7, region=arg_8_11)
    IfAttackedWithDamageType(3, attacked_entity=arg_4_7, attacking_character=-1)
    IfCharacterHuman(-1, PLAYER)
    IfCharacterType(-1, PLAYER, CharacterType.WhitePhantom)
...
def Event12410012():
    ...
    IfFlagOn(0, CommonFlags.HuntersDreamVisited)
...
def Event12410510():
    ...
    IfActionButtonParam(0, action_button_id=2410060, entity=2411200)
...
def Event12410645():
    ...
    EnableBackread(2410710)
    DisableBackread(2410711)
    Move(2410710, destination=2412172, destination_type=CoordEntityType.Region, model_point=-1, set_draw_parent=0)
...
def Event12410659():
    ...
    # --- 0 --- #
    DefineLabel(0)
    Move(2410710, destination=2412173, destination_type=CoordEntityType.Region, model_point=-1, set_draw_parent=0)
...
def Event12410676():
    ...
    IfCharacterHuman(1, PLAYER)
    IfAttackedWithDamageType(1, attacked_entity=2410703, attacking_character=PLAYER)
    IfFlagOn(-1, 1141)
    IfFlagOn(-1, 1142)
    IfFlagOn(-1, 1144)
    IfConditionTrue(1, input_condition=-1)
...
def Event12410677():
    ...
    EndIfFlagOn(1149)
    IfFlagOn(1, 1146)
    IfAttacked(1, 2410711, attacking_character=PLAYER)
    IfConditionTrue(0, input_condition=1)
...
def AggroEmissary(_, enemy: CharacterTyping):
    ...
    IfAttacked(0, enemy, attacking_character=PLAYER)
...
def Event12410710():
    ...
    DisableHealthBar(2410762)
    IfAttacked(0, 2410762, attacking_character=PLAYER)
    EnableFlag(72410406)
    Wait(2.0)
    Restart()
...
def Event12410734():
    ...
    IfCharacterHuman(15, PLAYER)
    EndIfConditionFalse(15)
    IfAttacked(0, 2410702, attacking_character=PLAYER)
    EnableFlag(72410306)
    Wait(2.0)
    Restart()
...
def Event12410747():
    ...
    IfAttackedWithDamageType(-1, attacked_entity=2410111, attacking_character=-1)
    IfConditionTrue(0, input_condition=-1)
    EnableAI(2410111)
...
def Event12410763():
    ...
    IfCharacterHuman(15, PLAYER)
    EndIfConditionFalse(15)
    IfAttackedWithDamageType(1, attacked_entity=2410782, attacking_character=-1)
    IfFlagOn(-1, 1240)
    IfFlagOn(-1, 1241)
    IfFlagOn(-1, 1242)
    IfConditionTrue(1, input_condition=-1)
...
def Event12410786():
    ...
    IfFlagOn(-1, 1290)
    IfFlagOn(-1, 1291)
    IfFlagOn(1, Flags.GascoignePhaseTwo)
    IfConditionTrue(1, input_condition=-1)
    IfConditionTrue(0, input_condition=1)
...
def Event12410800():
    ...
    Move(2410900, destination=2412334, destination_type=CoordEntityType.Region, model_point=-1, set_draw_parent=2414124)
    SetNest(2410900, 2412334)
    SetTeamType(2410900, TeamType.HostileNPC)
    Goto(Label.L9)
    SkipLinesIfFlagOff(4, 1702)
    Move(2410900, destination=2412332, destination_type=CoordEntityType.Region, model_point=-1, set_draw_parent=2414122)
...
def Event12410807():
    ...
    IfFlagOff(-1, 1365)
    IfConditionTrue(1, input_condition=-1)
    IfAttacked(1, 2410900, attacking_character=PLAYER)
    IfConditionTrue(0, input_condition=1)
    WaitFrames(1)
    IfFlagOff(-2, 1364)
    IfFlagOff(-2, 1365)
    IfConditionTrue(2, input_condition=-2)
    IfAttacked(2, 2410900, attacking_character=PLAYER)
    IfConditionTrue(0, input_condition=2)
    WaitFrames(1)
    IfFlagOff(-3, 1364)
    IfFlagOff(-3, 1365)
    IfConditionTrue(3, input_condition=-3)
    IfAttacked(3, 2410900, attacking_character=PLAYER)
    IfConditionTrue(0, input_condition=3)
    WaitFrames(1)
...
def Event12414400(_, arg_0_3: int, arg_4_7: int, arg_8_11: int, arg_12_15: int, arg_16_19: int, arg_20_23: int):
    ...
    IfFlagOff(1, Flags.GascoigneFirstTimeDone)
    ...
    IfFlagOff(2, Flags.GascoigneFirstTimeDone)
...
def Event12414500():
    ...
    IfConditionTrue(1, input_condition=-1)
    IfFlagOff(1, Flags.ClericBeastDead)
    IfFlagOn(1, 72400461)  # TODO: Cathedral Ward dialogue flag?
    IfFlagRangeAnyOn(1, (1340, 1341))
    IfConditionTrue(0, input_condition=1)
    GotoIfFinishedConditionTrue(Label.L1, input_condition=3)
    Move(2410740, destination=2412720, destination_type=CoordEntityType.Region, model_point=-1, set_draw_parent=0)
    Goto(Label.L2)

    # --- 1 --- #
    DefineLabel(1)
    Move(2410740, destination=2412721, destination_type=CoordEntityType.Region, model_point=-1, set_draw_parent=2414021)
...
def Event12414600():
    ...
    IfConditionTrue(0, input_condition=1)
    GotoIfFinishedConditionTrue(Label.L1, input_condition=3)
    Move(2410158, destination=2412702, destination_type=CoordEntityType.Region, model_point=-1, set_draw_parent=2414020)
    Goto(Label.L2)

    # --- 1 --- #
    DefineLabel(1)
    Move(2410158, destination=2412703, destination_type=CoordEntityType.Region, model_point=-1, set_draw_parent=2414021)
...
def Event12410239(_, arg_0_3: int):
    ...
    IfAttackedWithDamageType(4, attacked_entity=arg_0_3, attacking_character=PLAYER)
    IfConditionTrue(0, input_condition=4)
    WaitFrames(5)
...
def Event12410285(_, arg_0_3: int, arg_4_7: int, arg_8_11: int, arg_12_15: int):
    ...
    RegisterLadder(start_climbing_flag=arg_0_3, stop_climbing_flag=arg_4_7, obj=arg_8_11)
    DisableObjectActivation(arg_12_15, obj_act_id=2410000)
    IfActionButtonParam(0, action_button_id=7100, entity=arg_12_15)
    DisplayDialog(
        10010172,
        anchor_entity=-1,
        display_distance=3.0,
...
def Event12410370():
    ...
    IfAttacked(-3, 2410028, attacking_character=PLAYER)
    IfAttacked(-3, 2410030, attacking_character=PLAYER)
    IfConditionTrue(0, input_condition=-3)
...
def Event12410990():
    ...
    EndIfThisEventOn()
    IfStandingOnCollision(0, 2413500)
