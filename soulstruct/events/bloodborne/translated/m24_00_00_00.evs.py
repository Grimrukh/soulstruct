...
def Constructor():
    ...
    DisableFlag(2407)
    SkipLines(14)
    SkipLinesIfFlagOn(7, Flags.VicarAmeliaDead)
    DisableFlag(2400)
    DisableFlag(2401)
    DisableFlag(2405)
    DisableFlag(2406)
...
def Event12400507():
    ...
    IfCharacterHuman(15, PLAYER)
    EndIfConditionFalse(15)
    IfAttackedWithDamageType(1, attacked_entity=2400730, attacking_character=-1)
...
def Event12400570():
    ...
    IfCharacterHuman(15, PLAYER)
    EndIfConditionFalse(15)
    IfAttackedWithDamageType(1, attacked_entity=2400765, attacking_character=-1)
...
def Event12400582():
    ...
    IfFlagOn(0, Flags.VicarAmeliaFirstTimeDone)
...
def Event12400663():
    ...
    IfFlagOn(-1, 1371)
    IfConditionTrue(1, input_condition=-1)
    IfAttackedWithDamageType(1, attacked_entity=2400903, attacking_character=PLAYER)
    IfConditionTrue(0, input_condition=1)
...
def Event12400732():
    ...
    IfAttackedWithDamageType(1, attacked_entity=2400700, attacking_character=-1)
    IfFlagOn(1, 72400981)
    IfConditionTrue(0, input_condition=1)
    EnableFlag(1109)
...
def Event12400904():
    ...
    IfConditionTrue(-1, input_condition=1)
    IfAttackedWithDamageType(-1, attacked_entity=2400775, attacking_character=-1)
    IfConditionTrue(0, input_condition=-1)
    EnableFlag(72400397)
    EnableAI(2400775)
...
def Event12400800():
    ...
    IfCharacterHuman(15, PLAYER)
    EndIfConditionFalse(15)
    IfAttackedWithDamageType(1, attacked_entity=2400765, attacking_character=PLAYER)
    IfHealthEqual(1, 2400765, 0.0)
    IfAttackedWithDamageType(2, attacked_entity=2400730, attacking_character=PLAYER)
    IfHealthEqual(2, 2400730, 0.0)
    IfAttackedWithDamageType(3, attacked_entity=2400750, attacking_character=PLAYER)
    IfHealthEqual(3, 2400750, 0.0)
    IfAttackedWithDamageType(4, attacked_entity=2400754, attacking_character=PLAYER)
    IfHealthEqual(4, 2400754, 0.0)
    IfAttackedWithDamageType(5, attacked_entity=2400757, attacking_character=PLAYER)
    IfHealthEqual(5, 2400757, 0.0)
    IfAttackedWithDamageType(7, attacked_entity=2400770, attacking_character=PLAYER)
    IfHealthEqual(7, 2400770, 0.0)
    IfAttackedWithDamageType(8, attacked_entity=2400772, attacking_character=PLAYER)
    IfHealthEqual(8, 2400772, 0.0)
    IfAttackedWithDamageType(9, attacked_entity=2400774, attacking_character=PLAYER)
...
def PlayVicarAmeliaDeathSound():
    ...
    DisableNetworkSync()
    EndIfFlagOn(Flags.VicarAmeliaDead)
    IfFlagOn(1, Flags.VicarAmeliaDead)
...
def SummonStartVicarAmeliaBattle():
    ...
    IfCharacterHuman(1, PLAYER)
    IfFlagOn(1, Flags.VicarAmeliaFogEntered)
    IfConditionTrue(0, input_condition=1)
    EndIfHost()
    EnableCharacter(Characters.VicarAmelia)
    EnableFlag(Flags.VicarAmeliaFogEntered)
...
def ControlVicarAmeliaMusic():
    ...
    DisableSoundEvent(2403803)
    IfFlagOff(1, Flags.VicarAmeliaDead)
    IfFlagOn(1, Flags.VicarAmeliaBattleStarted)
    SkipLinesIfHost(1)
    IfFlagOn(1, 12404801)
    IfCharacterInsideRegion(1, PLAYER, region=2402802)
    IfConditionTrue(0, input_condition=1)
    EnableBossMusic(2403802)
    IfHasTAEEvent(2, Characters.VicarAmelia, tae_event_id=100)

    # --- 0 --- #
    DefineLabel(0)
    IfFlagOff(2, Flags.VicarAmeliaDead)
    IfFlagOn(2, Flags.VicarAmeliaBattleStarted)
    SkipLinesIfHost(1)
    IfFlagOn(2, 12404801)
...
def VicarAmeliaPhaseTwoTrigger():
    ...
    IfHasTAEEvent(0, Characters.VicarAmelia, tae_event_id=100)
...
def VicarAmeliaLimbDamage(
    ...
    CancelSpecialEffect(Characters.VicarAmelia, not_wounded_effect)
    ReplanAI(Characters.VicarAmelia)
    Wait(30.0)
    AICommand(Characters.VicarAmelia, command_id=1, slot=0)
    ReplanAI(Characters.VicarAmelia)
    IfHasTAEEvent(0, Characters.VicarAmelia, tae_event_id=300)
    SetNPCPartHealth(Characters.VicarAmelia, npc_part_id=vulnerable_npc_part_id, desired_hp=-1, overwrite_max=True)
    AddSpecialEffect(Characters.VicarAmelia, not_wounded_effect, affect_npc_part_hp=False)
    CancelSpecialEffect(Characters.VicarAmelia, wounded_effect)
    AICommand(Characters.VicarAmelia, command_id=-1, slot=0)
    ReplanAI(Characters.VicarAmelia)
    WaitFrames(10)
    Restart()
