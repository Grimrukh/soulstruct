...
def ChildhoodsBeginningEnding():
    ...
    DisableNetworkSync()
    EndIfClient()
    IfFlagOn(1, Flags.MoonPresenceDead)
    IfStandingOnCollision(-1, 2103601)
    IfStandingOnCollision(-1, 2103602)
    IfStandingOnCollision(-1, 2103603)
    IfStandingOnCollision(-1, 2103604)
...
def Event12100010():
    ...
    IfFlagOff(1, CommonFlags.CentralYharnamVisited)
...
def Event12100111():
    ...
    # --- 1 --- #
    DefineLabel(1)
    EndIfFlagOff(CommonFlags.BloodMoonPhase)
...
def OpenWorkshopDoors():
    ...
    GotoIfFlagOff(Label.L0, CommonFlags.CentralYharnamVisited)
    DisableObject(Objects.WorkshopFrontDoorClosed)
    EnableObject(Objects.WorkshopFrontDoorOpen)
    DisableObject(Objects.WorkshopBackDoorClosed)
    EnableObject(Objects.WorkshopBackDoorOpen)
...
def Event12100163():
    ...
    IfFlagOff(1, 1029)
    IfFlagOff(1, 1030)
    IfHasTAEEvent(1, Characters.GehrmanAlly, tae_event_id=10)
    IfConditionTrue(0, input_condition=1)
    EnableFlag(12100163)
...
def InitializeWorkshopAppearance():
    ...
    GotoIfFlagOn(Label.L5, Flags.MoonPresenceBattleCutsceneDone)
    GotoIfFlagOn(Label.L4, CommonFlags.WorkshopOnFire)
    # The remaining story progression flags all have the same result (fire disabled).
    GotoIfFlagOn(Label.L3, CommonFlags.BloodMoonPhase)
...
def InitializeDreamMusic():
    ...
    GotoIfFlagOn(Label.L1, CommonFlags.WorkshopOnFire)
    IfPlayerInsightAmountGreaterThanOrEqual(-1, 50)
    IfFlagOn(-1, CommonFlags.BloodMoonPhase)
...
def OpenGateToField():
    ...
    EndIfFlagOff(CommonFlags.WorkshopOnFire)
...
def InitializeBossArena():
    ...
    GotoIfFlagOff(Label.L0, Flags.MoonPresenceDead)
    ...
    # --- 0 --- #
    DefineLabel(0)
    GotoIfFlagOff(Label.L1, Flags.MoonPresenceBattleCutsceneDone)
    DisableCharacter(Characters.GehrmanBoss)
    End()

    # --- 1 --- #
    DefineLabel(1)
    GotoIfFlagOff(Label.L2, Flags.GehrmanDead)
    DisableCharacter(Characters.MoonPresence)
    DisableCharacter(Characters.GehrmanBoss)
    SkipLinesIfClient(2)
    DisableObject(Objects.BossFog)
    ...
    DefineLabel(2)
    GotoIfFlagOff(Label.L3, Flags.GehrmanRefusalCutsceneDone)
    DisableCharacter(Characters.MoonPresence)
    End()
...
def GehrmanDies():
    ...
    Wait(3.0)
    SkipLinesIfFlagOn(2, CommonFlags.ThreeCordsConsumed)
...
def RefuseGehrmansOffer():
    ...
    IfFlagOn(0, Flags.GehrmanOfferRefused)
    EnableFlag(CommonFlags.CutsceneActive)
    WaitFrames(1)
    PlayCutscene(
    ...
    DisableFlag(2100)
    EndIfFlagOn(CommonFlags.InsightGained_GehrmanBattle)
...
def SummonStartGehrmanBattle():
    ...
    IfCharacterHuman(1, PLAYER)
    IfFlagOn(1, Flags.GehrmanBattleFogEntered)
    IfConditionTrue(0, input_condition=1)
    EndIfHost()
    EnableCharacter(Characters.GehrmanBoss)
    DisableCharacter(Characters.GehrmanAlly)
...
def EnterGehrmanBossFog():
    ...
    EndIfFlagOn(Flags.GehrmanDead)
    GotoIfFlagOn(Label.L0, Flags.GehrmanRefusalCutsceneDone)
    IfFlagOff(1, Flags.GehrmanDead)
    IfFlagOn(1, Flags.GehrmanRefusalCutsceneDone)
    IfConditionTrue(0, input_condition=1)
    ...
    # --- 0 --- #
    DefineLabel(0)
    IfFlagOff(2, Flags.GehrmanDead)
    IfCharacterHuman(2, PLAYER)
    IfActionButtonParam(2, action_button_id=Characters.GehrmanBoss, entity=Objects.BossFog)
    IfFlagOn(3, Flags.GehrmanDead)
    IfConditionTrue(-1, input_condition=2)
    IfConditionTrue(-1, input_condition=3)
    IfConditionTrue(0, input_condition=-1)
...
def EnterGehrmanBossFogAsSummon():
    ...
    IfActionButtonParam(1, action_button_id=Characters.GehrmanBoss, entity=Objects.BossFog)
    IfConditionTrue(0, input_condition=1)
    RotateToFaceEntity(PLAYER, Regions.BossFogRotateTarget, animation=101130, wait_for_completion=False)
...
def StartGehrmanBossBattle():
    ...
    IfFlagOn(0, Flags.GehrmanBattleFogEntered)
...
def ControlGehrmanMusic():
    ...
    DisableSoundEvent(Music.GehrmanPhase2Music)
    IfFlagOff(1, Flags.GehrmanDead)
    IfFlagOn(1, Flags.GehrmanBattleStarted)
    SkipLinesIfHost(1)
    IfFlagOn(1, Flags.GehrmanBattleStartedForSummon)
    IfCharacterInsideRegion(1, PLAYER, region=2102802)
    IfConditionTrue(0, input_condition=1)
    DisableSoundEvent(Music.NormalMusic)
    DisableSoundEvent(Music.BloodMoonMusic)
    EnableBossMusic(Music.GehrmanPhase1Music)
    IfHasTAEEvent(2, Characters.GehrmanBoss, tae_event_id=100)

    # --- 0 --- #
    DefineLabel(0)
    IfFlagOff(2, Flags.GehrmanDead)
    IfFlagOn(2, Flags.GehrmanBattleStarted)
    SkipLinesIfHost(1)
    IfFlagOn(2, Flags.GehrmanBattleStartedForSummon)
...
def StopGehrmanBossMusic():
    ...
    DisableNetworkSync()
    EndIfFlagOn(Flags.GehrmanDead)
    IfFlagOn(0, Flags.GehrmanBattleWon)
    DisableBossMusic(Music.GehrmanPhase1Music)
...
def MoonPresenceBattleCutscene():
    ...
    IfStandingOnCollision(-1, 2103605)
    IfConditionTrue(1, input_condition=-1)
    IfFlagOn(1, CommonFlags.ThreeCordsConsumed)
    IfConditionTrue(0, input_condition=1)
...
def SummonStartMoonPresenceBattle():
    ...
    IfCharacterHuman(1, PLAYER)
    IfFlagOn(1, Flags.MoonPresenceBattleActive)
    IfConditionTrue(0, input_condition=1)
    EndIfHost()
    DisableObject(Objects.NormalMoonSky)
    EnableObject(Objects.BloodMoonSky)
...
def EnterMoonPresenceBossFog():
    ...
    EndIfFlagOn(Flags.MoonPresenceDead)
    GotoIfFlagOn(Label.L0, Flags.MoonPresenceBattleCutsceneDone)
    IfFlagOff(1, Flags.MoonPresenceDead)
    ...
    # --- 0 --- #
    DefineLabel(0)
    IfFlagOff(2, Flags.MoonPresenceDead)
    IfCharacterHuman(2, PLAYER)
    IfActionButtonParam(2, action_button_id=Characters.GehrmanBoss, entity=Objects.BossFog)
    IfFlagOn(3, Flags.MoonPresenceDead)
    IfConditionTrue(-1, input_condition=2)
    IfConditionTrue(-1, input_condition=3)
    IfConditionTrue(0, input_condition=-1)
    EndIfFinishedConditionTrue(3)
...
def StartMoonPresenceBossBattle():
    ...
    GotoIfThisEventOn(Label.L0)
    IfFlagOn(0, Flags.MoonPresenceBattleActive)
    GotoIfClient(Label.L0)
    NotifyBossBattleStart()
...
def ControlMoonPresenceMusic():
    ...
    IfFlagOff(2, Flags.MoonPresenceDead)
    IfFlagOn(2, Flags.MoonPresenceBattleCutsceneDone)
    SkipLinesIfHost(1)
    IfFlagOn(2, 12104851)
    IfCharacterInsideRegion(2, PLAYER, region=2102801)
    IfConditionTrue(0, input_condition=2)
...
def ControlMoonPresenceTail(
    ...
    SetNPCPartHealth(Characters.MoonPresence, npc_part_id=monitor_part_id, desired_hp=-1, overwrite_max=True)
...
def MoonPresenceSinHarvest():
    ...
    IfAttackedWithDamageType(-1, attacked_entity=PLAYER, attacking_character=Characters.MoonPresence,
...
def InitializeInsightShop():
    ...
    IfCharacterHuman(15, PLAYER)
    EndIfConditionFalse(15)
    GotoIfFlagOn(Label.L0, Flags.InsightShopOpen)
...
def StumpMessengersAppear():
    ...
    DisableNetworkSync()
    GotoIfFlagOn(Label.L0, Flags.StumpMessengersActive)
    ForceAnimation(Characters.StumpMessengers, 0, loop=True)  # 0 == "hiding"
    IfCharacterHuman(15, PLAYER)
    EndIfConditionFalse(15)
    SkipLinesIfFlagOff(1, CommonFlags.RequestMessengerHat1)
    SetDisplayMask(Characters.StumpMessengers, bit_index=20, switch_type=OnOffChange.Off)
    SkipLinesIfFlagOff(1, CommonFlags.RequestMessengerHat2)
    SetDisplayMask(Characters.StumpMessengers, bit_index=21, switch_type=OnOffChange.Off)
    SkipLinesIfFlagOff(1, CommonFlags.RequestMessengerHat3)
    SetDisplayMask(Characters.StumpMessengers, bit_index=22, switch_type=OnOffChange.Off)
    SkipLinesIfFlagOff(1, CommonFlags.RequestMessengerHat4)
    SetDisplayMask(Characters.StumpMessengers, bit_index=23, switch_type=OnOffChange.Off)
    SkipLinesIfFlagOff(1, CommonFlags.RequestMessengerHat5)
    SetDisplayMask(Characters.StumpMessengers, bit_index=24, switch_type=OnOffChange.Off)
    SkipLinesIfFlagOff(1, CommonFlags.RequestMessengerHat6)
    SetDisplayMask(Characters.StumpMessengers, bit_index=25, switch_type=OnOffChange.Off)
    SkipLinesIfFlagOff(1, CommonFlags.RequestMessengerHat7)
    SetDisplayMask(Characters.StumpMessengers, bit_index=26, switch_type=OnOffChange.Off)
    SkipLinesIfFlagOff(1, CommonFlags.RequestMessengerHat8)
    SetDisplayMask(Characters.StumpMessengers, bit_index=27, switch_type=OnOffChange.Off)
    SkipLinesIfFlagOff(1, CommonFlags.RequestMessengerHat9)
    SetDisplayMask(Characters.StumpMessengers, bit_index=28, switch_type=OnOffChange.Off)
    IfFlagOn(-1, CommonFlags.PlayerHasMessengerHat1)
    IfFlagOn(-1, CommonFlags.PlayerHasMessengerHat2)
    IfFlagOn(-1, CommonFlags.PlayerHasMessengerHat3)
    IfFlagOn(-1, CommonFlags.PlayerHasMessengerHat4)
    IfFlagOn(-1, CommonFlags.PlayerHasMessengerHat5)
    IfFlagOn(-1, CommonFlags.PlayerHasMessengerHat6)
    IfFlagOn(-1, CommonFlags.PlayerHasMessengerHat7)
    IfFlagOn(-1, CommonFlags.PlayerHasMessengerHat8)
    IfFlagOn(-1, CommonFlags.PlayerHasMessengerHat9)
    IfFlagOn(-1, 6080)
    IfFlagOn(-1, 6081)
    IfFlagOn(-1, 6082)
    IfFlagOn(-1, 6083)
...
def OfferDLCMessengerHats():
    ...
    EndIfClient()
    IfFlagOn(1, 6900)
    IfFlagOff(1, CommonFlags.PlayerHasMessengerHat1)
    IfFlagOn(2, 6901)
    IfFlagOff(2, CommonFlags.PlayerHasMessengerHat2)
    IfFlagOn(3, 6902)
    IfFlagOff(3, CommonFlags.PlayerHasMessengerHat3)
    IfConditionTrue(-1, input_condition=1)
    IfConditionTrue(-1, input_condition=2)
    IfConditionTrue(-1, input_condition=3)
    IfConditionTrue(0, input_condition=-1)
    ...
    IfCharacterHuman(4, PLAYER)
    IfActionButtonParam(4, action_button_id=6025, entity=Characters.NearStumpMessengers)
    IfConditionTrue(0, input_condition=4)
    SkipLinesIfFlagOn(3, CommonFlags.PlayerHasMessengerHat1)
    SkipLinesIfFlagOff(2, 6900)
    AwardItemLot(2100900, host_only=False)
    EnableFlag(CommonFlags.PlayerHasMessengerHat1)
    SkipLinesIfFlagOn(3, CommonFlags.PlayerHasMessengerHat2)
    SkipLinesIfFlagOff(2, 6901)
    AwardItemLot(2100910, host_only=False)
    EnableFlag(CommonFlags.PlayerHasMessengerHat2)
    SkipLinesIfFlagOn(3, CommonFlags.PlayerHasMessengerHat3)
