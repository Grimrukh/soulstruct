...
def Event13200103():
    ...
    IfFlagOn(1, 1420)
    IfFlagOn(1, 73200327)
    IfAttackedWithDamageType(2, attacked_entity=3200101, attacking_character=PLAYER)
    IfConditionTrue(-1, input_condition=1)
    IfConditionTrue(-1, input_condition=2)
    IfConditionTrue(0, input_condition=-1)
...
def PlayRomDeathSound():
    ...
    DisableNetworkSync()
    EndIfFlagOn(Flags.RomDead)
    IfFlagOn(1, Flags.RomDead)
...
def RomFirstTime():
    ...
    IfThisEventOff(1)
    IfAttackedWithDamageType(1, attacked_entity=Characters.Rom, attacking_character=-1)
    IfConditionTrue(0, input_condition=1)
...
def KillRomSpider(_, spider: int, trigger_flag: int):
    ...
    GotoIfFlagOff(Label.L0, Flags.RomDead)
...
def SetSpiderEventTarget(_, spider: int):
    ...
    EndIfFlagOn(Flags.RomDead)
    IfFlagOn(0, Flags.RomBattleStarted)
...
def ControlRomMusic():
    ...
    DisableSoundEvent(3203803)
    IfFlagOff(1, Flags.RomDead)
    IfFlagOn(1, Flags.RomBattleStarted)
    SkipLinesIfHost(1)
    IfFlagOn(1, 13204801)
    IfCharacterInsideRegion(1, PLAYER, region=3202801)
    IfConditionTrue(0, input_condition=1)
    EnableBossMusic(3203802)
    IfHasTAEEvent(2, Characters.Rom, tae_event_id=10)

    # --- 0 --- #
    DefineLabel(0)
    IfFlagOff(2, Flags.RomDead)
    IfFlagOn(2, Flags.RomBattleStarted)
    SkipLinesIfHost(1)
    IfFlagOn(2, 13204801)
    IfCharacterInsideRegion(2, PLAYER, region=3202801)
    IfConditionTrue(0, input_condition=2)
...
def RomTeleportsAway():
    ...
    IfHasTAEEvent(0, Characters.Rom, tae_event_id=10)
    DisableCharacter(Characters.Rom)
    Wait(3.0)
...
def RomWeakPoint1Damage():
    ...
    SetNPCPartHealth(Characters.Rom, npc_part_id=3201, desired_hp=50, overwrite_max=True)
    ...
    IfHasTAEEvent(6, Characters.Rom, tae_event_id=20)
    IfConditionTrue(-2, input_condition=4)
    IfConditionTrue(-2, input_condition=5)
    ...
    SetNPCPartHealth(Characters.Rom, npc_part_id=3201, desired_hp=25, overwrite_max=True)
    ...
    IfHasTAEEvent(9, Characters.Rom, tae_event_id=20)
    ...
    # --- 0 --- #
    DefineLabel(0)
    SetNPCPartHealth(Characters.Rom, npc_part_id=3201, desired_hp=-1, overwrite_max=True)
    ReplanAI(2420800)
    WaitFrames(10)
    Restart()
...
def RomWeakPoint2Damage():
    ...
    SetNPCPartHealth(Characters.Rom, npc_part_id=3202, desired_hp=50, overwrite_max=True)
    ...
    SetNPCPartHealth(Characters.Rom, npc_part_id=3202, desired_hp=25, overwrite_max=True)
    ...
    # --- 0 --- #
    DefineLabel(0)
    SetNPCPartHealth(Characters.Rom, npc_part_id=3202, desired_hp=-1, overwrite_max=True)
    ReplanAI(2420800)
    WaitFrames(10)
    Restart()
...
def FallIntoMoonsideLake():
    ...
    SkipLinesIfFlagOff(1, Flags.RomFirstTimeDone)
    EnableFlag(Flags.RomLakeEntered)
    Restart()
...
def FallIntoMoonsideAsSummon():
    ...
    DisableNetworkSync()
    IfFlagOn(1, Flags.RomLakeEntered)  # you must be a White Phantom to still be outside the lake when this flag is on
    IfCharacterInsideRegion(1, PLAYER, region=3202800)
    IfConditionTrue(0, input_condition=1)
    EnableInvincibility(PLAYER)
    CreateTemporaryFX(932210, anchor_entity=PLAYER, anchor_type=CoordEntityType.Character, model_point=246)
