...
def AggravateFirstWitchOfHemwick():
    ...
    IfAttackedWithDamageType(
        -1, attacked_entity=Characters.FirstWitchOfHemwick, attacking_character=-1)
    IfConditionTrue(0, input_condition=-1)
...
def ResurrectWitch(_, witch: int, other_witch: int, warp_region: int, witch_moving_flag: int):
    ...
    Move(witch, destination=warp_region, destination_type=CoordEntityType.Region, model_point=-1, short_move=True)
...
def Event12205003():
    ...
    IfConditionTrue(-2, input_condition=1)
    IfAttackedWithDamageType(-2, attacked_entity=2200120, attacking_character=-1)
...
def Event12205050():
    ...
    IfAttackedWithDamageType(2, attacked_entity=2200280, attacking_character=-1)
