...
def Event13500418(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int):
    ...
    Move(ARG_4_7, destination=ARG_8_11, destination_type=CoordEntityType.Region, model_point=-1, set_draw_Collision=0)
    ReplanAI(ARG_4_7)
    End()
...
def Event13505902(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int, ARG_24_27: int, ARG_28_31: int):
    ...
    Move(ARG_0_3, destination=ARG_28_31, destination_type=CoordEntityType.Region, model_point=-1, set_draw_Collision=3504000)
    SkipLines(1)
    Move(ARG_0_3, destination=3502897, destination_type=CoordEntityType.Region, model_point=-1, set_draw_Collision=3504000)
    AICommand(ARG_0_3, command_id=-1, slot=0)
    ReplanAI(ARG_0_3)
    DisableInvincibility(ARG_0_3)
    EnableAnimations(ARG_0_3)
