...
def Event12704815(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int):
    ...
    Kill(ARG_0_3, award_souls=False)
    EnableCharacter(ARG_0_3)
    Move(ARG_0_3, destination=ARG_4_7, destination_type=CoordEntityType.Character, model_point=ARG_8_11, set_draw_Collision=ARG_4_7)
...
def Event12705370(ARG_0_3: int, ARG_4_7: float, ARG_8_11: int, ARG_12_15: int):
    ...
    Wait(ARG_4_7)
    Move(ARG_0_3, destination=ARG_12_15, destination_type=CoordEntityType.Character, model_point=21, copy_draw_Collision=ARG_12_15)
    WaitFrames(75)
...
def Event12705550():
    ...
    DisableCharacter(2700755)
    Move(2700756, destination=2700755, destination_type=CoordEntityType.Character, model_point=245, copy_draw_Collision=2700755)
