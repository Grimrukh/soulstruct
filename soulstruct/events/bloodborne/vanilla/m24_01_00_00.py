...
def Event12414807():
    ...
    Move(2410811, destination=2410810, destination_type=CoordEntityType.Character, model_point=203, copy_draw_Collision=2410810)
...
def Event12410645():
    ...
    EnableBackread(2410710)
    DisableBackread(2410711)
    Move(2410710, destination=2412172, destination_type=CoordEntityType.Region, model_point=-1, set_draw_Collision=0)
...
def Event12410659():
    ...
    Restart()
    Label(0)
    Move(2410710, destination=2412173, destination_type=CoordEntityType.Region, model_point=-1, set_draw_Collision=0)
...
def Event12410800():
    ...
    Move(2410900, destination=2412334, destination_type=CoordEntityType.Region, model_point=-1, set_draw_Collision=2414124)
    SetNest(2410900, 2412334)
    SetTeamType(2410900, TeamType.HostileNPC)
    Goto(Label.L9)
    SkipLinesIfFlagOff(4, 1702)
    Move(2410900, destination=2412332, destination_type=CoordEntityType.Region, model_point=-1, set_draw_Collision=2414122)
...
def Event12410811():
    ...
    Move(2410900, destination=2412333, destination_type=CoordEntityType.Region, model_point=-1, copy_draw_Collision=2414123)
    SetNest(2410900, 2412334)
    SetTeamType(2410900, TeamType.CoopNPC)
    WaitFrames(2)
...
def Event12414500():
    ...
    IfConditionTrue(0, input_condition=1)
    GotoIfFinishedConditionTrue(Label.L1, input_condition=3)
    Move(2410740, destination=2412720, destination_type=CoordEntityType.Region, model_point=-1, set_draw_Collision=0)
    Goto(Label.L2)
    Label(1)
    Move(2410740, destination=2412721, destination_type=CoordEntityType.Region, model_point=-1, set_draw_Collision=2414021)
    Label(2)
    Wait(5.0)
    EnableFlag(12414506)
...
def Event12414600():
    ...
    IfConditionTrue(0, input_condition=1)
    GotoIfFinishedConditionTrue(Label.L1, input_condition=3)
    Move(2410158, destination=2412702, destination_type=CoordEntityType.Region, model_point=-1, set_draw_Collision=2414020)
    Goto(Label.L2)
    Label(1)
    Move(2410158, destination=2412703, destination_type=CoordEntityType.Region, model_point=-1, set_draw_Collision=2414021)
    Label(2)
    Wait(5.0)
    EnableFlag(12414609)
    PlaySoundEffect(anchor_entity=10000, sound_type=SoundType.f_MenuEffect, sound_id=100000009)
