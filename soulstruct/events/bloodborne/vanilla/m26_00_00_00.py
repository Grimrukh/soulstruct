...
def Event12604830(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int):
    ...
    Move(ARG_0_3, destination=ARG_8_11, destination_type=CoordEntityType.Region, model_point=-1, set_draw_Collision=0)
    SkipLines(2)
    DisableCharacter(ARG_0_3)
    Move(ARG_0_3, destination=ARG_12_15, destination_type=CoordEntityType.Region, model_point=-1, set_draw_Collision=0)
    Wait(2.0)
...
def Event12604856():
    ...
    IfFlagOn(0, 12604986)
    EnableBossHealthBar(2600850, name=899000, slot=0)
    Move(2600850, destination=2602062, destination_type=CoordEntityType.Region, model_point=-1, set_draw_Collision=2604810)
...
def Event12604878():
    ...
    ForceAnimation(2600850, 103122, wait_for_completion=True)
    Move(2600850, destination=2602073, destination_type=CoordEntityType.Region, model_point=-1, set_draw_Collision=2604811)
...
def Event12604888():
    ...
    Restart()
    Label(0)
    Move(2600850, destination=2602040, destination_type=CoordEntityType.Region, model_point=-1, set_draw_Collision=2604800)
    Restart()
    Label(1)
    Move(2600850, destination=2602041, destination_type=CoordEntityType.Region, model_point=-1, set_draw_Collision=2604800)
    Restart()
    Label(2)
    Move(2600850, destination=2602042, destination_type=CoordEntityType.Region, model_point=-1, set_draw_Collision=2604801)
    Restart()
    Label(3)
    Move(2600850, destination=2602043, destination_type=CoordEntityType.Region, model_point=-1, set_draw_Collision=2604801)
    Restart()
    Label(4)
    Move(2600850, destination=2602044, destination_type=CoordEntityType.Region, model_point=-1, set_draw_Collision=2604802)
    Restart()
    Label(5)
    Move(2600850, destination=2602045, destination_type=CoordEntityType.Region, model_point=-1, set_draw_Collision=2604802)
    Restart()
...
def Event12604889():
    ...
    Move(2600850, destination=2602059, destination_type=CoordEntityType.Region, model_point=-1, set_draw_Collision=2604810)
    Restart()
    Move(2600850, destination=2602060, destination_type=CoordEntityType.Region, model_point=-1, set_draw_Collision=2604812)
    Restart()
    Move(2600850, destination=2602061, destination_type=CoordEntityType.Region, model_point=-1, set_draw_Collision=2604812)
    Restart()
    Move(2600850, destination=2602062, destination_type=CoordEntityType.Region, model_point=-1, set_draw_Collision=2604810)
    Restart()
    Move(2600850, destination=2602063, destination_type=CoordEntityType.Region, model_point=-1, set_draw_Collision=2604810)
    Restart()
    Move(2600850, destination=2602077, destination_type=CoordEntityType.Region, model_point=-1, set_draw_Collision=2604810)
    Restart()
    Move(2600850, destination=2602065, destination_type=CoordEntityType.Region, model_point=-1, set_draw_Collision=2604811)
    Restart()
    Move(2600850, destination=2602066, destination_type=CoordEntityType.Region, model_point=-1, set_draw_Collision=2604813)
    Restart()
    Move(2600850, destination=2602067, destination_type=CoordEntityType.Region, model_point=-1, set_draw_Collision=2604811)
    Restart()
    Move(2600850, destination=2602068, destination_type=CoordEntityType.Region, model_point=-1, set_draw_Collision=2604811)
    Restart()
    Move(2600850, destination=2602078, destination_type=CoordEntityType.Region, model_point=-1, set_draw_Collision=2604811)
    Restart()
...
def Event12600110(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int):
    ...
    WaitFrames(5)
    Move(ARG_4_7, destination=ARG_0_3, destination_type=CoordEntityType.Character, model_point=30, copy_draw_Collision=ARG_0_3)
    EnableCharacter(ARG_4_7)
    ForceAnimation(ARG_4_7, 7000)
    WaitFrames(15)
    Move(ARG_8_11, destination=ARG_0_3, destination_type=CoordEntityType.Character, model_point=30, copy_draw_Collision=ARG_0_3)
...
def Event12605200(ARG_0_3: int, ARG_4_7: int):
    ...
    End()
    Move(ARG_4_7, destination=ARG_0_3, destination_type=CoordEntityType.Character, model_point=100, set_draw_Collision=ARG_0_3)
    Restart()
