...
def Event12301800():
    ...
    DisableObject(2301800)
    DeleteVFX(2303800, erase_root_only=True)
...
def Event12304730():
    ...
    RotateToFaceEntity(2300810, PLAYER, animation=3008, wait_for_completion=False)
    IfCharacterHuman(4, PLAYER)
...
def Event12304715(_, arg_0_1: short, arg_4_7: int, arg_8_9: short, arg_12_15: int, arg_16_19: int, arg_20_23: int, 
    ...
    SetNPCPartEffects(2300810, npc_part_id=arg_4_7, material_sfx_id=77, material_vfx_id=77)
