...
42: ボス_戦闘開始
58: ボス戦_撃破時間
76: N:\\SPRJ\\data\\Param\\event\\common.events
152: 
154: 
156: 
158: 
...
def Event13604820():
    ...
    SetNetworkUpdateRate(3600800, is_fixed=True, update_rate=CharacterUpdateRate.Never)
    SetNetworkUpdateRate(3600801, is_fixed=True, update_rate=CharacterUpdateRate.Always)
    Move(3600801, destination=3600800, destination_type=CoordEntityType.Character, model_point=203, copy_draw_Collision=3600800)
...
def Event13605921(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int, ARG_24_27: int, ARG_28_31: int):
    ...
    IfConditionTrue(0, input_condition=1)
    SkipLinesIfFinishedConditionTrue(2, 3)
    Move(ARG_0_3, destination=ARG_28_31, destination_type=CoordEntityType.Region, model_point=-1, set_draw_Collision=3604027)
    SkipLines(1)
    Move(ARG_0_3, destination=3602917, destination_type=CoordEntityType.Region, model_point=-1, set_draw_Collision=3604027)
    AICommand(ARG_0_3, command_id=-1, slot=0)
    ReplanAI(ARG_0_3)
    DisableInvincibility(ARG_0_3)
    EnableAnimations(ARG_0_3)
