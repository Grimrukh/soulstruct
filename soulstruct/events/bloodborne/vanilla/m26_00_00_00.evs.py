...
def Constructor():
    ...
    RunEvent(12604980, slot=0, args=(20, 72600307, 72600311, 72600307, 72600311, 72600311, 72600306), 
             arg_types='iiiIIii')
    RunEvent(12604980, slot=1, args=(10, 72600312, 72600316, 72600312, 72600316, 72600316, 72600306), 
             arg_types='iiiIIii')
...
@RestartOnRest
def Event12604730(arg_0_3: int, arg_4_7: int, arg_8_11: int, arg_12_15: int, arg_16_19: int, arg_20_23: int, 
                  arg_24_27: int):
...
def Event12604845():
    ...
    IfCharacterHuman(2, PLAYER)
    IfBossFogActivated(2, boss_entity_id=2600800, fog_object_id=2601800)
    IfFlagOn(3, 12601800)
    IfConditionTrue(-1, input_condition=2)
    IfConditionTrue(-1, input_condition=3)
    IfConditionTrue(0, input_condition=-1)
...
def Event12604846():
    ...
    IfBossFogActivated(1, boss_entity_id=2600800, fog_object_id=2601800)
    IfConditionTrue(0, input_condition=1)
    RotateToFaceEntity(PLAYER, 2602800, animation=101130, wait_for_completion=True)
...
def Event12604860():
    ...
    IfCharacterHuman(2, PLAYER)
    IfBossFogActivated(2, boss_entity_id=2600850, fog_object_id=2601850)
    IfFlagOn(3, 12601850)
    IfConditionTrue(-1, input_condition=2)
    IfConditionTrue(-1, input_condition=3)
    IfConditionTrue(0, input_condition=-1)
...
def Event12604861():
    ...
    IfFlagOn(1, 12604850)
    IfCharacterType(1, PLAYER, CharacterType.WhitePhantom)
    IfBossFogActivated(1, boss_entity_id=2600850, fog_object_id=2601850)
    IfConditionTrue(0, input_condition=1)
    RotateToFaceEntity(PLAYER, 2602850, animation=101130, wait_for_completion=True)
    IfCharacterType(2, PLAYER, CharacterType.WhitePhantom)
...
def Event12604856():
    ...
    IfFlagOn(0, 12604986)
    EnableBossHealthBar(2600850, name=899000, slot=0)
    Move(2600850, destination=2602062, destination_type=CoordEntityType.Region, model_point=-1, set_draw_parent=2604810)
...
def Event12604870(arg_0_3: int, arg_4_7: int, arg_8_11: int, arg_12_15: int, arg_16_19: int, arg_20_23: int, 
...
def Event12604878():
    ...
    ForceAnimation(2600850, 103122, wait_for_completion=True)
    Move(2600850, destination=2602073, destination_type=CoordEntityType.Region, model_point=-1, set_draw_parent=2604811)
...
def Event12604880(arg_0_3: int, arg_4_7: int, arg_8_11: int, arg_12_15: int, arg_16_19: int, arg_20_23: int, 
                  arg_24_27: int, arg_28_31: int):
...
def Event12604888():
    ...
    # --- 0 --- #
    DefineLabel(0)
    Move(2600850, destination=2602040, destination_type=CoordEntityType.Region, model_point=-1, set_draw_parent=2604800)
    Restart()

    # --- 1 --- #
    DefineLabel(1)
    Move(2600850, destination=2602041, destination_type=CoordEntityType.Region, model_point=-1, set_draw_parent=2604800)
    Restart()

    # --- 2 --- #
    DefineLabel(2)
    Move(2600850, destination=2602042, destination_type=CoordEntityType.Region, model_point=-1, set_draw_parent=2604801)
    Restart()

    # --- 3 --- #
    DefineLabel(3)
    Move(2600850, destination=2602043, destination_type=CoordEntityType.Region, model_point=-1, set_draw_parent=2604801)
    Restart()

    # --- 4 --- #
    DefineLabel(4)
    Move(2600850, destination=2602044, destination_type=CoordEntityType.Region, model_point=-1, set_draw_parent=2604802)
    Restart()

    # --- 5 --- #
    DefineLabel(5)
    Move(2600850, destination=2602045, destination_type=CoordEntityType.Region, model_point=-1, set_draw_parent=2604802)
    Restart()
...
def Event12604889():
    ...
    Move(2600850, destination=2602059, destination_type=CoordEntityType.Region, model_point=-1, set_draw_parent=2604810)
    Restart()
    Move(2600850, destination=2602060, destination_type=CoordEntityType.Region, model_point=-1, set_draw_parent=2604812)
    Restart()
    Move(2600850, destination=2602061, destination_type=CoordEntityType.Region, model_point=-1, set_draw_parent=2604812)
    Restart()
    Move(2600850, destination=2602062, destination_type=CoordEntityType.Region, model_point=-1, set_draw_parent=2604810)
    Restart()
    Move(2600850, destination=2602063, destination_type=CoordEntityType.Region, model_point=-1, set_draw_parent=2604810)
    Restart()
    Move(2600850, destination=2602077, destination_type=CoordEntityType.Region, model_point=-1, set_draw_parent=2604810)
    Restart()
    Move(2600850, destination=2602065, destination_type=CoordEntityType.Region, model_point=-1, set_draw_parent=2604811)
    Restart()
    Move(2600850, destination=2602066, destination_type=CoordEntityType.Region, model_point=-1, set_draw_parent=2604813)
    Restart()
    Move(2600850, destination=2602067, destination_type=CoordEntityType.Region, model_point=-1, set_draw_parent=2604811)
    Restart()
    Move(2600850, destination=2602068, destination_type=CoordEntityType.Region, model_point=-1, set_draw_parent=2604811)
    Restart()
    Move(2600850, destination=2602078, destination_type=CoordEntityType.Region, model_point=-1, set_draw_parent=2604811)
    Restart()
...
def Event12604980(arg_0_3: int, arg_4_7: int, arg_8_11: int, arg_12_15: uint, arg_16_19: uint, arg_20_23: int, 
                  arg_24_27: int):
...
def Event12600026():
    ...
    GotoIfThisEventOn(Label.L0)
    IfBossFogActivated(0, boss_entity_id=7100, fog_object_id=2601271)
...
def Event12600180(arg_0_3: int, arg_4_7: int):
    ...
    IfBossFogActivated(1, boss_entity_id=2600030, fog_object_id=2601040)
...
def Event12600110(arg_0_3: int, arg_4_7: int, arg_8_11: int):
    ...
    WaitFrames(15)
    Move(arg_8_11, destination=arg_0_3, destination_type=CoordEntityType.Character, model_point=30, 
         copy_draw_parent=arg_0_3)
...
def Event12600125(arg_0_3: int, arg_4_7: int):
    ...
    IfBossFogActivated(0, boss_entity_id=2600030, fog_object_id=arg_0_3)
    ForceAnimation(PLAYER, 101140)
    AwardItemLot(arg_4_7, host_only=False)
...
def Event12601295(arg_0_3: int, arg_4_7: int, arg_8_11: int, arg_12_15: int, arg_16_16: uchar):
    ...
    IfFlagOn(2, arg_8_11)
    IfBossFogActivated(2, boss_entity_id=7100, fog_object_id=arg_0_3)
...
def Event12601320(arg_0_3: int, arg_4_7: int, arg_8_11: int, arg_12_15: int, arg_16_19: int, arg_20_23: int, 
                  arg_24_27: int, arg_28_31: int):
...
def Event12601330(arg_0_3: int, arg_4_7: int, arg_8_11: int, arg_12_15: int, arg_16_19: int, arg_20_23: int, 
                  arg_24_27: int, arg_28_31: int):
