...
from .base import FieldDisplayInfo, pad_field
...
NPC_PARAM_ST = {
    ...
    "fields": [
        ...
        FieldDisplayInfo("moveAnimId", "MoveAnimationID", False, int, "DOC-TODO"),
        FieldDisplayInfo("spMoveAnimId1", "SpecialMoveAnimationID1", False, int, "DOC-TODO"),
        FieldDisplayInfo("spMoveAnimId2", "SpecialMoveAnimationID2", False, int, "DOC-TODO"),
        FieldDisplayInfo("networkWarpDist", "NetworkWarpDistance", False, float, "DOC-TODO"),
        FieldDisplayInfo("dbgBehaviorR1", "DebugBehaviorR1", False, int, "DOC-TODO"),
        FieldDisplayInfo("dbgBehaviorL1", "DebugBehaviorL1", False, int, "DOC-TODO"),
        FieldDisplayInfo("dbgBehaviorR2", "DebugBehaviorR2", False, int, "DOC-TODO"),
        FieldDisplayInfo("dbgBehaviorL2", "DebugBehaviorL2", False, int, "DOC-TODO"),
        FieldDisplayInfo("dbgBehaviorRL", "DebugBehaviorRL", False, int, "DOC-TODO"),
        FieldDisplayInfo("dbgBehaviorRR", "DebugBehaviorRR", False, int, "DOC-TODO"),
        FieldDisplayInfo("dbgBehaviorRD", "DebugBehaviorRD", False, int, "DOC-TODO"),
        FieldDisplayInfo("dbgBehaviorRU", "DebugBehaviorRU", False, int, "DOC-TODO"),
        FieldDisplayInfo("dbgBehaviorLL", "DebugBehaviorLL", False, int, "DOC-TODO"),
        FieldDisplayInfo("dbgBehaviorLR", "DebugBehaviorLR", False, int, "DOC-TODO"),
        FieldDisplayInfo("dbgBehaviorLD", "DebugBehaviorLD", False, int, "DOC-TODO"),
        FieldDisplayInfo("dbgBehaviorLU", "DebugBehaviorLU", False, int, "DOC-TODO"),
        FieldDisplayInfo("animIdOffset2", "AnimationIDOffset2", False, int, "DOC-TODO"),
        FieldDisplayInfo(
            "partsDamageRate1",
        ...
        FieldDisplayInfo("knockbackRate", "KnockbackRate", True, int, "DOC-TODO"),
        FieldDisplayInfo(
            "knockbackParamId",
            "KnockbackID",
            True,
        ...
        FieldDisplayInfo("material", "Material", False, int, "DOC-TODO"),
        FieldDisplayInfo("materialSfx", "MaterialSFX", False, int, "DOC-TODO"),
        FieldDisplayInfo("material_Weak", "MaterialWeak", False, int, "DOC-TODO"),
        FieldDisplayInfo("materialSfx_Weak", "MaterialWeakSFX", False, int, "DOC-TODO"),
        FieldDisplayInfo(
            "partsDamageType",
            "PartsDamageType",
            False,
        ...
        FieldDisplayInfo("useRagdollCamHit:1", "UseRagdollCameraHit", False, bool, "DOC-TODO"),
        FieldDisplayInfo("disableClothRigidHit:1", "DisableClothRigidHit", False, bool, "DOC-TODO"),
        FieldDisplayInfo("useRagdoll:1", "UseRagdoll", False, bool, "DOC-TODO"),
        FieldDisplayInfo("isDemon:1", "IsDemon", True, bool, "DOC-TODO"),
        FieldDisplayInfo("isGhost:1", "IsGhost", True, bool, "DOC-TODO"),
        FieldDisplayInfo("isNoDamageMotion:1", "IsNoDamageMotion", True, bool, "DOC-TODO"),
        FieldDisplayInfo("isUnduration:1", "IsUnduration", False, bool, "DOC-TODO"),
        FieldDisplayInfo("isChangeWanderGhost:1", "IsChangeWanderGhost", False, bool, "Always false."),
        FieldDisplayInfo("modelDispMask0:1", "ModelDisplayMask0", False, bool, "DOC-TODO"),
        FieldDisplayInfo("modelDispMask1:1", "ModelDisplayMask1", False, bool, "DOC-TODO"),
        FieldDisplayInfo("modelDispMask2:1", "ModelDisplayMask2", False, bool, "DOC-TODO"),
        FieldDisplayInfo("modelDispMask3:1", "ModelDisplayMask3", False, bool, "DOC-TODO"),
        FieldDisplayInfo("modelDispMask4:1", "ModelDisplayMask4", False, bool, "DOC-TODO"),
        FieldDisplayInfo("modelDispMask5:1", "ModelDisplayMask5", False, bool, "DOC-TODO"),
        FieldDisplayInfo("modelDispMask6:1", "ModelDisplayMask6", False, bool, "DOC-TODO"),
        FieldDisplayInfo("modelDispMask7:1", "ModelDisplayMask7", False, bool, "DOC-TODO"),
        FieldDisplayInfo("modelDispMask8:1", "ModelDisplayMask8", False, bool, "DOC-TODO"),
        FieldDisplayInfo("modelDispMask9:1", "ModelDisplayMask9", False, bool, "DOC-TODO"),
        FieldDisplayInfo("modelDispMask10:1", "ModelDisplayMask10", False, bool, "DOC-TODO"),
        FieldDisplayInfo("modelDispMask11:1", "ModelDisplayMask11", False, bool, "DOC-TODO"),
        FieldDisplayInfo("modelDispMask12:1", "ModelDisplayMask12", False, bool, "DOC-TODO"),
        FieldDisplayInfo("modelDispMask13:1", "ModelDisplayMask13", False, bool, "DOC-TODO"),
        FieldDisplayInfo("modelDispMask14:1", "ModelDisplayMask14", False, bool, "DOC-TODO"),
        FieldDisplayInfo("modelDispMask15:1", "ModelDisplayMask15", False, bool, "DOC-TODO"),
        FieldDisplayInfo("isEnableNeckTurn:1", "IsEnableNeckTurn", False, bool, "DOC-TODO"),
        FieldDisplayInfo(
            "disableRespawn:1",
            "DisableRespawnOnRest",
            True,
            bool,
            "Prevents NPC from respawning when you rest at a bonfire, though they will still respawn when you die "
            "or the map is de-loaded unless they are disabled by an event script.",
        ),
        FieldDisplayInfo("isMoveAnimWait:1", "IsMoveAnimationWait", False, bool, "DOC-TODO"),
        ...
        FieldDisplayInfo("pad1:1", "Pad1", False, pad_field(1), "DOC-TODO"),
        FieldDisplayInfo(
            "vowType:3",
            "VowType",
            False,
        ...
        FieldDisplayInfo("pad3:4", "Pad2", False, pad_field(4), "DOC-TODO"),
        FieldDisplayInfo("pad2[6]", "Pad3", False, pad_field(6), "DOC-TODO"),
    ],
}
