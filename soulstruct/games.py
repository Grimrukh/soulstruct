...
DARK_SOULS_PTDE = Game(
    ...
    uses_dcx=False,
    bundled_paramdef_path=PACKAGE_PATH("params/darksouls1/resources/darksouls1ptde.paramdefbnd"),
)
DARK_SOULS_DSR = Game(
    "Dark Souls Remastered",
    aliases=("darksoulsremastered", "darksoulsdsr", "dsr"),
    uses_dcx=True,
    bundled_paramdef_path=PACKAGE_PATH("params/darksouls1/resources/darksouls1dsr.paramdefbnd.dcx"),
)
DARK_SOULS_2 = Game(
    "Dark Souls II",
...
SEKIRO = Game(
    "Sekiro",
    aliases=("sekiro", "sekiroshadowsdietwice"),
    uses_dcx=True,
)
ELDEN_RING = Game(
    "Elden Ring",
