...
class NPC_PARAM_ST(ParamRowData):
    ...
    SpecialEffectID0: SpecialEffectParam = ParamField(
    ...
    SpecialEffectID1: SpecialEffectParam = ParamField(
    ...
    SpecialEffectID2: SpecialEffectParam = ParamField(
    ...
    SpecialEffectID3: SpecialEffectParam = ParamField(
    ...
    SpecialEffectID4: SpecialEffectParam = ParamField(
    ...
    SpecialEffectID5: SpecialEffectParam = ParamField(
    ...
    SpecialEffectID6: SpecialEffectParam = ParamField(
    ...
    SpecialEffectID7: SpecialEffectParam = ParamField(
    ...
    NewGamePlusSpecialEffect: SpecialEffectParam = ParamField(
    ...
    MoveAnimationID: int = ParamField(
        int, "moveAnimId", default=0, hide=True,
        tooltip="TODO",
    )
    SpecialMoveAnimationID1: int = ParamField(
        int, "spMoveAnimId1", default=0, hide=True,
        tooltip="TODO",
    )
    SpecialMoveAnimationID2: int = ParamField(
        int, "spMoveAnimId2", default=0, hide=True,
        tooltip="TODO",
    )
    NetworkWarpDistance: float = ParamField(
        float, "networkWarpDist", default=0.0, hide=True,
        tooltip="TODO",
    )
    DebugBehaviorR1: int = ParamField(
        int, "dbgBehaviorR1", default=-1, hide=True,
        tooltip="TODO",
    )
    DebugBehaviorL1: int = ParamField(
        int, "dbgBehaviorL1", default=-1, hide=True,
        tooltip="TODO",
    )
    DebugBehaviorR2: int = ParamField(
        int, "dbgBehaviorR2", default=-1, hide=True,
        tooltip="TODO",
    )
    DebugBehaviorL2: int = ParamField(
        int, "dbgBehaviorL2", default=-1, hide=True,
        tooltip="TODO",
    )
    DebugBehaviorRL: int = ParamField(
        int, "dbgBehaviorRL", default=-1, hide=True,
        tooltip="TODO",
    )
    DebugBehaviorRR: int = ParamField(
        int, "dbgBehaviorRR", default=-1, hide=True,
        tooltip="TODO",
    )
    DebugBehaviorRD: int = ParamField(
        int, "dbgBehaviorRD", default=-1, hide=True,
        tooltip="TODO",
    )
    DebugBehaviorRU: int = ParamField(
        int, "dbgBehaviorRU", default=-1, hide=True,
        tooltip="TODO",
    )
    DebugBehaviorLL: int = ParamField(
        int, "dbgBehaviorLL", default=-1, hide=True,
        tooltip="TODO",
    )
    DebugBehaviorLR: int = ParamField(
        int, "dbgBehaviorLR", default=-1, hide=True,
        tooltip="TODO",
    )
    DebugBehaviorLD: int = ParamField(
        int, "dbgBehaviorLD", default=-1, hide=True,
        tooltip="TODO",
    )
    DebugBehaviorLU: int = ParamField(
        int, "dbgBehaviorLU", default=-1, hide=True,
        tooltip="TODO",
    )
    AnimationIDOffset2: int = ParamField(
        int, "animIdOffset2", default=0, hide=True,
        tooltip="TODO",
    )
    ...
    DefenseRepelPower: int = ParamField(
        ushort, "defFlickPower", default=0, hide=True,
    ...
    GhostModelID: int = ParamField(
        short, "ghostModelId", default=-1, hide=True,
    ...
    NormalChangeResourceID: int = ParamField(
        short, "normalChangeResouceId", default=-1, hide=True,
    ...
    SlashDamageReductionWhenGuarding: int = ParamField(
        short, "slashGuardCutRate", default=0, hide=True,
        tooltip="Always zero.",
    )
    StrikeDamageReductionWhenGuarding: int = ParamField(
        short, "blowGuardCutRate", default=0, hide=True,
        tooltip="Always zero.",
    )
    ThrustDamageReductionWhenGuarding: int = ParamField(
        short, "thrustGuardCutRate", default=0, hide=True,
        tooltip="Always zero.",
    )
    ...
    PCAttrB: int = ParamField(
        byte, "pcAttrB", default=0, hide=True,
        tooltip="Like a remnant of World Tendency. Always set to zero.",
    )
    PCAttrW: int = ParamField(
        byte, "pcAttrW", default=0, hide=True,
        tooltip="Like a remnant of World Tendency. Always set to zero.",
    )
    PCAttrL: int = ParamField(
        byte, "pcAttrL", default=0, hide=True,
        tooltip="Like a remnant of World Tendency. Always set to zero.",
    )
    PCAttrR: int = ParamField(
        byte, "pcAttrR", default=0, hide=True,
        tooltip="Like a remnant of World Tendency. Always set to zero.",
    )
    AreaAttrB: int = ParamField(
        byte, "areaAttrB", default=0, hide=True,
        tooltip="Like a remnant of World Tendency. Always set to zero.",
    )
    AreaAttrW: int = ParamField(
        byte, "areaAttrW", default=0, hide=True,
        tooltip="Like a remnant of World Tendency. Always set to zero.",
    )
    AreaAttrL: int = ParamField(
        byte, "areaAttrL", default=0, hide=True,
        tooltip="Like a remnant of World Tendency. Always set to zero.",
    )
    AreaAttrR: int = ParamField(
        byte, "areaAttrR", default=0, hide=True,
        tooltip="Like a remnant of World Tendency. Always set to zero.",
    )
    MPRecoveryBaseSpeed: int = ParamField(
        byte, "mpRecoverBaseVel", default=0, hide=True,
    ...
    RepelDamageCutRate: int = ParamField(
        byte, "flickDamageCutRate", default=0, hide=True,
    ...
    Material: int = ParamField(
        byte, "material", default=0, hide=True,
        tooltip="TODO",
    )
    MaterialSFX: int = ParamField(
        byte, "materialSfx", default=0, hide=True,
        tooltip="TODO",
    )
    MaterialWeak: int = ParamField(
        byte, "material_Weak", default=0, hide=True,
        tooltip="TODO",
    )
    MaterialWeakSFX: int = ParamField(
        byte, "materialSfx_Weak", default=0, hide=True,
        tooltip="TODO",
    )
    PartsDamageType: int = ParamField(
        byte, "partsDamageType", default=0, hide=True,
    ...
    MaxUndurationAngle: int = ParamField(
        byte, "maxUndurationAng", default=0, hide=True,
        tooltip="Unknown effect, but it is generally set to 30 for all four-legged enemies, and 0 for all others.",
    )
    GuardLevel: GUARDMOTION_CATEGORY = ParamField(
        sbyte, "guardLevel", default=0, hide=True,
    ...
    BurnSFXType: NPC_BURN_TYPE = ParamField(
        byte, "burnSfxType", default=0, hide=True,
    ...
    ParryAttack: int = ParamField(
        byte, "parryAttack", default=0, hide=True,
        tooltip="Always zero.",
    )
    ParryDefense: int = ParamField(
        byte, "parryDefence", default=0, hide=True,
        tooltip="Always zero.",
    )
    SFXSize: NPC_SFX_SIZE = ParamField(
        byte, "sfxSize", default=0, hide=True,
        tooltip="Set to 2 for very large enemies, 1 for large enemies, and 0 otherwise.",
    )
    PushOutCameraRegionRadius: int = ParamField(
        byte, "pushOutCamRegionRadius", default=12, hide=True,
        tooltip="Always zero.",
    )
    HitStopType: NPC_HITSTOP_TYPE = ParamField(
        byte, "hitStopType", default=0, hide=True,
    ...
    LadderEndCheckOffsetTop: int = ParamField(
        byte, "ladderEndChkOffsetTop", default=15, hide=True,
        tooltip="Not something you want to mess with.",
    )
    LadderEndCheckOffsetBottom: int = ParamField(
        byte, "ladderEndChkOffsetLow", default=8, hide=True,
        tooltip="Not something you want to mess with.",
    )
    UseRagdollCameraHit: bool = ParamField(
        byte, "useRagdollCamHit:1", bit_count=1, default=False, hide=True,
        tooltip="TODO",
    )
    DisableClothRigidHit: bool = ParamField(
        byte, "disableClothRigidHit:1", bit_count=1, default=False, hide=True,
        tooltip="TODO",
    )
    UseRagdoll: bool = ParamField(
        byte, "useRagdoll:1", bit_count=1, default=False, hide=True,
        tooltip="TODO",
    )
    IsDemon: bool = ParamField(
        byte, "isDemon:1", bit_count=1, default=False,
        tooltip="TODO",
    )
    IsGhost: bool = ParamField(
        byte, "isGhost:1", bit_count=1, default=False,
        tooltip="TODO",
    )
    IsNoDamageMotion: bool = ParamField(
        byte, "isNoDamageMotion:1", bit_count=1, default=False,
        tooltip="TODO",
    )
    IsUnduration: bool = ParamField(
        byte, "isUnduration:1", bit_count=1, default=False, hide=True,
        tooltip="TODO",
    )
    IsChangeWanderGhost: bool = ParamField(
        byte, "isChangeWanderGhost:1", bit_count=1, default=False, hide=True,
        tooltip="Always false.",
    )
    ModelDisplayMask0: bool = ParamField(
        byte, "modelDispMask0:1", bit_count=1, default=False, hide=True,
        tooltip="TODO",
    )
    ModelDisplayMask1: bool = ParamField(
        byte, "modelDispMask1:1", bit_count=1, default=False, hide=True,
        tooltip="TODO",
    )
    ModelDisplayMask2: bool = ParamField(
        byte, "modelDispMask2:1", bit_count=1, default=False, hide=True,
        tooltip="TODO",
    )
    ModelDisplayMask3: bool = ParamField(
        byte, "modelDispMask3:1", bit_count=1, default=False, hide=True,
        tooltip="TODO",
    )
    ModelDisplayMask4: bool = ParamField(
        byte, "modelDispMask4:1", bit_count=1, default=False, hide=True,
        tooltip="TODO",
    )
    ModelDisplayMask5: bool = ParamField(
        byte, "modelDispMask5:1", bit_count=1, default=False, hide=True,
        tooltip="TODO",
    )
    ModelDisplayMask6: bool = ParamField(
        byte, "modelDispMask6:1", bit_count=1, default=False, hide=True,
        tooltip="TODO",
    )
    ModelDisplayMask7: bool = ParamField(
        byte, "modelDispMask7:1", bit_count=1, default=False, hide=True,
        tooltip="TODO",
    )
    ModelDisplayMask8: bool = ParamField(
        byte, "modelDispMask8:1", bit_count=1, default=False, hide=True,
        tooltip="TODO",
    )
    ModelDisplayMask9: bool = ParamField(
        byte, "modelDispMask9:1", bit_count=1, default=False, hide=True,
        tooltip="TODO",
    )
    ModelDisplayMask10: bool = ParamField(
        byte, "modelDispMask10:1", bit_count=1, default=False, hide=True,
        tooltip="TODO",
    )
    ModelDisplayMask11: bool = ParamField(
        byte, "modelDispMask11:1", bit_count=1, default=False, hide=True,
        tooltip="TODO",
    )
    ModelDisplayMask12: bool = ParamField(
        byte, "modelDispMask12:1", bit_count=1, default=False, hide=True,
        tooltip="TODO",
    )
    ModelDisplayMask13: bool = ParamField(
        byte, "modelDispMask13:1", bit_count=1, default=False, hide=True,
        tooltip="TODO",
    )
    ModelDisplayMask14: bool = ParamField(
        byte, "modelDispMask14:1", bit_count=1, default=False, hide=True,
        tooltip="TODO",
    )
    ModelDisplayMask15: bool = ParamField(
        byte, "modelDispMask15:1", bit_count=1, default=False, hide=True,
        tooltip="TODO",
    )
    ...
    IsMoveAnimationWait: bool = ParamField(
        byte, "isMoveAnimWait:1", bit_count=1, default=False, hide=True,
        tooltip="TODO",
    )
    IsCrowd: bool = ParamField(
        byte, "isCrowd:1", bit_count=1, default=False, hide=True,
        tooltip="Always false.",
    )
    IsWeakToDivine: bool = ParamField(
        byte, "isWeakSaint:1", bit_count=1, default=False,
    ...
    IsSoulsGetByBoss: bool = ParamField(
        byte, "isSoulGetByBoss:1", bit_count=1, default=False,
        tooltip="TODO",
    )
    IsMultilingual: bool = ParamField(
        byte, "isMultilingual:1", bit_count=1, default=False,
        tooltip="TODO",
    )
