...
class ATK_PARAM_ST(ParamRow):
    ...
    AttackPowerForEffects: int = ParamField(
        sbyte, "atkPow_forSfxSe", ATKPARAM_SFX_SE_ATK_POW, default=0,
        tooltip="TODO",
    )
    AttackDirectionForEffects: int = ParamField(
        sbyte, "atkDir_forSfxSe", ATKPARAM_SFX_SE_ATK_DIR, default=0,
    ...
    IsChargeAttack: bool = ParamField(
        byte, "isChargeAtk:1", ATK_PARAM_BOOL, bit_count=1, default=False,
        tooltip="TODO",
    )
    SharesHitList: bool = ParamField(
        byte, "isShareHitList:1", ATK_PARAM_BOOL, bit_count=1, default=False,
        tooltip="TODO",
    )
    CollidesWithObjects: bool = ParamField(
        byte, "isCheckObjPenetration:1", ATK_PARAM_BOOL, bit_count=1, default=False,
    ...
    AppearAISoundID: int = ParamField(
        int, "appearAiSoundId", game_type=AISoundParam, default=0,
        tooltip="TODO",
    )
    HitAISoundID: int = ParamField(
        int, "hitAiSoundId", game_type=AISoundParam, default=0,
        tooltip="TODO",
    )
