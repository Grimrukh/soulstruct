...
class ATK_PARAM_ST(ParamRow):
    ...
    AttackPowerForEffects: int = ParamField(
        sbyte, "atkPow_forSfxSe", default=0,
        tooltip="TODO",
    )
    AttackDirectionForEffects: int = ParamField(
        sbyte, "atkDir_forSfxSe", default=0,
        tooltip="Name might be wrong.",
    )
    AffectsEnemies: bool = ParamField(
        byte, "opposeTarget:1", bit_count=1, default=True,
        tooltip="TODO",
    )
    AffectsAllies: bool = ParamField(
        byte, "friendlyTarget:1", bit_count=1, default=False,
        tooltip="TODO",
    )
    AffectsSelf: bool = ParamField(
        byte, "selfTarget:1", bit_count=1, default=False,
        tooltip="TODO",
    )
    IsChargeAttack: bool = ParamField(
        byte, "isChargeAtk:1", bit_count=1, default=False,
        tooltip="TODO",
    )
    SharesHitList: bool = ParamField(
        byte, "isShareHitList:1", bit_count=1, default=False,
        tooltip="TODO",
    )
    CollidesWithObjects: bool = ParamField(
        byte, "isCheckObjPenetration:1", bit_count=1, default=False,
        tooltip="Value might be inverted.",
    )
    _BitPad0: int = ParamBitPad(byte, "pad:2", bit_count=2)
    _Pad0: bytes = ParamPad(1, "pad2")
    ...
    RegainTimeScale: int = ParamField(
        float, "regainableTimeScale", default=1.0,
        tooltip="TODO",
    )
    RegainHPRateScale: int = ParamField(
