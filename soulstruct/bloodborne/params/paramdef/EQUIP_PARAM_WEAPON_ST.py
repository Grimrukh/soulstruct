...
class EQUIP_PARAM_WEAPON_ST(ParamRow):
    ...
    IsAttributeWeapon: bool = ParamField(
        byte, "isAttributeWep:1", EQUIP_BOOL, bit_count=1, default=False,
        tooltip="TODO",
    )
    EnchantsLeftHand: bool = ParamField(
        byte, "isEnchantLeftHand:1", EQUIP_BOOL, bit_count=1, default=False,
        tooltip="TODO",
    )
    ...
    PhysicalAttackMenuDisplayType: int = ParamField(
        byte, "PhysAtkMenuDispType", PHYS_ATK_MENU_DISP_TYPE, default=0,
        tooltip="TODO",
    )
    ...
    Slot0RightHangModelPoint: int = ParamField(
        short, "dmypolyId_Slot0RightHang", game_type=ModelDummy, default=-1,
        tooltip="TODO",
    )
    Slot0RightFormAModelPoint: int = ParamField(
        short, "dmypolyId_Slot0RightFormA", game_type=ModelDummy, default=-1,
        tooltip="TODO",
    )
    Slot0RightFormBModelPoint: int = ParamField(
        short, "dmypolyId_Slot0RightFormB", game_type=ModelDummy, default=-1,
        tooltip="TODO",
    )
    Slot0LeftHangModelPoint: int = ParamField(
        short, "dmypolyId_Slot0LeftHang", game_type=ModelDummy, default=-1,
        tooltip="TODO",
    )
    Slot0LeftFormAModelPoint: int = ParamField(
        short, "dmypolyId_Slot0LeftFormA", game_type=ModelDummy, default=-1,
        tooltip="TODO",
    )
    Slot0LeftFormBModelPoint: int = ParamField(
        short, "dmypolyId_Slot0LeftFormB", game_type=ModelDummy, default=-1,
        tooltip="TODO",
    )
    Slot1RightHangModelPoint: int = ParamField(
        short, "dmypolyId_Slot1RightHang", game_type=ModelDummy, default=-1,
        tooltip="TODO",
    )
    Slot1RightFormAModelPoint: int = ParamField(
        short, "dmypolyId_Slot1RightFormA", game_type=ModelDummy, default=-1,
        tooltip="TODO",
    )
    Slot1RightFormBModelPoint: int = ParamField(
        short, "dmypolyId_Slot1RightFormB", game_type=ModelDummy, default=-1,
        tooltip="TODO",
    )
    Slot1LeftHangModelPoint: int = ParamField(
        short, "dmypolyId_Slot1LeftHang", game_type=ModelDummy, default=-1,
        tooltip="TODO",
    )
    Slot1LeftFormAModelPoint: int = ParamField(
        short, "dmypolyId_Slot1LeftFormA", game_type=ModelDummy, default=-1,
        tooltip="TODO",
    )
    Slot1LeftFormBModelPoint: int = ParamField(
        short, "dmypolyId_Slot1LeftFormB", game_type=ModelDummy, default=-1,
        tooltip="TODO",
    )
    Slot2RightHangModelPoint: int = ParamField(
        short, "dmypolyId_Slot2RightHang", game_type=ModelDummy, default=-1,
        tooltip="TODO",
    )
    Slot2RightFormAModelPoint: int = ParamField(
        short, "dmypolyId_Slot2RightFormA", game_type=ModelDummy, default=-1,
        tooltip="TODO",
    )
    Slot2RightFormBModelPoint: int = ParamField(
        short, "dmypolyId_Slot2RightFormB", game_type=ModelDummy, default=-1,
        tooltip="TODO",
    )
    Slot2LeftHangModelPoint: int = ParamField(
        short, "dmypolyId_Slot2LeftHang", game_type=ModelDummy, default=-1,
        tooltip="TODO",
    )
    Slot2LeftFormAModelPoint: int = ParamField(
        short, "dmypolyId_Slot2LeftFormA", game_type=ModelDummy, default=-1,
        tooltip="TODO",
    )
    Slot2LeftFormBModelPoint: int = ParamField(
        short, "dmypolyId_Slot2LeftFormB", game_type=ModelDummy, default=-1,
        tooltip="TODO",
    )
    Slot3RightHangModelPoint: int = ParamField(
        short, "dmypolyId_Slot3RightHang", game_type=ModelDummy, default=-1,
        tooltip="TODO",
    )
    Slot3RightFormAModelPoint: int = ParamField(
        short, "dmypolyId_Slot3RightFormA", game_type=ModelDummy, default=-1,
        tooltip="TODO",
    )
    Slot3RightFormBModelPoint: int = ParamField(
        short, "dmypolyId_Slot3RightFormB", game_type=ModelDummy, default=-1,
        tooltip="TODO",
    )
    Slot3LeftHangModelPoint: int = ParamField(
        short, "dmypolyId_Slot3LeftHang", game_type=ModelDummy, default=-1,
        tooltip="TODO",
    )
    Slot3LeftFormAModelPoint: int = ParamField(
        short, "dmypolyId_Slot3LeftFormA", game_type=ModelDummy, default=-1,
        tooltip="TODO",
    )
    Slot3LeftFormBModelPoint: int = ParamField(
        short, "dmypolyId_Slot3LeftFormB", game_type=ModelDummy, default=-1,
        tooltip="TODO",
    )
