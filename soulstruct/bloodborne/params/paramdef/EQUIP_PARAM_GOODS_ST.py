...
class EQUIP_PARAM_GOODS_ST(ParamRow):
    ...
    UseableByPathOfTheDragon: bool = ParamField(
        byte, "vowType5:1", EQUIP_BOOL, bit_count=1, default=False,
    ...
    UseableByChaosServant: bool = ParamField(
        byte, "vowType9:1", EQUIP_BOOL, bit_count=1, default=False,
    ...
    UseMaxBulletCount: bool = ParamField(
        byte, "useBulletMaxNum:1", EQUIP_BOOL, bit_count=1, default=False,
        tooltip="TODO",
    )
    UseHealingMaxCount: bool = ParamField(
        byte, "useHpCureMaxNum:1", EQUIP_BOOL, bit_count=1, default=False,
        tooltip="TODO",
    )
    AutoReplenishes: bool = ParamField(
        byte, "isAutoReplenish:1", EQUIP_BOOL, bit_count=1, default=False,
        tooltip="TODO",
    )
    ...
    UseLimitCategory2: int = ParamField(
        byte, "useLimitCategory2", SP_EFFECT_USELIMIT_CATEGORY, default=0,
        tooltip="TODO",
    )
    ...
    ReplaceTriggerSpecialEffect: int = ParamField(
        int, "replaceTriggerSpEffectId", game_type=SpecialEffectParam, default=-1,
        tooltip="TODO",
    )
