...
class EQUIP_PARAM_GOODS_ST(ParamRowData):
    ...
    UseableByHumans: bool = ParamField(
        byte, "enable_live:1", bit_count=1, default=False,
    ...
    UseableByHollows: bool = ParamField(
        byte, "enable_gray:1", bit_count=1, default=False,
    ...
    UseMaxBulletCount: EQUIP_BOOL = ParamField(
        byte, "useBulletMaxNum:1", bit_count=1, default=False,
        tooltip="TODO",
    )
    UseHealingMaxCount: EQUIP_BOOL = ParamField(
        byte, "useHpCureMaxNum:1", bit_count=1, default=False,
        tooltip="TODO",
    )
    AutoReplenishes: EQUIP_BOOL = ParamField(
        byte, "isAutoReplenish:1", bit_count=1, default=False,
        tooltip="TODO",
    )
    CanMultiUse: EQUIP_BOOL = ParamField(
        byte, "canMultiUse:1", bit_count=1, default=False,
        tooltip="TODO",
    )
    ...
    ApplySpecialEffect: EQUIP_BOOL = ParamField(
        byte, "isApplySpecialEffect:1", bit_count=1, default=False,
        tooltip="TODO",
    )
    _BitPad0: int = ParamBitPad(byte, "pad0:3", bit_count=3)
    ...
    BulletCost: int = ParamField(
        byte, "bulletConsumeNum", default=0,
        tooltip="TODO",
    )
    UseLimitCategory2: SP_EFFECT_USELIMIT_CATEGORY = ParamField(
        byte, "useLimitCategory2", default=0,
        tooltip="TODO",
    )
    _Pad1: bytes = ParamPad(2, "pad1[2]")
    ReplaceItemIDBySpecialEffect: int = ParamField(
        int, "replaceItemId_bySpEffect", default=-1,
        tooltip="TODO",
    )
    ReplaceTriggerSpecialEffect: int = ParamField(
        int, "replaceTriggerSpEffectId", default=-1,
        tooltip="TODO",
    )
