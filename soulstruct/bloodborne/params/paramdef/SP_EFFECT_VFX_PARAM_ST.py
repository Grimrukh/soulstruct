...
class SP_EFFECT_VFX_PARAM_ST(ParamRowData):
    ...
    TransformBodyArmor: bool = ParamField(
        byte, "transformArmor:1", bit_count=1, default=False,
    ...
    TransformHandArmor: bool = ParamField(
        byte, "transformGauntlet:1", bit_count=1, default=False,
        tooltip="TODO",
    )
    TransformHeadArmor: bool = ParamField(
        byte, "transformHelmet:1", bit_count=1, default=False,
        tooltip="TODO",
    )
    TransformLegsArmor: bool = ParamField(
        byte, "transformLeggings:1", bit_count=1, default=False,
        tooltip="TODO",
    )
    ...
    TransformWeaponID: int = ParamField(
        int, "transformWeaponId", default=-1,
        tooltip="TODO",
    )
