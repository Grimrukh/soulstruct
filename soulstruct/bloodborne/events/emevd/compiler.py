...
def compile_game_object_test(
    ...
    game_object: BaseGameObject | tuple,
    negate=False,
    condition: int = None,
    skip_lines=0,
    end_event=False,
