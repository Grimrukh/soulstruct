...
def LudwigPhaseTwoTrigger():
    ...
    WaitFrames(96)
    RemoveSpecialEffect(Characters.LudwigTheHolyBlade, 5300)
...
def LudwigTheAccursedLimbDamage(
    ...
    RemoveSpecialEffect(Characters.LudwigTheAccursed, arg_16_19)
    WaitFrames(10)
...
def LaurenceLimbDamage(
    ...
    RemoveSpecialEffect(Characters.Laurence, arg_16_19)
    ...
    RemoveSpecialEffect(Characters.Laurence, arg_12_15)
