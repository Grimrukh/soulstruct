...
def EbrietasFirstTime():
    ...
    RemoveSpecialEffect(Characters.Ebrietas, 5647)
...
def EbrietasHeadDamage(
    ...
    RemoveSpecialEffect(Characters.Ebrietas, arg_20_23)
    ...
    RemoveSpecialEffect(Characters.Ebrietas, arg_16_19)
...
def Event12425250(
    ...
    ReplanAI(arg_0_3)
    SkipLinesIfValueNotEqual(arg_28_28, left=0, right=arg_24_27)
...
def Event12425500(_, arg_0_3: int, arg_4_7: float, arg_8_11: int, arg_12_15: int, arg_16_19: float):
    ...
    IfConditionTrue(-1, input_condition=1)
    IfAttacked(-1, arg_0_3, attacker=PLAYER)
    SkipLinesIfValueNotEqual(3, left=1, right=arg_8_11)
