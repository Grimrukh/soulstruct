...
def Event12800460(_, arg_0_3: int, arg_4_7: int, arg_8_11: int):
    ...
    WaitFrames(150)
    PlayCutsceneAndMovePlayer_Dummy(arg_4_7, move_to_map=YAHARGUL)
    WaitFrames(1)
...
def Event12801800():
    ...
    DisableObject(2801800)
    DisableObject(2801801)
    DeleteVFX(2803800, erase_root_only=True)
    DeleteVFX(2803801, erase_root_only=True)
...
def Event12804880():
    ...
    EndIfFlagEnabled(12801800)
    GotoIfFlagEnabled(Label.L0, 12801802)
    SkipLinesIfClient(2)
    DisableObject(2801800)
    DeleteVFX(2803800, erase_root_only=False)
    DisableObject(2801801)
...
def Event12804820(
    ...
    SetNPCPartEffects(2800800, npc_part_id=arg_4_7, material_sfx_id=59, material_vfx_id=59)
    ...
    SetNPCPartHealth(2800800, npc_part_id=arg_4_7, desired_health=50, overwrite_max=False)
    Restart()
    CreateNPCPart(
        2800800,
        npc_part_id=arg_0_1,
    ...
    SetNPCPartEffects(2800800, npc_part_id=arg_4_7, material_sfx_id=60, material_vfx_id=60)
...
@RestartOnRest
def Event12804840(_, arg_0_3: int):
...
@RestartOnRest
def Event12804850(_, arg_0_3: int):
