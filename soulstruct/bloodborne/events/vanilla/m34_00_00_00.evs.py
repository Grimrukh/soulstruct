...
def Event13404800():
    ...
    EndIfFlagEnabled(9471)
    GotoIfFlagEnabled(Label.L0, 13401801)
    SkipLinesIfClient(2)
    DisableObject(3401800)
...
def Event13404861():
    ...
    GotoIfFlagDisabled(Label.L0, 13401851)
...
def Event13404850():
    ...
    EndIfFlagEnabled(13401850)
    GotoIfFlagEnabled(Label.L0, 13401851)
    SkipLinesIfClient(2)
    DisableObject(3401850)
...
def Event13400940():
    ...
    GotoIfFlagRangeAnyEnabled(Label.L1, (1670, 1689))
