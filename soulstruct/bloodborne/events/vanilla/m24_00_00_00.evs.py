...
def Event_12404000():
    ...
    if not AND_1:
        return
    AND_2.Add(PlayerInsightAmountLessThan(value=50))
    ...
    # --- Label 0 --- #
    DefineLabel(0)
    AND_3.Add(PlayerInsightAmountLessThan(value=40))
    ...
    # --- Label 1 --- #
    DefineLabel(1)
    AND_4.Add(PlayerInsightAmountLessThan(value=15))
    if AND_4:
        return
    EnableFlag(12404002)
...
def Event_12405158():
    """Event 12405158"""
    MAIN.Await(EventValueNotEqual(flag=72400372, bit_count=2, value=0))
...
def Event_12405320():
    ...
    Wait(2.0)
    SkipLinesIfFinishedConditionFalse(2, input_condition=AND_5)
    ChangePatrolBehavior(2400300, patrol_information_id=2403101)
    Restart()
    SkipLinesIfFinishedConditionFalse(2, input_condition=AND_6)
    ChangePatrolBehavior(2400300, patrol_information_id=2403102)
    Restart()
    SkipLinesIfFinishedConditionFalse(2, input_condition=AND_7)
    ChangePatrolBehavior(2400300, patrol_information_id=2403103)
    Restart()
    SkipLinesIfFinishedConditionFalse(2, input_condition=AND_8)
...
def Event_12400610():
    ...
    # --- Label 0 --- #
    DefineLabel(0)
    OR_1.Add(EventValueNotEqual(flag=72400372, bit_count=2, value=0))
...
def Event_12400707():
    """Event 12400707"""
    MAIN.Await(EventValueGreaterThanOrEqual(flag=12400733, bit_count=3, value=3))
