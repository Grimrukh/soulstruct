...
def Event12400629():
    ...
    GotoIfFlagRangeAllOff(Label.L5, (70000200, 70000202))
...
def Event12400650():
    ...
    # --- 0 --- #
    DefineLabel(0)
    GotoIfFlagRangeAnyOn(Label.L0, (1373, 1375))
    ...
    GotoIfFlagRangeAnyOn(Label.L6, (1365, 1367))
    GotoIfFlagRangeAnyOn(Label.L7, (1362, 1364))
