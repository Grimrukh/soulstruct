...
def Constructor():
    ...
    Event_12600110(0, character__copy_draw_parent=2600104, character=2600210, character_1=2600211)
    Event_12600110(1, character__copy_draw_parent=2600113, character=2600212, character_1=2600213)
    Event_12600110(2, character__copy_draw_parent=2600201, character=2600214, character_1=2600215)
    Event_12600110(3, character__copy_draw_parent=2600103, character=2600216, character_1=2600217)
...
def Event_12600110(_, character__copy_draw_parent: int, character: int, character_1: int):
    """Event 12600110"""
    DisableCharacter(character)
...
def Event_12600125(_, obj: int, item_lot_param_id: int):
    ...
    IfActionButtonParam(0, action_button_id=2600030, entity=obj)
    ForceAnimation(PLAYER, 101140)
    AwardItemLot(item_lot_param_id, host_only=False)
    DeleteObjectVFX(obj)
...
def Event_12601295(_, entity: int, flag: int, flag_1: int, flag_2: int, state: uchar):
    ...
    IfActionButtonParam(2, action_button_id=7100, entity=entity)
