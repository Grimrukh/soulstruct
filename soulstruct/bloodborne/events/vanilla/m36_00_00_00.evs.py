...
def Event13604800():
    ...
    EndIfFlagEnabled(13601800)
    GotoIfFlagEnabled(Label.L0, 13601801)
    SkipLinesIfClient(2)
    DisableObject(3601800)
...
def Event13604804():
    ...
    DisableNetworkSync()
    EndIfFlagEnabled(13601800)
    GotoIfFlagEnabled(Label.L0, 13604820)
...
def Event13605921(
    ...
    IfConditionTrue(0, input_condition=1)
    SkipLinesIfFinishedConditionTrue(2, 3)
    Move(arg_0_3, destination=arg_28_31, destination_type=CoordEntityType.Region, set_draw_parent=3604027)
    SkipLines(1)
...
def Event13600950(_, arg_0_3: int):
    ...
    GotoIfFlagRangeAnyEnabled(Label.L0, (1710, 1729))
    ...
    # --- 3 --- #
    DefineLabel(3)
    GotoIfFlagRangeAnyEnabled(Label.L4, (1710, 1712))
    ...
    DefineLabel(8)
    DisableTreasure(3600906)
    GotoIfFlagRangeAnyEnabled(Label.L5, (1710, 1712))
