...
def Event12900304(_, arg_0_3: int, arg_4_7: int, arg_8_11: int):
    ...
    DisableFlag(arg_0_3)
    IfFlagOn(0, arg_0_3)
    PlayCutsceneAndMovePlayer_Dummy(arg_4_7, move_to_map=CHALICE_DUNGEON)
    WaitFrames(2)
    EnableFlag(arg_8_11)
...
def Event12904568(_, arg_0_3: int, arg_4_7: int):
    ...
    EnableCharacter(arg_0_3)
    IfFramesElapsed(0, 3)
    RotateToFaceEntity(arg_0_3, PLAYER, animation=3024)
    IfFramesElapsed(0, 1)
    EnableAI(arg_0_3)
...
def Event12904736(_, arg_0_3: int, arg_4_7: int, arg_8_11: float):
    ...
    WaitFrames(50)
    RotateToFaceEntity(arg_0_3, PLAYER, animation=3006)
    EnableAI(arg_0_3)
    ReplanAI(arg_0_3)
    End()
    EnableAI(arg_0_3)
...
def Event12904737(_, arg_0_3: int):
    ...
    IfObjectDamagedBy(-1, arg_0_3, attacker=PLAYER)
    IfConditionTrue(0, input_condition=-1)
    CreatePlayLog(1132)
    ForceAnimation(arg_0_3, 1)
...
def Event12904773(_, arg_0_3: int, arg_4_7: int, arg_8_11: int):
    ...
    IfConditionTrue(0, input_condition=1)
    RotateToFaceEntity(PLAYER, arg_0_3, animation=101130)
    Restart()
...
def Event12904881(
    ...
    EnableObject(arg_24_27)
    CreateVFX(arg_8_11)
    RotateToFaceEntity(arg_0_3, PLAYER, animation=7021)
    GotoIfCoopClientCountComparison(Label.L1, ComparisonType.Equal, 0)
    GotoIfCoopClientCountComparison(Label.L2, ComparisonType.Equal, 1)
    GotoIfCoopClientCountComparison(Label.L3, ComparisonType.Equal, 2)
...
def Event12906400(_, arg_0_3: int):
    ...
    IfAttackedWithDamageType(2, attacked_entity=arg_0_3, damage_type=DamageType.NoType)
    IfConditionTrue(-2, input_condition=1)
    IfConditionTrue(-2, input_condition=2)
    IfConditionTrue(-1, input_condition=1)
    IfConditionTrue(-1, input_condition=2)
...
def Event12907010(_, arg_0_3: int, arg_4_7: int):
    ...
    EndIfFlagOn(arg_0_3)
    IfFlagOn(0, arg_0_3)
    RotateToFaceEntity(PLAYER, arg_4_7, animation=101170)
    WaitFrames(32)
...
def Event12907020(_, arg_0_3: int, arg_4_7: int):
    ...
    IfFlagOn(0, arg_0_3)
    DisableFlag(arg_0_3)
    RotateToFaceEntity(PLAYER, arg_4_7, animation=101160)
    Wait(1.0)
