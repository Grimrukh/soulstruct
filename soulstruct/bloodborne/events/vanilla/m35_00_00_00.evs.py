...
def Event13504800():
    ...
    GotoIfFlagEnabled(Label.L0, 13501801)
    SkipLinesIfClient(2)
    DisableObject(3501800)
...
def Event13504850():
    ...
    EndIfFlagEnabled(13501850)
    GotoIfFlagEnabled(Label.L0, 13501851)
    SkipLinesIfClient(2)
    DisableObject(3501810)
...
def Event13504880():
    ...
    GotoIfFlagEnabled(Label.L0, 13504869)
    EnableRandomFlagInRange((13504873, 13504874))
    Goto(Label.L2)

    # --- 0 --- #
    DefineLabel(0)
    GotoIfFlagEnabled(Label.L1, 13504868)
    ...
    # --- 2 --- #
    DefineLabel(2)
    IfFlagRangeAllDisabled(0, (13504873, 13504878))
    WaitFrames(900)
    Restart()
...
def Event13505655():
    ...
    DisableNetworkSync()
    GotoIfFlagEnabled(Label.L1, 13501850)
    GotoIfThisEventFlagEnabled(Label.L0)
    ...
    IfConditionTrue(-1, input_condition=1)
    IfConditionTrue(0, input_condition=-1)
    GotoIfFlagEnabled(Label.L1, 13504895)
    EnableFlag(13505668)
    Wait(1.0)
...
def Event13500940(_, arg_0_3: int):
    ...
    GotoIfFlagRangeAnyEnabled(Label.L0, (1730, 1749))
    EnableFlag(1735)
...
def Event13500945(
    ...
    GotoIfFlagRangeAnyEnabled(Label.L0, (1650, 1669))
...
def Event13500960(_, arg_0_3: int, arg_4_7: int):
    ...
    IfCharacterHuman(-1, PLAYER)
    GotoIfConditionFalse(Label.L9, input_condition=-1)
    GotoIfFlagRangeAnyEnabled(Label.L1, (1750, 1769))
