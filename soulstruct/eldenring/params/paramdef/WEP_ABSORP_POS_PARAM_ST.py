...
class WEP_ABSORP_POS_PARAM_ST(ParamRowData):
    ...
    HangPosType: int = ParamField(
        byte, "hangPosType", default=0,
        tooltip="TOOLTIP-TODO",
    )
    IsSkeletonBind: int = ParamField(
        byte, "isSkeletonBind", default=0,
        tooltip="TOOLTIP-TODO",
    )
    _Pad2: bytes = ParamPad(2, "pad0[2]")
    ...
    WepInvisibleType0: int = ParamField(
        byte, "wepInvisibleType_0", default=0,
        tooltip="TOOLTIP-TODO",
    )
    WepInvisibleType1: int = ParamField(
        byte, "wepInvisibleType_1", default=0,
        tooltip="TOOLTIP-TODO",
    )
    WepInvisibleType2: int = ParamField(
        byte, "wepInvisibleType_2", default=0,
        tooltip="TOOLTIP-TODO",
    )
    WepInvisibleType3: int = ParamField(
        byte, "wepInvisibleType_3", default=0,
        tooltip="TOOLTIP-TODO",
    )
    ...
    DispPosTyperight0: int = ParamField(
        byte, "dispPosType_right_0", default=0,
        tooltip="TOOLTIP-TODO",
    )
    DispPosTypeleft0: int = ParamField(
        byte, "dispPosType_left_0", default=0,
        tooltip="TOOLTIP-TODO",
    )
    DispPosTyperightBoth0: int = ParamField(
        byte, "dispPosType_rightBoth_0", default=0,
        tooltip="TOOLTIP-TODO",
    )
    DispPosTypeleftBoth0: int = ParamField(
        byte, "dispPosType_leftBoth_0", default=0,
        tooltip="TOOLTIP-TODO",
    )
    DispPosTyperightHang0: int = ParamField(
        byte, "dispPosType_rightHang_0", default=0,
        tooltip="TOOLTIP-TODO",
    )
    DispPosTypeleftHang0: int = ParamField(
        byte, "dispPosType_leftHang_0", default=0,
        tooltip="TOOLTIP-TODO",
    )
    DispPosTyperight1: int = ParamField(
        byte, "dispPosType_right_1", default=0,
        tooltip="TOOLTIP-TODO",
    )
    DispPosTypeleft1: int = ParamField(
        byte, "dispPosType_left_1", default=0,
        tooltip="TOOLTIP-TODO",
    )
    DispPosTyperightBoth1: int = ParamField(
        byte, "dispPosType_rightBoth_1", default=0,
        tooltip="TOOLTIP-TODO",
    )
    DispPosTypeleftBoth1: int = ParamField(
        byte, "dispPosType_leftBoth_1", default=0,
        tooltip="TOOLTIP-TODO",
    )
    DispPosTyperightHang1: int = ParamField(
        byte, "dispPosType_rightHang_1", default=0,
        tooltip="TOOLTIP-TODO",
    )
    DispPosTypeleftHang1: int = ParamField(
        byte, "dispPosType_leftHang_1", default=0,
        tooltip="TOOLTIP-TODO",
    )
    DispPosTyperight2: int = ParamField(
        byte, "dispPosType_right_2", default=0,
        tooltip="TOOLTIP-TODO",
    )
    DispPosTypeleft2: int = ParamField(
        byte, "dispPosType_left_2", default=0,
        tooltip="TOOLTIP-TODO",
    )
    DispPosTyperightBoth2: int = ParamField(
        byte, "dispPosType_rightBoth_2", default=0,
        tooltip="TOOLTIP-TODO",
    )
    DispPosTypeleftBoth2: int = ParamField(
        byte, "dispPosType_leftBoth_2", default=0,
        tooltip="TOOLTIP-TODO",
    )
    DispPosTyperightHang2: int = ParamField(
        byte, "dispPosType_rightHang_2", default=0,
        tooltip="TOOLTIP-TODO",
    )
    DispPosTypeleftHang2: int = ParamField(
        byte, "dispPosType_leftHang_2", default=0,
        tooltip="TOOLTIP-TODO",
    )
    DispPosTyperight3: int = ParamField(
        byte, "dispPosType_right_3", default=0,
        tooltip="TOOLTIP-TODO",
    )
    DispPosTypeleft3: int = ParamField(
        byte, "dispPosType_left_3", default=0,
        tooltip="TOOLTIP-TODO",
    )
    DispPosTyperightBoth3: int = ParamField(
        byte, "dispPosType_rightBoth_3", default=0,
        tooltip="TOOLTIP-TODO",
    )
    DispPosTypeleftBoth3: int = ParamField(
        byte, "dispPosType_leftBoth_3", default=0,
        tooltip="TOOLTIP-TODO",
    )
    DispPosTyperightHang3: int = ParamField(
        byte, "dispPosType_rightHang_3", default=0,
        tooltip="TOOLTIP-TODO",
    )
    DispPosTypeleftHang3: int = ParamField(
        byte, "dispPosType_leftHang_3", default=0,
        tooltip="TOOLTIP-TODO",
    )
    _Pad3: bytes = ParamPad(12, "reserve[12]")
