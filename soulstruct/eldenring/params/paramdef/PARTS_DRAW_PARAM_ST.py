...
class PARTS_DRAW_PARAM_ST(ParamRowData):
    ...
    Lv01PlayDist: float = ParamField(
        float, "lv01_PlayDist", default=1,
        tooltip="TOOLTIP-TODO",
    )
    Lv12BorderDist: float = ParamField(
        float, "lv12_BorderDist", default=20,
        tooltip="TOOLTIP-TODO",
    )
    Lv12PlayDist: float = ParamField(
        float, "lv12_PlayDist", default=2,
        tooltip="TOOLTIP-TODO",
    )
    Lv23BorderDist: float = ParamField(
        float, "lv23_BorderDist", default=30,
        tooltip="TOOLTIP-TODO",
    )
    ...
    Lv34BorderDist: float = ParamField(
        float, "lv34_BorderDist", default=9999,
        tooltip="TOOLTIP-TODO",
    )
    ...
    Lv45BorderDist: float = ParamField(
        float, "lv45_BorderDist", default=9999,
        tooltip="TOOLTIP-TODO",
    )
    ...
    Texlv01BorderDist: float = ParamField(
        float, "tex_lv01_BorderDist", default=30,
        tooltip="TOOLTIP-TODO",
    )
    Texlv01PlayDist: float = ParamField(
        float, "tex_lv01_PlayDist", default=1,
        tooltip="TOOLTIP-TODO",
    )
    EnableCrossFade: int = ParamField(
        uint, "enableCrossFade:1", default=0,
        tooltip="TOOLTIP-TODO",
    )
    DrawDist: float = ParamField(
        float, "drawDist", default=9999,
        tooltip="TOOLTIP-TODO",
    )
    ...
    ShadowDrawDist: float = ParamField(
        float, "shadowDrawDist", default=9999,
        tooltip="TOOLTIP-TODO",
    )
    ...
    MotionBlurBorderDist: float = ParamField(
        float, "motionBlur_BorderDist", default=20,
        tooltip="TOOLTIP-TODO",
    )
    ...
    DistantViewModelBorderDist: float = ParamField(
        float, "DistantViewModel_BorderDist", default=30,
        tooltip="TOOLTIP-TODO",
    )
    DistantViewModelPlayDist: float = ParamField(
        float, "DistantViewModel_PlayDist", default=5,
        tooltip="TOOLTIP-TODO",
    )
    LimtedActivateBorderDistforGrid: float = ParamField(
        float, "LimtedActivate_BorderDist_forGrid", default=-1,
        tooltip="TOOLTIP-TODO",
    )
    LimtedActivatePlayDistforGrid: float = ParamField(
        float, "LimtedActivate_PlayDist_forGrid", default=10,
        tooltip="TOOLTIP-TODO",
    )
    ...
    ShadowDrawAlphaTestDist: float = ParamField(
        float, "shadowDrawAlphaTestDist", default=9999,
        tooltip="TOOLTIP-TODO",
    )
    FowardDrawEnvmapBlendType: int = ParamField(
        byte, "fowardDrawEnvmapBlendType", default=0,
        tooltip="TOOLTIP-TODO",
    )
