...
class CLEAR_COUNT_CORRECT_PARAM_ST(ParamRowData):
    ...
    NeturalAttackRate: float = ParamField(
        float, "NeturalAttackRate", default=1,
        tooltip="TOOLTIP-TODO",
    )
    ...
    PhysicsDefenseRate: float = ParamField(
        float, "PhysicsDefenseRate", default=1,
        tooltip="TOOLTIP-TODO",
    )
    MagicDefenseRate: float = ParamField(
        float, "MagicDefenseRate", default=1,
        tooltip="TOOLTIP-TODO",
    )
    FireDefenseRate: float = ParamField(
        float, "FireDefenseRate", default=1,
        tooltip="TOOLTIP-TODO",
    )
    ThunderDefenseRate: float = ParamField(
        float, "ThunderDefenseRate", default=1,
        tooltip="TOOLTIP-TODO",
    )
    DarkDefenseRate: float = ParamField(
        float, "DarkDefenseRate", default=1,
        tooltip="TOOLTIP-TODO",
    )
    ...
    SoulRate: float = ParamField(
        float, "SoulRate", default=1,
        tooltip="TOOLTIP-TODO",
    )
    PoisionResistRate: float = ParamField(
        float, "PoisionResistRate", default=1,
        tooltip="TOOLTIP-TODO",
    )
    DiseaseResistRate: float = ParamField(
        float, "DiseaseResistRate", default=1,
        tooltip="TOOLTIP-TODO",
    )
    BloodResistRate: float = ParamField(
        float, "BloodResistRate", default=1,
        tooltip="TOOLTIP-TODO",
    )
    CurseResistRate: float = ParamField(
        float, "CurseResistRate", default=1,
        tooltip="TOOLTIP-TODO",
    )
    FreezeResistRate: float = ParamField(
        float, "FreezeResistRate", default=1,
        tooltip="TOOLTIP-TODO",
    )
    BloodDamageRate: float = ParamField(
        float, "BloodDamageRate", default=1,
        tooltip="TOOLTIP-TODO",
    )
    SuperArmorDamageRate: float = ParamField(
        float, "SuperArmorDamageRate", default=1,
        tooltip="TOOLTIP-TODO",
    )
    FreezeDamageRate: float = ParamField(
        float, "FreezeDamageRate", default=1,
        tooltip="TOOLTIP-TODO",
    )
    SleepResistRate: float = ParamField(
        float, "SleepResistRate", default=1,
        tooltip="TOOLTIP-TODO",
    )
    MadnessResistRate: float = ParamField(
        float, "MadnessResistRate", default=1,
        tooltip="TOOLTIP-TODO",
    )
    SleepDamageRate: float = ParamField(
        float, "SleepDamageRate", default=1,
        tooltip="TOOLTIP-TODO",
    )
    MadnessDamageRate: float = ParamField(
        float, "MadnessDamageRate", default=1,
        tooltip="TOOLTIP-TODO",
    )
