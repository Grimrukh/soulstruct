"""Enums used in Elden Ring game parameters.

TODO: Copied from Bloodborne for now. Should at least be copied from DS3 or Sekiro first...
...
class ITEMLOT_LVDEP_ITEMCATEGORY(s32):
    """TODO: Probably not used in ER."""


class GAITEM_CATEGORY(u8):
    """Same as EMEVD `ItemType`."""
