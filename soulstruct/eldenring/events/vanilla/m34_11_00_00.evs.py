...
def Event_34112410():
    ...
    IfCharacterWhitePhantom(OR_1, PLAYER)
    IfConditionTrue(AND_1, input_condition=OR_1)
    IfHealthRatioLessThanOrEqual(AND_1, 34110710, value=0.800000011920929)
    IfCharacterDoesNotHaveSpecialEffect(AND_1, 34110710, 19385)
    ...
    CreateTemporaryVFX(vfx_id=600920, anchor_entity=34110710, model_point=157, anchor_type=CoordEntityType.Character)
    CreateTemporaryVFX(vfx_id=600921, anchor_entity=34110710, model_point=151, anchor_type=CoordEntityType.Character)
    AddSpecialEffect(34110710, 4240)
    Wait(0.5)
    SkipLinesIfCharacterDoesNotHaveSpecialEffect(line_count=3, character=34110710, special_effect=19385)
    ...
    SetLockOnPoint(character=34110710, lock_on_model_point=220, state=True)
    SetNetworkFlagState(FlagType.RelativeToThisEventSlot, 0, state=FlagSetting.On)
    AddSpecialEffect(34110710, 4241)
    End()
...
def Event_34112420():
    ...
    IfCharacterWhitePhantom(OR_1, PLAYER)
    IfConditionTrue(AND_1, input_condition=OR_1)
    IfHealthRatioLessThanOrEqual(AND_1, 34110710, value=0.6000000238418579)
    IfCharacterDoesNotHaveSpecialEffect(AND_1, 34110710, 19385)
    IfHealthValueGreaterThan(AND_1, 34110710, value=0)
...
def Event_34112430():
    ...
    IfCharacterWhitePhantom(OR_1, PLAYER)
    IfConditionTrue(AND_1, input_condition=OR_1)
    IfHealthRatioLessThanOrEqual(AND_1, 34110710, value=0.4000000059604645)
    IfCharacterDoesNotHaveSpecialEffect(AND_1, 34110710, 19385)
    IfHealthValueGreaterThan(AND_1, 34110710, value=0)
...
def Event_34112440(_, region: uint, region_1: uint):
    ...
    CreateTemporaryVFX(vfx_id=600921, anchor_entity=34110710, model_point=151, anchor_type=CoordEntityType.Character)
    Wait(0.5)
    SkipLinesIfCharacterDoesNotHaveSpecialEffect(line_count=2, character=34110710, special_effect=19385)
    AddSpecialEffect(34110710, 4241)
    Restart()
...
def Event_34112465():
    ...
    IfCharacterWhitePhantom(OR_1, PLAYER)
    IfConditionTrue(AND_1, input_condition=OR_1)
    IfHealthRatioLessThanOrEqual(AND_1, 34110711, value=0.30000001192092896)
    IfCharacterDoesNotHaveSpecialEffect(AND_1, 34110710, 19385)
    ...
    Wait(0.5)
    AddSpecialEffect(34110710, 4240)
    SkipLinesIfCharacterDoesNotHaveSpecialEffect(line_count=3, character=34110711, special_effect=19385)
...
def Event_34112475(_, flag: uint, character: uint, region: uint):
    ...
    IfCharacterDoesNotHaveSpecialEffect(AND_1, character, 19385)
    IfConditionTrue(MAIN, input_condition=AND_1)
    ...
    Wait(0.5)
    IfHealthValueEqual(OR_15, character, value=0)
    EndIfConditionTrue(input_condition=OR_15)
