...
def Event_31172810():
    ...
    SetLockOnPoint(character=Characters.GuardianGolem, lock_on_dummy_id=220, state=False)
    ...
    SetLockOnPoint(character=Characters.GuardianGolem, lock_on_dummy_id=220, state=True)
