...
from .enums.m60_45_52_00_enums import *
...
def Constructor():
    ...
    Event_1045522500()
    CommonFunc_FieldBattleHealthBar(0, boss=Characters.DraconicTreeSentinel, name=903250600, npc_threat_level=12)
    CommonFunc_90005860(
        0,
        flag=1045520800,
        left=0,
    ...
    CommonFunc_FieldBattleHalfHealthMusic(0, character=Characters.DraconicTreeSentinel, npc_threat_level=12, required_flag=0)
    CommonFunc_9005811(0, flag=1045520800, asset=Assets.AEG099_001_9000, dummy_id=5, right=0)
    CommonFunc_90005251(0, character=Characters.GuardianGolem2, radius=70.0, seconds=0.0, animation_id=3006)
    Event_1045522200()
    CommonFunc_90005300(0, flag=1045520200, character=Characters.GuardianGolem0, item_lot=30360, seconds=0.0, item_is_dropped=0)
    CommonFunc_90005300(0, flag=1045520202, character=Characters.GuardianGolem1, item_lot=30365, seconds=0.0, item_is_dropped=0)
    ...
    CommonFunc_900005610(0, asset=Assets.AEG099_090_9001, vfx_id=100, dummy_id=800, right=1045528600)
