...
def Constructor():
    ...
    CommonFunc_9005811(0, flag=1045520800, asset=Assets.AEG099_001_9000, vfx_id=5, right=0)
    ...
    CommonFunc_900005610(0, asset=Assets.AEG099_090_9001, dummy_id=100, vfx_id=800, right=1045528600)
