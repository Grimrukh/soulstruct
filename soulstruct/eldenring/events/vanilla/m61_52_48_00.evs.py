...
def Constructor():
    """Event 0"""
    CommonFunc_90005870(0, character=2052480800, name=906310600, npc_threat_level=19)
    CommonFunc_90005860(0, flag=2052480800, left=0, character=2052480800, left_1=0, item_lot=30960, seconds=0.0)
    Event_2052482200()
    Event_2052482201(
        0,
        character=2052480800,
        animation_id=30009,
...
@RestartOnRest(2052482200)
def Event_2052482200():
    """Event 2052482200"""
    GotoIfFlagEnabled(Label.L0, flag=2052480800)
    DeleteVFX(2052482200, erase_root_only=False)
    CreateVFX(2052482200)
    
    MAIN.Await(FlagEnabled(2052482202))
...
@RestartOnRest(2052482201)
def Event_2052482201(
    _,
    character: uint,
    animation_id: int,
    animation_id_1: int,
...
@RestartOnRest(2052482300)
def Event_2052482300(_, character: uint, animation_id: int, animation_id_1: int, seconds: float, flag: Flag | int):
    """Event 2052482300"""
    EndIffSpecialStandbyEndedFlagEnabled(character=character)
    ForceAnimation(character, animation_id, loop=True)
    AND_4.Add(CharacterHasSpecialEffect(character, 481))
