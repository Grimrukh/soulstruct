...
def Preconstructor():
    ...
    RunCommonEvent(0, 90005261, args=(39200203, 39202203, 2.0, 0.0, -1), arg_types="IIffi")
    RunCommonEvent(0, 90005261, args=(39200204, 39202203, 2.0, 0.0, -1), arg_types="IIffi")
    RunCommonEvent(0, 90005261, args=(39200213, 39202203, 2.0, 0.0, -1), arg_types="IIffi")
    Event_39202200()
