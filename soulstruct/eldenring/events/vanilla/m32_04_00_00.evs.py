...
from .enums.m32_04_00_00_enums import *
...
def Event_32042569(
    ...
    CreateAssetVFX(asset_3, dummy_id=101, vfx_id=806042)
...
def Event_32042849():
    ...
    CommonFunc_9005811(0, flag=32040800, asset=Assets.AEG099_001_9000, vfx_id=3, right=0)
    CommonFunc_9005822(
        0,
        flag=32040800,
