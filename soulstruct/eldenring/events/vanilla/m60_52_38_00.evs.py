...
def Event_1252382520(
    ...
    IfCharacterBackreadEnabled(AND_1, character)
    IfHealthRatioLessThanOrEqual(AND_1, character, value=0.009999999776482582)
    IfConditionTrue(MAIN, input_condition=AND_1)
    EnableInvincibility(character)
    DisableAnimations(character)
    SetTeamType(character, TeamType.NoTeam)
...
def Event_1252382600(
    ...
    SkipLinesIfUnsignedEqual(1, left=left, right=0)
    IfFlagEnabled(AND_1, left)
    IfHealthRatioGreaterThan(AND_1, character, value=0.009999999776482582)
    IfFlagEnabled(AND_1, flag)
    IfCharacterBackreadEnabled(AND_1, character)
    IfFlagEnabled(OR_1, 1252380800)
    ...
    IfCharacterBackreadEnabled(AND_3, character)
    IfHealthRatioLessThanOrEqual(AND_3, character, value=0.009999999776482582)
    ...
    DefineLabel(0)
    IfPlayerInOwnWorld(AND_2)
    IfHealthRatioGreaterThan(AND_2, character, value=0.009999999776482582)
    IfFlagEnabled(AND_2, flag)
    ...
    IfHealthRatioLessThanOrEqual(AND_4, character, value=0.009999999776482582)
    IfFlagEnabled(AND_4, flag)
    ...
    IfHealthRatioGreaterThan(AND_5, character, value=0.009999999776482582)
    ...
    IfHealthRatioLessThanOrEqual(AND_6, character, value=0.009999999776482582)
    IfFlagEnabled(AND_6, flag)
    ...
    # --- Label 1 --- #
    DefineLabel(1)
    IfHealthRatioLessThanOrEqual(AND_9, character, value=0.009999999776482582)
    ...
    ResetAnimation(character, disable_interpolation=True)
    SetNetworkUpdateRate(character, is_fixed=False, update_rate=CharacterUpdateRate.Unknown102)
    IfHealthRatioLessThanOrEqual(AND_10, character, value=0.009999999776482582)
