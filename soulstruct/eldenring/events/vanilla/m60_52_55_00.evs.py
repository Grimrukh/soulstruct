...
def Constructor():
    """Event 0"""
    RunCommonEvent(0, 90005261, args=(1052550390, 1052552390, 5.0, 0.0, 0), arg_types="IIffi")
    RunCommonEvent(0, 90005261, args=(1052550354, 1052552354, 5.0, 0.0, 0), arg_types="IIffi")
    RunCommonEvent(0, 90005300, args=(1052550390, 1052550390, 1052550700, 0.0, 0), arg_types="IIifi")
    Event_1052552270(0, 1052550270, 30001, 20001, 0, 3.0, 0.0, 0, 0, 0, 0)
    Event_1052552270(1, 1052550280, 30000, 20000, 0, 3.0, 0.0, 0, 0, 0, 0)
    RunCommonEvent(0, 90005261, args=(1052550282, 1052552282, 5.0, 0.0, 0), arg_types="IIffi")
    RunCommonEvent(0, 90005300, args=(1052550300, 1052550300, 40516, 0.0, 0), arg_types="IIifi")
    Event_1052552580()
    RunCommonEvent(0, 900005610, args=(1052551500, 100, 800, 0), arg_types="IiiI")
...
def Event_1052552580():
    """Event 1052552580"""
    RegisterLadder(start_climbing_flag=1052550580, stop_climbing_flag=1052550851, obj=1052551580)
    RegisterLadder(start_climbing_flag=1052550582, stop_climbing_flag=1052550853, obj=1052551582)
