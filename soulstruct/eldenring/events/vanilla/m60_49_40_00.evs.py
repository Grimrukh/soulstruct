...
def Constructor():
    ...
    CommonFunc_90005251(0, 1049400390, 0.0, 0.0, -1)
    CommonFunc_90005251(0, 1049400391, 0.0, 0.0, -1)
    CommonFunc_90005251(0, 1049400392, 0.0, 0.0, -1)
    CommonFunc_90005251(0, 1049400393, 0.0, 0.0, -1)
    CommonFunc_90005251(0, 1049400394, 0.0, 0.0, -1)
    Event_1049402390()
    CommonFunc_90005250(0, 1049400381, 1049402381, 0.0, -1)
