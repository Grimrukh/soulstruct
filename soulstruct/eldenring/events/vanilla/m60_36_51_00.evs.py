...
from .enums.m60_36_51_00_enums import *


@ContinueOnRest(0)
def Constructor():
    """Event 0"""
    CommonFunc_90005683(0, flag=62313, asset=Assets.AEG099_055_3000, dummy_id=208, flag_1=78390, flag_2=78390)
    CommonFunc_900005610(0, asset=Assets.AEG099_090_9000, dummy_id=100, vfx_id=800, right=1036518600)
    CommonFunc_90005620(
        0,
        flag=1036510570,
