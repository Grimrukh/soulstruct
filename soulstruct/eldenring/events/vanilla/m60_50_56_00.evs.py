...
def Event_1050562250(
    ...
    IfHealthRatioLessThanOrEqual(AND_1, character, value=0.0)
    ...
    IfHealthRatioLessThanOrEqual(AND_2, character_1, value=0.0)
    ...
    IfHealthRatioLessThanOrEqual(AND_3, character_2, value=0.0)
