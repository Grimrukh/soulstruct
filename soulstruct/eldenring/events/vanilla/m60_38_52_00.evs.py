...
def Constructor():
    ...
    CommonFunc_FieldBattleHealthBar(0, boss=Characters.TibiaMariner, name=904950602, npc_threat_level=24)
    CommonFunc_90005860(
        0,
        flag=1038520800,
        left=0,
    ...
    CommonFunc_900005610(0, asset=Assets.AEG099_090_9000, vfx_id=100, dummy_id=800, right=1038528600)
