...
def Event_717():
    ...
    OR_1.Add(InsideMap(game_map=MIDNAS_MANSE))
    ...
    OR_2.Add(InsideMap(game_map=MIDNAS_MANSE))
...
def Event_1070():
    ...
    AND_1.Add(OutsideMap(game_map=MIDNAS_MANSE))
    OR_1.Add(AND_1)
    ...
    AND_2.Add(OutsideMap(game_map=MIDNAS_MANSE))
    OR_2.Add(AND_2)
