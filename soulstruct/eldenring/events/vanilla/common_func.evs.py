...
def Event_90015502(_, flag: uint, obj: uint, region: uint):
    """Event 90015502"""
    DisableNetworkSync()
    EndIfFlagEnabled(flag)
    WaitFrames(frames=2)
    ...
    IfCharacterInsideRegion(AND_13, character=PLAYER, region=region)
    IfConditionTrue(AND_13, input_condition=OR_15)
    IfHealthValueNotEqual(AND_13, PLAYER, value=0)
    IfConditionTrue(OR_1, input_condition=AND_13)
    IfActionButtonParamActivated(OR_2, action_button_id=8301, entity=obj)
    IfConditionTrue(OR_3, input_condition=OR_1)
    IfConditionTrue(OR_3, input_condition=OR_2)
...
def Event_90005700(
    ...
    IfHealthRatioGreaterThan(AND_1, character, value=0.0)
...
def Event_90005703(
    ...
    IfAttackedWithDamageType(OR_1, attacked_entity=character, attacker=40000)
    IfCharacterHasSpecialEffect(OR_1, character, 1650000)
    IfHealthRatioGreaterThanOrEqual(AND_4, character, value=1.0)
    SkipLinesIfConditionFalse(2, AND_4)
    IfHealthRatioLessThan(AND_2, character, value=0.6499999761581421)
    Goto(Label.L10)
    IfHealthRatioGreaterThanOrEqual(AND_5, character, value=0.8999999761581421)
    SkipLinesIfConditionFalse(2, AND_5)
    IfHealthRatioLessThan(AND_2, character, value=0.550000011920929)
    Goto(Label.L10)
    IfHealthRatioGreaterThanOrEqual(AND_6, character, value=0.800000011920929)
    SkipLinesIfConditionFalse(2, AND_6)
    IfHealthRatioLessThan(AND_2, character, value=0.44999998807907104)
    Goto(Label.L10)
    IfHealthRatioGreaterThanOrEqual(AND_7, character, value=0.699999988079071)
    SkipLinesIfConditionFalse(2, AND_7)
    IfHealthRatioLessThan(AND_2, character, value=0.3499999940395355)
    Goto(Label.L10)
    IfHealthRatioGreaterThanOrEqual(AND_8, character, value=0.699999988079071)
    SkipLinesIfConditionFalse(2, AND_8)
    IfHealthRatioLessThan(AND_2, character, value=0.25)
    Goto(Label.L10)
    IfHealthRatioLessThan(AND_2, character, value=0.15000000596046448)
    Goto(Label.L10)
    ...
    IfConditionTrue(OR_2, input_condition=AND_2)
    IfHealthRatioGreaterThan(AND_3, character, value=0.0)
...
def Event_90005722(_, character: uint, character_1: uint):
    ...
    # --- Label 0 --- #
    DefineLabel(0)
    IfHealthRatioLessThan(OR_1, character, value=0.6499999761581421)
...
def Event_90005872(_, character: uint, entity_id__unk_4_8: uint, right: uint):
    ...
    IfFlagEnabled(AND_1, right)
    SkipLines(1)
    IfHealthRatioLessThanOrEqual(AND_1, character, value=0.550000011920929)
