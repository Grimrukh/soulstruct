...
__all__ = ['AIStatusType', 'BitOperation', 'NumberButtons', 'ButtonType', 'Category',
           'CharacterType', 'CharacterUpdateRate', 'ClassType', 'ComparisonType',
           'Contained', 'Covenant', 'CutsceneType', 'DamageTargetType', 'EventEndType',
           'FlagType', 'InterpolationState', 'ItemType', 'LogicalOperationType',
           'MultiplayerState', 'NavimeshType', 'OnOffChange', 'ReactionAttribute',
           'SiteType', 'SoundType', 'StatueType', 'SummonSignType', 'TeamType',
           'TendencyType', 'TextBannerType', 'UpdateAuthority']
...
class SoundType(IntEnum):
    ...
    m_music = 6
    v_voice = 7
    x_floor_material_dependent = 8
    b_armor_material_dependent = 9
    g_ghost = 10
