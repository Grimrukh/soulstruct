...
def Event11200000():
    ...
    WaitFrames(1)
    DisableObject(1201200)
    Move(1200800, destination=1202800, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
...
def Event11205390():
    ...
    IfFlagOff(1, 5)
    IfFlagOn(1, 11200000)
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1202998, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True, line_intersects=1201990, boss_version=True)
    IfConditionTrue(0, input_condition=1)
...
def Event11205391():
    ...
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1202998, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=False, line_intersects=1201990)
    IfConditionTrue(0, input_condition=1)
    RotateToFaceEntity(PLAYER, 1202997)
    ForceAnimation(PLAYER, 7410)
    Restart()
...
def Event11205380():
    ...
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1202898, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True, line_intersects=1201890, boss_version=True)
    IfConditionTrue(0, input_condition=1)
...
def Event11205381():
    ...
    IfFlagOn(1, 11205383)
    IfCharacterType(1, PLAYER, CharacterType.WhitePhantom)
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1202898, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=False, line_intersects=1201890)
    IfConditionTrue(0, input_condition=1)
    RotateToFaceEntity(PLAYER, 1202894)
    ForceAnimation(PLAYER, 7410)
    Restart()
...
def Event11205120(ARG_0_3: int, ARG_4_7: int):
    ...
    IfConditionTrue(0, input_condition=1)
    Move(1200801, destination=ARG_4_7, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
...
def Event11200100(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int):
    ...
    IfDialogPromptActivated(1, prompt_text=10010400, anchor_entity=ARG_12_15, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True, line_intersects=ARG_4_7, boss_version=True)
    IfConditionTrue(0, input_condition=1)
    EnableFlag(ARG_0_3)
...
def Event11200110(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int):
    ...
    IfDialogPromptActivated(1, prompt_text=10010400, anchor_entity=ARG_8_11, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=False, line_intersects=ARG_4_7)
    IfClient(2)
    IfDialogPromptActivated(2, prompt_text=10010400, anchor_entity=ARG_8_11, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=False, line_intersects=ARG_4_7)
    IfConditionTrue(-1, input_condition=1)
    IfConditionTrue(-1, input_condition=2)
    IfConditionTrue(0, input_condition=-1)
    EndIfFlagOn(ARG_0_3)
...
def Event11205300(ARG_0_1: short, ARG_2_3: short, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_16: uchar, ARG_17_17: uchar, ARG_20_23: int):
    ...
    Move(ARG_8_11, destination=1200010, destination_type=MapEntityType.Character, model_point=ARG_12_15, copy_draw_hitbox=1200010)
...
def Event11200530(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int):
    ...
    DisableFlagRange((ARG_4_7, ARG_8_11))
    EnableFlag(ARG_12_15)
    Move(ARG_0_3, destination=1200200, destination_type=MapEntityType.Character, model_point=101, copy_draw_hitbox=1200200)
    EnableCharacter(ARG_0_3)
    Wait(0.5)
...
def Event11205040(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int):
    ...
    IfFlagOn(1, 1122)
    IfFlagOn(1, ARG_0_3)
    IfDialogPromptActivated(1, prompt_text=50000000, anchor_entity=ARG_4_7, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, model_point=0, human_or_hollow_only=True)
    IfConditionTrue(0, input_condition=1)
    EnableFlag(11200215)
    DeleteFX(ARG_8_11, erase_root_only=True)
    Move(6051, destination=ARG_4_7, destination_type=MapEntityType.Region, model_point=-1, set_draw_hitbox=1203150)
    Wait(5.0)
    EnableCharacter(6051)
    CreateTemporaryFX(120, anchor_entity=ARG_4_7, anchor_type=MapEntityType.Region, model_point=-1)
    SetStandbyAnimationSettings(6051, standby_animation=7875)
...
def Event11200006():
    ...
    IfFlagOff(1, 17)
    IfSingleplayer(1)
    IfDialogPromptActivated(1, prompt_text=10010100, anchor_entity=1202008, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True)
    IfConditionTrue(0, input_condition=1)
    EndIfClient()
