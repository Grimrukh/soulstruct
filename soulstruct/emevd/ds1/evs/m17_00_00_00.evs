...
def Preconstructor():
    ...
    Move(6032, destination=1702501, destination_type=MapEntityType.Region, model_point=-1, set_draw_hitbox=1703300)
...
def Event11700085():
    ...
    End()
    EndIfClient()
    IfDialogPromptActivated(0, prompt_text=10010410, anchor_entity=1702610, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, model_point=0, human_or_hollow_only=True, line_intersects=1701710)
...
def Event11700000():
    ...
    CreateFX(1701991)
    Move(1700800, destination=1702800, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
...
def Event11705380():
    ...
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1702898, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True, line_intersects=1701890, boss_version=True)
    IfConditionTrue(0, input_condition=1)
...
def Event11705381():
    ...
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1702898, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=False, line_intersects=1701890)
    IfConditionTrue(0, input_condition=1)
    RotateToFaceEntity(PLAYER, 1702897)
    ForceAnimation(PLAYER, 7410)
    Restart()
...
def Event11705382():
    ...
    DisableNetworkSync()
    IfFlagOff(1, 11700000)
    IfDialogPromptActivated(1, prompt_text=10010404, anchor_entity=1702895, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=False, line_intersects=1701890)
    IfConditionTrue(0, input_condition=1)
...
def Event11705390():
    ...
    IfFlagOff(1, 14)
    IfFlagOn(1, 11700000)
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1702998, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True, line_intersects=1701990, boss_version=True)
    IfConditionTrue(0, input_condition=1)
    SkipLinesIfClient(1)
    NotifyBossBattleStart()
...
def Event11705391():
    ...
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1702998, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=False, line_intersects=1701990)
    IfConditionTrue(0, input_condition=1)
    RotateToFaceEntity(PLAYER, 1702997)
    ForceAnimation(PLAYER, 7410)
    Restart()
...
def Event11700001():
    ...
    CreateTemporaryFX(90014, anchor_entity=1701950, anchor_type=MapEntityType.Object, model_point=-1)
    Wait(2.0)
...
def Event11705397():
    ...
    Move(1700801, destination=1700800, destination_type=MapEntityType.Character, model_point=150, copy_draw_hitbox=1700800)
...
def Event11700160(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int, ARG_24_27: int):
    ...
    IfDialogPromptActivated(1, prompt_text=10010501, anchor_entity=ARG_4_7, anchor_type=MapEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=192, human_or_hollow_only=False)
    ...
    Move(PLAYER, destination=ARG_4_7, destination_type=MapEntityType.Object, model_point=191, short_move=True)
...
def Event11700090(ARG_0_3: int, ARG_4_4: uchar, ARG_8_11: int, ARG_12_15: int):
    ...
    IfDialogPromptActivated(1, prompt_text=10010501, anchor_entity=ARG_8_11, anchor_type=MapEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=195, human_or_hollow_only=False)
    IfConditionTrue(0, input_condition=1)
...
def Event11705150(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int):
    ...
    IfDialogPromptActivated(1, prompt_text=10010503, anchor_entity=ARG_4_7, anchor_type=MapEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=192, human_or_hollow_only=False)
    IfDialogPromptActivated(2, prompt_text=10010503, anchor_entity=ARG_8_11, anchor_type=MapEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=192, human_or_hollow_only=False)
    IfConditionTrue(-1, input_condition=1)
    IfConditionTrue(-1, input_condition=2)
    IfConditionTrue(0, input_condition=-1)
    ...
    Move(PLAYER, destination=ARG_8_11, destination_type=MapEntityType.Object, model_point=191, short_move=True)
    SkipLinesIfFlagOn(2, ARG_0_3)
...
def Event11700140():
    ...
    IfDialogPromptActivated(1, prompt_text=10010400, anchor_entity=1701300, anchor_type=MapEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=100, human_or_hollow_only=True)
    IfFlagOn(2, 14)
    IfConditionTrue(-1, input_condition=1)
    IfConditionTrue(-1, input_condition=2)
    IfConditionTrue(0, input_condition=-1)
    DisableFlag(405)
    SkipLinesIfFinishedConditionTrue(2, 2)
    Move(PLAYER, destination=1701300, destination_type=MapEntityType.Object, model_point=120, short_move=True)
...
def Event11700141():
    ...
    IfDialogPromptActivated(1, prompt_text=10010400, anchor_entity=1701300, anchor_type=MapEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=100, human_or_hollow_only=False)
    IfFlagOff(2, 11700140)
    IfDialogPromptActivated(2, prompt_text=10010400, anchor_entity=1701300, anchor_type=MapEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=101, human_or_hollow_only=False)
    IfConditionTrue(-1, input_condition=1)
    IfConditionTrue(-1, input_condition=2)
    IfConditionTrue(0, input_condition=-1)
...
def Event11705201(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int):
    ...
    IfConditionTrue(0, input_condition=1)
    Move(ARG_4_7, destination=ARG_8_11, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
...
def Event11700532(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int):
    ...
    EnableFlag(11700594)
    EnableCharacter(ARG_0_3)
    Move(ARG_0_3, destination=1702501, destination_type=MapEntityType.Region, model_point=-1, set_draw_hitbox=1703300)
    IfCharacterBackreadEnabled(0, ARG_0_3)
...
def Event11700539(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int):
    ...
    DisableFlagRange((ARG_4_7, ARG_8_11))
    EnableFlag(ARG_12_15)
    Move(ARG_0_3, destination=1700500, destination_type=MapEntityType.Character, model_point=101, copy_draw_hitbox=1700500)
    EnableCharacter(ARG_0_3)
