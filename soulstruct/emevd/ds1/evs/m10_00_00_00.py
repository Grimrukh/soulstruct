...
def Event11005390():
    ...
    IfFlagOff(1, 2)
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1002998, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True, line_intersects=1001990, boss_version=True)
    IfConditionTrue(0, input_condition=1)
...
def Event11005391():
    ...
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1002998, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=False, line_intersects=1001990)
    IfConditionTrue(0, input_condition=1)
    RotateToFaceEntity(PLAYER, 1002997)
    ForceAnimation(PLAYER, 7410)
    Restart()
...
def Event11005396():
    ...
    Move(1000801, destination=1000800, destination_type=MapEntityType.Character, model_point=100, copy_draw_hitbox=1000800)
...
def Event11000100():
    ...
    IfDialogPromptActivated(1, prompt_text=10010400, anchor_entity=1001319, anchor_type=MapEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=101, human_or_hollow_only=False)
    IfConditionTrue(0, input_condition=1)
    Move(PLAYER, destination=1001319, destination_type=MapEntityType.Object, model_point=121, short_move=True)
...
def Event11000101():
    ...
    DisableNetworkSync()
    IfFlagOff(1, 11000100)
    IfDialogPromptActivated(1, prompt_text=10010400, anchor_entity=1001319, anchor_type=MapEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=100, human_or_hollow_only=False)
    IfConditionTrue(0, input_condition=1)
...
def Event11000110():
    ...
    IfDialogPromptActivated(1, prompt_text=10010400, anchor_entity=1001200, anchor_type=MapEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=100, human_or_hollow_only=True)
    IfConditionTrue(0, input_condition=1)
    EnableFlag(11000111)
    Move(PLAYER, destination=1001200, destination_type=MapEntityType.Object, model_point=120, short_move=True)
...
def Event11000111():
    ...
    IfDialogPromptActivated(1, prompt_text=10010400, anchor_entity=1001200, anchor_type=MapEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=100, human_or_hollow_only=True)
    IfClient(2)
    IfDialogPromptActivated(2, prompt_text=10010400, anchor_entity=1001200, anchor_type=MapEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=100, human_or_hollow_only=False)
    IfConditionTrue(-1, input_condition=1)
    IfConditionTrue(-1, input_condition=2)
    IfConditionTrue(0, input_condition=-1)
