...
def Constructor():
    ...
    EnableNavimeshType(1503110, NavimeshType.WallTouchingFloor)
    EnableNavimeshType(1503101, NavimeshType.WallTouchingFloor)
    EnableNavimeshType(1503111, NavimeshType.Wall)
    EnableNavimeshType(1503102, NavimeshType.WallTouchingFloor)
    EnableNavimeshType(1503112, NavimeshType.Wall)
    EnableNavimeshType(1503103, NavimeshType.Wall)
    EnableNavimeshType(1503113, NavimeshType.WallTouchingFloor)
    EndOfAnimation(1501011, 12)
    SkipLines(9)
    EnableNavimeshType(1503100, NavimeshType.WallTouchingFloor)
    EnableNavimeshType(1503110, NavimeshType.Wall)
    EnableNavimeshType(1503101, NavimeshType.Wall)
    EnableNavimeshType(1503111, NavimeshType.WallTouchingFloor)
    EnableNavimeshType(1503102, NavimeshType.Wall)
    EnableNavimeshType(1503112, NavimeshType.WallTouchingFloor)
    EnableNavimeshType(1503103, NavimeshType.WallTouchingFloor)
...
def Preconstructor():
    ...
    SkipLines(1)
    Move(6280, destination=1502510, destination_type=MapEntityType.Region, model_point=-1, set_draw_hitbox=1503300)
...
def Event11505300():
    ...
    CreateHazard(11505301, 1501850, model_point=101, behavior_param_id=5040, target_type=DamageTargetType.Character, radius=0.30000001192092896, life=0.0, repetition_time=2.0)
    CreateHazard(11505302, 1501851, model_point=101, behavior_param_id=5040, target_type=DamageTargetType.Character, radius=0.30000001192092896, life=0.0, repetition_time=2.0)
    CreateHazard(11505303, 1501852, model_point=101, behavior_param_id=5040, target_type=DamageTargetType.Character, radius=0.30000001192092896, life=0.0, repetition_time=2.0)
    CreateHazard(11505304, 1501853, model_point=101, behavior_param_id=5040, target_type=DamageTargetType.Character, radius=0.30000001192092896, life=0.0, repetition_time=2.0)
    CreateHazard(11505305, 1501854, model_point=101, behavior_param_id=5040, target_type=DamageTargetType.Character, radius=0.30000001192092896, life=0.0, repetition_time=2.0)
    CreateHazard(11505306, 1501855, model_point=101, behavior_param_id=5040, target_type=DamageTargetType.Character, radius=0.30000001192092896, life=0.0, repetition_time=2.0)
    CreateHazard(11505307, 1501856, model_point=101, behavior_param_id=5040, target_type=DamageTargetType.Character, radius=0.30000001192092896, life=0.0, repetition_time=2.0)
    CreateHazard(11505308, 1501857, model_point=101, behavior_param_id=5040, target_type=DamageTargetType.Character, radius=0.30000001192092896, life=0.0, repetition_time=2.0)
    CreateHazard(11505309, 1501858, model_point=101, behavior_param_id=5040, target_type=DamageTargetType.Character, radius=0.30000001192092896, life=0.0, repetition_time=2.0)
    CreateHazard(11505310, 1501859, model_point=101, behavior_param_id=5040, target_type=DamageTargetType.Character, radius=0.30000001192092896, life=0.0, repetition_time=2.0)
    CreateHazard(11505311, 1501860, model_point=101, behavior_param_id=5040, target_type=DamageTargetType.Character, radius=0.30000001192092896, life=0.0, repetition_time=2.0)
    CreateHazard(11505312, 1501861, model_point=101, behavior_param_id=5040, target_type=DamageTargetType.Character, radius=0.30000001192092896, life=0.0, repetition_time=2.0)
    CreateHazard(11505313, 1501862, model_point=101, behavior_param_id=5040, target_type=DamageTargetType.Character, radius=0.30000001192092896, life=0.0, repetition_time=2.0)
    CreateHazard(11505314, 1501863, model_point=101, behavior_param_id=5040, target_type=DamageTargetType.Character, radius=0.30000001192092896, life=0.0, repetition_time=2.0)
    CreateHazard(11505315, 1501864, model_point=101, behavior_param_id=5040, target_type=DamageTargetType.Character, radius=0.30000001192092896, life=0.0, repetition_time=2.0)
    CreateHazard(11505316, 1501865, model_point=101, behavior_param_id=5040, target_type=DamageTargetType.Character, radius=0.30000001192092896, life=0.0, repetition_time=2.0)
    CreateHazard(11505317, 1501866, model_point=101, behavior_param_id=5040, target_type=DamageTargetType.Character, radius=0.30000001192092896, life=0.0, repetition_time=2.0)
    CreateHazard(11505290, 1501010, model_point=101, behavior_param_id=5060, target_type=DamageTargetType.Character, radius=1.2000000476837158, life=0.0, repetition_time=0.5)
...
def Event11505390():
    ...
    IfFlagOff(1, 11)
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1502998, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True, line_intersects=1501990, boss_version=True)
    IfConditionTrue(0, input_condition=1)
...
def Event11505391():
    ...
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1502998, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=False, line_intersects=1501990)
    IfConditionTrue(0, input_condition=1)
    RotateToFaceEntity(PLAYER, 1502997)
    ForceAnimation(PLAYER, 7410)
    Restart()
...
def Event11505351():
    ...
    CreateNPCPart(1500800, npc_part_id=2320, part_index=NPCPartType.Part2, part_health=200, damage_correction=1.0, body_damage_correction=1.0, is_invincible=False, start_in_stop_state=False)
    ...
    EnableFlag(11505355)
    CreateNPCPart(1500800, npc_part_id=2321, part_index=NPCPartType.Part2, part_health=100, damage_correction=1.0, body_damage_correction=1.0, is_invincible=False, start_in_stop_state=False)
...
def Event11500791():
    ...
    EnableAI(1500110)
    CreateHazard(11505200, 1501800, model_point=101, behavior_param_id=5050, target_type=DamageTargetType.Character, radius=1.7000000476837158, life=1.0, repetition_time=0.0)
...
def Event11500700(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: float, ARG_16_19: int, ARG_20_23: int):
    ...
    CreateHazard(ARG_0_3, ARG_4_7, model_point=101, behavior_param_id=5050, target_type=DamageTargetType.Character, radius=1.7000000476837158, life=ARG_12_15, repetition_time=0.20000000298023224)
...
@NeverRestart
def Event11500750(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int, ARG_24_27: int, ARG_28_31: int):
    ...
    ForceAnimation(ARG_16_19, 1)
    CreateHazard(ARG_0_3, ARG_4_7, model_point=101, behavior_param_id=5050, target_type=DamageTargetType.Character, radius=1.7000000476837158, life=12.5, repetition_time=0.20000000298023224)
    ForceAnimation(ARG_4_7, ARG_8_11, wait_for_completion=True)
...
def Event11500850():
    ...
    IfDialogPromptActivated(1, prompt_text=10010502, anchor_entity=1501790, anchor_type=MapEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=104, human_or_hollow_only=False)
    IfFlagOff(2, 11505250)
    IfDialogPromptActivated(2, prompt_text=10010502, anchor_entity=1501790, anchor_type=MapEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=102, human_or_hollow_only=False)
    IfConditionTrue(-1, input_condition=1)
    IfConditionTrue(-1, input_condition=2)
    IfConditionTrue(0, input_condition=-1)
    ...
    Move(PLAYER, destination=1501790, destination_type=MapEntityType.Object, model_point=101, short_move=True)
    ForceAnimation(PLAYER, 8020)
    CreateTemporaryFX(150001, anchor_entity=1501790, anchor_type=MapEntityType.Object, model_point=-1)
    ...
    Move(PLAYER, destination=1501790, destination_type=MapEntityType.Object, model_point=103, short_move=True)
...
def Event11500100():
    ...
    DisableNavimeshType(1503110, NavimeshType.WallTouchingFloor)
    DisableNavimeshType(1503101, NavimeshType.WallTouchingFloor)
    DisableNavimeshType(1503111, NavimeshType.Wall)
    DisableNavimeshType(1503102, NavimeshType.WallTouchingFloor)
    DisableNavimeshType(1503112, NavimeshType.Wall)
    DisableNavimeshType(1503103, NavimeshType.Wall)
    DisableNavimeshType(1503113, NavimeshType.WallTouchingFloor)
    ...
    DisableNavimeshType(1503100, NavimeshType.WallTouchingFloor)
    DisableNavimeshType(1503110, NavimeshType.Wall)
    DisableNavimeshType(1503101, NavimeshType.Wall)
    DisableNavimeshType(1503111, NavimeshType.WallTouchingFloor)
    DisableNavimeshType(1503102, NavimeshType.Wall)
    DisableNavimeshType(1503112, NavimeshType.WallTouchingFloor)
    DisableNavimeshType(1503103, NavimeshType.WallTouchingFloor)
...
def Event11500102():
    ...
    IfDialogPromptActivated(1, prompt_text=10010400, anchor_entity=1501011, anchor_type=MapEntityType.Object, facing_angle=60.0, max_distance=2.0, model_point=105, human_or_hollow_only=True)
    IfConditionTrue(0, input_condition=1)
    Move(PLAYER, destination=1501011, destination_type=MapEntityType.Object, model_point=120, short_move=True)
    ForceAnimation(PLAYER, 7111)
    ForceAnimation(1501011, 10)
    EndIfClient()
    DisplayDialog(10010862, anchor_entity=-1, display_distance=3.0, button_type=ButtonType.Yes_or_No, number_buttons=NumberButtons.NoButton)
...
def Event11500103():
    ...
    IfDialogPromptActivated(1, prompt_text=10010400, anchor_entity=1501011, anchor_type=MapEntityType.Object, facing_angle=60.0, max_distance=2.0, model_point=105, human_or_hollow_only=False)
    IfConditionTrue(0, input_condition=1)
    DisplayDialog(10010163, anchor_entity=-1, display_distance=3.0, button_type=ButtonType.Yes_or_No, number_buttons=NumberButtons.NoButton)
    Restart()
...
def Event11500106():
    ...
    IfDialogPromptActivated(1, prompt_text=10010400, anchor_entity=1501001, anchor_type=MapEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=101, human_or_hollow_only=False)
    IfConditionTrue(0, input_condition=1)
    DisplayDialog(10010161, anchor_entity=1501001, display_distance=3.0, button_type=ButtonType.OK_or_Cancel, number_buttons=NumberButtons.NoButton)
    Restart()
...
def Event11500107():
    ...
    End()
    IfFlagOff(1, 11500105)
    IfDialogPromptActivated(1, prompt_text=10010400, anchor_entity=1501001, anchor_type=MapEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=100, human_or_hollow_only=False)
    IfConditionTrue(0, input_condition=1)
    EnableFlag(11500105)
    Move(PLAYER, destination=1501001, destination_type=MapEntityType.Object, model_point=120, short_move=True)
...
def Event11500110(ARG_0_3: int, ARG_4_7: int):
    ...
    DisplayDialog(10010883, anchor_entity=ARG_0_3, display_distance=3.0, button_type=ButtonType.Yes_or_No, number_buttons=NumberButtons.NoButton)
    SkipLines(1)
    DisplayDialog(10010862, anchor_entity=ARG_0_3, display_distance=3.0, button_type=ButtonType.Yes_or_No, number_buttons=NumberButtons.NoButton)
...
def Event11505270(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int):
    ...
    CreateTemporaryFX(150005, anchor_entity=ARG_4_7, anchor_type=MapEntityType.Object, model_point=101)
...
def Event11505050():
    ...
    IfAttacked(-1, 1500101, attacking_character=10000)
    IfConditionTrue(0, input_condition=-1)
    EnableFlag(11505050)
...
def Event11505051():
    ...
    Move(1500101, destination=1502100, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
...
def Event11505110():
    ...
    ShootProjectile(owner_entity=1500200, projectile_id=1500100, model_point=50, behavior_id=5305, launch_angle_x=0, launch_angle_y=0, launch_angle_z=0)
    ...
    ShootProjectile(owner_entity=1500200, projectile_id=1500100, model_point=50, behavior_id=5304, launch_angle_x=0, launch_angle_y=0, launch_angle_z=0)
    DisableFlagRange((11505111, 11505116))
    AICommand(1500100, command_id=-1, slot=2)
    DisableFlag(11505105)
    RestartEvent(11505102, slot=0)
    ...
    ShootProjectile(owner_entity=1500200, projectile_id=1500100, model_point=50, behavior_id=5303, launch_angle_x=0, launch_angle_y=0, launch_angle_z=0)
    DisableFlagRange((11505111, 11505116))
    AICommand(1500100, command_id=-1, slot=2)
    DisableFlag(11505105)
    RestartEvent(11505102, slot=0)
    ...
    ShootProjectile(owner_entity=1500200, projectile_id=1500100, model_point=50, behavior_id=5302, launch_angle_x=0, launch_angle_y=0, launch_angle_z=0)
    DisableFlagRange((11505111, 11505116))
    AICommand(1500100, command_id=-1, slot=2)
    DisableFlag(11505105)
    RestartEvent(11505102, slot=0)
    ...
    ShootProjectile(owner_entity=1500200, projectile_id=1500100, model_point=50, behavior_id=5301, launch_angle_x=0, launch_angle_y=0, launch_angle_z=0)
    DisableFlagRange((11505111, 11505116))
    AICommand(1500100, command_id=-1, slot=2)
    DisableFlag(11505105)
    RestartEvent(11505102, slot=0)
    ...
    ShootProjectile(owner_entity=1500200, projectile_id=1500100, model_point=50, behavior_id=5300, launch_angle_x=0, launch_angle_y=0, launch_angle_z=0)
    DisableFlagRange((11505111, 11505116))
    AICommand(1500100, command_id=-1, slot=2)
    DisableFlag(11505105)
    RestartEvent(11505102, slot=0)
...
def Event11505080():
    ...
    End()
    IfAttacked(-1, 1500122, attacking_character=10000)
...
def Event11505010():
    ...
    IfDialogPromptActivated(1, prompt_text=10010400, anchor_entity=1500010, anchor_type=MapEntityType.Character, facing_angle=45.0, max_distance=1.2000000476837158, model_point=7, human_or_hollow_only=False)
    IfConditionTrue(0, input_condition=1)
    Move(PLAYER, destination=1500010, destination_type=MapEntityType.Character, model_point=100, copy_draw_hitbox=1500010)
...
def Event11505011():
    ...
    IfAttacked(1, 1500010, attacking_character=10000)
    IfConditionTrue(0, input_condition=1)
...
def Event11505014():
    ...
    ReplanAI(1500010)
    Move(1500010, destination=1502010, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
...
def Event11500210():
    ...
    IfTimeElapsed(0, 5.0)
    IfFlagOn(0, 11)
    IfDialogPromptActivated(0, prompt_text=10010120, anchor_entity=1502505, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True)
    DisableBackread(1500201)
    WaitFrames(1)
    SkipLinesIfFlagOn(2, 11510400)
    PlayCutscene(150000, skippable=True, fade_out=False, player_id=PLAYER, move_to_region=1502501, move_to_map=ANOR_LONDO)
    SkipLines(1)
    PlayCutscene(150002, skippable=True, fade_out=False, player_id=PLAYER, move_to_region=1502501, move_to_map=ANOR_LONDO)
    WaitFrames(1)
    AwardAchievement(33)
    Restart()
...
def Event11500534(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int):
    ...
    DisableFlagRange((ARG_4_7, ARG_8_11))
    EnableFlag(ARG_12_15)
    Move(ARG_0_3, destination=1502510, destination_type=MapEntityType.Region, model_point=-1, set_draw_hitbox=1503300)
...
def Event11505030():
    ...
    IfEntityWithinDistance(1, 6510, 10000, radius=10.0)
    IfConditionTrue(0, input_condition=1)
