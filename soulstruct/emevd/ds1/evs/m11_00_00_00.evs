...
def Event11105390():
    ...
    IfFlagOff(1, 4)
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1102998, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True, line_intersects=1101990, boss_version=True)
    IfConditionTrue(0, input_condition=1)
...
def Event11105391():
    ...
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1102998, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=False, line_intersects=1101990)
    IfConditionTrue(0, input_condition=1)
    RotateToFaceEntity(PLAYER, 1102997)
    ForceAnimation(PLAYER, 7410)
    Restart()
...
def Event11105396():
    ...
    SetHitboxMask(1100160, bit_index=1, switch_type=OnOffChange.Off)
    End()
    ...
    SetDisplayMask(1100160, bit_index=0, switch_type=OnOffChange.On)
    SetHitboxMask(1100160, bit_index=1, switch_type=OnOffChange.Off)
    Move(1100161, destination=1100160, destination_type=MapEntityType.Character, model_point=40, copy_draw_hitbox=1100160)
...
def Event11105397():
    ...
    Move(1100160, destination=1102810, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    SkipLinesIfFlagOff(3, 11105111)
    IfCharacterInsideRegion(2, 1100160, region=1102811)
    SkipLinesIfConditionTrue(2, 2)
    Move(1100160, destination=1102811, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    SkipLinesIfFlagOff(3, 11105112)
    IfCharacterInsideRegion(3, 1100160, region=1102812)
    SkipLinesIfConditionTrue(2, 3)
    Move(1100160, destination=1102812, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    SkipLinesIfFlagOff(3, 11105113)
    IfCharacterInsideRegion(4, 1100160, region=1102813)
    SkipLinesIfConditionTrue(2, 4)
    Move(1100160, destination=1102813, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    SkipLinesIfFlagOff(3, 11105114)
    IfCharacterInsideRegion(5, 1100160, region=1102814)
    SkipLinesIfConditionTrue(2, 5)
    Move(1100160, destination=1102814, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    SkipLinesIfFlagOff(3, 11105115)
    IfCharacterInsideRegion(6, 1100160, region=1102815)
    SkipLinesIfConditionTrue(2, 6)
    Move(1100160, destination=1102815, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    SkipLinesIfFlagOff(3, 11105116)
    IfCharacterInsideRegion(7, 1100160, region=1102816)
    SkipLinesIfConditionTrue(2, 7)
    Move(1100160, destination=1102816, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    SkipLinesIfFlagOff(3, 11105117)
    IfCharacterInsideRegion(-1, 1100160, region=1102817)
    SkipLinesIfConditionTrue(2, -1)
    Move(1100160, destination=1102817, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    SkipLinesIfFlagOff(3, 11105118)
    IfCharacterInsideRegion(-2, 1100160, region=1102818)
    SkipLinesIfConditionTrue(2, -2)
    Move(1100160, destination=1102818, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    SkipLinesIfFlagOff(3, 11105119)
    IfCharacterInsideRegion(-3, 1100160, region=1102819)
    SkipLinesIfConditionTrue(2, -3)
    Move(1100160, destination=1102819, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    SkipLines(1)
    Move(1100160, destination=1102810, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
...
def Event11105371():
    ...
    SetDisplayMask(1100170, bit_index=0, switch_type=OnOffChange.On)
    SetDisplayMask(1100170, bit_index=1, switch_type=OnOffChange.On)
    Move(1100172, destination=1100170, destination_type=MapEntityType.Character, model_point=30, copy_draw_hitbox=1100170)
...
def Event11100030():
    ...
    IfDialogPromptActivated(1, prompt_text=10010400, anchor_entity=1101130, anchor_type=MapEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=100, human_or_hollow_only=False)
    IfConditionTrue(0, input_condition=1)
    Move(PLAYER, destination=1102090, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
...
def Event11100031():
    ...
    IfDialogPromptActivated(1, prompt_text=10010400, anchor_entity=1101130, anchor_type=MapEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=101, human_or_hollow_only=False)
    IfConditionTrue(0, input_condition=1)
...
def Event11100135():
    ...
    End()
    IfDialogPromptActivated(0, prompt_text=10010503, anchor_entity=1101150, anchor_type=MapEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=192, human_or_hollow_only=False)
    DisableObject(1101018)
    DisableObject(1101019)
    DisableObject(1101020)
    Move(PLAYER, destination=1101150, destination_type=MapEntityType.Object, model_point=191, short_move=True)
...
def Event11100136():
    ...
    IfDialogPromptActivated(1, prompt_text=10010400, anchor_entity=1101170, anchor_type=MapEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=100, human_or_hollow_only=False)
    IfConditionTrue(0, input_condition=1)
...
def Event11100420():
    ...
    SkipLinesIfThisEventOff(3)
    Move(1100180, destination=1102201, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
...
def Event11105010():
    ...
    Move(1100200, destination=1102830, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    Move(1100201, destination=1102831, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    Move(1100202, destination=1102832, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    Move(1100203, destination=1102833, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    Move(1100204, destination=1102834, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    Move(1100205, destination=1102835, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    Move(1100206, destination=1102836, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    Move(1100207, destination=1102837, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    Move(1100208, destination=1102838, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    Move(1100209, destination=1102839, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    Move(1100210, destination=1102840, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    Move(1100211, destination=1102841, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    Move(1100212, destination=1102842, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    Move(1100213, destination=1102843, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
