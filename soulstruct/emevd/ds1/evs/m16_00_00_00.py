...
def Event11605390():
    ...
    IfFlagOff(1, 13)
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1602998, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True, line_intersects=1601990, boss_version=True)
    IfConditionTrue(0, input_condition=1)
...
def Event11605391():
    ...
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1602998, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=False, line_intersects=1601990)
    IfConditionTrue(0, input_condition=1)
    RotateToFaceEntity(PLAYER, 1602997)
    ForceAnimation(PLAYER, 7410)
    Restart()
...
def Event11600001():
    ...
    EndIfClient()
    AwardAchievement(37)
    CreateTemporaryFX(90014, anchor_entity=1601950, anchor_type=MapEntityType.Object, model_point=-1)
    Wait(2.0)
...
def Event11605397():
    ...
    IfFlagOn(-1, 13)
    IfConditionTrue(0, input_condition=-1)
    DisableHitbox(1603310)
    DisableHitbox(1603311)
    EndIfFlagOn(13)
    IfCharacterDoesNotHaveSpecialEffect(0, PLAYER, 2200)
    EnableHitbox(1603310)
    EnableHitbox(1603311)
    Restart()
...
def Event11605380():
    ...
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1602898, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True, boss_version=True)
    IfConditionTrue(0, input_condition=1)
    SkipLinesIfClient(1)
    NotifyBossBattleStart()
...
def Event11605381():
    ...
    IfFlagOn(1, 11605380)
    IfCharacterType(1, PLAYER, CharacterType.WhitePhantom)
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1602898, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=False)
    IfConditionTrue(0, input_condition=1)
    RotateToFaceEntity(PLAYER, 1602897)
    ForceAnimation(PLAYER, 7410)
    Restart()
...
def Event11600150():
    ...
    DisableHitbox(1603250)
    DisableHitbox(1603251)
    DisableHitbox(1603252)
    DisableHitbox(1603253)
    DisableHitbox(1603254)
    DisableHitbox(1603255)
    DisableHitbox(1603256)
    DisableHitbox(1603257)
    DisableHitbox(1603258)
    DisableHitbox(1603259)
    DisableHitbox(1603260)
    DisableHitbox(1603261)
    DisableHitbox(1603262)
    DisableHitbox(1603263)
    DisableHitbox(1603264)
    DisableHitbox(1603265)
    DisableHitbox(1603266)
    DisableHitbox(1603267)
    ...
    DisableHitbox(1603121)
    DisableHitbox(1603122)
    IfFlagOn(0, 11600100)
    EnableHitbox(1603250)
    EnableHitbox(1603251)
    EnableHitbox(1603252)
    EnableHitbox(1603253)
    EnableHitbox(1603254)
    EnableHitbox(1603255)
    EnableHitbox(1603256)
    EnableHitbox(1603257)
    EnableHitbox(1603258)
    EnableHitbox(1603259)
    EnableHitbox(1603260)
    EnableHitbox(1603261)
    EnableHitbox(1603262)
    EnableHitbox(1603263)
    EnableHitbox(1603264)
    EnableHitbox(1603265)
    EnableHitbox(1603266)
    EnableHitbox(1603267)
    ...
    EnableHitbox(1603121)
    EnableHitbox(1603122)
    DisableMapSound(1603850)
    DisableHitbox(1603200)
    DisableHitbox(1603201)
    DisableHitbox(1603202)
    DisableHitbox(1603203)
    DisableHitbox(1603204)
    DisableHitbox(1603205)
    DisableHitbox(1603206)
    DisableHitbox(1603207)
    DisableHitbox(1603208)
    DisableHitbox(1603209)
    DisableHitbox(1603210)
    DisableHitbox(1603211)
    DisableHitbox(1603212)
    DisableHitbox(1603213)
    DisableHitbox(1603214)
    DisableHitbox(1603215)
    DisableHitbox(1603216)
    DisableHitbox(1603217)
...
def Event11600100():
    ...
    DisableHitbox(1603100)
    DisableHitbox(1603102)
    DisableHitbox(1603103)
    DisableHitbox(1603104)
    DisableObject(1601120)
    DisableFlag(404)
    End()
    EnableHitbox(1603103)
    EnableHitbox(1603104)
    IfFlagOn(0, 11600101)
    SkipLinesIfMultiplayer(2)
...
def Event11600101(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int):
    ...
    End()
    IfDialogPromptActivated(0, prompt_text=10010502, anchor_entity=ARG_0_3, anchor_type=MapEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=104, human_or_hollow_only=False)
    Move(PLAYER, destination=ARG_0_3, destination_type=MapEntityType.Object, model_point=101, short_move=True)
...
def Event11600160():
    ...
    End()
    IfDialogPromptActivated(0, prompt_text=10010500, anchor_entity=1601142, anchor_type=MapEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=194, human_or_hollow_only=False)
    EnableFlag(11600160)
    Move(PLAYER, destination=1601142, destination_type=MapEntityType.Object, model_point=192, short_move=True)
...
def Event11600250():
    ...
    IfFlagOff(1, 11600201)
    IfDialogPromptActivated(1, prompt_text=10010501, anchor_entity=1021201, anchor_type=MapEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=192, human_or_hollow_only=False)
    IfFlagOff(2, 11605120)
    IfFlagOn(2, 11600201)
    IfDialogPromptActivated(2, prompt_text=10010501, anchor_entity=1601202, anchor_type=MapEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=192, human_or_hollow_only=False)
    IfMultiplayer(3)
...
def Event11600251():
    ...
    IfFlagOn(1, 11600211)
    IfDialogPromptActivated(1, prompt_text=10010501, anchor_entity=1601211, anchor_type=MapEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=192, human_or_hollow_only=False)
    IfFlagOff(2, 11605121)
    IfFlagOff(2, 11600211)
    IfDialogPromptActivated(2, prompt_text=10010501, anchor_entity=1601212, anchor_type=MapEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=192, human_or_hollow_only=False)
    IfFlagOff(3, 11600100)
    IfDialogPromptActivated(3, prompt_text=10010501, anchor_entity=1601211, anchor_type=MapEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=192, human_or_hollow_only=False)
    IfConditionTrue(-1, input_condition=1)
    IfConditionTrue(-1, input_condition=2)
    IfConditionTrue(-1, input_condition=3)
    IfConditionTrue(0, input_condition=-1)
...
def Event11600252():
    ...
    IfFlagOn(1, 11600221)
    IfDialogPromptActivated(1, prompt_text=10010501, anchor_entity=1601221, anchor_type=MapEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=192, human_or_hollow_only=False)
    IfFlagOff(2, 11605122)
    IfFlagOff(2, 11600221)
    IfDialogPromptActivated(2, prompt_text=10010501, anchor_entity=1601222, anchor_type=MapEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=192, human_or_hollow_only=False)
    IfFlagOff(3, 11600100)
    IfDialogPromptActivated(3, prompt_text=10010501, anchor_entity=1601221, anchor_type=MapEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=192, human_or_hollow_only=False)
    IfConditionTrue(-1, input_condition=1)
    IfConditionTrue(-1, input_condition=2)
    IfConditionTrue(-1, input_condition=3)
    IfConditionTrue(0, input_condition=-1)
...
def Event11600253():
    ...
    IfFlagOn(1, 11600231)
    IfDialogPromptActivated(1, prompt_text=10010501, anchor_entity=1601231, anchor_type=MapEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=192, human_or_hollow_only=False)
    IfFlagOff(2, 11605123)
    IfFlagOff(2, 11600231)
    IfDialogPromptActivated(2, prompt_text=10010501, anchor_entity=1601232, anchor_type=MapEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=192, human_or_hollow_only=False)
    IfConditionTrue(-1, input_condition=1)
    IfConditionTrue(-1, input_condition=2)
    IfConditionTrue(0, input_condition=-1)
    DisplayDialog(10010170, anchor_entity=-1, display_distance=3.0, button_type=ButtonType.OK_or_Cancel, number_buttons=NumberButtons.NoButton)
