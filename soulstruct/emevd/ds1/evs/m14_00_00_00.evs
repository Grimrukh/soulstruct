...
def Preconstructor():
    ...
    Move(6160, destination=1402300, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
...
def Event11405390():
    ...
    IfFlagOff(1, 9)
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1402998, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True, line_intersects=1401990, boss_version=True)
    IfConditionTrue(0, input_condition=1)
...
def Event11405391():
    ...
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1402998, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=False, line_intersects=1401990)
    IfConditionTrue(0, input_condition=1)
    RotateToFaceEntity(PLAYER, 1402997)
    ForceAnimation(PLAYER, 7410)
    Restart()
...
def Event11400230():
    ...
    IfSingleplayer(1)
    IfFlagOff(1, 590)
    IfDialogPromptActivated(1, prompt_text=10010400, anchor_entity=1001200, anchor_type=MapEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=101, human_or_hollow_only=False)
    IfConditionTrue(0, input_condition=1)
...
def Event11405200(ARG_0_3: int, ARG_4_7: int):
    ...
    Move(ARG_0_3, destination=ARG_4_7, destination_type=MapEntityType.Object, model_point=100, short_move=True)
...
def Event140():
    ...
    DisableNetworkSync()
    IfThisEventOn(1)
    IfDialogPromptActivated(1, prompt_text=10010182, anchor_entity=1401960, anchor_type=MapEntityType.Object, facing_angle=180.0, max_distance=3.4000000953674316, human_or_hollow_only=True)
    IfConditionTrue(0, input_condition=1)
