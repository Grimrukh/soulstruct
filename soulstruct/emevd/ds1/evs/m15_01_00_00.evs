...
def Constructor():
    ...
    DisableHitbox(1513301)
    DisableHitbox(1513302)
    DisableHitbox(1513303)
...
def Event11515380():
    ...
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1512898, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True, line_intersects=1511890, boss_version=True)
    IfConditionTrue(0, input_condition=1)
    EnableFlag(743)
...
def Event11515381():
    ...
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1512898, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=False, line_intersects=1511890)
    IfConditionTrue(0, input_condition=1)
    RotateToFaceEntity(PLAYER, 1512897)
    SkipLinesIfFlagOn(2, 11510400)
    PlayCutscene(150151, skippable=False, fade_out=False, player_id=PLAYER, move_to_region=1512901, move_to_map=ANOR_LONDO)
    SkipLines(1)
    PlayCutscene(150156, skippable=False, fade_out=False, player_id=PLAYER, move_to_region=1512901, move_to_map=ANOR_LONDO)
    WaitFrames(1)
...
def Event11510900():
    ...
    IfFlagOn(0, 11515389)
    SkipLinesIfFlagOn(2, 11510400)
    PlayCutscene(150152, skippable=True, fade_out=False, player_id=PLAYER, move_to_region=1512897, move_to_map=ANOR_LONDO)
    SkipLines(1)
    PlayCutscene(150157, skippable=True, fade_out=False, player_id=PLAYER, move_to_region=1512897, move_to_map=ANOR_LONDO)
    WaitFrames(1)
    SkipLinesIfFlagOff(1, 12)
    EnableFlag(120)
    EnableFlag(11510900)
...
def Event11515386():
    ...
    PlayCutscene(150155, skippable=True, fade_out=False, player_id=PLAYER, move_to_region=1512900, move_to_map=ANOR_LONDO)
    SkipLines(4)
    SkipLinesIfClient(2)
    PlayCutscene(150155, skippable=False, fade_out=False, player_id=PLAYER, move_to_region=1512900, move_to_map=ANOR_LONDO)
    SkipLines(1)
    ...
    SkipLinesIfMultiplayer(2)
    PlayCutscene(150161, skippable=True, fade_out=False, player_id=PLAYER, move_to_region=1512900, move_to_map=ANOR_LONDO)
    SkipLines(4)
    SkipLinesIfClient(2)
    PlayCutscene(150161, skippable=False, fade_out=False, player_id=PLAYER, move_to_region=1512900, move_to_map=ANOR_LONDO)
    SkipLines(1)
    ...
    End()
    SkipLinesIfMultiplayer(2)
    PlayCutscene(150160, skippable=True, fade_out=False, player_id=PLAYER, move_to_region=1512900, move_to_map=ANOR_LONDO)
    SkipLines(4)
    SkipLinesIfClient(2)
    PlayCutscene(150160, skippable=False, fade_out=False, player_id=PLAYER, move_to_region=1512900, move_to_map=ANOR_LONDO)
    SkipLines(1)
...
def Event11515390():
    ...
    IfFlagOff(1, 12)
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1512998, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True, line_intersects=1511990, boss_version=True)
    IfConditionTrue(0, input_condition=1)
...
def Event11515391():
    ...
    IfFlagOn(1, 11515393)
    IfCharacterType(1, PLAYER, CharacterType.WhitePhantom)
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1512998, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=False, line_intersects=1511990)
    IfConditionTrue(0, input_condition=1)
    RotateToFaceEntity(PLAYER, 1512997)
    ForceAnimation(PLAYER, 7410)
    Restart()
...
def Event11515398():
    ...
    CreateNPCPart(1510810, npc_part_id=2360, part_index=NPCPartType.Part1, part_health=100, damage_correction=0.0, body_damage_correction=0.0, is_invincible=True, start_in_stop_state=False)
...
def Event11515399():
    ...
    CreateNPCPart(1510811, npc_part_id=2360, part_index=NPCPartType.Part1, part_health=100, damage_correction=0.0, body_damage_correction=0.0, is_invincible=True, start_in_stop_state=False)
...
def Event11515060(ARG_0_3: int):
    ...
    CreateNPCPart(ARG_0_3, npc_part_id=2870, part_index=NPCPartType.Part2, part_health=100, damage_correction=0.0, body_damage_correction=0.0, is_invincible=True, start_in_stop_state=False)
...
def Event11515080(ARG_0_3: int, ARG_4_7: int):
    ...
    SetHitboxMask(ARG_0_3, bit_index=1, switch_type=OnOffChange.Off)
    AddSpecialEffect(ARG_0_3, 5434)
    AICommand(ARG_0_3, command_id=20, slot=0)
    End()
    IfCharacterBackreadEnabled(0, ARG_0_3)
    CreateNPCPart(ARG_0_3, npc_part_id=5351, part_index=NPCPartType.Part1, part_health=65, damage_correction=1.0, body_damage_correction=1.0, is_invincible=False, start_in_stop_state=False)
    ...
    Move(ARG_4_7, destination=ARG_0_3, destination_type=MapEntityType.Character, model_point=110, copy_draw_hitbox=ARG_0_3)
...
def Event11510110():
    ...
    End()
    IfDialogPromptActivated(0, prompt_text=10010400, anchor_entity=1511010, anchor_type=MapEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=100, human_or_hollow_only=False)
    Move(PLAYER, destination=1511010, destination_type=MapEntityType.Object, model_point=120, short_move=True)
...
def Event11510200():
    ...
    IfDialogPromptActivated(1, prompt_text=10010502, anchor_entity=1511001, anchor_type=MapEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=102, human_or_hollow_only=False)
    IfConditionTrue(0, input_condition=1)
    Move(PLAYER, destination=1511001, destination_type=MapEntityType.Object, model_point=103, short_move=True)
...
def Event11510201():
    ...
    IfDialogPromptActivated(1, prompt_text=10010400, anchor_entity=1512000, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=False, line_intersects=1511000)
    IfConditionTrue(0, input_condition=1)
...
def Event11510210():
    ...
    End()
    EnableNavimeshType(1513200, NavimeshType.Solid)
    IfDialogPromptActivated(0, prompt_text=10010400, anchor_entity=1511200, anchor_type=MapEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=101, human_or_hollow_only=False)
    Move(PLAYER, destination=1511200, destination_type=MapEntityType.Object, model_point=121, short_move=True)
    ForceAnimation(PLAYER, 7110)
    ForceAnimation(1511200, 0)
    DisableNavimeshType(1513200, NavimeshType.Solid)
...
def Event11510211():
    ...
    IfDialogPromptActivated(1, prompt_text=10010400, anchor_entity=1511200, anchor_type=MapEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=100, human_or_hollow_only=False)
    IfConditionTrue(0, input_condition=1)
    DisplayDialog(10010161, anchor_entity=1511200, display_distance=3.0, button_type=ButtonType.OK_or_Cancel, number_buttons=NumberButtons.NoButton)
    Restart()
...
def Event11510300():
    ...
    IfDialogPromptActivated(1, prompt_text=10010502, anchor_entity=1511300, anchor_type=MapEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=102, human_or_hollow_only=False)
    IfFlagOff(2, 11510303)
    IfDialogPromptActivated(2, prompt_text=10010502, anchor_entity=1511300, anchor_type=MapEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=104, human_or_hollow_only=False)
    IfFlagOn(3, 11510305)
    IfFlagOff(3, 11510303)
    IfDialogPromptActivated(3, prompt_text=10010501, anchor_entity=1511301, anchor_type=MapEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=192, human_or_hollow_only=False)
    IfFlagOn(4, 11510305)
    IfFlagOn(4, 11510303)
    IfDialogPromptActivated(4, prompt_text=10010501, anchor_entity=1511302, anchor_type=MapEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=192, human_or_hollow_only=False)
    IfFlagOn(5, 11510305)
    IfFlagOff(5, 11510301)
    IfDialogPromptActivated(5, prompt_text=10010501, anchor_entity=1511303, anchor_type=MapEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=192, human_or_hollow_only=False)
    IfFlagOn(6, 11510305)
    IfFlagOff(6, 11510302)
    IfDialogPromptActivated(6, prompt_text=10010501, anchor_entity=1511304, anchor_type=MapEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=192, human_or_hollow_only=False)
    IfConditionTrue(-1, input_condition=1)
    IfConditionTrue(-1, input_condition=2)
    IfConditionTrue(-1, input_condition=3)
    ...
    Move(PLAYER, destination=1511300, destination_type=MapEntityType.Object, model_point=103, short_move=True)
    ForceAnimation(PLAYER, 8021)
    ForceAnimation(1511300, 10, wait_for_completion=True)
    SkipLinesIfMultiplayer(2)
    PlayCutscene(cutscene_id=150100, skippable=True, fade_out=False, player_id=PLAYER, rotation=-90, relative_rotation_axis_x=337.5, relative_rotation_axis_z=255.0, vertical_translation=-12.0)
    SkipLines(4)
    SkipLinesIfFlagOff(2, 11510304)
    PlayCutscene(cutscene_id=150100, skippable=False, fade_out=False, player_id=PLAYER, rotation=-90, relative_rotation_axis_x=337.5, relative_rotation_axis_z=255.0, vertical_translation=-12.0)
    SkipLines(1)
    ...
    Move(PLAYER, destination=1511302, destination_type=MapEntityType.Object, model_point=191, short_move=True)
    ...
    Move(PLAYER, destination=1511303, destination_type=MapEntityType.Object, model_point=191, short_move=True)
    ForceAnimation(PLAYER, 8000)
    ...
    Move(PLAYER, destination=1511304, destination_type=MapEntityType.Object, model_point=191, short_move=True)
    ForceAnimation(PLAYER, 8000)
    ...
    Move(PLAYER, destination=1511300, destination_type=MapEntityType.Object, model_point=101, short_move=True)
    ...
    Move(PLAYER, destination=1511301, destination_type=MapEntityType.Object, model_point=191, short_move=True)
    ForceAnimation(PLAYER, 8000)
...
@NeverRestart
def Event11515330(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int, ARG_24_27: int, ARG_28_31: int):
...
def Event11510340():
    ...
    EnableHitbox(1513310)
    EnableNavimeshType(1513350, NavimeshType.Solid)
    EnableNavimeshType(1513351, NavimeshType.Solid)
    EnableNavimeshType(1513352, NavimeshType.Solid)
    EnableNavimeshType(1513353, NavimeshType.Solid)
    EnableNavimeshType(1513354, NavimeshType.Solid)
    IfFlagOff(0, 11515300)
    Restart()
    SkipLinesIfFlagOff(8, 11510303)
    EnableHitbox(1513310)
    DisableNavimeshType(1513350, NavimeshType.Solid)
    EnableNavimeshType(1513351, NavimeshType.Solid)
    EnableNavimeshType(1513352, NavimeshType.Solid)
    EnableNavimeshType(1513353, NavimeshType.Solid)
    EnableNavimeshType(1513354, NavimeshType.Solid)
    ...
    DisableHitbox(1513310)
    EnableNavimeshType(1513350, NavimeshType.Solid)
    DisableNavimeshType(1513351, NavimeshType.Solid)
    DisableNavimeshType(1513352, NavimeshType.Solid)
    DisableNavimeshType(1513353, NavimeshType.Solid)
    EnableNavimeshType(1513354, NavimeshType.Solid)
    IfFlagOn(0, 11515300)
    Restart()
    ...
    EnableNavimeshType(1513352, NavimeshType.Solid)
    DisableNavimeshType(1513353, NavimeshType.Solid)
    DisableNavimeshType(1513354, NavimeshType.Solid)
    IfFlagOn(0, 11515300)
    Restart()
    DisplayDialog(10010105, anchor_entity=-1, display_distance=3.0, button_type=ButtonType.OK_or_Cancel, number_buttons=NumberButtons.NoButton)
    Restart()
...
def Event11510400():
    ...
    IfEntityWithinDistance(1, 1510600, 10000, radius=15.0)
    IfConditionTrue(0, input_condition=1)
    Wait(3.0)
    DisableMapSound(1513801)
    EnableFlag(743)
...
def Event11510401():
    ...
    IfFlagOn(1, 11510400)
    IfEntityWithinDistance(1, 1511400, 10000, radius=15.0)
    IfHost(2)
    IfCharacterHasSpecialEffect(2, PLAYER, 2310)
    IfEntityWithinDistance(2, 1511400, 10000, radius=15.0)
    IfConditionTrue(-1, input_condition=1)
    IfConditionTrue(-1, input_condition=2)
    IfConditionTrue(0, input_condition=-1)
...
def Event11515110(ARG_0_3: int, ARG_4_7: int):
    ...
    Move(1510650, destination=ARG_0_3, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    EnableCharacter(1510650)
    ReplanAI(1510650)
...
def Event11510230():
    ...
    IfDialogPromptActivated(0, prompt_text=10010100, anchor_entity=1512510, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True)
    IfSingleplayer(1)
    IfHost(1)
    ...
    DisplayDialog(10010170, anchor_entity=-1, display_distance=3.0, button_type=ButtonType.OK_or_Cancel, number_buttons=NumberButtons.NoButton)
    Restart()
    PlayCutscene(150135, skippable=True, fade_out=False, player_id=PLAYER, move_to_region=1102510, move_to_map=PAINTED_WORLD)
    WaitFrames(1)
...
def Event11510240():
    ...
    IfDialogPromptActivated(2, prompt_text=10010200, anchor_entity=1510100, anchor_type=MapEntityType.Character, facing_angle=180.0, max_distance=7.0, human_or_hollow_only=True)
    IfConditionTrue(0, input_condition=2)
    SkipLinesIfSingleplayer(2)
    DisplayDialog(10010170, anchor_entity=-1, display_distance=3.0, button_type=ButtonType.OK_or_Cancel, number_buttons=NumberButtons.NoButton)
    Restart()
    SkipLinesIfFlagOn(2, 11510400)
    PlayCutscene(150130, skippable=True, fade_out=False, player_id=PLAYER, move_to_region=1502500, move_to_map=SENS_FORTRESS)
    SkipLines(1)
    PlayCutscene(150132, skippable=True, fade_out=False, player_id=PLAYER, move_to_region=1502500, move_to_map=SENS_FORTRESS)
    WaitFrames(1)
    Restart()
...
def Event11515050():
    ...
    IfAttacked(-1, 1510100, attacking_character=10000)
    IfFlagOn(-1, 11515050)
    IfConditionTrue(0, input_condition=-1)
    EnableFlag(11515050)
...
def Event11510120():
    ...
    IfStandingOnHitbox(-1, 1513405)
    IfStandingOnHitbox(-1, 1513100)
    IfConditionTrue(1, input_condition=-1)
    IfConditionTrue(0, input_condition=1)
...
def Event11510130():
    ...
    EndIfFlagOn(1034)
    Move(6010, destination=1512450, destination_type=MapEntityType.Region, model_point=-1, copy_draw_hitbox=1510452)
...
def Event11510460():
    ...
    IfFlagOff(1, 743)
    IfFlagOn(1, 1240)
    IfDialogPromptActivated(1, prompt_text=10010210, anchor_entity=1512410, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True)
    ...
    IfFlagOn(3, 11515350)
    IfHost(3)
    IfCharacterOutsideRegion(3, PLAYER, region=1512410)
    IfConditionTrue(-1, input_condition=1)
    IfConditionTrue(-1, input_condition=2)
    IfConditionTrue(-1, input_condition=3)
    IfConditionTrue(0, input_condition=-1)
...
def Event11515250():
    ...
    IfAttacked(2, 1510310, attacking_character=10000)
    IfConditionTrue(-1, input_condition=1)
    IfConditionTrue(-1, input_condition=2)
    IfConditionTrue(0, input_condition=-1)
...
def Event11515251():
    ...
    IfAttacked(-1, 1510305, attacking_character=10000)
    IfEntityWithinDistance(-1, 1510305, 10000, radius=4.0)
    IfConditionTrue(0, input_condition=-1)
    EnableAI(1510305)
...
def Event11510541(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int):
    ...
    IfFlagOn(-1, 11510598)
    IfAttacked(-1, ARG_0_3, attacking_character=10000)
    IfAttacked(-1, 6490, attacking_character=10000)
    IfAttacked(-1, 6500, attacking_character=10000)
    IfConditionTrue(0, input_condition=-1)
    EnableAI(ARG_0_3)
    EnableAI(6490)
    EnableAI(6500)
...
def Event151():
    ...
    DisableNetworkSync()
    IfThisEventOn(1)
    IfDialogPromptActivated(1, prompt_text=10010182, anchor_entity=1511960, anchor_type=MapEntityType.Object, facing_angle=180.0, max_distance=3.4000000953674316, human_or_hollow_only=True)
    IfConditionTrue(0, input_condition=1)
    DisplayDialog(10010184, anchor_entity=1511960, display_distance=3.4000000953674316, button_type=ButtonType.Yes_or_No, number_buttons=NumberButtons.NoButton)
    Restart()
...
def Event11515030():
    ...
    IfEntityWithinDistance(1, 6543, 10000, radius=30.0)
    IfConditionTrue(0, input_condition=1)
