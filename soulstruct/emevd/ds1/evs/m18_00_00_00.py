...
def Event11805390():
    ...
    IfFlagOff(1, 15)
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1802998, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True, line_intersects=1801990, boss_version=True)
    IfConditionTrue(0, input_condition=1)
...
def Event11805391():
    ...
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1802998, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=False, line_intersects=1801990)
    IfConditionTrue(0, input_condition=1)
    RotateToFaceEntity(PLAYER, 1802997)
    ForceAnimation(PLAYER, 7410)
    Restart()
...
def Event11800001():
    ...
    CreateTemporaryFX(90014, anchor_entity=1801950, anchor_type=MapEntityType.Object, model_point=-1)
    Wait(2.0)
...
def Event20():
    ...
    EndIfClient()
    IfFlagOn(1, 15)
    IfDialogPromptActivated(1, prompt_text=10010108, anchor_entity=1801950, anchor_type=MapEntityType.Object, facing_angle=180.0, max_distance=1.5, human_or_hollow_only=True)
    IfConditionTrue(0, input_condition=1)
...
def Event11800100():
    ...
    IfDialogPromptActivated(1, prompt_text=10010105, anchor_entity=1801960, anchor_type=MapEntityType.Object, facing_angle=180.0, max_distance=2.0, model_point=150, human_or_hollow_only=True)
    IfConditionTrue(0, input_condition=1)
...
def Event11800101():
    ...
    IfDialogPromptActivated(1, prompt_text=10010105, anchor_entity=1801960, anchor_type=MapEntityType.Object, facing_angle=180.0, max_distance=2.0, model_point=150, human_or_hollow_only=False)
    IfFlagOn(2, 11800100)
    IfConditionTrue(-1, input_condition=1)
    IfConditionTrue(-1, input_condition=2)
    IfConditionTrue(0, input_condition=-1)
    EndIfFinishedConditionTrue(2)
    DisplayDialog(10010174, anchor_entity=1801960, display_distance=3.0, button_type=ButtonType.OK_or_Cancel, number_buttons=NumberButtons.NoButton)
    Restart()
...
def Event11800220():
    ...
    IfDialogPromptActivated(1, prompt_text=10010400, anchor_entity=1802100, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=False, line_intersects=1801101)
    IfFlagOn(2, 11805110)
    IfConditionTrue(-1, input_condition=1)
    IfConditionTrue(-1, input_condition=2)
    IfConditionTrue(0, input_condition=-1)
    SkipLinesIfFinishedConditionTrue(2, 2)
    DisplayDialog(10010160, anchor_entity=1801101, display_distance=3.0, button_type=ButtonType.OK_or_Cancel, number_buttons=NumberButtons.NoButton)
    SkipLines(2)
    DisableFlag(11805110)
    DisplayDialog(10010171, anchor_entity=1801960, display_distance=3.0, button_type=ButtonType.OK_or_Cancel, number_buttons=NumberButtons.NoButton)
    Restart()
...
def Event11800539(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int):
    ...
    IfEntityBeyondDistance(7, ARG_0_3, 10000, radius=15.0)
...
def Event11806200():
    ...
    IfConditionTrue(0, input_condition=1)
    DisableFlag(824)
    PlayCutscene(180050, skippable=True, fade_out=False, player_id=PLAYER, move_to_region=1022110, move_to_map=FIRELINK_SHRINE)
...
def Event11806201():
    ...
    IfConditionTrue(0, input_condition=1)
    DisableFlag(825)
    PlayCutscene(180051, skippable=True, fade_out=False, player_id=PLAYER, move_to_region=1602110, move_to_map=NEW_LONDO_RUINS)
...
def Event11805030():
    ...
    IfEntityWithinDistance(1, 6544, 10000, radius=30.0)
    IfConditionTrue(0, input_condition=1)
