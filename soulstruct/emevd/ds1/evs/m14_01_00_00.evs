...
def Preconstructor():
    ...
    SkipLines(1)
    Move(6002, destination=1412500, destination_type=MapEntityType.Region, model_point=-1, set_draw_hitbox=1413000)
    ...
    Move(6286, destination=1412360, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
...
def Event11410095():
    ...
    End()
    EndIfClient()
    IfDialogPromptActivated(0, prompt_text=10010410, anchor_entity=1412660, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, model_point=0, human_or_hollow_only=True, line_intersects=1411710)
...
def Event11415390():
    ...
    IfFlagOff(1, 10)
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1412998, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True, line_intersects=1411990, boss_version=True)
    IfConditionTrue(0, input_condition=1)
...
def Event11415391():
    ...
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1412998, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=False, line_intersects=1411990)
    IfConditionTrue(0, input_condition=1)
    RotateToFaceEntity(PLAYER, 1412997)
    ForceAnimation(PLAYER, 7410)
    Restart()
...
def Event11410001():
    ...
    DisableNetworkSync()
    CreateTemporaryFX(90014, anchor_entity=1411950, anchor_type=MapEntityType.Object, model_point=-1)
    Wait(2.0)
...
def Event11410200():
    ...
    CreateTemporaryFX(140009, anchor_entity=1411202, anchor_type=MapEntityType.Object, model_point=-1)
...
def Event11410201(ARG_0_3: int, ARG_4_7: int):
    ...
    IfFlagOn(-1, 11410292)
    IfConditionTrue(0, input_condition=-1)
    IfEntityWithinDistance(0, ARG_0_3, 10000, radius=8.0)
    DisableObjectInvulnerability(ARG_0_3)
    DestroyObject(ARG_0_3, slot=1)
    CreateTemporaryFX(140008, anchor_entity=ARG_0_3, anchor_type=MapEntityType.Object, model_point=-1)
...
def Event11415370():
    ...
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1412698, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True, line_intersects=1411790, boss_version=True)
    IfConditionTrue(0, input_condition=1)
...
def Event11415371():
    ...
    IfFlagOn(1, 11415373)
    IfCharacterType(1, PLAYER, CharacterType.WhitePhantom)
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1412698, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=False, line_intersects=1411790)
    IfConditionTrue(0, input_condition=1)
    RotateToFaceEntity(PLAYER, 1412697)
    ForceAnimation(PLAYER, 7410)
    Restart()
...
def Event11415372():
    ...
    IfFlagOn(1, 51410180)
    IfFlagOn(2, 11415373)
    IfAttacked(2, 1410600, attacking_character=10000)
    IfConditionTrue(-1, input_condition=1)
    IfConditionTrue(-1, input_condition=2)
    IfConditionTrue(0, input_condition=-1)
    EnableAI(1410600)
...
def Event11415376():
    ...
    IfConditionTrue(0, input_condition=1)
    Move(1410600, destination=1412797, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    ForceAnimation(1410600, 17006, wait_for_completion=True)
    Move(1410600, destination=1412798, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
...
def Event11415310(ARG_0_3: int):
    ...
    IfFlagOn(1, 11415376)
    IfFlagOn(1, ARG_0_3)
    IfAttacked(1, 1410600, attacking_character=10000)
    IfConditionTrue(0, input_condition=1)
    End()
...
def Event11415380():
    ...
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1412898, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True, line_intersects=1411890, boss_version=True)
    IfConditionTrue(0, input_condition=1)
...
def Event11415381():
    ...
    IfFlagOn(1, 11415383)
    IfCharacterType(1, PLAYER, CharacterType.WhitePhantom)
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1412898, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=False, line_intersects=1411890)
    IfConditionTrue(0, input_condition=1)
    RotateToFaceEntity(PLAYER, 1412897)
    ForceAnimation(PLAYER, 7410)
    Restart()
...
def Event11415350(ARG_0_3: int, ARG_4_5: short, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int):
    ...
    SetHitboxMask(1410700, bit_index=1, switch_type=OnOffChange.Off)
    AICommand(1410700, command_id=20, slot=0)
    End()
    IfFlagOn(0, ARG_0_3)
    CreateNPCPart(1410700, npc_part_id=ARG_4_5, part_index=NPCPartType.Part1, part_health=ARG_12_15, damage_correction=1.0, body_damage_correction=1.0, is_invincible=False, start_in_stop_state=False)
    ...
    EnableCharacter(ARG_16_19)
    Move(ARG_16_19, destination=1410700, destination_type=MapEntityType.Character, model_point=140, copy_draw_hitbox=1410700)
    ...
    SetHitboxMask(1410700, bit_index=1, switch_type=OnOffChange.On)
...
def Event11415360(ARG_0_3: int, ARG_4_5: short, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int):
    ...
    SetHitboxMask(1410700, bit_index=2, switch_type=OnOffChange.Off)
    AICommand(1410700, command_id=20, slot=1)
    End()
    IfFlagOn(0, ARG_0_3)
    CreateNPCPart(1410700, npc_part_id=ARG_4_5, part_index=NPCPartType.Part2, part_health=ARG_12_15, damage_correction=1.0, body_damage_correction=1.0, is_invincible=False, start_in_stop_state=False)
    IfCharacterPartHealthLessThanOrEqual(1, 1410700, npc_part_id=ARG_8_11, value=0)
    IfHealthLessThanOrEqual(2, 1410700, 0.0)
    IfConditionTrue(-1, input_condition=1)
    IfConditionTrue(-1, input_condition=2)
    ...
    IfHasTAEEvent(0, 1410700, tae_event_id=400)
    EnableCharacter(ARG_16_19)
    Move(ARG_16_19, destination=1410700, destination_type=MapEntityType.Character, model_point=141, copy_draw_hitbox=1410700)
    ForceAnimation(ARG_16_19, 8100)
    SetDisplayMask(1410700, bit_index=1, switch_type=OnOffChange.On)
    SetHitboxMask(1410700, bit_index=2, switch_type=OnOffChange.Off)
    ...
    SetHitboxMask(1410700, bit_index=2, switch_type=OnOffChange.On)
...
def Event11410340():
    ...
    IfFlagOn(1, 11400598)
    IfDialogPromptActivated(1, prompt_text=10010510, anchor_entity=1412201, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True, line_intersects=1411340)
    IfDialogPromptActivated(2, prompt_text=10010510, anchor_entity=1412200, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True, line_intersects=1411340)
    IfConditionTrue(-1, input_condition=1)
    IfConditionTrue(-1, input_condition=2)
    IfConditionTrue(0, input_condition=-1)
    EnableFlag(11410340)
    ...
    CreateTemporaryFX(140000, anchor_entity=1411340, anchor_type=MapEntityType.Object, model_point=-1)
...
def Event11410341():
    ...
    IfDialogPromptActivated(-2, prompt_text=10010510, anchor_entity=1412201, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True, line_intersects=1411340)
    IfConditionTrue(1, input_condition=-2)
    IfFlagOff(2, 11410340)
    IfClient(2)
    IfDialogPromptActivated(-3, prompt_text=10010510, anchor_entity=1412200, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=False, line_intersects=1411340)
    IfDialogPromptActivated(-3, prompt_text=10010510, anchor_entity=1412201, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=False, line_intersects=1411340)
    ...
    DisplayDialog(10010160, anchor_entity=1411340, display_distance=5.0, button_type=ButtonType.Yes_or_No, number_buttons=NumberButtons.NoButton)
    Restart()
...
def Event11410402():
    ...
    IfMultiplayer(-2)
    IfConditionTrue(1, input_condition=-2)
    IfDialogPromptActivated(1, prompt_text=10010510, anchor_entity=1411400, anchor_type=MapEntityType.Object, facing_angle=180.0, max_distance=1.5, model_point=100, human_or_hollow_only=False)
    IfConditionTrue(0, input_condition=1)
    DisplayDialog(10010170, anchor_entity=1411400, display_distance=3.0, button_type=ButtonType.Yes_or_No, number_buttons=NumberButtons.NoButton)
    Restart()
...
def Event11415340():
    ...
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1412411, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True, line_intersects=1411410, boss_version=True)
    IfConditionTrue(0, input_condition=1)
...
def Event11415341():
    ...
    IfFlagOn(1, 11415343)
    IfCharacterType(1, PLAYER, CharacterType.WhitePhantom)
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1412411, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=False, line_intersects=1411410)
    IfConditionTrue(0, input_condition=1)
    RotateToFaceEntity(PLAYER, 1412412)
    ForceAnimation(PLAYER, 7410)
    Restart()
...
def Event11415100(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: float, ARG_16_19: float):
    ...
    End()
    IfEntityWithinDistance(0, ARG_0_3, 10000, radius=ARG_12_15)
    Wait(ARG_16_19)
    SetStandbyAnimationSettings(ARG_4_7, cancel_animation=ARG_8_11)
...
def Event5202(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int):
    ...
    Move(ARG_8_11, destination=ARG_0_3, destination_type=MapEntityType.Character, model_point=ARG_16_19, copy_draw_hitbox=ARG_0_3)
    Move(ARG_12_15, destination=ARG_0_3, destination_type=MapEntityType.Character, model_point=ARG_20_23, copy_draw_hitbox=ARG_0_3)
...
def Event11415250(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int):
    ...
    Move(ARG_4_7, destination=ARG_0_3, destination_type=MapEntityType.Character, model_point=100, copy_draw_hitbox=ARG_0_3)
    Move(ARG_8_11, destination=ARG_0_3, destination_type=MapEntityType.Character, model_point=101, copy_draw_hitbox=ARG_0_3)
    Move(ARG_12_15, destination=ARG_0_3, destination_type=MapEntityType.Character, model_point=102, copy_draw_hitbox=ARG_0_3)
    Move(ARG_16_19, destination=ARG_0_3, destination_type=MapEntityType.Character, model_point=103, copy_draw_hitbox=ARG_0_3)
    Move(ARG_20_23, destination=ARG_0_3, destination_type=MapEntityType.Character, model_point=104, copy_draw_hitbox=ARG_0_3)
...
def Event11410350():
    ...
    CreateTemporaryFX(140001, anchor_entity=1411351, anchor_type=MapEntityType.Object, model_point=-1)
...
def Event11410532(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int):
    ...
    DisableFlagRange((ARG_4_7, ARG_8_11))
    EnableFlag(ARG_12_15)
    Move(ARG_0_3, destination=1412500, destination_type=MapEntityType.Region, model_point=-1, set_draw_hitbox=1413000)
    EnableFlag(11410580)
    IfCharacterBackreadEnabled(0, ARG_0_3)
...
def Event11415030():
    ...
    IfEntityWithinDistance(1, 6542, 10000, radius=20.0)
    IfConditionTrue(0, input_condition=1)
