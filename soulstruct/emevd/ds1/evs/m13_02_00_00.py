...
def Event11325100():
    ...
    EnableFlag(11325101)
    Move(1320700, destination=1322700, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    ForceAnimation(1320700, 3011, wait_for_completion=True)
    Move(1320700, destination=1322710, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    SetNest(1320700, 1322710)
    ForceAnimation(1320700, 9060, wait_for_completion=True)
    ReplanAI(1320700)
    Restart()
    DisableFlag(11325101)
    Move(1320700, destination=1322701, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    ForceAnimation(1320700, 3014, wait_for_completion=True)
    Move(1320700, destination=1322711, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
...
def Event11325110(ARG_0_1: short, ARG_2_3: short, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_16: uchar, ARG_17_17: uchar, ARG_20_23: int):
    ...
    Move(ARG_8_11, destination=1320700, destination_type=MapEntityType.Character, model_point=ARG_12_15, copy_draw_hitbox=1320700)
...
def Event11325001():
    ...
    Move(1320801, destination=1320800, destination_type=MapEntityType.Character, model_point=19, copy_draw_hitbox=1320800)
