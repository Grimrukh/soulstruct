...
def Event11310095():
    ...
    End()
    EndIfClient()
    IfDialogPromptActivated(0, prompt_text=10010410, anchor_entity=1312610, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, model_point=0, human_or_hollow_only=True, line_intersects=1311710)
...
def Event11315390():
    ...
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1312998, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True, line_intersects=1311990, boss_version=True)
    IfConditionTrue(0, input_condition=1)
...
def Event11315391():
    ...
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1312998, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=False, line_intersects=1311990)
    IfConditionTrue(0, input_condition=1)
    RotateToFaceEntity(PLAYER, 1312997)
    ForceAnimation(PLAYER, 7410)
    Restart()
...
def Event11310001():
    ...
    Kill(1310810, award_souls=False)
    CreateTemporaryFX(90014, anchor_entity=1311950, anchor_type=MapEntityType.Object, model_point=-1)
    Wait(2.0)
...
def Event11315398():
    ...
    CreateHazard(11315399, 1311250, model_point=1, behavior_param_id=11300, target_type=DamageTargetType.Character, radius=0.30000001192092896, life=0.30000001192092896, repetition_time=0.0)
    CreateTemporaryFX(15224, anchor_entity=1311250, anchor_type=MapEntityType.Object, model_point=-1)
    Restart()


@UnknownRestart
def Event11315370(ARG_0_3: int, ARG_4_5: short, ARG_6_7: short, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int, ARG_24_27: int):
    """ 11315370: Event 11315370 """
    IfFlagOn(0, ARG_0_3)
    CreateNPCPart(1310800, npc_part_id=ARG_6_7, part_index=ARG_4_5, part_health=200, damage_correction=1.0, body_damage_correction=1.0, is_invincible=False, start_in_stop_state=False)
    ...
    SetHitboxMask(1310800, bit_index=1, switch_type=OnOffChange.Off)
    ...
    SetHitboxMask(1310800, bit_index=2, switch_type=OnOffChange.Off)
    ...
    SkipLines(4)
    SetHitboxMask(1310800, bit_index=3, switch_type=OnOffChange.Off)
    ...
    Move(ARG_16_19, destination=1310800, destination_type=MapEntityType.Character, model_point=50, copy_draw_hitbox=1310800)
    ForceAnimation(ARG_16_19, 7000)
    EnableCharacter(ARG_20_23)
    Move(ARG_20_23, destination=1310800, destination_type=MapEntityType.Character, model_point=51, copy_draw_hitbox=1310800)
...
def Event11315050(ARG_0_3: int, ARG_4_7: int, ARG_8_11: float):
    ...
    IfEntityWithinDistance(0, ARG_4_7, 10000, radius=5.0)
    Wait(ARG_8_11)
...
def Event11315080():
    ...
    EndIfThisEventOn()
    DisableAI(1310250)
    IfEntityWithinDistance(1, 1310250, 10000, radius=7.0)
    IfAttacked(2, 1310250, attacking_character=10000)
    IfConditionTrue(-1, input_condition=1)
    IfConditionTrue(-1, input_condition=2)
    IfConditionTrue(0, input_condition=-1)
    EnableAI(1310250)
    ...
    Move(1310250, destination=1312250, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    IfEntityWithinDistance(-1, 1310251, 10000, radius=5.0)
    IfAttacked(-1, 1310251, attacking_character=10000)
    IfConditionTrue(0, input_condition=-1)
...
def Event11310052():
    ...
    Wait(3.0)
    PlayCutscene(130121, skippable=True, fade_out=False, player_id=PLAYER, move_to_region=1302010, move_to_map=CATACOMBS)
...
def Event11310054():
    ...
    IfSingleplayer(1)
    IfFlagOn(1, 11310050)
    IfEntityWithinDistance(1, 1311300, 10000, radius=2.0)
    IfConditionTrue(0, input_condition=1)
    Wait(1.0)
    ResetStandbyAnimationSettings(PLAYER)
    EnableObjectActivation(1311300, obj_act_id=-1)
    IfEntityBeyondDistance(0, 1311300, 10000, radius=3.0)
    Restart()
...
def Event11310002():
    ...
    SkipLinesIfFinishedConditionTrue(2, 2)
    PlayCutscene(130111, skippable=True, fade_out=False, player_id=PLAYER, move_to_region=1312120, move_to_map=TOMB_OF_THE_GIANTS)
    SkipLines(1)
    PlayCutscene(130110, skippable=True, fade_out=False, player_id=PLAYER, move_to_region=1312120, move_to_map=TOMB_OF_THE_GIANTS)
    WaitFrames(1)
    Move(6321, destination=1312121, model_point=-1, destination_type=MapEntityType.Region)
    End()
    SkipLinesIfClient(7)
    SkipLinesIfFinishedConditionTrue(2, 2)
    PlayCutscene(130111, skippable=False, fade_out=False, player_id=PLAYER, move_to_region=1312120, move_to_map=TOMB_OF_THE_GIANTS)
    SkipLines(1)
    PlayCutscene(130110, skippable=False, fade_out=False, player_id=PLAYER, move_to_region=1312120, move_to_map=TOMB_OF_THE_GIANTS)
    WaitFrames(1)
    Move(6321, destination=1312121, model_point=-1, destination_type=MapEntityType.Region)
    End()
    SkipLinesIfFinishedConditionTrue(2, 2)
