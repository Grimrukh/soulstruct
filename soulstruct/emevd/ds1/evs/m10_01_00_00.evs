...
def Preconstructor():
    ...
    SkipLines(1)
    Move(6001, destination=1012530, destination_type=MapEntityType.Region, model_point=-1, set_draw_hitbox=1013050)
...
def Event11015390():
    ...
    IfFlagOff(1, 3)
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1012998, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True, line_intersects=1011990, boss_version=True)
    IfConditionTrue(0, input_condition=1)
...
def Event11015391():
    ...
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1012998, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=False, line_intersects=1011990)
    IfConditionTrue(0, input_condition=1)
    RotateToFaceEntity(PLAYER, 1012997)
    ForceAnimation(PLAYER, 7410)
    Restart()
...
def Event11015396():
    ...
    Move(1010801, destination=1012650, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
...
def Event11015397(ARG_0_3: int, ARG_4_5: short, ARG_8_11: int, ARG_12_15: int):
    ...
    IfConditionTrue(0, input_condition=1)
    CreateNPCPart(ARG_0_3, npc_part_id=ARG_4_5, part_index=NPCPartType.Part1, part_health=65, damage_correction=1.0, body_damage_correction=1.0, is_invincible=False, start_in_stop_state=False)
    ...
    Move(ARG_12_15, destination=ARG_0_3, destination_type=MapEntityType.Character, model_point=130, copy_draw_hitbox=ARG_0_3)
...
def Event11015398(ARG_0_3: int, ARG_4_7: int):
    ...
    SetHitboxMask(ARG_0_3, bit_index=1, switch_type=OnOffChange.Off)
    SetHitboxMask(ARG_0_3, bit_index=2, switch_type=OnOffChange.Off)
...
def Event11015380():
    ...
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1012898, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True, line_intersects=1011890, boss_version=True)
    IfConditionTrue(0, input_condition=1)
...
def Event11015381():
    ...
    IfFlagOn(1, 11015383)
    IfCharacterType(1, PLAYER, CharacterType.WhitePhantom)
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1012898, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=False, line_intersects=1011890)
    IfConditionTrue(0, input_condition=1)
    RotateToFaceEntity(PLAYER, 1012897)
    ForceAnimation(PLAYER, 7410)
    Restart()
...
def Event11015382():
    ...
    IfAttacked(1, 1010700, attacking_character=10000)
    IfHost(2)
...
def Event11015386():
    ...
    IfConditionTrue(0, input_condition=-1)
    SkipLinesIfFinishedConditionTrue(2, 2)
    Move(1010700, destination=1012741, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    SkipLines(1)
    Move(1010700, destination=1012740, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    Restart()
...
def Event11015370():
    ...
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1012888, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True, line_intersects=1011790, boss_version=True)
    IfConditionTrue(0, input_condition=1)
...
def Event11015371():
    ...
    IfFlagOn(1, 11015373)
    IfCharacterType(1, PLAYER, CharacterType.WhitePhantom)
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1012888, anchor_type=MapEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=False, line_intersects=1011790)
    IfConditionTrue(0, input_condition=1)
    RotateToFaceEntity(PLAYER, 1012887)
    ForceAnimation(PLAYER, 7410)
    Restart()
...
def Event11015110():
    ...
    End()
    DisableAI(1010102)
    IfEntityWithinDistance(1, 10000, 1010102, radius=5.0)
...
def Event11015111():
    ...
    IfAttacked(2, 1010110, attacking_character=10000)
    IfEntityWithinDistance(3, 1010110, 10000, radius=2.0)
    IfConditionTrue(-1, input_condition=1)
    IfConditionTrue(-1, input_condition=2)
    IfConditionTrue(-1, input_condition=3)
    IfConditionTrue(0, input_condition=-1)
...
def Event11015113():
    ...
    IfAttacked(-1, 1010200, attacking_character=10000)
    IfEntityWithinDistance(-1, 1010200, 10000, radius=5.0)
    IfConditionTrue(0, input_condition=-1)
    EnableAI(1010200)
...
def Event11015112():
    ...
    EndIfThisEventOn()
    DisableAI(1010111)
    IfAttacked(-3, 1010111, attacking_character=10000)
    ...
    IfAttacked(-2, 1010111, attacking_character=10000)
...
def Event11010111():
    ...
    EndIfThisEventOn()
    DisableAI(1010130)
    IfAttacked(1, 1010130, attacking_character=10000)
    ...
    Move(1010130, destination=1012171, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
...
def Event11010120():
    ...
    End()
    DisableAI(1010103)
    IfAttacked(-1, 1010103, attacking_character=10000)
...
def Event11010101(ARG_0_3: int, ARG_4_7: int, ARG_8_9: short, ARG_12_15: int, ARG_16_19: int):
    ...
    End()
    IfDialogPromptActivated(0, prompt_text=10010400, anchor_entity=ARG_0_3, anchor_type=MapEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=ARG_8_9, human_or_hollow_only=False)
    Move(PLAYER, destination=ARG_0_3, destination_type=MapEntityType.Object, model_point=ARG_12_15, short_move=True)
...
def Event11010102(ARG_0_3: int, ARG_4_7: int, ARG_8_9: short):
    ...
    DisableNetworkSync()
    IfFlagOn(-1, ARG_0_3)
    IfDialogPromptActivated(-1, prompt_text=10010400, anchor_entity=ARG_4_7, anchor_type=MapEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=ARG_8_9, human_or_hollow_only=False)
    IfConditionTrue(0, input_condition=-1)
    EndIfFlagOn(ARG_0_3)
    DisplayDialog(10010161, anchor_entity=ARG_4_7, display_distance=3.0, button_type=ButtonType.Yes_or_No, number_buttons=NumberButtons.NoButton)
    Restart()
...
def Event11010125():
    ...
    Move(1010104, destination=1012130, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    IfThisEventOn(0)
...
def Event11010100():
    ...
    End()
    IfDialogPromptActivated(0, prompt_text=10010500, anchor_entity=1011149, anchor_type=MapEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=194, human_or_hollow_only=False)
    EnableFlag(11010100)
    Move(PLAYER, destination=1011149, destination_type=MapEntityType.Object, model_point=192, short_move=True)
...
def Event11015250(ARG_0_3: int, ARG_4_7: int, ARG_8_11: float, ARG_12_15: float):
    ...
    IfEntityWithinDistance(0, 10000, ARG_4_7, radius=ARG_8_11)
    DisableNetworkSync()
    Wait(ARG_12_15)
...
def Event11010607():
    ...
    SkipLinesIfThisEventOff(3)
    Move(6010, destination=1012201, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
...
def Event11010899():
    ...
    Move(1010300, destination=1012310, destination_type=MapEntityType.Region, model_point=-1, set_draw_hitbox=1013211)
    SetStandbyAnimationSettings(1010300, standby_animation=7006)
    DisableCollision(1010300)
    DisableGravity(1010300)
    IfFlagOn(2, 11010791)
    IfFlagOn(2, 11015311)
    SkipLinesIfConditionFalse(4, 2)
    EnableCharacter(1010300)
    Move(1010300, destination=1012320, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
...
def Event11010790():
    ...
    Move(1010302, destination=1012300, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
...
def Event11010791():
    ...
    EnableFlag(11010780)
    EnableCharacter(1010300)
    Move(1010300, destination=1012302, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    SetStandbyAnimationSettings(1010300, standby_animation=7006)
    ForceAnimation(1010300, 7005)
    WaitFrames(395)
    Move(1010300, destination=1012310, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    DisableFlag(11015310)
...
def Event11015301():
    ...
    SetHitboxMask(1010300, bit_index=1, switch_type=OnOffChange.Off)
    AICommand(1010300, command_id=20, slot=0)
    End()
    CreateNPCPart(1010300, npc_part_id=3430, part_index=NPCPartType.Part1, part_health=200, damage_correction=1.0, body_damage_correction=1.0, is_invincible=False, start_in_stop_state=False)
    IfCharacterPartHealthLessThanOrEqual(1, 1010300, npc_part_id=3430, value=0)
    IfFlagOff(1, 11015300)
    IfAttacked(1, 1010300, attacking_character=10000)
    IfHealthGreaterThanOrEqual(1, 1010300, 0.10000000149011612)
    ...
    SetDisplayMask(1010300, bit_index=0, switch_type=OnOffChange.On)
    SetHitboxMask(1010300, bit_index=1, switch_type=OnOffChange.Off)
    Move(1010301, destination=1010300, destination_type=MapEntityType.Character, model_point=66, copy_draw_hitbox=1010300)
...
@NeverRestart
def Event11010890(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int, ARG_24_27: int):
...
def Event11015307():
    ...
    Move(1010300, destination=1012340, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    SetStandbyAnimationSettings(1010300, standby_animation=7006)
...
def Event11010782():
    ...
    DisableCharacter(1010300)
    Move(1010300, destination=1012310, destination_type=MapEntityType.Region, model_point=-1, set_draw_hitbox=1013210)
...
def Event11010531(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int):
    ...
    DisableFlagRange((ARG_4_7, ARG_8_11))
    EnableFlag(ARG_12_15)
    Move(ARG_0_3, destination=1012530, destination_type=MapEntityType.Region, model_point=-1, set_draw_hitbox=1013050)
...
def Event11010583():
    ...
    IfFlagOff(0, 744)
    Wait(1.0)
    Move(6001, destination=1012010, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    SetStandbyAnimationSettings(6001, standby_animation=7845)
    Move(6040, destination=1012011, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    Move(6072, destination=1012012, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    SetStandbyAnimationSettings(6072, standby_animation=7880)
    Move(6190, destination=1012013, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    ...
    Move(6230, destination=1012014, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    SetStandbyAnimationSettings(6230, standby_animation=9000)
    Move(6300, destination=1012015, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
...
def Event11015103():
    ...
    IfEntityWithinDistance(1, 6590, 10000, radius=20.0)
    IfConditionTrue(0, input_condition=1)
