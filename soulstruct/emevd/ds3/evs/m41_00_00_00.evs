...
def Event14100100():
    ...
    DisableHitbox(4104100)
    EnableHitbox(4104103)
    WaitFrames(1)
    ...
    DisableHitbox(4104103)
    EnableHitbox(4104101)
    EnableHitbox(4104102)
    WaitFrames(1)
    ForceAnimation(entity=4100100, animation_id=30004, loop=True, wait_for_completion=False, skip_transition=False, unknown1=0, unknown2=1.0)
    IfOngoingCutsceneFinished(0, 4102110)
    IfDamageType(-2, attacked_character=4100100, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
...
def Event14100800():
    ...
    EnableFlag(9321)
    EnableFlag(6321)
    CreateTemporaryFX(1060, anchor_entity=4101952, anchor_type=MapEntityType.Object, model_point=200)
...
def Event14105811():
    ...
    IfDamageType(1, attacked_character=4100800, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
    IfConditionTrue(0, input_condition=1)
