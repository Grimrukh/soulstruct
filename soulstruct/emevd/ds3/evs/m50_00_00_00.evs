...
def Event15005300(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int):
    ...
    MakeEnemyAppear(ARG_8_11)
    WaitFrames(1)
    Move(ARG_4_7, destination=ARG_0_3, destination_type=MapEntityType.Character, model_point=8, copy_draw_hitbox=ARG_0_3)
    Restart()
...
def Event15005360(ARG_0_3: int, ARG_4_7: int):
    ...
    IfCharacterHasSpecialEffect(0, character=ARG_0_3, special_effect=16249)
    Move(ARG_0_3, destination=5002390, destination_type=MapEntityType.Region, model_point=-1, copy_draw_hitbox=ARG_0_3)
...
def Event15005460(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int, ARG_24_27: float, ARG_28_31: int):
    ...
    IfDamageType(-2, attacked_character=ARG_16_19, attacking_character=-1, damage_type=DamageType.Unspecified)
    IfDamageType(-2, attacked_character=ARG_28_31, attacking_character=-1, damage_type=DamageType.Unspecified)
    IfConditionTrue(1, input_condition=-2)
    IfCharacterBackreadEnabled(1, character=ARG_0_3)
    IfCharacterHasSpecialEffect(1, character=ARG_0_3, special_effect=5450)
    IfConditionTrue(-3, input_condition=1)
...
def Event15005502():
    ...
    SetCameraVibration(vibration_id=105, anchor_entity=5002502, model_point=-1, decay_start_distance=999.0, decay_end_distance=999.0, anchor_type=MapEntityType.Region)
    Wait(1.600000023841858)
    SetCameraVibration(vibration_id=105, anchor_entity=5002502, model_point=-1, decay_start_distance=999.0, decay_end_distance=999.0, anchor_type=MapEntityType.Region)
    Wait(1.600000023841858)
    SetCameraVibration(vibration_id=104, anchor_entity=5002502, model_point=-1, decay_start_distance=999.0, decay_end_distance=999.0, anchor_type=MapEntityType.Region)
...
def Event15005810():
    ...
    IfConditionTrue(-1, input_condition=1)
    IfDamageType(-1, attacked_character=5000801, attacking_character=-1, damage_type=DamageType.Unspecified)
    IfConditionTrue(0, input_condition=-1)
    Goto(Label.L2)
    Label(1)
    IfFlagOn(9, 15005805)
...
def Event15005811():
    ...
    IfConditionTrue(-1, input_condition=1)
    IfFlagOn(-1, 15005811)
    IfDamageType(-1, attacked_character=5000802, attacking_character=-1, damage_type=DamageType.Unspecified)
...
def Event15005825(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int, ARG_24_27: int):
    ...
    Move(ARG_4_7, destination=ARG_0_3, destination_type=MapEntityType.Character, model_point=ARG_20_23, copy_draw_hitbox=ARG_0_3)
    SetNetworkConnectedFlagState(flag=ARG_8_11, state=FlagState.On)
    ReplanAI(ARG_4_7)
