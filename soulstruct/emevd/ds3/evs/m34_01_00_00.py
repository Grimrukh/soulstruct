...
def Constructor():
    ...
    RunEvent(13415351, slot=0, args=(3410200, 3412780, 3412781, 3412782, 3412783, 3412784, 3412790, 3412791, 3412792, 3412793))
...
def Event13415250(ARG_0_3: int, ARG_4_7: int):
    ...
    ForceAnimation(entity=ARG_4_7, animation_id=1, loop=True, wait_for_completion=False, skip_transition=False, unknown1=0, unknown2=1.0)
    IfFlagOn(0, ARG_0_3)
    Label(0)
...
def Event13415350(ARG_0_3: int):
    ...
    IfConditionTrue(0, input_condition=1)
    ForceAnimation(entity=ARG_0_3, animation_id=20003, loop=False, wait_for_completion=False, skip_transition=False, unknown1=0, unknown2=1.0)
    Label(0)
...
@RestartOnRest
def Event13415351(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int, ARG_24_27: int, ARG_28_31: int, ARG_32_35: int, ARG_36_39: int):
    ...
    Label(0)
    Move(ARG_0_3, destination=ARG_24_27, destination_type=MapEntityType.Region, model_point=-1, copy_draw_hitbox=ARG_24_27)
    SetAIParamID(ARG_0_3, 132051)
    Goto(Label.L4)
    Label(1)
    Move(ARG_0_3, destination=ARG_32_35, destination_type=MapEntityType.Region, model_point=-1, copy_draw_hitbox=ARG_32_35)
    SetAIParamID(ARG_0_3, 132052)
    Goto(Label.L4)
    Label(2)
    Move(ARG_0_3, destination=ARG_28_31, destination_type=MapEntityType.Region, model_point=-1, copy_draw_hitbox=ARG_28_31)
    SetAIParamID(ARG_0_3, 132052)
    Goto(Label.L4)
    Label(3)
    Move(ARG_0_3, destination=ARG_36_39, destination_type=MapEntityType.Region, model_point=-1, copy_draw_hitbox=ARG_36_39)
    SetAIParamID(ARG_0_3, 132052)
    Goto(Label.L4)
    Label(4)
...
def Event13415400():
    ...
    RunCommonEvent(20005625, args=(13410450, 13410452, 3411450, 3411451, 3414451, 3411452, 3414452, 3412451, 3412452, 13411450, 13414450, 13410451))


@RestartOnRest
def Event13415410():
    """ 13415410: Event 13415410 """
    RunCommonEvent(20005623, args=(13410460, 13410462, 3411460, 3411461, 3414461, 3411462, 3414462, 3412461, 3412462, 13411460, 13414460, 0))
...
@RestartOnRest
def Event13417500(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int, ARG_24_27: float, ARG_28_31: int, ARG_32_35: int):
    """ 13417500: Event 13417500 """
    ForceAnimation(entity=ARG_4_7, animation_id=ARG_8_11, loop=True, wait_for_completion=False, skip_transition=False, unknown1=0, unknown2=1.0)
    ...
    IfEntityWithinDistance(-1, 10000, ARG_4_7, radius=ARG_24_27)
    ...
    CreateHazard(ARG_28_31, ARG_4_7, model_point=210, behavior_param_id=5210, target_type=DamageTargetType.Character, radius=1.5, life=0.0, repetition_time=1.0)
    EnableFlag(ARG_32_35)
    Wait(1.2000000476837158)
    Label(0)
    ForceAnimation(entity=ARG_4_7, animation_id=ARG_16_19, loop=True, wait_for_completion=False, skip_transition=False, unknown1=0, unknown2=1.0)
    IfFramesElapsed(-3, 210)
    IfObjectDestroyed(-3, obj=ARG_0_3)
    IfConditionTrue(0, input_condition=-3)
    SkipLinesIfObjectDestroyed(2, obj=ARG_0_3)
    IfEntityWithinDistance(3, 10000, ARG_4_7, radius=ARG_24_27)
    RestartIfConditionTrue(3)
    ForceAnimation(entity=ARG_4_7, animation_id=ARG_20_23, loop=False, wait_for_completion=True, skip_transition=False, unknown1=0, unknown2=1.0)
...
@RestartOnRest
def Event13417600(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int, ARG_24_27: float, ARG_28_31: int, ARG_32_35: int):
...
def Event13415490(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int):
    ...
    ForceAnimation(entity=ARG_4_7, animation_id=2, loop=False, wait_for_completion=False, skip_transition=False, unknown1=0, unknown2=1.0)
    ...
    Wait(2.0)
    ForceAnimation(entity=ARG_8_11, animation_id=2, loop=False, wait_for_completion=False, skip_transition=False, unknown1=0, unknown2=1.0)
    DisableObjectActivation(ARG_8_11, obj_act_id=ARG_12_15)
...
def Event13415830():
    ...
    PlayCutscene(34010010, skippable=True, fade_out=False, player_id=PLAYER, move_to_region=3412840, move_to_map=GRAND_ARCHIVES)
    SkipLines(4)
    SkipLinesIfClientTypeCountComparison(2, client_type=ClientType.Invader, comparison_type=ComparisonType.Equal, value=0)
    PlayCutscene(34010010, skippable=False, fade_out=True, player_id=PLAYER, move_to_region=3412840, move_to_map=GRAND_ARCHIVES)
    SkipLines(1)
    PlayCutscene(34010010, skippable=False, fade_out=False, player_id=PLAYER)
    WaitFrames(1)
    EnableCharacter(3410832)
    EnableAnimations(3410832)
    Move(3410832, destination=3412841, destination_type=MapEntityType.Region, model_point=-1, copy_draw_hitbox=3412841)
    Goto(Label.L1)
    Label(0)
...
def Event13415831():
    ...
    WaitFrames(1)
    Move(3410830, destination=3410832, destination_type=MapEntityType.Character, model_point=-1, copy_draw_hitbox=3410832)
    DisableCharacter(3410832)
    DisableAnimations(3410832)
    DisableAI(3410832)
...
def Event13410832():
    ...
    ForceAnimation(entity=3410830, animation_id=20001, loop=False, wait_for_completion=False, skip_transition=True, unknown1=0, unknown2=1.0)
    Wait(7.5)
    Goto(Label.L2)
    Label(1)
    ForceAnimation(entity=3410830, animation_id=20002, loop=False, wait_for_completion=False, skip_transition=True, unknown1=0, unknown2=1.0)
    Wait(8.0)
    Label(2)
...
def Event13415841():
    ...
    IfFlagOn(0, 13415842)
    Move(3410831, destination=3410830, destination_type=MapEntityType.Character, model_point=50, copy_draw_hitbox=3410830)
    Restart()
...
def Event13415843():
    ...
    EnableFlag(73410100)
    ForceAnimation(entity=3410831, animation_id=20000, loop=False, wait_for_completion=False, skip_transition=True, unknown1=0, unknown2=1.0)
    ForceAnimation(entity=3410830, animation_id=20000, loop=False, wait_for_completion=True, skip_transition=True, unknown1=0, unknown2=1.0)
    Restart()
