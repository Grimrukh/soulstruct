...
def Constructor():
    ...
    Label(0)
    RunCommonEvent(20005920, args=(0, 14705300, 10020000, 10020010))
    RunCommonEvent(20005930, args=(14705300,))
    RunCommonEvent(20005941, args=(14705300,))
    End()
    Label(1)
    RunCommonEvent(20005920, args=(1, 14705300, 10020001, 10020011))
    Goto(Label.L9)
    Label(2)
    RunCommonEvent(20005920, args=(2, 14705300, 10020002, 10020012))
    Goto(Label.L9)
    Label(3)
    RunCommonEvent(20005920, args=(3, 14705300, 10020003, 10020013))
    Goto(Label.L9)
    Label(4)
    RunCommonEvent(20005920, args=(4, 14705300, 10020004, 10020014))
    Goto(Label.L9)
    Label(5)
    RunCommonEvent(20005920, args=(5, 14705300, 10020005, 10020015))
    Goto(Label.L9)
    Label(9)
