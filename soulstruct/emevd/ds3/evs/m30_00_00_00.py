...
def Constructor():
    ...
    RunEvent(13005200, slot=0, args=(3000451, 20001, 0.8999999761581421, 0, 3000450, 3000601, 3000607, 3000452), arg_types='iifiiiii')
    RunEvent(13005200, slot=1, args=(3000450, 20000, 0.20000000298023224, 3000451, 0, 3000601, 3000607, 3000452), arg_types='iifiiiii')
    RunEvent(13005200, slot=2, args=(3000601, 20001, 0.4000000059604645, 3000451, 3000450, 0, 3000607, 3000452), arg_types='iifiiiii')
    RunEvent(13005200, slot=3, args=(3000607, 20001, 0.0, 3000451, 3000450, 3000601, 0, 3000452), arg_types='iifiiiii')
    RunEvent(13005200, slot=4, args=(3000452, 20002, 0.699999988079071, 3000451, 3000450, 3000601, 3000607, 0), arg_types='iifiiiii')
    ...
    RunCommonEvent(20005701, args=(13000800, 13005700, 13005701, 3000190, 3002780, 13005392), event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    RunEvent(13005826, slot=0, args=(13005700, 13005805, 13005885, 3000190, 3002800, 3002896, 3002820, 3002870, 13000801, 13000896), event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    ...
    RunEvent(13005390)
    RunEvent(13005391)
    RunCommonEvent(20005701, args=(13000800, 13005705, 13005706, 3000191, 3002781, 9500), event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    RunEvent(13005826, slot=1, args=(13005705, 13005805, 13005885, 3000191, 3002800, 3002896, 3002820, 3002870, 13000801, 13000896), event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    ...
    RunEvent(13005540)
    DeleteObjectFX(3001885, erase_root=True)
    DeleteObjectFX(3001886, erase_root=True)
    DeleteObjectFX(3001887, erase_root=True)
    DeleteObjectFX(3001888, erase_root=True)
    CreateObjectFX(800023, obj=3001885, model_point=200)
    CreateObjectFX(800023, obj=3001886, model_point=200)
    CreateObjectFX(800023, obj=3001887, model_point=200)
    CreateObjectFX(800023, obj=3001888, model_point=200)
...
def Event13000360():
    ...
    CreateTemporaryFX(30300, anchor_entity=10000, anchor_type=MapEntityType.Character, model_point=245)
    CreateObjectFX(830095, obj=3001705, model_point=90)
    EnableFlag(13000360)
    Wait(10.0)
    DeleteObjectFX(3001705, erase_root=True)


@NeverRestart
def Event13000380(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int):
...
def Event13005025():
    ...
    EndIfThisEventSlotOn()
    ForceAnimation(entity=3000404, animation_id=703, loop=True, wait_for_completion=False, skip_transition=False, unknown1=0, unknown2=1.0)
    DisableAI(3000404)
    IfObjectDestroyed(-1, obj=3001250)
    IfAttacked(-2, 3000404, attacking_character=10000)
    ...
    ForceAnimation(entity=3000404, animation_id=1703, loop=False, wait_for_completion=True, skip_transition=False, unknown1=0, unknown2=1.0)
    EnableAI(3000404)


@RestartOnRest
def Event13005200(ARG_0_3: int, ARG_4_7: int, ARG_8_11: float, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int, ARG_24_27: int, ARG_28_31: int):
    """ 13005200: Event 13005200 """
    EndIfThisEventSlotOn()
    Wait(1.0)
    IfDamageType(-1, attacked_character=ARG_12_15, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
    IfDamageType(-1, attacked_character=ARG_16_19, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
    IfDamageType(-1, attacked_character=ARG_20_23, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
    IfDamageType(-1, attacked_character=ARG_24_27, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
    IfDamageType(-1, attacked_character=ARG_28_31, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
    IfEntityWithinDistance(1, ARG_0_3, 10000, radius=1.0)
    IfHasAIStatus(2, character=3000427, ai_status=AIStatusType.Battle)
    IfEntityWithinDistance(2, 3000427, ARG_0_3, radius=3.5)
    IfHasAIStatus(3, character=3000443, ai_status=AIStatusType.Battle)
    IfEntityWithinDistance(3, 3000443, ARG_0_3, radius=3.5)
    IfHasAIStatus(4, character=3000426, ai_status=AIStatusType.Battle)
    IfEntityWithinDistance(4, 3000426, ARG_0_3, radius=3.5)
    IfHasAIStatus(5, character=3000483, ai_status=AIStatusType.Battle)
    IfEntityWithinDistance(5, 3000483, ARG_0_3, radius=3.5)
    IfHasAIStatus(6, character=3005500, ai_status=AIStatusType.Battle, target_comparison_type=ComparisonType.GreaterThanOrEqual, target_count=1.0)
    IfEntityWithinDistance(6, 10000, ARG_0_3, radius=3.5)
...
@RestartOnRest
def Event13005210(ARG_0_3: int, ARG_4_7: int, ARG_8_11: float, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int, ARG_24_27: int, ARG_28_31: int):
    ...
    IfHasAIStatus(5, character=3000483, ai_status=AIStatusType.Battle)
    IfEntityWithinDistance(5, 3000483, ARG_0_3, radius=3.5)
    IfHasAIStatus(6, character=3005500, ai_status=AIStatusType.Battle)
    IfEntityWithinDistance(6, 10000, ARG_0_3, radius=3.5)
    IfHasTAEEvent(7, character=3000443, tae_event_id=20)
    IfConditionTrue(-2, input_condition=-1)
    IfConditionTrue(-2, input_condition=1)
    IfConditionTrue(-2, input_condition=2)
    IfConditionTrue(-2, input_condition=3)
...
@RestartOnRest
def Event13005220(ARG_0_3: int, ARG_4_7: int, ARG_8_11: float, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int, ARG_24_27: int, ARG_28_31: int):
    ...
    IfHasAIStatus(5, character=3000483, ai_status=AIStatusType.Battle)
    IfEntityWithinDistance(5, 3000483, ARG_0_3, radius=3.5)
    IfHasAIStatus(6, character=3000561, ai_status=AIStatusType.Battle)
    IfEntityWithinDistance(6, 3000561, ARG_0_3, radius=3.5)
    IfHasAIStatus(7, character=3000408, ai_status=AIStatusType.Battle)
    IfEntityWithinDistance(7, 3000408, ARG_0_3, radius=3.5)
    IfHasAIStatus(8, character=3000560, ai_status=AIStatusType.Battle)
    IfEntityWithinDistance(8, 3000560, ARG_0_3, radius=3.5)
    IfHasAIStatus(9, character=3000579, ai_status=AIStatusType.Battle)
    IfEntityWithinDistance(9, 3000579, ARG_0_3, radius=3.5)
    IfHasAIStatus(10, character=3000428, ai_status=AIStatusType.Battle)
    IfEntityWithinDistance(10, 3000428, ARG_0_3, radius=3.5)
    IfHasAIStatus(11, character=3005501, ai_status=AIStatusType.Battle, target_comparison_type=ComparisonType.GreaterThanOrEqual, target_count=1.0)
    IfEntityWithinDistance(11, 10000, ARG_0_3, radius=3.5)
    IfConditionTrue(-2, input_condition=-1)
    IfConditionTrue(-2, input_condition=1)
    IfConditionTrue(-2, input_condition=2)
    IfConditionTrue(-2, input_condition=3)
...
@RestartOnRest
def Event13005230(ARG_0_3: int, ARG_4_7: int, ARG_8_11: float, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int, ARG_24_27: int, ARG_28_31: int):
    ...
    IfDamageType(-1, attacked_character=ARG_28_31, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
    IfEntityWithinDistance(1, ARG_0_3, 10000, radius=1.0)
    IfHasAIStatus(2, character=3000418, ai_status=AIStatusType.Battle)
    IfEntityWithinDistance(2, 3000418, ARG_0_3, radius=3.5)
    IfHasAIStatus(3, character=3000522, ai_status=AIStatusType.Battle)
    IfEntityWithinDistance(3, 3000522, ARG_0_3, radius=3.5)
    IfHasAIStatus(4, character=3000471, ai_status=AIStatusType.Battle)
    IfEntityWithinDistance(4, 3000471, ARG_0_3, radius=3.5)
    IfHasAIStatus(5, character=3000494, ai_status=AIStatusType.Battle)
    IfEntityWithinDistance(5, 3000494, ARG_0_3, radius=3.5)
    IfHasAIStatus(6, character=3000488, ai_status=AIStatusType.Battle)
    IfEntityWithinDistance(6, 3000488, ARG_0_3, radius=3.5)
    IfHasAIStatus(7, character=3000230, ai_status=AIStatusType.Battle)
    IfEntityWithinDistance(7, 3000230, ARG_0_3, radius=3.5)
    IfHasAIStatus(8, character=3005502, ai_status=AIStatusType.Battle, target_comparison_type=ComparisonType.GreaterThanOrEqual, target_count=1.0)
    IfEntityWithinDistance(8, 10000, ARG_0_3, radius=3.5)
    IfConditionTrue(-2, input_condition=-1)
    IfConditionTrue(-2, input_condition=1)
    IfConditionTrue(-2, input_condition=2)
    IfConditionTrue(-2, input_condition=3)
...
@RestartOnRest
def Event13005240(ARG_0_3: int, ARG_4_7: int, ARG_8_11: float, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int, ARG_24_27: int, ARG_28_31: int):
    ...
    IfDamageType(-1, attacked_character=ARG_28_31, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
    IfEntityWithinDistance(1, ARG_0_3, 10000, radius=1.0)
    IfHasAIStatus(2, character=3000255, ai_status=AIStatusType.Battle)
    IfEntityWithinDistance(2, 3000255, ARG_0_3, radius=3.5)
    IfHasAIStatus(3, character=3000520, ai_status=AIStatusType.Battle)
    IfEntityWithinDistance(3, 3000520, ARG_0_3, radius=3.5)
    IfHasAIStatus(4, character=3000253, ai_status=AIStatusType.Battle)
    IfEntityWithinDistance(4, 3000253, ARG_0_3, radius=3.5)
    IfHasAIStatus(5, character=3000242, ai_status=AIStatusType.Battle)
    IfEntityWithinDistance(5, 3000242, ARG_0_3, radius=3.5)
    IfHasAIStatus(6, character=3000245, ai_status=AIStatusType.Battle)
    IfEntityWithinDistance(6, 3000245, ARG_0_3, radius=3.5)
    IfHasAIStatus(7, character=3005503, ai_status=AIStatusType.Battle, target_comparison_type=ComparisonType.GreaterThanOrEqual, target_count=1.0)
    IfEntityWithinDistance(7, 10000, ARG_0_3, radius=3.5)
    IfConditionTrue(-2, input_condition=-1)
    IfConditionTrue(-2, input_condition=1)
    IfConditionTrue(-2, input_condition=2)
    IfConditionTrue(-2, input_condition=3)
...
@NeverRestart
def Event13005280(ARG_0_3: int, ARG_4_7: int):
    """ 13005280: Event 13005280 """
    IfObjectBurnState(1, obj=ARG_0_3, comparison_type=ComparisonType.GreaterThan, state=False)
    IfFlagOn(1, 13000890)
    IfConditionTrue(0, input_condition=1)
    CreateTemporaryFX(ARG_4_7, anchor_entity=ARG_0_3, anchor_type=MapEntityType.Object, model_point=200)


@RestartOnRest
def Event13005350(ARG_0_3: int, ARG_4_7: int):
...
def Event13005391():
    ...
    IfFlagOn(2, 13005700)
    IfConditionTrue(0, input_condition=2)
    ForceAnimation(entity=3000190, animation_id=91030, loop=False, wait_for_completion=False, skip_transition=False, unknown1=0, unknown2=1.0)
    Wait(2.0)
...
def Event13005480():
    ...
    Move(3000850, destination=3002600, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    ...
    ForceAnimation(entity=3000850, animation_id=30002, loop=False, wait_for_completion=False, skip_transition=True, unknown1=0, unknown2=1.0)
    End()
    Label(0)
    ...
    EnableCharacter(3000850)
    SetNetworkUpdateRate(3000850, is_fixed=True, update_rate=CharacterUpdateRate.Always)
    ForceAnimation(entity=3000850, animation_id=20003, loop=False, wait_for_completion=False, skip_transition=True, unknown1=0, unknown2=1.0)
    EnableFlag(13000480)
    EnableImmortality(3000850)
    End()
    Label(1)
...
def Event13005481():
    ...
    EndIfFlagOn(13000481)
    EndIfFlagOn(9420)
    IfHealthComparison(1, character=3000850, comparison_type=ComparisonType.LessThanOrEqual, value=0.20000000298023224)
    IfFlagOn(2, 9420)
    ...
    Label(0)
    ForceAnimation(entity=3000850, animation_id=20007, loop=False, wait_for_completion=True, skip_transition=True, unknown1=0, unknown2=1.0)
    DisableCharacter(3000850)
...
def Event13005485():
    ...
    IfCharacterHasSpecialEffect(2, character=3000850, special_effect=11000)
    IfCharacterHasSpecialEffect(2, character=3000850, special_effect=11001)
    IfConditionTrue(3, input_condition=-1)
    IfConditionTrue(3, input_condition=1)
    IfConditionTrue(3, input_condition=2)
    IfConditionTrue(0, input_condition=3)
    CancelSpecialEffect(3000850, 11000)
    ForceAnimation(entity=3000850, animation_id=20001, loop=False, wait_for_completion=False, skip_transition=True, unknown1=0, unknown2=1.0)
    End()
    Label(0)
    CancelSpecialEffect(3000850, 11000)
    ForceAnimation(entity=3000850, animation_id=30002, loop=False, wait_for_completion=False, skip_transition=True, unknown1=0, unknown2=1.0)
...
def Event13005493():
    ...
    EndIfFlagOn(13000481)
    EndIfFlagOn(9420)
    IfDamageType(1, attacked_character=3000850, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
...
@RestartOnRest
def Event13005510(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: float):
    """ 13005510: Event 13005510 """
    EndIfThisEventSlotOn()
    IfHasTAEEvent(0, character=ARG_0_3, tae_event_id=100)
    Wait(ARG_12_15)
    IfCharacterHasSpecialEffect(1, character=ARG_4_7, special_effect=5450)
...
def Event13005530():
    ...
    EndIfThisEventSlotOn()
    Wait(5.0)
    Move(3000496, destination=3002500, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    Move(3000580, destination=3002501, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    Move(3000526, destination=3002502, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    Move(3000522, destination=3002503, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
...
def Event13005535():
    ...
    IfAttacked(-3, 3000488, attacking_character=10000)
    IfConditionTrue(1, input_condition=-1)
    IfConditionTrue(1, input_condition=-2)
    IfConditionTrue(0, input_condition=1)
    IfConditionTrue(0, input_condition=-3)
    ...
    IfAttacked(-4, 3000488, attacking_character=10000)
    GotoIfConditionTrue(Label.L0, input_condition=2)
    GotoIfConditionTrue(Label.L1, input_condition=-4)
    Label(0)
    ForceAnimation(entity=3000488, animation_id=3004, loop=False, wait_for_completion=False, skip_transition=True, unknown1=0, unknown2=1.0)
    EnableAI(3000488)
    End()
    Label(1)
    EnableAI(3000488)
...
def Event13005550():
    ...
    EndIfPlayerNotInOwnWorld()
    IfActionButtonInRegion(0, action_button_id=3001810, region=3001650)
    IfPlayerHasGood(1, 2102, including_box=False)
    GotoIfConditionTrue(Label.L0, input_condition=1)
    DisplayDialog(10012001, anchor_entity=-1, display_distance=3.0, button_type=ButtonType.OK_or_Cancel, number_buttons=NumberButtons.NoButton)
    Restart()
    Label(0)
    ...
    PlayCutsceneAndMovePlayerAndSetMapCeremony(31000010, cutscene_type=CutsceneType.Skippable, ceremony_id=0, unknown=1, region=3102515, game_map=UNDEAD_SETTLEMENT, player_id=10000)
    SkipLines(1)
    WarpToMap(game_map=UNDEAD_SETTLEMENT, destination_player_id=3100974)
    EnableFlag(13100330)
    WaitFrames(1)
...
def Event13005440():
    ...
    RunCommonEvent(20005621, args=(13000300, 13000301, 3001200, 3001201, 3004201, 3001202, 3004202, 3002301, 3002302, 13001300, 13004300, 0))
    RunCommonEvent(20005625, args=(13000310, 13000311, 3001210, 3001211, 3004211, 3001212, 3004212, 3002311, 3002312, 13001310, 13004310, 0))
    RunCommonEvent(20005621, args=(13000320, 13000321, 3001220, 3001221, 3004221, 3001222, 3004222, 3002321, 3002322, 13001320, 13004320, 0))
    RunCommonEvent(20005623, args=(13000330, 13000331, 3001230, 3001231, 3004231, 3001232, 3004232, 3002331, 3002332, 13001330, 13004330, 0))
...
def Event13005810():
    ...
    EndIfFlagOn(13000800, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    ...
    GotoIfFlagOn(Label.L1, 13000801, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    Move(3000800, destination=3002811, destination_type=MapEntityType.Region, model_point=-1, short_move=True, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    IfCharacterInsideRegion(1, PLAYER, region=3002815, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    IfConditionTrue(0, input_condition=1, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    ...
    Label(0, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    GotoIfFlagOn(Label.L2, 13000801)
    SkipLinesIfTryingToCreateSession(2, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    PlayCutscene(30000030, skippable=True, fade_out=False, player_id=PLAYER, move_to_region=3002810, move_to_map=HIGH_WALL_OF_LOTHRIC, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    SkipLines(4, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    SkipLinesIfClientTypeCountComparison(2, client_type=ClientType.Invader, comparison_type=ComparisonType.Equal, value=0, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    PlayCutscene(30000030, skippable=False, fade_out=True, player_id=PLAYER, move_to_region=3002810, move_to_map=HIGH_WALL_OF_LOTHRIC, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    SkipLines(1, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    PlayCutscene(30000030, skippable=False, fade_out=False, player_id=PLAYER, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    WaitFrames(1, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    Goto(Label.L2, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    Label(1)
    EnableCharacter(3000800, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    IfFlagOff(3, 13000800, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    IfCharacterInsideRegion(3, PLAYER, region=3002801, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    IfConditionTrue(0, input_condition=3, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    ForceAnimation(entity=3000800, animation_id=3030, loop=False, wait_for_completion=False, skip_transition=False, unknown1=0, unknown2=1.0, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    Label(2, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    EnableCharacter(3000800, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    EnableAI(3000800, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    SetNetworkUpdateRate(3000800, is_fixed=True, update_rate=CharacterUpdateRate.Always, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    EnableBossHealthBar(3000800, name=902240, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    SetNetworkConnectedFlagState(flag=13000801, state=FlagState.On, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
...
def Event13005811():
    ...
    EndIfFlagOn(13000800)
    IfHealthComparison(0, character=3000800, comparison_type=ComparisonType.LessThanOrEqual, value=0.0)
    Wait(1.0)
...
def Event13005812():
    ...
    IfFlagOn(0, 13000800)
    Wait(2.0)
    ForceAnimation(entity=3001815, animation_id=1, loop=False, wait_for_completion=False, skip_transition=True, unknown1=0, unknown2=1.0)
    Wait(7.5)
    CreateObjectFX(830101, obj=3001815, model_point=100)
    End()
    Label(0)
    ForceAnimation(entity=3001815, animation_id=2, loop=True, wait_for_completion=False, skip_transition=False, unknown1=0, unknown2=1.0)
    CreateObjectFX(830101, obj=3001815, model_point=100)
...
def Event13005815():
    ...
    EndIfFlagOn(13000800)
    IfHasTAEEvent(0, character=3000800, tae_event_id=10)
    End()
...
@RestartOnRest
def Event13005825(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int):
...
@RestartOnRest
def Event13005826(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int, ARG_24_27: int, ARG_28_31: int, ARG_32_35: int, ARG_36_39: int):
...
def Event13005830():
    ...
    IfFlagOff(1, 13000830, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    IfCharacterInsideRegion(1, PLAYER, region=3002830, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    IfConditionTrue(0, input_condition=1, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    SkipLinesIfClientTypeCountComparison(1, client_type=ClientType.Invader, comparison_type=ComparisonType.Equal, value=0)
    BanishInvaders(unknown=0)
    IfCharacterInvadeType(-15, character=PLAYER, invade_type=4)
    ...
    SkipLinesIfTryingToCreateSession(2, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    PlayCutscene(30000040, skippable=True, fade_out=False, player_id=PLAYER, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    SkipLines(4, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    SkipLinesIfClientTypeCountComparison(2, client_type=ClientType.Invader, comparison_type=ComparisonType.Equal, value=0, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    PlayCutscene(30000040, skippable=False, fade_out=True, player_id=PLAYER, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    SkipLines(1, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    PlayCutscene(30000040, skippable=False, fade_out=False, player_id=PLAYER, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    WaitFrames(1, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    Goto(Label.L1, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    Label(0, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    EnableCharacter(3000830, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    IfFlagOff(2, 13000830, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    IfCharacterInsideRegion(2, PLAYER, region=3002830, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    IfConditionTrue(0, input_condition=2, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    Label(1, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    EnableCharacter(3000830, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    EnableAI(3000830, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    SetNetworkUpdateRate(3000830, is_fixed=True, update_rate=CharacterUpdateRate.Always, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    EnableBossHealthBar(3000830, name=902090, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    DisableObjectActivation(3001813, obj_act_id=300371, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    SetNetworkConnectedFlagState(flag=13000838, state=FlagState.On, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
...
def Event13005831():
    ...
    EndIfFlagOn(13000830)
    IfHealthComparison(0, character=3000830, comparison_type=ComparisonType.LessThanOrEqual, value=0.0)
    Wait(1.0)
...
def Event13005835():
    ...
    EndIfFlagOn(13000830)
    IfHasTAEEvent(0, character=3000830, tae_event_id=10)
    WaitFrames(1)
    End()
...
def Event13005836():
    ...
    EndIfFlagOn(13000830)
    IfHasTAEEvent(0, character=3000830, tae_event_id=20)
    EnableFlag(73000202)
    WaitFrames(1)
    End()
...
def Event13005837():
    ...
    EndIfFlagOn(13000830)
    IfHasTAEEvent(0, character=3000830, tae_event_id=20)
    CreateNPCPart(3000830, npc_part_id=10, part_index=NPCPartType.Part6, part_health=193, damage_correction=1.0, body_damage_correction=1.0, is_invincible=False, start_in_stop_state=False)
...
def Event13005838():
    ...
    EndIfFlagOn(13000830)
    IfCharacterHasSpecialEffect(1, character=3000830, special_effect=5404)
    IfCharacterPartHealthLessThanOrEqual(1, 3000830, npc_part_id=10, value=0)
    IfFlagOn(1, 13005837)
    IfConditionTrue(0, input_condition=1)
    ForceAnimation(entity=3000830, animation_id=20000, loop=False, wait_for_completion=True, skip_transition=True, unknown1=0, unknown2=1.0)
    CreateNPCPart(3000830, npc_part_id=10, part_index=NPCPartType.Part6, part_health=193, damage_correction=1.0, body_damage_correction=1.0, is_invincible=False, start_in_stop_state=False)
    Restart()
...
def Event13005880():
    ...
    GotoIfFlagOn(Label.L0, 13000885, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    ForceAnimation(entity=3001087, animation_id=0, loop=True, wait_for_completion=False, skip_transition=False, unknown1=0, unknown2=1.0, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    DisableObject(3001870, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    EndIfPlayerNotInOwnWorld()
    IfFlagOn(0, 13000890, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    IfActionButtonInRegion(0, action_button_id=3001895, region=3001896, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    SkipLinesIfTryingToCreateSession(2, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    PlayCutscene(30000020, skippable=True, fade_out=False, player_id=PLAYER, move_to_region=3002880, move_to_map=HIGH_WALL_OF_LOTHRIC, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    SkipLines(4, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    SkipLinesIfClientTypeCountComparison(2, client_type=ClientType.Invader, comparison_type=ComparisonType.Equal, value=0, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    PlayCutscene(30000020, skippable=False, fade_out=True, player_id=PLAYER, move_to_region=3002880, move_to_map=HIGH_WALL_OF_LOTHRIC, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    SkipLines(1, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    PlayCutscene(30000020, skippable=False, fade_out=False, player_id=PLAYER, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    WaitFrames(1, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    RemoveGoodFromPlayer(2117, quantity=1)
    Label(0)
    ForceAnimation(entity=3001087, animation_id=10, loop=True, wait_for_completion=False, skip_transition=False, unknown1=0, unknown2=1.0, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    EnableObject(3001870, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    RegisterLadder(start_climbing_flag=13000264, stop_climbing_flag=13000265, obj=3001087, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    ForceAnimation(entity=3001896, animation_id=2, loop=True, wait_for_completion=False, skip_transition=False, unknown1=0, unknown2=1.0, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    EnableFlag(13000885, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
...
def Event13005890():
    ...
    DisableMapSound(3002899)
    DisableMapSound(3002898)
    ForceAnimation(entity=3001895, animation_id=2, loop=True, wait_for_completion=False, skip_transition=False, unknown1=0, unknown2=1.0)
    DisableObjectActivation(3001895, obj_act_id=300370)
    CreateObjectFX(800030, obj=3001360, model_point=210)
    CreateObjectFX(800030, obj=3001360, model_point=212)
    CreateObjectFX(800043, obj=3001360, model_point=214)
    CreateObjectFX(800030, obj=3001361, model_point=210)
    CreateObjectFX(800030, obj=3001361, model_point=212)
    CreateObjectFX(800043, obj=3001361, model_point=214)
    CreateObjectFX(800030, obj=3001362, model_point=210)
    CreateObjectFX(800030, obj=3001362, model_point=212)
    CreateObjectFX(800043, obj=3001362, model_point=214)
    CreateObjectFX(800030, obj=3001363, model_point=210)
    CreateObjectFX(800030, obj=3001363, model_point=212)
    CreateObjectFX(800043, obj=3001363, model_point=214)
    DeleteObjectFX(3001890, erase_root=True)
    DeleteObjectFX(3001899, erase_root=True)
    EndIfFlagOn(13000890)
    GotoIfFlagOn(Label.L1, 13000896)
    Move(3000899, destination=3002893, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    SkipLinesIfClientTypeCountComparison(2, client_type=ClientType.Coop, comparison_type=ComparisonType.Equal, value=0)
    EnableObject(3001890)
    CreateObjectFX(3, obj=3001890, model_point=101)
    SkipLinesIfClientTypeCountComparison(1, client_type=ClientType.Invader, comparison_type=ComparisonType.Equal, value=0)
    ...
    IfActionButtonInRegion(0, action_button_id=3001890, region=3001890)
...
def Event13005891():
    ...
    EndIfFlagOn(13000890)
    IfHasTAEEvent(0, character=3000899, tae_event_id=10)
...
def Event13005892():
    ...
    EndIfFlagOn(13000890)
    CreateNPCPart(3000899, npc_part_id=10, part_index=NPCPartType.Part5, part_health=400, damage_correction=1.0, body_damage_correction=1.0, is_invincible=False, start_in_stop_state=False)
    IfCharacterPartHealthLessThanOrEqual(0, 3000899, npc_part_id=10, value=0)
    ForceAnimation(entity=3000899, animation_id=20000, loop=False, wait_for_completion=True, skip_transition=True, unknown1=0, unknown2=1.0)
    SetNPCPartHealth(3000899, npc_part_id=10, desired_hp=400, overwrite_max=True)
    Restart()
...
def Event13005893():
    ...
    ForceAnimation(entity=3001895, animation_id=2, loop=False, wait_for_completion=False, skip_transition=False, unknown1=0, unknown2=1.0)
    Goto(Label.L1)
    Label(0)
    ForceAnimation(entity=3001895, animation_id=0, loop=False, wait_for_completion=False, skip_transition=False, unknown1=0, unknown2=1.0)
    Label(1)
    IfFlagOn(0, 13005885)
    IfCharacterType(1, character=PLAYER, character_type=CharacterType.WhitePhantom)
    IfFlagOff(1, 13000890)
    IfActionButtonInRegion(1, action_button_id=3001890, region=3001890)
    IfConditionTrue(0, input_condition=1)
    RotateToFaceEntity(PLAYER, 3002896, animation=60060, wait_for_completion=True)
    EnableBossMusic(3002899)
    EnableBossHealthBar(3000899, name=905270)
...
def Event13005895():
    ...
    EndIfFlagOn(13000890)
    IfHealthComparison(0, character=3000899, comparison_type=ComparisonType.LessThanOrEqual, value=0.0)
    Wait(1.0)
    ...
    DeleteObjectFX(3001890, erase_root=True)
    ChangeCamera(normal_camera_id=-1, locked_camera_id=-1)
    Wait(2.0, event_layers=[0, 1, 2, 3, 4, 5, 6, 7, 8])
    SkipLinesIfFlagOn(2, 13000880)
    ForceAnimation(entity=3001895, animation_id=1, loop=False, wait_for_completion=True, skip_transition=False, unknown1=0, unknown2=1.0)
    ForceAnimation(entity=3001895, animation_id=2, loop=False, wait_for_completion=False, skip_transition=False, unknown1=0, unknown2=1.0)
...
def Event13005899():
    ...
    PlayCutscene(30000010, skippable=True, fade_out=True, player_id=PLAYER, move_to_region=3002897, move_to_map=HIGH_WALL_OF_LOTHRIC)
    SkipLines(4)
    SkipLinesIfClientTypeCountComparison(2, client_type=ClientType.Invader, comparison_type=ComparisonType.Equal, value=0)
    PlayCutscene(30000010, skippable=False, fade_out=True, player_id=PLAYER, move_to_region=3002897, move_to_map=HIGH_WALL_OF_LOTHRIC)
    SkipLines(1)
    PlayCutscene(30000010, skippable=False, fade_out=False, player_id=PLAYER)
    DeleteObjectFX(3001360, erase_root=True)
    DeleteObjectFX(3001361, erase_root=True)
    DeleteObjectFX(3001362, erase_root=True)
    DeleteObjectFX(3001363, erase_root=True)
    WaitFrames(1)
    ForceAnimation(entity=3001895, animation_id=0, loop=False, wait_for_completion=False, skip_transition=False, unknown1=0, unknown2=1.0)
    EnableFlag(13005894)
    End()
...
@RestartOnRest
def Event13000901(ARG_0_3: int):
    """ 13000901: Event 13000901 """
    EndIfPlayerNotInOwnWorld()
    EndIfFlagOn(6079)
    DisableNetworkSync()
    CreateObjectFX(62, obj=ARG_0_3, model_point=90)
    IfActionButtonInRegion(0, action_button_id=4200, region=ARG_0_3)
...
@NeverRestart
def Event13005600(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int):
    """ 13005600: Event 13005600 """
    GotoIfPlayerNotInOwnWorld(Label.L9)
    SkipLinesIfFlagRangeAnyOn(2, (1435, 1439))
    SetNetworkConnectedFlagRangeState(flag_range=(1435, 1439), state=RangeState.AllOn)
    ...
    SetNetworkConnectedFlagRangeState(flag_range=(1420, 1434), state=RangeState.AllOn)
    ...
    ForceAnimation(entity=ARG_0_3, animation_id=20, loop=False, wait_for_completion=False, skip_transition=False, unknown1=0, unknown2=1.0)
    Move(ARG_0_3, destination=3002705, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    ...
    DisableGravity(ARG_0_3)
    DisableCollision(ARG_0_3)
    Move(ARG_0_3, destination=3002710, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    DisableObject(ARG_4_7)
    GotoIfFlagOn(Label.L10, 1438)
    ForceAnimation(entity=ARG_0_3, animation_id=30000, loop=False, wait_for_completion=False, skip_transition=False, unknown1=0, unknown2=1.0)
...
@NeverRestart
def Event13005602(ARG_0_3: int, ARG_4_7: int):
    """ 13005602: Event 13005602 """
    EndIfPlayerNotInOwnWorld()
    DisableFlag(ARG_4_7)
    IfFlagOn(0, ARG_4_7)
    ForceAnimation(entity=ARG_0_3, animation_id=20001, loop=False, wait_for_completion=False, skip_transition=False, unknown1=0, unknown2=1.0)


@NeverRestart
def Event13005603(ARG_0_3: int):
    """ 13005603: Event 13005603 """
    EndIfPlayerNotInOwnWorld()
    IfFlagOn(1, 1421)
    IfDamageType(1, attacked_character=ARG_0_3, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
    IfConditionTrue(0, input_condition=1)
    EnableFlag(73000182)
    ForceAnimation(entity=ARG_0_3, animation_id=20001, loop=False, wait_for_completion=False, skip_transition=False, unknown1=0, unknown2=1.0)
...
def Event13005620(ARG_0_3: int):
    ...
    ForceAnimation(entity=ARG_0_3, animation_id=90360, loop=False, wait_for_completion=False, skip_transition=True, unknown1=0, unknown2=1.0)
    End()
    Label(1)
