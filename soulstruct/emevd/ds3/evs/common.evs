...
def Event710():
    ...
    GotoIfInsideMap(Label.L1, IRITHYLL_DUNGEON)
    Goto(Label.L2)
    Label(0)
    Wait(3.0)
    EnableFlag(13700002)
    ...
    PlayCutsceneAndMovePlayer_WithSecondRegion(cutscene=37000030, cutscene_type=CutsceneType.Skippable, region=3002100, game_map=HIGH_WALL_OF_LOTHRIC, player_id=10000, other_region=3002890)
    SkipLines(1)
    PlayCutsceneAndMovePlayer_WithSecondRegion(cutscene=37000030, cutscene_type=CutsceneType.Skippable, region=3002890, game_map=HIGH_WALL_OF_LOTHRIC, player_id=10000, other_region=3002890)
    Goto(Label.L2)
    Label(1)
    ...
    PlayCutsceneAndMovePlayer_WithSecondRegion(cutscene=39000030, cutscene_type=CutsceneType.Skippable, region=3002100, game_map=HIGH_WALL_OF_LOTHRIC, player_id=10000, other_region=3002890)
    SkipLines(1)
    PlayCutsceneAndMovePlayer_WithSecondRegion(cutscene=39000030, cutscene_type=CutsceneType.Skippable, region=3002890, game_map=HIGH_WALL_OF_LOTHRIC, player_id=10000, other_region=3002890)
    Goto(Label.L2)
    Label(2)
    EnableFlag(711)
    WaitFrames(0)
...
def Event9540(ARG_0_1: ushort, ARG_4_7: int, ARG_8_11: int):
    ...
    IfEntityWithinDistance(1, 10000, 3800196, radius=20.0)
    IfHasAIStatus(2, character=3800198, ai_status=AIStatusType.Battle)
    IfEntityWithinDistance(2, 10000, 3800198, radius=20.0)
...
def Event9014():
    ...
    DisplayDialog(13007000, anchor_entity=10000, display_distance=0.0, button_type=ButtonType.OK_or_Cancel, number_buttons=NumberButtons.OneButton)
    End()
    Label(0)
    IfFlagOn(0, 9014)
    EnableFlag(9014)
...
@RestartOnRest
def Event9120(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: uint, ARG_16_16: uchar, ARG_20_23: uint, ARG_24_27: int):
    """ 9120: Event 9120 """
    EndIfPlayerNotInOwnWorld()
    EndIfFlagOn(ARG_4_7)
...
def Event840(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int):
    ...
    ForceAnimation(entity=10000, animation_id=ARG_4_7, loop=False, wait_for_completion=False, skip_transition=False, unknown1=0, unknown2=1.0)
    Wait(1.0)
    ...
    ForceAnimation(entity=10000, animation_id=ARG_12_15, loop=True, wait_for_completion=False, skip_transition=False, unknown1=0, unknown2=1.0)
    Restart()
