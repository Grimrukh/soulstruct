...
def Event12421802():
    ...
    EndIfFlagOn(12421800)
    GotoIfThisEventOff(Label.L0)
    Move(2420800, destination=2422800, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    ...
    IfThisEventOff(1)
    IfCharacterHuman(1, PLAYER)
    IfDamageType(1, attacked_character=2420800, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
    IfConditionTrue(0, input_condition=1)
...
def Event12424702():
    ...
    IfDamageType(-1, attacked_character=2420810, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
    IfDamageType(-1, attacked_character=2420711, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
    IfDamageType(-1, attacked_character=2420712, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
    IfDamageType(-1, attacked_character=2420713, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
    IfDamageType(-1, attacked_character=2420716, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
    IfDamageType(-1, attacked_character=2420717, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
    IfDamageType(-1, attacked_character=2420719, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
    IfDamageType(-1, attacked_character=2420720, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
    IfConditionTrue(0, input_condition=-1)
    EnableAI(2420810)
    EnableAI(2420711)
    EnableAI(2420712)
...
def Event12424790():
    ...
    WaitFrames(5)
    DisableCharacter(2420810)
    Move(2420811, destination=2420810, destination_type=MapEntityType.Character, model_point=203, copy_draw_hitbox=2420810)
...
def Event12424791():
    ...
    WaitFrames(135)
    Move(2420750, destination=2420811, destination_type=MapEntityType.Character, model_point=40, copy_draw_hitbox=2420811)
    Move(2420751, destination=2420811, destination_type=MapEntityType.Character, model_point=41, copy_draw_hitbox=2420811)
    Restart()
...
def Event12424795():
    ...
    IfDamageType(1, attacked_character=2420811, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
    IfConditionTrue(0, input_condition=1)
...
def Event12420310():
    ...
    Move(2420205, destination=2422205, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
...
def Event12420320():
    ...
    Move(2420200, destination=2422200, destination_type=MapEntityType.Region, model_point=-1, set_draw_hitbox=2420203)
    Move(2420201, destination=2422201, destination_type=MapEntityType.Region, model_point=-1, set_draw_hitbox=2420203)
    Move(2420202, destination=2422202, destination_type=MapEntityType.Region, model_point=-1, set_draw_hitbox=2420203)
...
def Event12420853():
    ...
    Wait(6.0)
    CreateFX(2427031)
    CreateTemporaryFX(920206, anchor_entity=2421204, anchor_type=MapEntityType.Object, model_point=200)
    CreateTemporaryFX(920207, anchor_entity=2421204, anchor_type=MapEntityType.Object, model_point=242)
    Wait(4.0)
    CreateFX(2427032)
    CreateFX(2427033)
...
def Event12425225():
    ...
    IfDamageType(-3, attacked_character=2420253, attacking_character=-1, damage_type=DamageType.Unspecified)
    IfConditionTrue(0, input_condition=-3)
...
def Event12425601():
    ...
    IfCharacterBackreadEnabled(1, 2420402)
    IfConditionTrue(0, input_condition=1)
    Move(2420731, destination=2420402, destination_type=MapEntityType.Character, model_point=40, short_move=True)
    Restart()
