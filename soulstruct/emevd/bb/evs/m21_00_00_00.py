...
def Event12100110():
    ...
    End()
    Label(1)
    Move(2100700, destination=2102301, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    ForceAnimation(2100700, 9009, loop=True)
    Goto(Label.L8)
    Label(2)
    EnableFlag(12100510)
    Move(2100700, destination=2102302, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    ...
    End()
    Move(2100700, destination=2102303, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    ForceAnimation(2100700, 9000, loop=True)
    Goto(Label.L8)
    Label(4)
    ...
    Move(2100700, destination=2102300, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    ...
    End()
    Label(9)
    Move(2100700, destination=2102304, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
...
def Event12100114():
    ...
    EndIfConditionFalse(15)
    IfFlagOn(0, 7500)
    CreateTemporaryFX(178, anchor_entity=10000, anchor_type=MapEntityType.Character, model_point=1)
    DisableFlag(7500)
    Restart()
...
def Event12100160():
    ...
    End()
    Label(1)
    Move(2100600, destination=2102310, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    End()
    Label(2)
    ForceAnimation(2100600, 9002, loop=True)
    Move(2100600, destination=2102312, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    End()
    Label(3)
    DisableCharacter(2100600)
...
def Event12100161():
    ...
    Move(2100600, destination=2102311, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    End()
    Label(0)
    SkipLinesIfFlagOn(2, 100)
...
def Event12104870():
    ...
    IfDamageType(-1, attacked_character=PLAYER, attacking_character=2100810, damage_type=DamageType.Unspecified)
...
def Event12105004(ARG_0_3: int, ARG_4_7: int):
    ...
    EndIfConditionFalse(15)
    IfFlagOn(0, ARG_4_7)
    Move(ARG_0_3, destination=2102305, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
...
def Event12105010():
    ...
    IfConditionTrue(0, input_condition=-1)
    WaitFrames(31)
    CreateTemporaryFX(350, anchor_entity=2100954, anchor_type=MapEntityType.Character, model_point=200)
    ...
    Label(9)
    CreateTemporaryFX(351, anchor_entity=2100954, anchor_type=MapEntityType.Character, model_point=200)
    Restart()
...
def Event12105011():
    ...
    IfConditionTrue(0, input_condition=-1)
    WaitFrames(31)
    CreateTemporaryFX(350, anchor_entity=2100955, anchor_type=MapEntityType.Character, model_point=200)
    GotoIfFinishedConditionTrue(Label.L0, input_condition=1)
    GotoIfFinishedConditionTrue(Label.L1, input_condition=2)
    GotoIfFinishedConditionTrue(Label.L2, input_condition=3)
    GotoIfFinishedConditionTrue(Label.L3, input_condition=4)
    ...
    Label(9)
    CreateTemporaryFX(351, anchor_entity=2100955, anchor_type=MapEntityType.Character, model_point=200)
    Restart()
...
def Event12105012():
    ...
    IfConditionTrue(0, input_condition=-1)
    WaitFrames(31)
    CreateTemporaryFX(350, anchor_entity=2100956, anchor_type=MapEntityType.Character, model_point=200)
    GotoIfFinishedConditionTrue(Label.L0, input_condition=1)
    GotoIfFinishedConditionTrue(Label.L1, input_condition=2)
    GotoIfFinishedConditionTrue(Label.L2, input_condition=3)
    GotoIfFinishedConditionTrue(Label.L3, input_condition=4)
    ...
    Label(9)
    CreateTemporaryFX(351, anchor_entity=2100956, anchor_type=MapEntityType.Character, model_point=200)
    Restart()
...
def Event12105013():
    ...
    IfConditionTrue(0, input_condition=-1)
    WaitFrames(31)
    CreateTemporaryFX(350, anchor_entity=2100957, anchor_type=MapEntityType.Character, model_point=200)
    GotoIfFinishedConditionTrue(Label.L0, input_condition=1)
    GotoIfFinishedConditionTrue(Label.L1, input_condition=2)
    GotoIfFinishedConditionTrue(Label.L2, input_condition=3)
    GotoIfFinishedConditionTrue(Label.L3, input_condition=4)
    ...
    Label(9)
    CreateTemporaryFX(351, anchor_entity=2100957, anchor_type=MapEntityType.Character, model_point=200)
    Restart()
...
def Event12105014():
    ...
    IfConditionTrue(0, input_condition=-1)
    WaitFrames(31)
    CreateTemporaryFX(350, anchor_entity=2100958, anchor_type=MapEntityType.Character, model_point=200)
    GotoIfFinishedConditionTrue(Label.L0, input_condition=1)
    GotoIfFinishedConditionTrue(Label.L1, input_condition=2)
    GotoIfFinishedConditionTrue(Label.L2, input_condition=3)
    GotoIfFinishedConditionTrue(Label.L3, input_condition=4)
    ...
    Label(9)
    CreateTemporaryFX(351, anchor_entity=2100958, anchor_type=MapEntityType.Character, model_point=200)
    Restart()
...
def Event12105015():
    ...
    IfConditionTrue(0, input_condition=-1)
    WaitFrames(31)
    CreateTemporaryFX(350, anchor_entity=2100959, anchor_type=MapEntityType.Character, model_point=200)
    GotoIfFinishedConditionTrue(Label.L0, input_condition=1)
    GotoIfFinishedConditionTrue(Label.L1, input_condition=2)
    GotoIfFinishedConditionTrue(Label.L2, input_condition=3)
    GotoIfFinishedConditionTrue(Label.L3, input_condition=4)
    ...
    Label(9)
    CreateTemporaryFX(351, anchor_entity=2100959, anchor_type=MapEntityType.Character, model_point=200)
    Restart()
...
def Event12105016():
    ...
    IfConditionTrue(0, input_condition=-1)
    WaitFrames(31)
    CreateTemporaryFX(350, anchor_entity=2100960, anchor_type=MapEntityType.Character, model_point=200)
    GotoIfFinishedConditionTrue(Label.L0, input_condition=1)
    GotoIfFinishedConditionTrue(Label.L1, input_condition=2)
    GotoIfFinishedConditionTrue(Label.L2, input_condition=3)
    GotoIfFinishedConditionTrue(Label.L3, input_condition=4)
    ...
    Label(9)
    CreateTemporaryFX(351, anchor_entity=2100960, anchor_type=MapEntityType.Character, model_point=200)
    Restart()
