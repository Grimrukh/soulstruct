...
def Event13601312():
    ...
    Move(PLAYER, destination=3601305, destination_type=MapEntityType.Object, model_point=192, short_move=True)
...
def Event13601802():
    ...
    Move(3600802, destination=3601802, destination_type=MapEntityType.Object, model_point=100, short_move=True)
...
def Event13604802():
    ...
    IfDamageType(-2, attacked_character=3600800, attacking_character=-1, damage_type=DamageType.Unspecified)
    IfConditionTrue(1, input_condition=-2)
    IfConditionTrue(0, input_condition=1)
    Label(5)
...
def Event13604820():
    ...
    SetNetworkUpdateRate(3600800, is_fixed=True, update_rate=CharacterUpdateRate.Never)
    SetNetworkUpdateRate(3600801, is_fixed=True, update_rate=CharacterUpdateRate.Always)
    Move(3600801, destination=3600800, destination_type=MapEntityType.Character, model_point=203, copy_draw_hitbox=3600800)
...
def Event13605752():
    ...
    IfDamageType(2, attacked_character=3600315, attacking_character=-1, damage_type=DamageType.Unspecified)
    IfConditionTrue(-2, input_condition=1)
    IfConditionTrue(-2, input_condition=2)
    IfConditionTrue(0, input_condition=-2)
...
def Event13605761():
    ...
    IfDamageType(3, attacked_character=3600303, attacking_character=-1, damage_type=DamageType.Unspecified)
    IfConditionTrue(-2, input_condition=1)
    IfConditionTrue(-2, input_condition=2)
    IfConditionTrue(-2, input_condition=3)
    IfConditionTrue(0, input_condition=-2)
...
def Event13605920(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int, ARG_24_27: int, ARG_28_31: int):
    ...
    IfConditionTrue(1, input_condition=-1)
    IfConditionTrue(0, input_condition=1)
    Move(ARG_0_3, destination=ARG_28_31, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    AICommand(ARG_0_3, command_id=-1, slot=0)
    ReplanAI(ARG_0_3)
...
def Event13605921(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int, ARG_24_27: int, ARG_28_31: int):
    ...
    IfConditionTrue(0, input_condition=1)
    SkipLinesIfFinishedConditionTrue(2, 3)
    Move(ARG_0_3, destination=ARG_28_31, destination_type=MapEntityType.Region, model_point=-1, set_draw_hitbox=3604027)
    SkipLines(1)
    Move(ARG_0_3, destination=3602917, destination_type=MapEntityType.Region, model_point=-1, set_draw_hitbox=3604027)
    AICommand(ARG_0_3, command_id=-1, slot=0)
    ReplanAI(ARG_0_3)
    DisableInvincibility(ARG_0_3)
    EnableAnimations(ARG_0_3)
