...
def Event12701802():
    ...
    EndIfFlagOn(12701800)
    GotoIfThisEventOff(Label.L0)
    Move(2700800, destination=2702236, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    Move(2700801, destination=2702235, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    Move(2700802, destination=2702234, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    DeleteFX(2703805, erase_root_only=True)
    End()
    Label(0)
...
def Event12704815(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int):
    ...
    Kill(ARG_0_3, award_souls=False)
    EnableCharacter(ARG_0_3)
    Move(ARG_0_3, destination=ARG_4_7, destination_type=MapEntityType.Character, model_point=ARG_8_11, set_draw_hitbox=ARG_4_7)
...
def Event12700180(ARG_0_3: int, ARG_4_7: int):
    ...
    IfConditionTrue(0, input_condition=1)
    Move(ARG_4_7, destination=ARG_0_3, destination_type=MapEntityType.Character, model_point=40, short_move=True)
    Restart()
...
def Event12700700():
    ...
    EnableBackread(2700755)
    EnableBackread(2700756)
    Move(2700755, destination=2702302, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    ForceAnimation(2700755, 103072)
    End()
    Label(3)
    DisableBackread(2700755)
...
def Event12700707():
    ...
    IfCharacterHuman(15, PLAYER)
    EndIfConditionFalse(15)
    IfDamageType(1, attacked_character=2700755, attacking_character=-1, damage_type=DamageType.Unspecified)
...
def Event12700722():
    ...
    WaitFrames(30)
    IfFlagOn(1, 1202)
    IfDamageType(-1, attacked_character=2700755, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
...
def Event12700723():
    ...
    IfConditionTrue(0, input_condition=1)
    WaitFrames(1)
    IfDamageType(2, attacked_character=2700755, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
    IfConditionTrue(0, input_condition=2)
    WaitFrames(1)
    IfDamageType(3, attacked_character=2700755, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
...
def Event12700910():
    ...
    Goto(Label.L1)
    Label(0)
    Move(2700930, destination=2702920, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    End()
    Label(1)
...
def Event12705201():
    ...
    IfDamageType(-1, attacked_character=2700135, attacking_character=-1, damage_type=DamageType.Unspecified)
    IfConditionTrue(0, input_condition=-1)
...
def Event12705300(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int):
    ...
    Move(ARG_4_7, destination=ARG_8_11, destination_type=MapEntityType.Object, model_point=200, short_move=True)
...
def Event12705360():
    ...
    IfDamageType(-1, attacked_character=2700514, attacking_character=-1, damage_type=DamageType.Unspecified)
    IfConditionTrue(0, input_condition=-1)
...
def Event12705370(ARG_0_3: int, ARG_4_7: float, ARG_8_11: int, ARG_12_15: int):
    ...
    Wait(ARG_4_7)
    Move(ARG_0_3, destination=ARG_12_15, destination_type=MapEntityType.Character, model_point=21, copy_draw_hitbox=ARG_12_15)
    WaitFrames(75)
...
def Event12705550():
    ...
    DisableCharacter(2700755)
    Move(2700756, destination=2700755, destination_type=MapEntityType.Character, model_point=245, copy_draw_hitbox=2700755)
