...
def Event12415460(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_19: float, ARG_20_23: int, ARG_24_27: int):
    ...
    WaitFrames(10)
    Move(ARG_0_3, destination=ARG_20_23, model_point=-1, destination_type=MapEntityType.Region)
    GotoIfThisEventSlotOff(Label.L0)
    End()
    Label(0)
    ForceAnimation(ARG_0_3, ARG_4_7, loop=True, skip_transition=True)
...
def Event12411702():
    ...
    IfConditionTrue(0, input_condition=1)
    Move(2410800, destination=2412831, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    EnableFlag(72410511)
...
def Event12411802():
    ...
    WaitFrames(1)
    DisableFlag(9180)
    Move(2410810, destination=2412830, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
...
def Event12414807():
    ...
    Move(2410811, destination=2410810, destination_type=MapEntityType.Character, model_point=203, copy_draw_hitbox=2410810)
...
def Event12415340(ARG_0_3: int, ARG_4_7: int, ARG_8_11: float, ARG_12_15: int):
    ...
    IfConditionTrue(-2, input_condition=3)
    IfConditionTrue(1, input_condition=-2)
    IfDamageType(4, attacked_character=ARG_0_3, attacking_character=-1, damage_type=DamageType.Unspecified)
    IfConditionTrue(-3, input_condition=1)
    IfConditionTrue(-3, input_condition=4)
    IfConditionTrue(0, input_condition=-3)
    GotoIfFinishedConditionTrue(Label.L1, input_condition=3)
...
def Event12415345(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_19: float, ARG_20_23: int, ARG_24_27: int):
    ...
    IfFlagOn(1, ARG_0_3)
    IfCharacterInsideRegion(2, ARG_4_7, region=ARG_8_11)
    IfDamageType(3, attacked_character=ARG_4_7, attacking_character=-1, damage_type=DamageType.Unspecified)
    IfCharacterHuman(-1, PLAYER)
    IfCharacterType(-1, PLAYER, CharacterType.WhitePhantom)
...
def Event12410645():
    ...
    EnableBackread(2410710)
    DisableBackread(2410711)
    Move(2410710, destination=2412172, destination_type=MapEntityType.Region, model_point=-1, set_draw_hitbox=0)
...
def Event12410659():
    ...
    Restart()
    Label(0)
    Move(2410710, destination=2412173, destination_type=MapEntityType.Region, model_point=-1, set_draw_hitbox=0)
...
def Event12410676():
    ...
    IfCharacterHuman(1, PLAYER)
    IfDamageType(1, attacked_character=2410703, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
    IfFlagOn(-1, 1141)
    IfFlagOn(-1, 1142)
    IfFlagOn(-1, 1144)
    IfConditionTrue(1, input_condition=-1)
...
def Event12410747():
    ...
    IfDamageType(-1, attacked_character=2410111, attacking_character=-1, damage_type=DamageType.Unspecified)
    IfConditionTrue(0, input_condition=-1)
    EnableAI(2410111)
...
def Event12410763():
    ...
    IfCharacterHuman(15, PLAYER)
    EndIfConditionFalse(15)
    IfDamageType(1, attacked_character=2410782, attacking_character=-1, damage_type=DamageType.Unspecified)
    IfFlagOn(-1, 1240)
    IfFlagOn(-1, 1241)
    IfFlagOn(-1, 1242)
    IfConditionTrue(1, input_condition=-1)
...
def Event12410800():
    ...
    Move(2410900, destination=2412334, destination_type=MapEntityType.Region, model_point=-1, set_draw_hitbox=2414124)
    SetNest(2410900, 2412334)
    SetTeamType(2410900, TeamType.HostileNPC)
    Goto(Label.L9)
    SkipLinesIfFlagOff(4, 1702)
    Move(2410900, destination=2412332, destination_type=MapEntityType.Region, model_point=-1, set_draw_hitbox=2414122)
...
def Event12410811():
    ...
    Move(2410900, destination=2412333, destination_type=MapEntityType.Region, model_point=-1, copy_draw_hitbox=2414123)
    SetNest(2410900, 2412334)
    SetTeamType(2410900, TeamType.CoopNPC)
    WaitFrames(2)
...
def Event12410830():
    ...
    Move(2410770, destination=2412281, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    End()
    Label(1)
    EnableBackread(2410770)
    EnableBackread(2410771)
...
def Event12414500():
    ...
    IfConditionTrue(0, input_condition=1)
    GotoIfFinishedConditionTrue(Label.L1, input_condition=3)
    Move(2410740, destination=2412720, destination_type=MapEntityType.Region, model_point=-1, set_draw_hitbox=0)
    Goto(Label.L2)
    Label(1)
    Move(2410740, destination=2412721, destination_type=MapEntityType.Region, model_point=-1, set_draw_hitbox=2414021)
    Label(2)
    Wait(5.0)
    EnableFlag(12414506)
...
def Event12414502():
    ...
    CreateTemporaryFX(121, anchor_entity=2410740, anchor_type=MapEntityType.Character, model_point=236)
    Wait(2.0)
    DisableCharacter(2410740)
...
def Event12414600():
    ...
    IfConditionTrue(0, input_condition=1)
    GotoIfFinishedConditionTrue(Label.L1, input_condition=3)
    Move(2410158, destination=2412702, destination_type=MapEntityType.Region, model_point=-1, set_draw_hitbox=2414020)
    Goto(Label.L2)
    Label(1)
    Move(2410158, destination=2412703, destination_type=MapEntityType.Region, model_point=-1, set_draw_hitbox=2414021)
    Label(2)
    Wait(5.0)
    EnableFlag(12414609)
    PlaySoundEffect(anchor_entity=10000, sound_type=SoundType.f_MenuEffect, sound_id=100000009)
...
def Event12410239(ARG_0_3: int):
    ...
    IfDamageType(4, attacked_character=ARG_0_3, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
    IfConditionTrue(0, input_condition=4)
    WaitFrames(5)
    Label(0)
...
def Event12410378(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int):
    ...
    EndOfAnimation(ARG_8_11, 2)
    Move(ARG_0_3, destination=ARG_12_15, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    End()
    DisableAI(ARG_0_3)
