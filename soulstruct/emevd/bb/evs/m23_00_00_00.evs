...
def Event12304502():
    ...
    CreateTemporaryFX(121, anchor_entity=2300740, anchor_type=MapEntityType.Character, model_point=236)
    Wait(2.0)
    DisableCharacter(2300740)
...
def Event12300100():
    ...
    Move(2300204, destination=2302300, destination_type=MapEntityType.Region, model_point=-1, set_draw_hitbox=2306000)
    ...
    IfDamageType(-3, attacked_character=2300204, attacking_character=-1, damage_type=DamageType.Unspecified)
    IfConditionTrue(0, input_condition=-3)
...
def Event12305000():
    ...
    IfDamageType(-2, attacked_character=2300250, attacking_character=-1, damage_type=DamageType.Unspecified)
    IfConditionTrue(0, input_condition=-2)
    Label(0)
    EnableAI(2300250)
    WaitFrames(1)
...
def Event12305040(ARG_0_3: int, ARG_4_7: int):
    ...
    EndIfThisEventSlotOn()
    IfDamageType(-1, attacked_character=ARG_0_3, attacking_character=-1, damage_type=DamageType.Fire)
    IfDamageType(-1, attacked_character=ARG_0_3, attacking_character=-1, damage_type=DamageType.NoType)
    IfConditionTrue(1, input_condition=-1)
    IfDamageType(-2, attacked_character=ARG_0_3, attacking_character=-1, damage_type=DamageType.Magic)
    IfDamageType(-2, attacked_character=ARG_0_3, attacking_character=-1, damage_type=DamageType.Lightning)
    IfDamageType(-2, attacked_character=ARG_0_3, attacking_character=-1, damage_type=DamageType.Blunt)
    IfDamageType(-2, attacked_character=ARG_0_3, attacking_character=-1, damage_type=DamageType.Slash)
    IfDamageType(-2, attacked_character=ARG_0_3, attacking_character=-1, damage_type=DamageType.Thrust)
    IfConditionTrue(2, input_condition=-2)
...
def Event12305070():
    ...
    IfConditionTrue(1, input_condition=-2)
    IfConditionTrue(-3, input_condition=1)
    IfDamageType(-3, attacked_character=2300520, attacking_character=-1, damage_type=DamageType.Unspecified)
    IfConditionTrue(0, input_condition=-3)
...
def Event12305080():
    ...
    IfConditionTrue(-3, input_condition=1)
    IfConditionTrue(-3, input_condition=2)
    IfDamageType(-3, attacked_character=2300314, attacking_character=-1, damage_type=DamageType.Unspecified)
    IfConditionTrue(0, input_condition=-3)
    EndIfFinishedConditionTrue(2)
    Label(0)
...
def Event12305130():
    ...
    IfConditionTrue(1, input_condition=-2)
    IfConditionTrue(-3, input_condition=1)
    IfDamageType(-3, attacked_character=2300203, attacking_character=-1, damage_type=DamageType.Unspecified)
    IfConditionTrue(0, input_condition=-3)
...
def Event12305480():
    ...
    IfConditionTrue(-3, input_condition=1)
    IfConditionTrue(-3, input_condition=2)
    IfDamageType(-3, attacked_character=2300406, attacking_character=-1, damage_type=DamageType.Unspecified)
    IfConditionTrue(0, input_condition=-3)
    EndIfFinishedConditionTrue(2)
    Label(0)
...
def Event12305481():
    ...
    IfDamageType(-2, attacked_character=2300406, attacking_character=-1, damage_type=DamageType.Unspecified)
    IfConditionTrue(0, input_condition=-2)
    Label(0)
...
def Event12300703():
    ...
    IfConditionTrue(1, input_condition=-1)
    IfFlagOn(1, 1320)
    IfDamageType(1, attacked_character=2300710, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
    IfConditionTrue(2, input_condition=-1)
    IfFlagOn(2, 1325)
    IfDamageType(2, attacked_character=2300710, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
    IfFlagOn(3, 1325)
