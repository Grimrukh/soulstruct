...
def Event7000(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int):
    ...
    CreateTemporaryFX(100330, anchor_entity=ARG_4_7, anchor_type=MapEntityType.Object, model_point=100)
    Label(0)
    EnableObject(ARG_4_7)
    EnableCharacter(ARG_0_3)
...
def Event7200(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int):
    ...
    Wait(1.0)
    CreateTemporaryFX(100320, anchor_entity=ARG_4_7, anchor_type=MapEntityType.Object, model_point=100)
    Wait(3.0)
...
def Event7300(ARG_0_3: int, ARG_4_7: int):
    ...
    IfFlagOn(0, ARG_0_3)
    WaitFrames(1)
    CreateTemporaryFX(100321, anchor_entity=ARG_4_7, anchor_type=MapEntityType.Object, model_point=100)
    InitializeWarpObject(ARG_4_7)
    DisableFlag(ARG_0_3)
...
def Event9215():
    ...
    PlaySoundEffect(anchor_entity=10000, sound_type=SoundType.s_SFX, sound_id=10307)
...
@NeverRestart
def Event9280(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int, ARG_20_20: uchar, ARG_21_21: uchar):
    """ 9280: Event 9280 """
...
def Event9770():
    """ 9770: Event 9770 """
    IfFlagOn(1, 1351)
    IfOutsideMap(1, game_map=CAINHURST)
    IfConditionTrue(0, input_condition=1)
    EnableFlag(72500359)
