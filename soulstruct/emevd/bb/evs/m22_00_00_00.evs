...
def Event12204811():
    ...
    IfDamageType(-1, attacked_character=2200800, attacking_character=-1, damage_type=DamageType.Unspecified)
    IfConditionTrue(0, input_condition=-1)
    Label(0)
...
def Event12204812(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int):
    ...
    Move(ARG_0_3, destination=ARG_8_11, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
...
def Event12200150(ARG_0_3: int, ARG_4_7: int):
    ...
    EndIfConditionFalse(1)
    Move(ARG_0_3, destination=ARG_4_7, destination_type=MapEntityType.Region, model_point=-1, set_draw_hitbox=0)
...
def Event12205003():
    ...
    IfConditionTrue(-2, input_condition=1)
    IfDamageType(-2, attacked_character=2200120, attacking_character=-1, damage_type=DamageType.Unspecified)
...
def Event12205050():
    ...
    IfDamageType(2, attacked_character=2200280, attacking_character=-1, damage_type=DamageType.Unspecified)
