...
@RestartOnRest
def Event12804500(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int, ARG_24_27: float):
...
def Event12805050():
    ...
    Move(2800563, destination=2802564, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
...
@RestartOnRest
def Event12805470(ARG_0_1: short, ARG_4_7: int, ARG_8_9: short, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int, ARG_24_27: int, ARG_28_31: int):
...
@RestartOnRest
def Event12805600(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int, ARG_24_27: int, ARG_28_31: int):
...
def Event12805920(ARG_0_3: int, ARG_4_7: int):
    ...
    ShootProjectile(owner_entity=2800560, projectile_id=ARG_0_3, model_point=100, behavior_id=6032, launch_angle_x=0, launch_angle_y=0, launch_angle_z=0)
    Wait(2.0)
    Restart()
...
def Event12805930(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int):
    ...
    IfConditionTrue(1, input_condition=-1)
    IfEntityWithinDistance(-2, 10000, ARG_8_11, radius=2.0)
...
def Event12800140():
    ...
    IfConditionTrue(0, input_condition=1)
    EnableFlag(13207850)
    DisplayDialog(10012014, anchor_entity=-1, display_distance=3.0, button_type=ButtonType.OK_or_Cancel, number_buttons=NumberButtons.OneButton)
...
def Event12800402():
    ...
    DisplayDialog(10010171, anchor_entity=2801300, display_distance=3.0, button_type=ButtonType.OK_or_Cancel, number_buttons=NumberButtons.OneButton)
    Restart()
...
def Event12800403():
    ...
    DisplayDialog(10010171, anchor_entity=2801150, display_distance=3.0, button_type=ButtonType.OK_or_Cancel, number_buttons=NumberButtons.OneButton)
    Restart()
...
def Event12800430():
    ...
    Move(PLAYER, destination=2801500, destination_type=MapEntityType.Object, model_point=220, short_move=True)
...
@NeverRestart
def Event12800600(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int, ARG_24_27: int):
...
def Event12804882():
    ...
    IfCharacterHuman(1, PLAYER)
    IfEntityWithinDistance(1, 10000, 2801800, radius=6.0)
    IfConditionTrue(0, input_condition=1)
...
def Event12804883():
    ...
    IfCharacterHuman(1, PLAYER)
    IfEntityBeyondDistance(1, 10000, 2801800, radius=6.0)
    IfEntityWithinDistance(1, 10000, 2801800, radius=12.0)
    IfConditionTrue(0, input_condition=1)
...
def Event12804804():
    ...
    IfEntityWithinDistance(1, 10000, 2800800, radius=12.0)
    IfConditionTrue(0, input_condition=1)
    SetLockedCameraSlot(game_map=YAHARGUL, camera_slot=1)
    IfHealthGreaterThan(2, 2800803, 0.0)
    IfEntityBeyondDistance(2, 10000, 2800800, radius=12.5)
    IfConditionTrue(0, input_condition=2)
    SetLockedCameraSlot(game_map=YAHARGUL, camera_slot=0)
    Restart()
...
def Event12804806():
    ...
    Wait(1.0)
    Label(0)
    Move(2800801, destination=2800800, destination_type=MapEntityType.Character, model_point=100, set_draw_hitbox=2800801)
    Restart()
...
@NeverRestart
def Event12804820(ARG_0_1: short, ARG_4_7: int, ARG_8_9: short, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int, ARG_24_27: int):
    """ 12804820: Event 12804820 """
    EndIfFlagOn(12801800)
    CreateNPCPart(2800800, npc_part_id=ARG_0_1, part_index=ARG_8_9, part_health=ARG_12_15, damage_correction=1.0, body_damage_correction=1.0, is_invincible=False, start_in_stop_state=False)
    ...
    Restart()
    CreateNPCPart(2800800, npc_part_id=ARG_0_1, part_index=ARG_8_9, part_health=9999999, damage_correction=1.0, body_damage_correction=1.5, is_invincible=False, start_in_stop_state=False)
...
def Event12804830():
    ...
    IfConditionTrue(0, input_condition=1)
    Move(2800802, destination=10000, destination_type=MapEntityType.Character, model_point=246, short_move=True)
...
def Event12804831():
    ...
    IfConditionTrue(0, input_condition=1)
    Move(2800802, destination=2800800, destination_type=MapEntityType.Character, model_point=100, short_move=True)
...
def Event12804832():
    ...
    Move(2800802, destination=2800800, destination_type=MapEntityType.Character, model_point=10, short_move=True)
...
def Event12804834():
    ...
    Move(2800802, destination=2800800, destination_type=MapEntityType.Character, model_point=15, short_move=True)
    AICommand(2800802, command_id=220, slot=0)
    ReplanAI(2800802)
    WaitFrames(1)
    AICommand(2800802, command_id=-1, slot=0)
...
def Event12804835():
    ...
    Move(2800802, destination=2800800, destination_type=MapEntityType.Character, model_point=50, short_move=True)
    AICommand(2800802, command_id=220, slot=0)
    ReplanAI(2800802)
    WaitFrames(1)
    AICommand(2800802, command_id=-1, slot=0)
...
def Event12804836():
    ...
    Move(2800802, destination=2800800, destination_type=MapEntityType.Character, model_point=55, short_move=True)
    AICommand(2800802, command_id=220, slot=0)
    ReplanAI(2800802)
    WaitFrames(1)
    AICommand(2800802, command_id=-1, slot=0)
...
def Event12800908():
    ...
    IfCharacterHuman(15, PLAYER)
    EndIfConditionFalse(15)
    IfDamageType(1, attacked_character=2800670, attacking_character=-1, damage_type=DamageType.Unspecified)
...
def Event12800911():
    ...
    EnableBackread(2800670)
    DisableBackread(2800671)
    Move(2800670, destination=2802452, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
...
@RestartOnRest
def Event12804410(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int, ARG_24_27: int, ARG_28_31: int):
...
@RestartOnRest
def Event12804460(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int, ARG_24_27: int):
