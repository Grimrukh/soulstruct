...
def Event12500015():
    ...
    EndIfClient()
    IfDamageType(0, attacked_character=2500600, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
...
def Event12500020():
    ...
    GotoIfConditionTrue(Label.L0, input_condition=1)
    DisplayDialog(10010150, anchor_entity=-1, display_distance=3.0, button_type=ButtonType.OK_or_Cancel, number_buttons=NumberButtons.OneButton)
    Restart()
    Label(0)
...
def Event12500030():
    ...
    IfInsideMap(0, game_map=CAINHURST)
...
def Event12500206(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int):
    ...
    IfDamageType(0, attacked_character=PLAYER, attacking_character=ARG_0_3, damage_type=DamageType.Unspecified)
    EnableFlag(ARG_4_7)
    EnableFlag(ARG_8_11)
...
def Event12500220(ARG_0_3: int, ARG_4_7: int):
    ...
    EnableFlag(ARG_4_7)
    Wait(1.0)
    IfDamageType(1, attacked_character=PLAYER, attacking_character=ARG_0_3, damage_type=DamageType.Unspecified)
...
def Event12500430(ARG_0_3: int, ARG_4_7: int):
    ...
    IfHasAIStatus(1, ARG_0_3, ai_status=AIStatusType.Battle)
    IfDamageType(2, attacked_character=ARG_4_7, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
    IfConditionTrue(-1, input_condition=1)
    IfConditionTrue(-1, input_condition=2)
    IfConditionTrue(0, input_condition=-1)
...
def Event12500440(ARG_0_3: int, ARG_4_7: int):
    ...
    IfHasAIStatus(1, ARG_0_3, ai_status=AIStatusType.Battle)
    IfEntityWithinDistance(1, ARG_0_3, 10000, radius=8.0)
    IfHasAIStatus(2, ARG_4_7, ai_status=AIStatusType.Battle)
    IfEntityWithinDistance(2, ARG_4_7, 10000, radius=8.0)
    IfConditionTrue(-1, input_condition=1)
    IfConditionTrue(-1, input_condition=2)
    IfConditionTrue(0, input_condition=-1)
...
@RestartOnRest
def Event12500454(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int, ARG_24_27: int, ARG_28_31: int):
...
def Event12500520(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: float, ARG_16_19: float):
    ...
    IfEntityWithinDistance(2, ARG_0_3, 10000, radius=ARG_16_19)
...
def Event101():
    """ 101: Event 101 """
    IfFlagOn(0, 100)
    EnableMapPart(2506001)
    IfFlagOff(0, 100)
    DisableMapPart(2506001)
    Restart()
...
def Event12500810():
    ...
    End()
    Label(0)
    DisableMapPart(2506000)
    DisableMapPart(2506001)
    DisableMapPart(2506002)
    DisableMapPart(2506003)
    DisableMapPart(2506004)
    DisableMapPart(2506005)
    DisableMapPart(2506006)
    DisableMapPart(2506007)
    DisableMapPart(2506008)
    DisableMapPart(2506009)
    DisableMapPart(2506010)
    DisableMapPart(2506011)
    DisableMapPart(2506012)
    DisableMapPart(2506013)
    DisableMapPart(2506014)
    DisableMapPart(2506015)
    DisableMapPart(2506016)
    DisableMapPart(2506017)
    DisableMapPart(2506070)
    DisableMapPart(2506071)
    DisableMapPart(2506072)
    DisableMapPart(2506073)
    ...
    DisableHitbox(2506037)
    DisableHitbox(2506038)
    ...
    WaitFrames(1)
    DisableFlag(9180)
    EnableMapPart(2506000)
    EnableMapPart(2506001)
    EnableMapPart(2506002)
    EnableMapPart(2506003)
    EnableMapPart(2506004)
    EnableMapPart(2506005)
    EnableMapPart(2506006)
    EnableMapPart(2506007)
    EnableMapPart(2506008)
    EnableMapPart(2506009)
    EnableMapPart(2506010)
    EnableMapPart(2506011)
    EnableMapPart(2506012)
    EnableMapPart(2506013)
    EnableMapPart(2506014)
    EnableMapPart(2506015)
    EnableMapPart(2506016)
    EnableMapPart(2506017)
    EnableMapPart(2506070)
    EnableMapPart(2506071)
    EnableMapPart(2506072)
    EnableMapPart(2506073)
    ...
    EnableHitbox(2506037)
    EnableHitbox(2506038)
...
def Event12501800():
    ...
    GotoIfThisEventOff(Label.L0)
    DisableMapSound(2503802)
    DisableMapSound(2503803)
    ...
    DisableObject(2501800)
    DeleteFX(2503800, erase_root_only=True)
    SetLockedCameraSlot(game_map=CAINHURST, camera_slot=0)
    Wait(3.0)
    KillBoss(2500800)
    DisableNetworkSync()
...
def Event12504810():
    ...
    CreateFX(2503800)
    Label(0)
    Move(2500800, destination=2502807, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
...
def Event12504812():
    ...
    IfCharacterHuman(1, PLAYER)
    IfEntityWithinDistance(1, 10000, 2501800, radius=2.0)
    IfConditionTrue(0, input_condition=1)
...
def Event12504813():
    ...
    IfCharacterHuman(1, PLAYER)
    IfEntityBeyondDistance(1, 10000, 2501800, radius=2.0)
    IfConditionTrue(0, input_condition=1)
...
def Event12504804():
    ...
    SetLockedCameraSlot(game_map=CAINHURST, camera_slot=1)
...
def Event12504806():
    ...
    Move(2500801, destination=2500800, destination_type=MapEntityType.Character, model_point=100, copy_draw_hitbox=2500800)
    EnableCharacter(2500801)
    Wait(1.0)
    EnableAI(2500801)
    IfDamageType(-1, attacked_character=2500801, attacking_character=-1, damage_type=DamageType.Unspecified)
    ...
    CreateTemporaryFX(623206, anchor_entity=2500801, anchor_type=MapEntityType.Character, model_point=100)
...
def Event12504807():
    ...
    ShootProjectile(owner_entity=2500802, projectile_id=2500800, model_point=6, behavior_id=223200590, launch_angle_x=0, launch_angle_y=0, launch_angle_z=0)
    Wait(1.0)
    Restart()
