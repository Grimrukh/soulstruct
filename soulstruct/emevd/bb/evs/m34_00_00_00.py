...
def Event13404825():
    ...
    SetNetworkUpdateRate(3400801, is_fixed=True, update_rate=CharacterUpdateRate.Always)
    SetNetworkUpdateRate(3400800, is_fixed=True, update_rate=CharacterUpdateRate.Never)
    Move(3400800, destination=3402900, model_point=-1, destination_type=MapEntityType.Region)
    Move(3400801, destination=3402806, destination_type=MapEntityType.Region, model_point=-1, copy_draw_hitbox=3400800)
...
def Event13404840():
    ...
    CreateTemporaryFX(645114, anchor_entity=10000, anchor_type=MapEntityType.Character, model_point=236)
    ...
    EnableCharacter(3400800)
    Move(3400800, destination=10000, destination_type=MapEntityType.Character, model_point=236, short_move=True)
...
def Event13404861():
    ...
    Move(3400850, destination=3402853, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    End()
    Label(0)
...
def Event13405103():
    ...
    IfConditionTrue(1, input_condition=-2)
    IfConditionTrue(-3, input_condition=1)
    IfDamageType(-3, attacked_character=3400551, attacking_character=-1, damage_type=DamageType.Unspecified)
    IfConditionTrue(0, input_condition=-3)
...
def Event13400941():
    ...
    Move(3400900, destination=3402911, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    Goto(Label.L9)
    Label(0)
    ...
    Move(3400900, destination=3402912, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    Goto(Label.L9)
    Label(1)
    ...
    Move(3400900, destination=3402913, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    Goto(Label.L9)
    Label(2)
    Move(3400900, destination=34029134, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    Goto(Label.L9)
    Label(9)
    DisableFlagRange((1670, 1689))
    EnableFlag(1681)
...
def Event13400942(ARG_0_3: int):
    ...
    IfConditionTrue(0, input_condition=-1)
    EnableCharacter(3400906)
    Move(3400906, destination=3400900, destination_type=MapEntityType.Character, model_point=10, short_move=True)
    WaitFrames(1)
    DropMandatoryTreasure(3400906)
    EndIfFlagOn(73400519)
    ForceAnimation(3400900, 7002, loop=True, skip_transition=True)
...
def Event13400930():
    ...
    IfDamageType(-1, attacked_character=3400910, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
    IfConditionTrue(0, input_condition=-1)
    EnableAI(3400910)
