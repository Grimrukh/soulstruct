...
def Preconstructor():
    ...
    DisableCollision(3200101)
    RunEvent(13200102)


@NeverRestart
def Event13200010(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int):
...
@NeverRestart
def Event13200020(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int):
    """ 13200020: Event 13200020 """
    DisableNetworkSync()
    EndIfFlagOn(ARG_12_15)
    IfActionButtonInRegion(1, action_button_id=ARG_0_3, region=ARG_8_11)
    IfActionButtonInRegion(2, action_button_id=ARG_4_7, region=ARG_8_11)
...
@NeverRestart
def Event13200030(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int):
    """ 13200030: Event 13200030 """
    DisableNetworkSync()
    IfFlagOn(1, ARG_12_15)
    IfActionButtonInRegion(1, action_button_id=ARG_4_7, region=ARG_0_3)
    IfConditionTrue(0, input_condition=1)
...
@NeverRestart
def Event13200040(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int):
...
@NeverRestart
def Event13200050(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int):
...
@NeverRestart
def Event13200055(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int):
...
@NeverRestart
def Event13200060(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int):
...
def Event13200102():
    ...
    Label(0)
    PostDestruction(3201300, slot=1)
    PostDestruction(3201301, slot=1)
    PostDestruction(3201302, slot=1)
    PostDestruction(3201303, slot=1)
    PostDestruction(3201304, slot=1)
    PostDestruction(3201305, slot=1)
    PostDestruction(3201306, slot=1)
    PostDestruction(3201307, slot=1)
    PostDestruction(3201308, slot=1)
    PostDestruction(3201309, slot=1)
    PostDestruction(3201310, slot=1)
    PostDestruction(3201311, slot=1)
    PostDestruction(3201312, slot=1)
    PostDestruction(3201313, slot=1)
    PostDestruction(3201314, slot=1)
    PostDestruction(3201315, slot=1)
    PostDestruction(3201316, slot=1)
    PostDestruction(3201317, slot=1)
    PostDestruction(3201318, slot=1)
    PostDestruction(3201319, slot=1)
    PostDestruction(3201320, slot=1)
    SetNest(3200101, 3202852)
    Move(3200101, destination=3202852, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    ...
    Move(3200101, destination=3202851, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
...
def Event13200103():
    ...
    IfFlagOn(1, 1420)
    IfFlagOn(1, 73200327)
    IfDamageType(2, attacked_character=3200101, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
    IfConditionTrue(-1, input_condition=1)
    IfConditionTrue(-1, input_condition=2)
    IfConditionTrue(0, input_condition=-1)
...
def Event13200106():
    ...
    EndIfConditionFalse(15)
    IfFlagOn(1, 13200101)
    IfEntityWithinDistance(1, 10000, 3200101, radius=5.0)
    IfConditionTrue(0, input_condition=1)
...
def Event13200108():
    ...
    IfAttacked(1, 3200101, attacking_character=10000)
    IfConditionTrue(0, input_condition=1)
...
@NeverRestart
def Event13200200(ARG_0_3: int, ARG_4_7: int):
...
def Event13200310():
    ...
    CreateTemporaryFX(932201, anchor_entity=3202001, anchor_type=MapEntityType.Region, model_point=-1)
    Wait(6.0)
    MovePlayerToRespawnPoint(2602959)
...
def Event13200311():
    ...
    CreateTemporaryFX(932201, anchor_entity=3202000, anchor_type=MapEntityType.Region, model_point=-1)
    Wait(6.0)
    MovePlayerToRespawnPoint(3302959)
...
def Event13200400():
    ...
    IfActionButtonInRegion(0, action_button_id=3200010, region=3201010)
...
def Event13201800():
    ...
    DeleteFX(3203800, erase_root_only=False)
    DisableHitbox(3204010)
    End()
    Label(0)
    IfCharacterDead(0, 3200800)
    DisplayBanner(BannerType.PreySlaughtered)
    DisableObject(3201800)
    DeleteFX(3203800, erase_root_only=True)
    DisableHitbox(3204010)
...
def Event13201802():
    ...
    IfThisEventOff(1)
    IfDamageType(1, attacked_character=3200800, attacking_character=-1, damage_type=DamageType.Unspecified)
    IfConditionTrue(0, input_condition=1)
    EnableFlag(13204800)
    EndIfFlagOn(9303)
    RunEvent(9350, slot=0, args=(2,))
...
def Event13201803():
    ...
    Move(3200801, destination=3202815, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    Goto(Label.L1)
    Move(3200801, destination=3202816, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    Goto(Label.L1)
    Move(3200801, destination=3202817, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    Goto(Label.L1)
    Move(3200801, destination=3202818, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    Label(1)
    ForceAnimation(3200801, 7001)
    IfCharacterHuman(8, PLAYER)
    IfEntityWithinDistance(8, 10000, 3200801, radius=12.0)
    ...
    DisableFlag(9180)
    EnableFlag(70002802)
    MovePlayerToRespawnPoint(2802958)
    End()
    Label(2)
    IfFlagOn(0, 6001)
    Wait(0.0)
...
@NeverRestart
def Event13204000(ARG_0_3: int, ARG_4_7: int):
    ...
    IfConditionTrue(0, input_condition=1)
    EnableAI(ARG_0_3)
    RotateToFaceEntity(ARG_0_3, 10000, animation=7000, wait_for_completion=True)
    EnableGravity(ARG_0_3)


@NeverRestart
def Event13204050(ARG_0_3: int, ARG_4_7: int):
...
@NeverRestart
def Event13204100(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int):
...
def Event13204830():
    ...
    CreateFX(3203800)
    EnableHitbox(3204010)
    Label(0)
    IfFlagOff(2, 13201800)
    IfCharacterHuman(2, PLAYER)
    IfActionButtonInRegion(2, action_button_id=3200800, region=3201800)
    IfFlagOn(3, 13201800)
    IfConditionTrue(-1, input_condition=2)
    IfConditionTrue(-1, input_condition=3)
    IfConditionTrue(0, input_condition=-1)
...
def Event13204831():
    ...
    IfActionButtonInRegion(1, action_button_id=3200800, region=3201800)
    IfConditionTrue(0, input_condition=1)
    RotateToFaceEntity(PLAYER, 3202800, animation=101130, wait_for_completion=False)
    IfCharacterType(2, PLAYER, CharacterType.WhitePhantom)
...
def Event13204832():
    ...
    IfCharacterHuman(1, PLAYER)
    IfEntityWithinDistance(1, 10000, 3201800, radius=2.0)
    IfConditionTrue(0, input_condition=1)
...
def Event13204833():
    ...
    IfCharacterHuman(1, PLAYER)
    IfEntityBeyondDistance(1, 10000, 3201800, radius=2.0)
    IfEntityWithinDistance(1, 10000, 3201800, radius=4.0)
    IfConditionTrue(0, input_condition=1)
...
def Event13204803():
    ...
    IfConditionTrue(0, input_condition=1)
    SetBossMusicState(3203802, state=True)
    ...
    IfCharacterInsideRegion(2, PLAYER, region=3202801)
    IfConditionTrue(0, input_condition=2)
    SetBossMusicState(3203802, state=False)
    WaitFrames(0)
    SetBossMusicState(3203803, state=True)
...
def Event13204804():
    ...
    IfEntityWithinDistance(1, 10000, 3200800, radius=4.0)
    IfConditionTrue(0, input_condition=1)
    SetLockedCameraSlot(game_map=BYRGENWERTH, camera_slot=1)
    IfHealthGreaterThan(2, 3200800, 0.0)
    IfEntityBeyondDistance(2, 10000, 3200800, radius=6.0)
    IfConditionTrue(0, input_condition=2)
    SetLockedCameraSlot(game_map=BYRGENWERTH, camera_slot=0)
    Restart()
...
def Event13204805():
    ...
    IfFlagOn(0, 13201800)
    SetBossMusicState(3203802, state=False)
    SetBossMusicState(3203803, state=False)
...
def Event13204807():
    ...
    DisableCharacter(3200800)
    Wait(3.0)
    Move(3200800, destination=3202806, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    ...
    DisableCharacter(3200800)
    Wait(3.0)
    Move(3200800, destination=3202807, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    EnableCharacter(3200800)
    ForceAnimation(3200800, 3021)
...
def Event13204808():
    ...
    EndIfFlagOn(13201800)
    CreateNPCPart(3200800, npc_part_id=3201, part_index=NPCPartType.Part2, part_health=100, damage_correction=1.0, body_damage_correction=1.0, is_invincible=False, start_in_stop_state=False)
    SetNPCPartEffects(3200800, npc_part_id=3201, material_special_effect_id=59, material_fx_id=59)
    ...
    SetNPCPartHealth(3200800, npc_part_id=3201, desired_hp=50, overwrite_max=True)
    ...
    SetNPCPartHealth(3200800, npc_part_id=3201, desired_hp=25, overwrite_max=True)
    ...
    CreateNPCPart(3200800, npc_part_id=3201, part_index=NPCPartType.Part2, part_health=9999, damage_correction=1.0, body_damage_correction=1.25, is_invincible=False, start_in_stop_state=False)
    SetNPCPartEffects(3200800, npc_part_id=3201, material_special_effect_id=60, material_fx_id=60)
    ReplanAI(3200800)
    IfTimeElapsed(0, 30.0)
    Label(0)
    SetNPCPartHealth(3200800, npc_part_id=3201, desired_hp=-1, overwrite_max=True)
    ReplanAI(2420800)
    WaitFrames(10)
    Restart()
...
def Event13204809():
    ...
    EndIfFlagOn(13201800)
    CreateNPCPart(3200800, npc_part_id=3202, part_index=NPCPartType.Part3, part_health=100, damage_correction=1.0, body_damage_correction=1.0, is_invincible=False, start_in_stop_state=False)
    SetNPCPartEffects(3200800, npc_part_id=3202, material_special_effect_id=59, material_fx_id=59)
    ...
    SetNPCPartHealth(3200800, npc_part_id=3202, desired_hp=50, overwrite_max=True)
    ...
    SetNPCPartHealth(3200800, npc_part_id=3202, desired_hp=25, overwrite_max=True)
    ...
    CreateNPCPart(3200800, npc_part_id=3202, part_index=NPCPartType.Part3, part_health=9999, damage_correction=1.0, body_damage_correction=1.2999999523162842, is_invincible=False, start_in_stop_state=False)
    SetNPCPartEffects(3200800, npc_part_id=3202, material_special_effect_id=60, material_fx_id=60)
    ReplanAI(3200800)
    IfTimeElapsed(0, 30.0)
    Label(0)
    SetNPCPartHealth(3200800, npc_part_id=3202, desired_hp=-1, overwrite_max=True)
    ReplanAI(2420800)
    WaitFrames(10)
    Restart()
...
def Event13204810():
    ...
    EndIfFlagOn(13201800)
    CreateNPCPart(3200800, npc_part_id=3200, part_index=NPCPartType.Part1, part_health=50, damage_correction=0.5, body_damage_correction=0.5, is_invincible=False, start_in_stop_state=False)
    SetNPCPartEffects(3200800, npc_part_id=3200, material_special_effect_id=61, material_fx_id=61)
...
def Event13204820():
    ...
    CreateTemporaryFX(932210, anchor_entity=10000, anchor_type=MapEntityType.Character, model_point=246)
    Label(0)
    Wait(5.0)
...
@RestartOnRest
def Event13205000(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: float, ARG_16_19: int):
...
@RestartOnRest
def Event13205040(ARG_0_3: int, ARG_4_7: int, ARG_8_11: float, ARG_12_15: float, ARG_16_19: int):
...
@RestartOnRest
def Event13205050(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int):
...
@RestartOnRest
def Event13205060(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int):
...
@RestartOnRest
def Event13205080(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int):
...
@RestartOnRest
def Event13205100(ARG_0_3: int, ARG_4_7: int):
    ...
    WaitFrames(59)
    RotateToFaceEntity(ARG_0_3, 10000, animation=3011, wait_for_completion=False)
...
def Event13205140(ARG_0_3: int, ARG_4_7: int):
    ...
    EndIfFinishedConditionTrue(-1)
    EndIfFinishedConditionTrue(2)
    RotateToFaceEntity(ARG_0_3, 10000, animation=3002, wait_for_completion=False)
...
def Event13205200():
    ...
    IfConditionTrue(0, input_condition=1)
    Move(3200621, destination=3200620, destination_type=MapEntityType.Character, model_point=90, copy_draw_hitbox=3200620)
...
@RestartOnRest
def Event13205300(ARG_0_3: int, ARG_4_5: short, ARG_8_11: int):
    """ 13205300: Event 13205300 """
    IfCharacterBackreadEnabled(0, ARG_0_3)
    CreateNPCPart(ARG_0_3, npc_part_id=ARG_4_5, part_index=NPCPartType.Part1, part_health=30, damage_correction=1.0, body_damage_correction=1.0, is_invincible=False, start_in_stop_state=False)
...
@NeverRestart
def Event13205600(ARG_0_1: short, ARG_4_7: int, ARG_8_9: short, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int, ARG_24_27: int, ARG_28_31: int):
...
@NeverRestart
def Event13205630(ARG_0_1: short, ARG_4_7: int, ARG_8_9: short, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int):
...
@NeverRestart
def Event13205660(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_16: uchar, ARG_17_17: uchar):
...
def Event13200960():
    ...
    IfCharacterHuman(1, PLAYER)
    GotoIfConditionFalse(Label.L0, input_condition=1)
    IfStandingOnHitbox(-1, 3204001)
    IfStandingOnHitbox(-1, 3204002)
    IfConditionTrue(0, input_condition=-1)
    AwardAchievement(13)
    End()
    Label(0)
...
@RestartOnRest
def Event13204450(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int):
...
@RestartOnRest
def Event13204400(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int):
...
@RestartOnRest
def Event13204401(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int):
...
@RestartOnRest
def Event13204402(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int):
...
@RestartOnRest
def Event13204410(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int, ARG_24_27: int, ARG_28_31: int):
...
@RestartOnRest
def Event13204460(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int, ARG_24_27: int):
