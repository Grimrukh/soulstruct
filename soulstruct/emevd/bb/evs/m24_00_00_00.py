...
def Event12400402():
    ...
    IfFlagOn(1, 72400440)
    IfConditionTrue(0, input_condition=1)
    Move(2400830, destination=2402033, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
...
def Event12400850(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int, ARG_20_23: float, ARG_24_27: int, ARG_28_31: int):
    ...
    Wait(ARG_20_23)
    CreateFX(ARG_0_3)
    CreateTemporaryFX(ARG_28_31, anchor_entity=ARG_24_27, anchor_type=MapEntityType.Region, model_point=-1)
    Wait(4.0)
    CreateFX(ARG_4_7)
    CreateFX(ARG_8_11)
...
def Event12400854():
    ...
    Wait(6.0)
    CreateFX(2406711)
    CreateTemporaryFX(920206, anchor_entity=2401204, anchor_type=MapEntityType.Object, model_point=200)
    CreateTemporaryFX(920207, anchor_entity=2401204, anchor_type=MapEntityType.Object, model_point=201)
    Wait(4.0)
    CreateFX(2406712)
    CreateFX(2406713)
...
def Event12405110(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int, ARG_24_27: int):
    ...
    CreateTemporaryFX(929208, anchor_entity=ARG_12_15, anchor_type=MapEntityType.Object, model_point=101)
...
def Event12405140():
    ...
    DisableAI(2400111)
    IfFlagOn(1, 12405681)
    IfDamageType(2, attacked_character=2400111, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
    IfCharacterHuman(-1, PLAYER)
    IfCharacterType(-1, PLAYER, CharacterType.WhitePhantom)
    IfConditionTrue(3, input_condition=-1)
...
def Event12405150(ARG_0_3: int, ARG_4_7: int):
    ...
    DisableBackread(ARG_0_3)
    Move(2400756, destination=2404507, model_point=-1, destination_type=MapEntityType.Region)
...
def Event12400500():
    ...
    Move(2400730, destination=2404501, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    End()
    Label(5)
    EnableBackread(2400730)
    DisableBackread(2400732)
    ...
    Move(2400732, destination=2404382, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
...
def Event12400507():
    ...
    IfCharacterHuman(15, PLAYER)
    EndIfConditionFalse(15)
    IfDamageType(1, attacked_character=2400730, attacking_character=-1, damage_type=DamageType.Unspecified)
...
def Event12400520():
    ...
    Move(2400750, destination=2404502, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    End()
    Label(2)
    EnableObject(2400748)
    DisableMapPart(2404601)
    ...
    Move(2400754, destination=2404504, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    End()
    Label(3)
    EnableObject(2400748)
    DisableMapPart(2404601)
    ...
    Move(2400757, destination=2404504, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    End()
    Label(4)
    EnableObject(2400748)
...
def Event12400560():
    ...
    Move(2400765, destination=2404500, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    End()
    Label(3)
    DisableBackread(2400765)
...
def Event12400570():
    ...
    IfCharacterHuman(15, PLAYER)
    EndIfConditionFalse(15)
    IfDamageType(1, attacked_character=2400765, attacking_character=-1, damage_type=DamageType.Unspecified)
...
def Event12400590():
    ...
    Move(2400762, destination=2404508, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
...
def Event12400627(ARG_0_3: int, ARG_4_7: int):
    ...
    IfConditionTrue(0, input_condition=1)
    WaitFrames(1)
    IfDamageType(2, attacked_character=ARG_0_3, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
    IfConditionTrue(0, input_condition=2)
    WaitFrames(1)
    IfDamageType(3, attacked_character=ARG_0_3, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
...
def Event12400663():
    ...
    IfFlagOn(-1, 1371)
    IfConditionTrue(1, input_condition=-1)
    IfDamageType(1, attacked_character=2400903, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
    IfConditionTrue(0, input_condition=1)
...
def Event12400732():
    ...
    IfDamageType(1, attacked_character=2400700, attacking_character=-1, damage_type=DamageType.Unspecified)
    IfFlagOn(1, 72400981)
    IfConditionTrue(0, input_condition=1)
    EnableFlag(1109)
...
def Event12400900():
    ...
    Move(2400770, destination=2404503, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    EndIfClient()
    EnableFlag(72400491)
    End()
    Label(4)
    ...
    Move(2400774, destination=2404503, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    End()
    Label(1)
    DisableBackread(2400770)
    ...
    Move(2400772, destination=2404503, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    End()
    Label(2)
    DisableBackread(2400770)
    DisableBackread(2400772)
    ...
    PostDestruction(2400773, slot=1)
    DisableAI(2400775)
    Move(2400775, destination=2404381, destination_type=MapEntityType.Region, model_point=-1, set_draw_hitbox=2404100)
    ...
    Move(2400770, destination=2404506, destination_type=MapEntityType.Region, model_point=-1, short_move=True)
    WaitFrames(1)
...
def Event12400904():
    ...
    IfConditionTrue(-1, input_condition=1)
    IfDamageType(-1, attacked_character=2400775, attacking_character=-1, damage_type=DamageType.Unspecified)
    IfConditionTrue(0, input_condition=-1)
    EnableFlag(72400397)
    EnableAI(2400775)
...
def Event12400800():
    ...
    IfCharacterHuman(15, PLAYER)
    EndIfConditionFalse(15)
    IfDamageType(1, attacked_character=2400765, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
    IfHealthEqual(1, 2400765, 0.0)
    IfDamageType(2, attacked_character=2400730, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
    IfHealthEqual(2, 2400730, 0.0)
    IfDamageType(3, attacked_character=2400750, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
    IfHealthEqual(3, 2400750, 0.0)
    IfDamageType(4, attacked_character=2400754, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
    IfHealthEqual(4, 2400754, 0.0)
    IfDamageType(5, attacked_character=2400757, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
    IfHealthEqual(5, 2400757, 0.0)
    IfDamageType(7, attacked_character=2400770, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
    IfHealthEqual(7, 2400770, 0.0)
    IfDamageType(8, attacked_character=2400772, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
    IfHealthEqual(8, 2400772, 0.0)
    IfDamageType(9, attacked_character=2400774, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
    IfHealthEqual(9, 2400774, 0.0)
    IfDamageType(13, attacked_character=2400700, attacking_character=PLAYER, damage_type=DamageType.Unspecified)
...
def Event12400840(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int):
    ...
    IfConditionTrue(0, input_condition=1)
    Move(PLAYER, destination=ARG_8_11, destination_type=MapEntityType.Object, model_point=210, short_move=True)
