...
def Constructor():
    ...
    RunEvent(13304830, slot=7, args=(3308, 3308, 3, 483, 200, 8030, 0.20000000298023224, 0.30000001192092896), arg_types='hihiiiff')
    RunEvent(13304830, slot=8, args=(3309, 3309, 11, 484, 100, 8040, 0.20000000298023224, 0.30000001192092896), arg_types='hihiiiff')
    RunEvent(13304830, slot=9, args=(3310, 3310, 12, 483, 100, 8030, 0.20000000298023224, 0.30000001192092896), arg_types='hihiiiff')
    RunEvent(13304840)
    RunEvent(13300100)
    RunEvent(13300110)
    RunEvent(13300111)
...
def Preconstructor():
    ...
    DisableCollision(3303950)
    DisableAnimations(3303951)
    DisableGravity(3303951)
    DisableCollision(3303951)


@RestartOnRest
def Event13304700(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int):
...
@RestartOnRest
def Event13304710(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int):
...
@RestartOnRest
def Event13304720(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int):
...
@RestartOnRest
def Event13304730(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int):
...
def Event13304872():
    ...
    IfCharacterHuman(1, PLAYER)
    IfEntityWithinDistance(1, 10000, 3301800, radius=4.0)
    IfConditionTrue(0, input_condition=1)
...
def Event13304873():
    ...
    IfCharacterHuman(1, PLAYER)
    IfEntityBeyondDistance(1, 10000, 3301800, radius=4.0)
    IfConditionTrue(0, input_condition=1)
...
def Event13304803():
    ...
    IfConditionTrue(0, input_condition=1)
    SetBossMusicState(3303802, state=True)
    ...
    IfConditionTrue(0, input_condition=2)
    SetBossMusicState(3303802, state=False)
    WaitFrames(0)
    SetBossMusicState(3303803, state=True)
...
def Event13304804():
    ...
    IfEntityWithinDistance(1, 10000, 3300800, radius=14.0)
    IfConditionTrue(0, input_condition=1)
    SetLockedCameraSlot(game_map=NIGHTMARE_FRONTIER, camera_slot=1)
    IfHealthGreaterThan(1, 3300800, 0.0)
    IfEntityBeyondDistance(0, 10000, 3300800, radius=17.0)
    IfConditionTrue(0, input_condition=1)
    SetLockedCameraSlot(game_map=NIGHTMARE_FRONTIER, camera_slot=0)
    Restart()
...
def Event13304805():
    ...
    IfFlagOn(0, 13301800)
    SetBossMusicState(3303802, state=False)
    SetBossMusicState(3303803, state=False)
...
@RestartOnRest
def Event13304820(ARG_0_1: short, ARG_4_7: int, ARG_8_9: short, ARG_10_10: uchar, ARG_11_11: uchar):
    """ 13304820: Event 13304820 """
    EndIfFlagOn(13301800)
    GotoIfThisEventOn(Label.L0)
    SetHitboxMask(3300800, bit_index=ARG_11_11, switch_type=OnOffChange.Off)
    Label(0)
    IfCharacterHasSpecialEffect(0, 3300800, 5402)
    SetHitboxMask(3300800, bit_index=ARG_10_10, switch_type=OnOffChange.Off)
    SetHitboxMask(3300800, bit_index=ARG_11_11, switch_type=OnOffChange.On)
    CreateNPCPart(3300800, npc_part_id=ARG_0_1, part_index=ARG_8_9, part_health=9999999, damage_correction=0.0, body_damage_correction=0.0, is_invincible=True, start_in_stop_state=False)
    SetNPCPartEffects(3300800, npc_part_id=ARG_4_7, material_special_effect_id=59, material_fx_id=59)


@RestartOnRest
def Event13304830(ARG_0_1: short, ARG_4_7: int, ARG_8_9: short, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int, ARG_24_27: float, ARG_28_31: float):
    """ 13304830: Event 13304830 """
    EndIfFlagOn(13301800)
    CreateNPCPart(3300800, npc_part_id=ARG_0_1, part_index=ARG_8_9, part_health=ARG_16_19, damage_correction=ARG_24_27, body_damage_correction=ARG_24_27, is_invincible=False, start_in_stop_state=False)
    SetNPCPartEffects(3300800, npc_part_id=ARG_4_7, material_special_effect_id=59, material_fx_id=59)
    ...
    CreateNPCPart(3300800, npc_part_id=ARG_0_1, part_index=ARG_8_9, part_health=9999999, damage_correction=1.0, body_damage_correction=ARG_28_31, is_invincible=False, start_in_stop_state=False)
...
def Event13304840():
    ...
    EndIfFlagOn(13301800)
    CreateNPCPart(3300800, npc_part_id=3300, part_index=NPCPartType.Part1, part_health=300, damage_correction=1.399999976158142, body_damage_correction=1.399999976158142, is_invincible=False, start_in_stop_state=False)
    ...
    IfConditionTrue(0, input_condition=-1)
    EndIfFinishedConditionTrue(3)
    CreateNPCPart(3300800, npc_part_id=3300, part_index=NPCPartType.Part1, part_health=9999999, damage_correction=1.0, body_damage_correction=2.0999999046325684, is_invincible=False, start_in_stop_state=False)
    SetNPCPartEffects(3300800, npc_part_id=3300, material_special_effect_id=60, material_fx_id=60)
    WaitFrames(1)
    ResetAnimation(3300800, disable_interpolation=False)
...
@RestartOnRest
def Event13300130(ARG_0_3: int, ARG_4_7: int):
...
def Event13300200():
    ...
    PlayCutscene(33000000, skippable=True, fade_out=False, player_id=PLAYER, move_to_region=3302171, move_to_map=NIGHTMARE_FRONTIER)
    SkipLines(1)
    PlayCutscene(33001000, skippable=True, fade_out=False, player_id=PLAYER, move_to_region=3302171, move_to_map=NIGHTMARE_FRONTIER)
    Goto(Label.L1)
    Label(0)
    GotoIfClient(Label.L2)
    SkipLinesIfPlayerGender(2, Gender.Female)
    PlayCutscene(33000000, skippable=False, fade_out=False, player_id=PLAYER, move_to_region=3302171, move_to_map=NIGHTMARE_FRONTIER)
    SkipLines(1)
    PlayCutscene(33001000, skippable=False, fade_out=False, player_id=PLAYER, move_to_region=3302171, move_to_map=NIGHTMARE_FRONTIER)
    Goto(Label.L1)
    Label(2)
    SkipLinesIfPlayerGender(2, Gender.Female)
...
@RestartOnRest
def Event13305150(ARG_0_3: int, ARG_4_7: int, ARG_8_11: float, ARG_12_15: int):
    ...
    IfConditionTrue(1, input_condition=-1)
    IfConditionTrue(1, input_condition=-2)
    IfDamageType(3, attacked_character=ARG_0_3, attacking_character=-1, damage_type=DamageType.Unspecified)
...
@RestartOnRest
def Event13305030(ARG_0_3: int, ARG_4_7: int):
...
@RestartOnRest
def Event13305200(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: float, ARG_16_19: int):
    """ 13305200: Event 13305200 """
    GotoIfThisEventSlotOn(Label.L0)
    IfCharacterHuman(-1, PLAYER)
    IfCharacterType(-1, PLAYER, CharacterType.WhitePhantom)
    IfConditionTrue(1, input_condition=-1)
    IfEntityWithinDistance(1, 10000, ARG_8_11, radius=ARG_12_15)
...
@RestartOnRest
def Event13305210(ARG_0_3: int, ARG_4_7: float, ARG_8_11: int, ARG_12_15: int, ARG_16_19: float, ARG_20_23: int):
    ...
    IfConditionTrue(-3, input_condition=1)
    IfDamageType(-3, attacked_character=ARG_0_3, attacking_character=-1, damage_type=DamageType.Unspecified)
    IfHasAIStatus(-3, ARG_0_3, ai_status=AIStatusType.Recognition)
    IfHasAIStatus(-3, ARG_0_3, ai_status=AIStatusType.Alert)
...
def Event13305230():
    ...
    IfEntityWithinDistance(-1, 3300104, 10000, radius=5.0)
...
@RestartOnRest
def Event13305250(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int):
...
@RestartOnRest
def Event13305255(ARG_0_3: int, ARG_4_7: int):
...
def Event13300700():
    ...
    IfDamageType(0, attacked_character=3300710, attacking_character=-1, damage_type=DamageType.Unspecified)
    ForceAnimation(3300710, 7006)
    WaitFrames(45)
    Move(3300710, destination=3302160, destination_type=MapEntityType.Region, model_point=-1, copy_draw_hitbox=0)
    WaitFrames(1)
    DropMandatoryTreasure(3300710)
