...
def decompile_instruction(instruction_class, instruction_index, req_args, game_module):
    ...
    if instruction_class == 3:
        ...
        if instruction_index == 23:
            condition, attacked_character, attacking_character, damage_type = req_args
            if attacked_character == 10000:
                attacked_character = 'PLAYER'
            if attacking_character == 10000:
                attacking_character = 'PLAYER'
            return (f"IfDamageType({condition}, attacked_character={attacked_character}, "
