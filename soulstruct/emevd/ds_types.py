...
class Flag(IntEnum):
    ...
    def __call__(self, negate=False, condition=None, skip_lines=0, end_event=False, restart_event=False):
        ...
        return _get_value_condition(
            ...
            skip_if_true_func=p.skip_if_event_flag_on, skip_if_false_func=p.skip_if_event_flag_off,
            if_true_func=p.if_event_flag_on, if_false_func=p.if_event_flag_off,
            end_if_true_func=p.end_if_event_flag_on, end_if_false_func=p.end_if_event_flag_off,
            restart_if_true_func=p.restart_if_event_flag_on, restart_if_false_func=p.restart_if_event_flag_off)
...
class Region(MapEntity):
    ...
    def __call__(self, negate=False, condition=None, skip_lines=0):
        ...
        return _get_value_condition(
            value=value, negate=negate, condition=condition, skip_lines=skip_lines,
            if_true_func=p.if_player_inside_region, if_false_func=p.if_player_outside_region)

    @property
    def category(self):
        return p.Category.region
...
class Object(MapEntity):
    ...
    def __call__(self, negate=False, condition=None, skip_lines=0, end_event=False, restart_event=False):
        ...
        return _get_value_condition(
            value=value, negate=negate, condition=condition, skip_lines=skip_lines,
            end_event=end_event, restart_event=restart_event,
            skip_if_true_func=p.skip_if_object_not_destroyed, skip_if_false_func=p.skip_if_object_destroyed,
            if_true_func=p.if_object_not_destroyed, if_false_func=p.if_object_destroyed,
            end_if_true_func=p.end_if_object_not_destroyed, end_if_false_func=p.end_if_object_destroyed,
            restart_if_true_func=p.restart_if_object_not_destroyed, restart_if_false_func=p.restart_if_object_destroyed)

    @property
    def category(self):
        return p.Category.object
...
class Character(MapEntity):
    ...
    def __call__(self, negate=False, condition=None, skip_lines=0):
        ...
        return _get_value_condition(
            ...
            if_true_func=p.if_entity_alive, if_false_func=p.if_entity_dead)

    @property
    def category(self):
        return p.Category.character
...
class Weapon(Item):
    def __call__(self, negate=False, condition=None):
        ...
        return _get_value_condition(
            ...
            if_true_func=p.if_player_has_weapon,
            if_false_func=p.if_player_does_not_have_weapon)

    @staticmethod
    def get_type():
        return p.ItemType.weapon
...
class Armor(Item):
    def __call__(self, negate=False, condition=None):
        ...
        return _get_value_condition(
            value=value, negate=negate, condition=condition,
            if_true_func=p.if_player_has_armor,
            if_false_func=p.if_player_does_not_have_armor)

    @staticmethod
    def get_type():
        return p.ItemType.armor
...
class Ring(Item):
    def __call__(self, negate=False, condition=None):
        ...
        return _get_value_condition(
            value=value, negate=negate, condition=condition,
            if_true_func=p.if_player_has_ring,
            if_false_func=p.if_player_does_not_have_ring)

    @staticmethod
    def get_type():
        return p.ItemType.ring
...
class Good(Item):
    def __call__(self, negate=False, condition=None):
        ...
        return _get_value_condition(
            value=value, negate=negate, condition=condition,
            if_true_func=p.if_player_has_good,
            if_false_func=p.if_player_does_not_have_good)

    @staticmethod
    def get_type():
        return p.ItemType.good
...
class FlagRange(object):
    ...
    def any(self, negate=False, condition=None, skip_lines=0, end_event=False, restart_event=False):
        return _get_value_condition(
            ...
            end_event=end_event, restart_event=restart_event,
            skip_if_true_func=p.skip_if_event_flag_range_not_all_off, skip_if_false_func=p.skip_if_event_flag_range_all_off,
            if_true_func=p.if_event_flag_range_not_all_off, if_false_func=p.if_event_flag_range_all_off,
            end_if_true_func=p.end_if_event_flag_range_not_all_off, end_if_false_func=p.end_if_event_flag_range_all_off,
            restart_if_true_func=p.restart_if_event_flag_range_not_all_off,
            restart_if_false_func=p.restart_if_event_flag_range_all_off,
        )
    ...
    def all(self, negate=False, condition=None, skip_lines=0, end_event=False, restart_event=False):
        return _get_value_condition(
            value=self, negate=negate, condition=condition, skip_lines=skip_lines,
            end_event=end_event, restart_event=restart_event,
            skip_if_true_func=p.skip_if_event_flag_range_all_on, skip_if_false_func=p.skip_if_event_flag_range_not_all_on,
            if_true_func=p.if_event_flag_range_all_on, if_false_func=p.if_event_flag_range_not_all_on,
            end_if_true_func=p.end_if_event_flag_range_all_on, end_if_false_func=p.end_if_event_flag_range_not_all_on,
            restart_if_true_func=p.restart_if_event_flag_range_all_on,
            restart_if_false_func=p.restart_if_event_flag_range_not_all_on,
        )
