...
def Event13205310():
    ...
    Move(3200300, destination=3202310, destination_type=CoordEntityType.Region, model_point=-1, copy_draw_hitbox=3200300)
    ...
    SetNetworkConnectedFlagState(flag=13205398, state=FlagState.Off)
    SkipLines(1)
    Move(3200300, destination=3202312, destination_type=CoordEntityType.Region, model_point=-1, copy_draw_hitbox=3200300)
    End()
    Label(9)
...
def Event13205320():
    ...
    Move(3200300, destination=3202311, destination_type=CoordEntityType.Region, model_point=-1, copy_draw_hitbox=3200300)
...
def Event13205330():
    ...
    SetNetworkConnectedFlagState(flag=13205398, state=FlagState.Off)
    SkipLines(1)
    Move(3200300, destination=3202313, destination_type=CoordEntityType.Region, model_point=-1, copy_draw_hitbox=3200300)
    End()
    Label(1)
...
def Event13205370(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int, ARG_24_27: int, ARG_28_31: int):
    ...
    Move(ARG_0_3, destination=ARG_12_15, destination_type=CoordEntityType.Region, model_point=-1, copy_draw_hitbox=ARG_24_27)
    ...
    Move(ARG_0_3, destination=ARG_16_19, destination_type=CoordEntityType.Region, model_point=-1, copy_draw_hitbox=ARG_24_27)
    AddSpecialEffect(ARG_24_27, 11292)
    Label(2)
...
def Event13205375(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int):
    ...
    ForceAnimation(entity=ARG_0_3, animation_id=63010, loop=False, wait_for_completion=False, skip_transition=False, unknown1=0, unknown2=1.0)
    CreateTemporaryFX(30300, anchor_entity=ARG_12_15, anchor_type=CoordEntityType.Region, model_point=-1)
    Move(ARG_0_3, destination=ARG_12_15, destination_type=CoordEntityType.Region, model_point=-1, copy_draw_hitbox=ARG_16_19)
...
def Event13205810():
    ...
    DisableCharacter(3200800)
    DisableAI(3200800)
    Move(3200800, destination=3202802, destination_type=CoordEntityType.Region, model_point=-1, copy_draw_hitbox=3200800)
    IfFlagOn(1, 13205805)
