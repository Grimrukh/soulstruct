...
def Event11815390():
    ...
    IfFlagOff(1, 16)
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1812998, anchor_type=CoordEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True, line_intersects=1811990)
    IfConditionTrue(0, input_condition=1)
...
def Event11810313():
    ...
    IfFlagOn(1, 11810312)
    IfFlagOn(1, 61810105)
    IfDialogPromptActivated(1, prompt_text=10010400, anchor_entity=1811111, anchor_type=CoordEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=100, human_or_hollow_only=True)
    IfConditionTrue(0, input_condition=1)
...
def Event11815380():
    ...
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1812898, anchor_type=CoordEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True, line_intersects=0, boss_version=True)
    IfConditionTrue(0, input_condition=1)
    SkipLinesIfClient(1)
    NotifyBossBattleStart()
...
def Event11810150():
    ...
    IfDialogPromptActivated(0, prompt_text=10010506, anchor_entity=1812001, anchor_type=CoordEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=False)
    ...
    AwardAchievement(28)
    Restart()
    IfDialogPromptActivated(1, prompt_text=10010507, anchor_entity=1812001, anchor_type=CoordEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=False)
