...
def Preconstructor():
    ...
    SkipLines(1)
    Move(6001, destination=1012530, destination_type=CoordEntityType.Region, model_point=-1, set_draw_hitbox=1013050)
...
def Event11015390():
    ...
    IfFlagOff(1, 3)
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1012998, anchor_type=CoordEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True, line_intersects=1011990, boss_version=True)
    IfConditionTrue(0, input_condition=1)
...
def Event11015391():
    ...
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1012998, anchor_type=CoordEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=False, line_intersects=1011990)
    IfConditionTrue(0, input_condition=1)
    RotateToFaceEntity(PLAYER, 1012997)
    ForceAnimation(PLAYER, 7410)
    Restart()
...
def Event11015397(ARG_0_3: int, ARG_4_5: short, ARG_8_11: int, ARG_12_15: int):
    ...
    Move(ARG_12_15, destination=ARG_0_3, destination_type=CoordEntityType.Character, model_point=130, copy_draw_hitbox=ARG_0_3)
...
def Event11015380():
    ...
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1012898, anchor_type=CoordEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True, line_intersects=1011890, boss_version=True)
    IfConditionTrue(0, input_condition=1)
...
def Event11015381():
    ...
    IfFlagOn(1, 11015383)
    IfCharacterType(1, PLAYER, CharacterType.WhitePhantom)
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1012898, anchor_type=CoordEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=False, line_intersects=1011890)
    IfConditionTrue(0, input_condition=1)
    RotateToFaceEntity(PLAYER, 1012897)
    ForceAnimation(PLAYER, 7410)
    Restart()
...
def Event11015370():
    ...
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1012888, anchor_type=CoordEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True, line_intersects=1011790, boss_version=True)
    IfConditionTrue(0, input_condition=1)
...
def Event11015371():
    ...
    IfFlagOn(1, 11015373)
    IfCharacterType(1, PLAYER, CharacterType.WhitePhantom)
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1012888, anchor_type=CoordEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=False, line_intersects=1011790)
    IfConditionTrue(0, input_condition=1)
    RotateToFaceEntity(PLAYER, 1012887)
    ForceAnimation(PLAYER, 7410)
    Restart()
...
def Event11010101(ARG_0_3: int, ARG_4_7: int, ARG_8_9: short, ARG_12_15: int, ARG_16_19: int):
    ...
    End()
    IfDialogPromptActivated(0, prompt_text=10010400, anchor_entity=ARG_0_3, anchor_type=CoordEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=ARG_8_9, human_or_hollow_only=False)
...
def Event11010102(ARG_0_3: int, ARG_4_7: int, ARG_8_9: short):
    ...
    DisableNetworkSync()
    IfFlagOn(-1, ARG_0_3)
    IfDialogPromptActivated(-1, prompt_text=10010400, anchor_entity=ARG_4_7, anchor_type=CoordEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=ARG_8_9, human_or_hollow_only=False)
    IfConditionTrue(0, input_condition=-1)
    EndIfFlagOn(ARG_0_3)
...
def Event11010100():
    ...
    End()
    IfDialogPromptActivated(0, prompt_text=10010500, anchor_entity=1011149, anchor_type=CoordEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=194, human_or_hollow_only=False)
    EnableFlag(11010100)
...
def Event11010899():
    ...
    Move(1010300, destination=1012310, destination_type=CoordEntityType.Region, model_point=-1, set_draw_hitbox=1013211)
...
def Event11015301():
    ...
    SetDisplayMask(1010300, bit_index=0, switch_type=OnOffChange.On)
    SetHitboxMask(1010300, bit_index=1, switch_type=OnOffChange.Off)
    Move(1010301, destination=1010300, destination_type=CoordEntityType.Character, model_point=66, copy_draw_hitbox=1010300)
...
def Event11010782():
    ...
    DisableCharacter(1010300)
    Move(1010300, destination=1012310, destination_type=CoordEntityType.Region, model_point=-1, set_draw_hitbox=1013210)
...
def Event11010531(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int):
    ...
    DisableFlagRange((ARG_4_7, ARG_8_11))
    EnableFlag(ARG_12_15)
    Move(ARG_0_3, destination=1012530, destination_type=CoordEntityType.Region, model_point=-1, set_draw_hitbox=1013050)
