...
def Preconstructor():
    ...
    SkipLines(1)
    Move(6280, destination=1502510, destination_type=CoordEntityType.Region, model_point=-1, set_draw_hitbox=1503300)
...
def Event11505390():
    ...
    IfFlagOff(1, 11)
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1502998, anchor_type=CoordEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True, line_intersects=1501990, boss_version=True)
    IfConditionTrue(0, input_condition=1)
...
def Event11505391():
    ...
    IfDialogPromptActivated(1, prompt_text=10010403, anchor_entity=1502998, anchor_type=CoordEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=False, line_intersects=1501990)
    IfConditionTrue(0, input_condition=1)
    RotateToFaceEntity(PLAYER, 1502997)
    ForceAnimation(PLAYER, 7410)
    Restart()
...
def Event11500850():
    ...
    IfDialogPromptActivated(1, prompt_text=10010502, anchor_entity=1501790, anchor_type=CoordEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=104, human_or_hollow_only=False)
    IfFlagOff(2, 11505250)
    IfDialogPromptActivated(2, prompt_text=10010502, anchor_entity=1501790, anchor_type=CoordEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=102, human_or_hollow_only=False)
    IfConditionTrue(-1, input_condition=1)
    IfConditionTrue(-1, input_condition=2)
    IfConditionTrue(0, input_condition=-1)
...
def Event11500102():
    ...
    IfDialogPromptActivated(1, prompt_text=10010400, anchor_entity=1501011, anchor_type=CoordEntityType.Object, facing_angle=60.0, max_distance=2.0, model_point=105, human_or_hollow_only=True)
    IfConditionTrue(0, input_condition=1)
...
def Event11500103():
    ...
    IfDialogPromptActivated(1, prompt_text=10010400, anchor_entity=1501011, anchor_type=CoordEntityType.Object, facing_angle=60.0, max_distance=2.0, model_point=105, human_or_hollow_only=False)
    IfConditionTrue(0, input_condition=1)
...
def Event11500106():
    ...
    IfDialogPromptActivated(1, prompt_text=10010400, anchor_entity=1501001, anchor_type=CoordEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=101, human_or_hollow_only=False)
    IfConditionTrue(0, input_condition=1)
...
def Event11500107():
    ...
    End()
    IfFlagOff(1, 11500105)
    IfDialogPromptActivated(1, prompt_text=10010400, anchor_entity=1501001, anchor_type=CoordEntityType.Object, facing_angle=60.0, max_distance=1.5, model_point=100, human_or_hollow_only=False)
    IfConditionTrue(0, input_condition=1)
    EnableFlag(11500105)
...
def Event11505010():
    ...
    IfDialogPromptActivated(1, prompt_text=10010400, anchor_entity=1500010, anchor_type=CoordEntityType.Character, facing_angle=45.0, max_distance=1.2000000476837158, model_point=7, human_or_hollow_only=False)
    IfConditionTrue(0, input_condition=1)
    Move(PLAYER, destination=1500010, destination_type=CoordEntityType.Character, model_point=100, copy_draw_hitbox=1500010)
...
def Event11500210():
    ...
    IfTimeElapsed(0, 5.0)
    IfFlagOn(0, 11)
    IfDialogPromptActivated(0, prompt_text=10010120, anchor_entity=1502505, anchor_type=CoordEntityType.Region, facing_angle=0.0, max_distance=0.0, human_or_hollow_only=True)
...
def Event11500534(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int):
    ...
    DisableFlagRange((ARG_4_7, ARG_8_11))
    EnableFlag(ARG_12_15)
    Move(ARG_0_3, destination=1502510, destination_type=CoordEntityType.Region, model_point=-1, set_draw_hitbox=1503300)
