...
def Event11215006(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int):
    ...
    Move(ARG_0_3, destination=ARG_4_7, destination_type=CoordEntityType.Character, model_point=150, copy_draw_hitbox=ARG_4_7)
...
def Event11215009():
    ...
    Move(1210801, destination=1212007, destination_type=CoordEntityType.Region, model_point=-1, copy_draw_hitbox=1210800)
    Move(1210802, destination=1212008, destination_type=CoordEntityType.Region, model_point=-1, copy_draw_hitbox=1210800)
    SetNest(1210801, 1212007)
    SetNest(1210802, 1212008)
    IfCharacterInsideRegion(0, PLAYER, region=1212009)
    Move(1210801, destination=1212010, destination_type=CoordEntityType.Region, model_point=-1, copy_draw_hitbox=1210800)
    Move(1210802, destination=1212011, destination_type=CoordEntityType.Region, model_point=-1, copy_draw_hitbox=1210800)
    SetNest(1210801, 1212010)
    SetNest(1210802, 1212011)
    Restart()
...
def Event11210340():
    ...
    Move(6760, destination=1212331, destination_type=CoordEntityType.Region, model_point=-1, copy_draw_hitbox=6760)
    End()
    IfHost(1)
...
def Event11210341():
    ...
    Move(6760, destination=1212332, destination_type=CoordEntityType.Region, model_point=-1, copy_draw_hitbox=6760)
    End()
    IfHost(1)
    IfFlagOn(1, 11210340)
...
def Event11210150():
    ...
    Move(1210350, destination=1212143, destination_type=CoordEntityType.Region, model_point=-1, set_draw_hitbox=1213040)
    Move(1210350, destination=1212150, destination_type=CoordEntityType.Region, model_point=-1, set_draw_hitbox=1213040)
...
def Event11210050():
    ...
    Move(1210400, destination=1212051, destination_type=CoordEntityType.Region, model_point=-1, set_draw_hitbox=1213000)
...
def Event11215051():
    ...
    EnableFlag(11215054)
    Restart()
    Move(1210410, destination=1210401, destination_type=CoordEntityType.Character, model_point=150, copy_draw_hitbox=1210401)
...
def Event11210540():
    ...
    DisableFlag(1127)
    EnableFlag(1128)
    Move(6700, destination=1210840, destination_type=CoordEntityType.Character, model_point=30, copy_draw_hitbox=1210840)
...
def Event11210905(ARG_0_3: int, ARG_4_7: int, ARG_8_11: int, ARG_12_15: int, ARG_16_19: int, ARG_20_23: int):
    ...
    WaitFrames(80)
    DisableCharacter(ARG_0_3)
    Move(ARG_0_3, destination=ARG_8_11, destination_type=CoordEntityType.Region, model_point=-1, set_draw_hitbox=ARG_12_15)
