...
def Event11105396():
    ...
    SetDisplayMask(1100160, bit_index=0, switch_type=OnOffChange.On)
    SetHitboxMask(1100160, bit_index=1, switch_type=OnOffChange.Off)
    Move(1100161, destination=1100160, destination_type=CoordEntityType.Character, model_point=40, copy_draw_hitbox=1100160)
...
def Event11105371():
    ...
    SetDisplayMask(1100170, bit_index=0, switch_type=OnOffChange.On)
    SetDisplayMask(1100170, bit_index=1, switch_type=OnOffChange.On)
    Move(1100172, destination=1100170, destination_type=CoordEntityType.Character, model_point=30, copy_draw_hitbox=1100170)
