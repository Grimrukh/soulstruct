...
def IfPlayerArmorType(condition: int, armor_type: ArmorType, required_armor_range_first: gt.ArmorInt,
                      required_armor_range_last: gt.ArmorInt):
...
def AddSpecialEffect(character: gt.CharacterInt, special_effect_id: int, affect_npc_part_hp: bool):
...
def SetDistanceLimitForConversationStateChanges(character: gt.CharacterInt, distance: float):
...
def SetGravityAndCollisionExcludingOwnWorld(character: gt.CharacterInt, state: bool):
...
def AddSpecialEffect_WithUnknownEffect(character: gt.CharacterInt, special_effect: int, affect_npc_parts_hp: bool):
...
def ActivateObjectWithSpecificCharacter(obj: gt.ObjectInt, objact_id: int, relative_index: int,
                                        character: gt.CharacterInt):
...
def SetObjectDamageShieldState(obj: gt.ObjectInt, state: bool):
