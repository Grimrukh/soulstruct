...
def Event13205290():
    ...
    IfCharacterHasTAEEvent(0, 3205290, tae_event_id=10)
...
def Event13205300():
    ...
    GotoIfFlagEnabled(Label.L0, 13200300)
...
def Event13205310():
    ...
    GotoIfFlagDisabled(Label.L0, 13200300)
    ...
    # --- 0 --- #
    DefineLabel(0)
    GotoIfFlagEnabled(Label.L9, 13205399)
    GotoIfFlagEnabled(Label.L1, 13205311)
    EndIfFlagEnabled(13205312)
    EndIfFlagEnabled(13205321)
    EndIfFlagEnabled(13205331)
    ...
    IfAttacked(2, 3200300, attacker=PLAYER)
    IfConditionTrue(-3, input_condition=1)
    IfConditionTrue(-3, input_condition=2)
    IfFlagEnabled(3, 13205301)
    IfFlagDisabled(3, 13205398)
    IfConditionTrue(3, input_condition=-3)
    IfCharacterHasSpecialEffect(3, 3200300, 5450)
    IfConditionTrue(0, input_condition=3)
    EndIfFlagEnabled(13205399)
    ...
    # --- 9 --- #
    DefineLabel(9)
    SkipLinesIfFlagEnabled(7, 13205399)
    SetNetworkConnectedFlagState(flag=13205301, state=FlagState.Off)
    SetNetworkConnectedFlagState(flag=13205399, state=FlagState.On)
    ForceAnimation(3200300, 20013, skip_transition=True)
    IfCharacterHasTAEEvent(4, 3200300, tae_event_id=60)
    IfCharacterAlive(4, 3200300)
    IfCharacterBackreadEnabled(4, 3200300)
...
def Event13205320():
    ...
    EndIfFlagEnabled(13200300)
    GotoIfFlagEnabled(Label.L9, 13205399)
    GotoIfFlagEnabled(Label.L0, 13205321)
    IfCharacterInsideRegion(1, 3200300, region=3202321)
    IfCharacterHasTAEEvent(1, 3200300, tae_event_id=50)
    IfFlagDisabled(1, 13205322)
    IfCharacterHuman(-1, PLAYER)
    IfCharacterType(-1, PLAYER, CharacterType.WhitePhantom)
    IfCharacterHollow(-1, PLAYER)
    ...
    IfFlagEnabled(-6, 13205311)
    IfFlagEnabled(-6, 13205312)
    IfConditionTrue(3, input_condition=-2)
    ...
    IfFlagDisabled(4, 13205321)
    IfFlagEnabled(-7, 13205311)
    IfFlagEnabled(-7, 13205312)
    ...
    # --- 9 --- #
    DefineLabel(9)
    SkipLinesIfFlagEnabled(11, 13205399)
    SetNetworkConnectedFlagState(flag=13205311, state=FlagState.Off)
    ...
    ForceAnimation(3200300, 20014, skip_transition=True)
    IfCharacterHasTAEEvent(5, 3200300, tae_event_id=60)
    IfCharacterAlive(5, 3200300)
    IfCharacterBackreadEnabled(5, 3200300)
...
def Event13205330():
    ...
    EndIfFlagEnabled(13200300)
    GotoIfFlagEnabled(Label.L9, 13205399)
    GotoIfFlagEnabled(Label.L1, 13205331)
    GotoIfFlagEnabled(Label.L0, 13205312)
    IfCharacterHuman(-1, PLAYER)
    IfCharacterType(-1, PLAYER, CharacterType.WhitePhantom)
    IfCharacterHollow(-1, PLAYER)
    ...
    SetNetworkConnectedFlagState(flag=13205321, state=FlagState.Off)
    SetNetworkConnectedFlagState(flag=13205399, state=FlagState.On)
    ForceAnimation(3200300, 20015, skip_transition=True)
    IfCharacterHasTAEEvent(4, 3200300, tae_event_id=60)
    IfCharacterAlive(4, 3200300)
    IfCharacterBackreadEnabled(4, 3200300)
    IfConditionTrue(0, input_condition=4)
...
def Event13205340():
    ...
    IfConditionTrue(1, input_condition=-2)
    IfAttacked(2, 3200300, attacker=PLAYER)
    IfHealthLessThanOrEqual(2, 3200300, 0.30000001192092896)
    IfConditionTrue(-3, input_condition=1)
    IfConditionTrue(-3, input_condition=2)
    IfFlagEnabled(3, 13205331)
    IfFlagDisabled(3, 13205398)
    IfConditionTrue(3, input_condition=-3)
    IfCharacterHasSpecialEffect(3, 3200300, 5450)
    IfConditionTrue(0, input_condition=3)
...
def Event13205360(
    ...
    IfConditionTrue(0, input_condition=1)
    GotoIfFlagEnabled(Label.L0, 13200381)
...
def Event13205370(
    ...
    # --- 0 --- #
    DefineLabel(0)
    IfHealthNotEqual(9, arg_0_3, 0.0)
    ...
    CreateTemporaryVFX(30300, anchor_entity=arg_12_15, anchor_type=CoordEntityType.Region)
    Move(arg_0_3, destination=arg_12_15, destination_type=CoordEntityType.Region, copy_draw_parent=arg_24_27)
    ...
    DefineLabel(1)
    ForceAnimation(arg_0_3, 63010)
    CreateTemporaryVFX(30300, anchor_entity=arg_16_19, anchor_type=CoordEntityType.Region)
    Move(arg_0_3, destination=arg_16_19, destination_type=CoordEntityType.Region, copy_draw_parent=arg_24_27)
    AddSpecialEffect(arg_24_27, 11292)
...
def Event13205375(_, arg_0_3: int, arg_4_7: int, arg_8_11: int, arg_12_15: int, arg_16_19: int, arg_20_23: int):
    ...
    ForceAnimation(arg_0_3, 63010)
    CreateTemporaryVFX(30300, anchor_entity=arg_12_15, anchor_type=CoordEntityType.Region)
    Move(arg_0_3, destination=arg_12_15, destination_type=CoordEntityType.Region, copy_draw_parent=arg_16_19)
...
def Event13205380():
    ...
    EndIfFlagEnabled(13200380)
    IfPlayerInOwnWorld(1)
    IfHealthValueEqual(1, 3200291, 0)
    IfConditionTrue(0, input_condition=1)
    EnableFlag(9480)
    EnableFlag(13200380)
...
def Event13205381():
    ...
    EndIfFlagEnabled(13200381)
    IfPlayerInOwnWorld(1)
    IfHealthValueEqual(1, 3200299, 0)
    IfConditionTrue(0, input_condition=1)
    EnableFlag(9481)
    EnableFlag(13200381)
...
def Event13205410():
    ...
    GotoIfFlagEnabled(Label.L0, 13200410)
    ...
    Wait(2.25)
    ForceAnimation(3201410, 1, wait_for_completion=True, skip_transition=True)
    ForceAnimation(3201410, 2, skip_transition=True)
    ForceAnimation(3201411, 3, skip_transition=True)
    EnableFlag(13200410)
    End()
...
def Event13205420():
    ...
    GotoIfFlagEnabled(Label.L0, 13200800)
    IfFlagEnabled(0, 13200800)
    ForceAnimation(3201420, 2, skip_transition=True)
    End()
...
def Event13205435():
    ...
    GotoIfFlagEnabled(Label.L0, 13200850)
    IfFlagEnabled(0, 13200850)
    ForceAnimation(3201435, 2, skip_transition=True)
    ForceAnimation(3201436, 2, skip_transition=True)
    End()
...
def Event13205440():
    ...
    GotoIfFlagEnabled(Label.L2, 13200445)
    GotoIfFlagEnabled(Label.L1, 13200440)
    ...
    ForceAnimation(3201441, 3, skip_transition=True)
...
def Event13205441():
    ...
    PlayCutsceneAndSetMapCeremony(
        32000000,
        cutscene_type=CutsceneFlags.UnskippableFadeOut,
        ceremony_id=10,
        unknown=1,
        player_id=PLAYER,
    )
    ...
    PlayCutsceneAndSetMapCeremony(
        32000000,
        cutscene_type=CutsceneFlags.Unskippable,
        ceremony_id=10,
        unknown=1,
        player_id=PLAYER,
    )
...
def Event13205442():
    ...
    GotoIfFlagEnabled(Label.L0, 13200862)
    IfFlagEnabled(0, 13200856)
    WaitFrames(1)
...
def Event13205810():
    ...
    GotoIfFlagDisabled(Label.L0, 13200800)
    ...
    EnableAI(3200800)
    ForceAnimation(3200800, 20001, wait_for_completion=True)
...
def Event13200811():
    ...
    EndIfFlagEnabled(13200800)
    IfHealthLessThanOrEqual(0, 3200800, 0.0)
    Wait(0.5)
...
def Event13205860():
    ...
    GotoIfFlagEnabled(Label.L1, 13200445)
    GotoIfFlagDisabled(Label.L0, 13200850)
    ...
    ForceAnimation(3200850, 700)
    IfFlagEnabled(1, 13205855)
    ...
    ForceAnimation(3200850, 1700, wait_for_completion=True)
    EnableAI(3200850)
...
def Event13205861():
    ...
    EndIfFlagEnabled(13200850)
    IfHealthLessThanOrEqual(1, 3200850, 0.009999999776482582)
    IfPlayerInOwnWorld(1)
    IfConditionTrue(0, input_condition=1)
    IfCharacterHasSpecialEffect(-1, 3200850, 12160)
    SkipLinesIfConditionTrue(1, -1)
    ForceAnimation(3200850, 20001, wait_for_completion=True)
    DisableBossMusic(-1)
    WaitFrames(1)
    SkipLinesIfTryingToCreateSession(2)
    PlayCutscene(
...
def Event13200862():
    ...
    GotoIfFlagEnabled(Label.L2, 13200856)
    GotoIfFlagEnabled(Label.L1, 13200855)
    GotoIfFlagEnabled(Label.L0, 13200850)
    ...
    PlayCutsceneAndMovePlayerAndSetMapCeremony(
        32000020,
        CutsceneFlags.SkippableFadeOut,
        ceremony_id=0,
        unknown=0,
    ...
    PlayCutsceneAndMovePlayerAndSetMapCeremony(
        32000020,
        CutsceneFlags.UnskippableFadeOut,
        ceremony_id=0,
        unknown=0,
        move_to_region=3202859,
        move_to_map=ARCHDRAGON_PEAK,
...
def Event13200863():
    ...
    EndIfFlagEnabled(13200850)
    IfHealthLessThanOrEqual(0, 3200851, 0.0)
    Wait(1.0)
...
def Event13205864():
    ...
    EndIfFlagEnabled(13200850)
    SkipLinesIfClientTypeCountComparison(2, ClientType.Invader, ComparisonType.Equal, 0)
    IfFlagEnabled(0, 13205855)
    SkipLines(1)
    IfFlagEnabled(0, 13205856)
    GotoIfFlagEnabled(Label.L0, 13205852)
    ChangeCamera(normal_camera_id=5030, locked_camera_id=5030)
    IfFlagEnabled(0, 13205852)
...
def Event13205930():
    ...
    EndIfFlagEnabled(13200850)
    EndIfFlagEnabled(13200930)
    EndIfFlagEnabled(13200445)
    IfFlagEnabled(1, 13204190)
    IfCharacterInsideRegion(1, 3200190, region=3202930)
    IfFlagEnabled(2, 13200445)
    IfFlagEnabled(2, 13204190)
    IfConditionTrue(-1, input_condition=1)
    IfConditionTrue(-1, input_condition=2)
    IfConditionTrue(0, input_condition=-1)
    GotoIfFlagEnabled(Label.L1, 13200445)
    ...
    ForceAnimation(3200190, 91050, wait_for_completion=True)
    Wait(5.0)
    ForceAnimation(3200190, 91052)
    Wait(1.0)
