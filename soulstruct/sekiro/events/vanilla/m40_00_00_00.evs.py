...
def Event14005101():
    ...
    IfActionButtonParamActivated(-1, action_button_id=9351, entity=4001950)
...
def Event14005102():
    ...
    IfPlayerStandingOnCollision(1, 4004100)
    ...
    IfPlayerStandingOnCollision(1, 4004101)
    IfConditionTrue(0, input_condition=1)
    ...
    IfPlayerStandingOnCollision(3, 4004100)
    SkipLines(1)
    ...
    IfTimeElapsed(4, 2.0)
    SkipLinesIfFinishedConditionTrue(2, 10)
    IfPlayerStandingOnCollision(5, 4004100)
    SkipLines(1)
...
def Event14005110():
    ...
    IfActionButtonParamActivated(-2, action_button_id=9101, entity=4001950)
...
def Event14000130():
    ...
    IfPlayerInOwnWorld(1)
    IfActionButtonParamActivated(1, action_button_id=9355, entity=4001200)
    IfConditionTrue(0, input_condition=1)
...
def Event14005450():
    ...
    IfPlayerStandingOnCollision(-1, 4004100)
    IfPlayerStandingOnCollision(-1, 4004101)
    IfPlayerStandingOnCollision(-1, 4004102)
    IfPlayerStandingOnCollision(-1, 4004103)
    IfPlayerStandingOnCollision(-1, 4004104)
    IfPlayerStandingOnCollision(-1, 4004109)
    IfConditionTrue(1, input_condition=-1)
    ...
    Wait(0.5)
    IfPlayerStandingOnCollision(-2, 4004100)
    IfPlayerStandingOnCollision(-2, 4004101)
    IfPlayerStandingOnCollision(-2, 4004102)
    IfPlayerStandingOnCollision(-2, 4004103)
    IfPlayerStandingOnCollision(-2, 4004104)
    IfPlayerStandingOnCollision(-2, 4004109)
...
def Event14005460():
    ...
    IfActionButtonParamActivated(0, action_button_id=9350, entity=4001460)
...
def Event14005461():
    ...
    IfActionButtonParamActivated(0, action_button_id=4000, entity=4001461)
...
def Event14005470():
    ...
    DisableNetworkSync()
    IfPlayerStandingOnCollision(1, 4004120)
...
def Event14005811():
    ...
    IfActionButtonParamActivated(-1, action_button_id=8900, entity=4000800)
    IfConditionTrue(0, input_condition=-1)
