...
class InstructionDecompiler(_BaseDecompiler):
    ...
    @parse_parameters("IfPlayerGender", no_name_count=2)
    def _3_30(self, condition, gender: Gender):
        pass

    @parse_parameters("IfOngoingCutsceneFinished", no_name_count=2)
    def _3_31(self, condition, cutscene):
        pass
    ...
    @parse_parameters("IfHollowArenaSoloResults", no_name_count=2)
    def _3_33(self, condition, result: HollowArenaResult):
        pass

    @parse_parameters("IfHollowArenaSoloScoreComparison", no_name_count=1)
    def _3_34(self, condition, comparison_type: ComparisonType, value):
        pass
    ...
    @parse_parameters
    def _1003_12(self, label: Label, not_in_own_world: bool):
        if not_in_own_world is True:
    ...
    @parse_parameters
    def _1003_13(self, event_return_type: EventReturnType, not_in_own_world: bool):
    ...
    def _2002_10(self, cutscene, cutscene_type: CutsceneFlags, ceremony_id, unknown, player_id: PlayerEntity):
        pass
    ...
    def _2002_11(
        ...
        move_to_map = self._get_game_map_variable_name(area_id, block_id)
        return (
            f"PlayCutsceneAndMovePlayer_WithUnknowns({cutscene}, {cutscene_type}, {move_to_region=}, {move_to_map=}, "
            f"{player_id=}, {unknown1=}, {unknown2=})"
        )
    ...
    def _2002_12(
        ...
        move_to_map = self._get_game_map_variable_name(area_id, block_id)
        return (
            f"PlayCutsceneAndMovePlayer_WithSecondRegion({cutscene}, {cutscene_type}, {move_to_region=}, "
            f"{move_to_map=}, {player_id=}, {other_region=})"
        )
    ...
    @parse_parameters("InitializeCrowTrade")
    def _2003_66(self, item_type: ItemType, item_id, item_lot_id, trade_completed_flag, crow_response_flag):
        pass
    ...
    def _2003_80(self, state: bool, character: Character, slot, name, decoration):
        ...
        if state is False:
            return f"DisableDecoratedBossHealthBar({character}, {slot=}, {name=}, {decoration=})"
