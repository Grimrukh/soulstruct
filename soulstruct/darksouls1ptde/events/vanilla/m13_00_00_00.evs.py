...
def Event_11305000():
    ...
    EnableFlag(11310050)
    PlayCutscene(130020, cutscene_flags=0, player_id=10000, move_to_region=1312110, move_to_map=TOMB_OF_THE_GIANTS)
...
def Event_11300210():
    ...
    PlayCutscene(130010, cutscene_flags=0, player_id=10000, move_to_region=1302030, move_to_map=CATACOMBS)
    WaitFrames(frames=1)
    SkipLines(5)
    SkipLinesIfFlagDisabled(2, 11305060)
    PlayCutscene(130010, cutscene_flags=2, player_id=10000, move_to_region=1302030, move_to_map=CATACOMBS)
    SkipLines(1)
