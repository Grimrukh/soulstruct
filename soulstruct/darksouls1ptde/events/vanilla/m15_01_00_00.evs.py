...
def Event_11515381():
    ...
    PlayCutscene(150151, cutscene_flags=2, player_id=10000, move_to_region=1512901, move_to_map=ANOR_LONDO)
    SkipLines(1)
    PlayCutscene(150156, cutscene_flags=2, player_id=10000, move_to_region=1512901, move_to_map=ANOR_LONDO)
    WaitFrames(frames=1)
...
def Event_11510900():
    ...
    SkipLinesIfFlagEnabled(2, 11510400)
    PlayCutscene(150152, cutscene_flags=0, player_id=10000, move_to_region=1512897, move_to_map=ANOR_LONDO)
    SkipLines(1)
    PlayCutscene(150157, cutscene_flags=0, player_id=10000, move_to_region=1512897, move_to_map=ANOR_LONDO)
    WaitFrames(frames=1)
    SkipLinesIfFlagDisabled(1, 12)
    EnableFlag(120)
    EnableFlag(11510900)
...
def Event_11515386():
    ...
    PlayCutscene(150155, cutscene_flags=0, player_id=10000, move_to_region=1512900, move_to_map=ANOR_LONDO)
    SkipLines(4)
    SkipLinesIfClient(2)
    PlayCutscene(150155, cutscene_flags=2, player_id=10000, move_to_region=1512900, move_to_map=ANOR_LONDO)
    SkipLines(1)
    ...
    SkipLinesIfMultiplayer(2)
    PlayCutscene(150161, cutscene_flags=0, player_id=10000, move_to_region=1512900, move_to_map=ANOR_LONDO)
    SkipLines(4)
    SkipLinesIfClient(2)
    PlayCutscene(150161, cutscene_flags=2, player_id=10000, move_to_region=1512900, move_to_map=ANOR_LONDO)
    SkipLines(1)
    ...
    End()
    SkipLinesIfMultiplayer(2)
    PlayCutscene(150160, cutscene_flags=0, player_id=10000, move_to_region=1512900, move_to_map=ANOR_LONDO)
    SkipLines(4)
    SkipLinesIfClient(2)
    PlayCutscene(150160, cutscene_flags=2, player_id=10000, move_to_region=1512900, move_to_map=ANOR_LONDO)
    SkipLines(1)
...
def Event_11510400():
    ...
    SetLockedCameraSlot(area_id=15, block_id=1, camera_slot=1)
...
def Event_11510230():
    ...
    DisplayDialog(text=10010170)
    Restart()
    PlayCutscene(150135, cutscene_flags=0, player_id=10000, move_to_region=1102510, move_to_map=PAINTED_WORLD)
    WaitFrames(frames=1)
...
def Event_11510240():
    ...
    Restart()
    SkipLinesIfFlagEnabled(2, 11510400)
    PlayCutscene(150130, cutscene_flags=0, player_id=10000, move_to_region=1502500, move_to_map=SENS_FORTRESS)
    SkipLines(1)
    PlayCutscene(150132, cutscene_flags=0, player_id=10000, move_to_region=1502500, move_to_map=SENS_FORTRESS)
    WaitFrames(frames=1)
    Restart()
