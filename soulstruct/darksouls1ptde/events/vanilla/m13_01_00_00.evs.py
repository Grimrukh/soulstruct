...
def Event_11310052():
    ...
    Wait(3.0)
    PlayCutscene(130121, cutscene_flags=0, player_id=10000, move_to_region=1302010, move_to_map=CATACOMBS)
...
def Event_11310002():
    ...
    SkipLinesIfFinishedConditionTrue(2, condition=2)
    PlayCutscene(130111, cutscene_flags=0, player_id=10000, move_to_region=1312120, move_to_map=TOMB_OF_THE_GIANTS)
    SkipLines(1)
    PlayCutscene(130110, cutscene_flags=0, player_id=10000, move_to_region=1312120, move_to_map=TOMB_OF_THE_GIANTS)
    WaitFrames(frames=1)
    MoveToEntity(6321, destination=1312121, destination_type=CoordEntityType.Region)
    End()
    SkipLinesIfClient(7)
    SkipLinesIfFinishedConditionTrue(2, condition=2)
    PlayCutscene(130111, cutscene_flags=2, player_id=10000, move_to_region=1312120, move_to_map=TOMB_OF_THE_GIANTS)
    SkipLines(1)
    PlayCutscene(130110, cutscene_flags=2, player_id=10000, move_to_region=1312120, move_to_map=TOMB_OF_THE_GIANTS)
    WaitFrames(frames=1)
    MoveToEntity(6321, destination=1312121, destination_type=CoordEntityType.Region)
    End()
    SkipLinesIfFinishedConditionTrue(2, condition=2)
