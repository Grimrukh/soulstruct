...
def Event_11600001():
    ...
    PlayCutscene(160010, cutscene_flags=0, player_id=10000, move_to_region=1602120, move_to_map=NEW_LONDO_RUINS)
    SkipLines(4)
    SkipLinesIfClient(2)
    PlayCutscene(160010, cutscene_flags=2, player_id=10000, move_to_region=1602120, move_to_map=NEW_LONDO_RUINS)
    SkipLines(1)
...
def Event_11606200():
    ...
    PlayCutscene(160040, cutscene_flags=0, player_id=10000, move_to_region=1802110, move_to_map=KILN_OF_THE_FIRST_FLAME)
