...
def Event_11505395():
    ...
    IfConditionTrue(0, input_condition=1)
    DisableSoundEvent(sound_id=1503800)
    PlaySoundEffect(anchor_entity=1502990, sound_id=150100002, sound_type=SoundType.a_Ambient)
...
def Event_11505351():
    ...
    RestartEvent(event_id=11505352, slot=0)
...
def Event_11505352():
    ...
    IfConditionTrue(0, input_condition=1)
    RestartEvent(event_id=11505351, slot=0)
...
def Event_11505110():
    ...
    RestartEvent(event_id=11505102, slot=0)
    Wait(1.0)
...
def Event_11500210():
    ...
    PlayCutscene(150000, cutscene_flags=0, player_id=10000, move_to_region=1502501, move_to_map=ANOR_LONDO)
    SkipLines(1)
    PlayCutscene(150002, cutscene_flags=0, player_id=10000, move_to_region=1502501, move_to_map=ANOR_LONDO)
    WaitFrames(frames=1)
