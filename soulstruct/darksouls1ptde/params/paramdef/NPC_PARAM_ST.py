...
class NPC_PARAM_ST(ParamRow):
    ...
    DebugBehaviorR1: int = ParamField(
        int, "dbgBehaviorR1", default=0, hide=True,
        tooltip="TODO",
    )
    DebugBehaviorL1: int = ParamField(
        int, "dbgBehaviorL1", default=0, hide=True,
        tooltip="TODO",
    )
    DebugBehaviorR2: int = ParamField(
        int, "dbgBehaviorR2", default=0, hide=True,
        tooltip="TODO",
    )
    DebugBehaviorL2: int = ParamField(
        int, "dbgBehaviorL2", default=0, hide=True,
        tooltip="TODO",
    )
    DebugBehaviorRL: int = ParamField(
        int, "dbgBehaviorRL", default=0, hide=True,
        tooltip="TODO",
    )
    DebugBehaviorRR: int = ParamField(
        int, "dbgBehaviorRR", default=0, hide=True,
        tooltip="TODO",
    )
    DebugBehaviorRD: int = ParamField(
        int, "dbgBehaviorRD", default=0, hide=True,
        tooltip="TODO",
    )
    DebugBehaviorRU: int = ParamField(
        int, "dbgBehaviorRU", default=0, hide=True,
        tooltip="TODO",
    )
    DebugBehaviorLL: int = ParamField(
        int, "dbgBehaviorLL", default=0, hide=True,
        tooltip="TODO",
    )
    DebugBehaviorLR: int = ParamField(
        int, "dbgBehaviorLR", default=0, hide=True,
        tooltip="TODO",
    )
    DebugBehaviorLD: int = ParamField(
        int, "dbgBehaviorLD", default=0, hide=True,
        tooltip="TODO",
    )
    DebugBehaviorLU: int = ParamField(
        int, "dbgBehaviorLU", default=0, hide=True,
        tooltip="TODO",
    )
    ...
    TeamType: NPC_TEMA_TYPE = ParamField(
    ...
    _BitPad1: int = ParamBitPad(byte, "pad3:4", bit_count=4)
