...
class NPC_PARAM_ST(ParamRow):
    ...
    SpecialEffectID5: int = ParamField(
        int, "spEffectID5", game_type=SpecialEffectParam, default=0,
    ...
    SpecialEffectID6: int = ParamField(
        int, "spEffectID6", game_type=SpecialEffectParam, default=0,
    ...
    SpecialEffectID7: int = ParamField(
        int, "spEffectID7", game_type=SpecialEffectParam, default=0,
    ...
    TeamType: int = ParamField(
        byte, "teamType", NPC_TEMA_TYPE, default=0,
