...
from soulstruct.utilities import BiDict, camel_case_to_spaces, word_wrap
...
def _get_evs_map_id(map_name):
    map_id = DARK_SOULS_MAP_NAMES[map_name]
    if map_id == "m12_00_00_01":
        return "m12_00_00_00"  # ignore Darkroot MSB file variant index
    return map_id
...
class SoulstructEntityEditor(SoulstructBaseEditor):
    ...
    def build(self):
        with self.set_master(sticky='nsew', row_weights=[0, 1], column_weights=[1], auto_rows=0):
            ...
            with self.set_master(pady=10, sticky='w', row_weights=[1], column_weights=[1, 1, 1, 1, 1], auto_columns=0):
                ...
                self.Button(text="Import Entity ID Module", font_size=10, width=25, padx=10,
                            ...
                            tooltip_text="Import all entity ID names and descriptions from an existing Python module "
                                         "generated by this tab.")
                self.Button(text="Write Entity ID Module", font_size=10, width=25, padx=10,
                            command=self._write_entities_module,
                            tooltip_text="Generate (or replace) the Python entities module that can be imported into "
                ...
                self.Button(text="Restore EVS IDs", font_size=10, width=25, padx=10,
    ...
    def _import_entities_module(self):
        ...
        map_id = _get_evs_map_id(self._get_map_choice_name())
