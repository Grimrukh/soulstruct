...
class SoulstructTalkEditor(SoulstructBaseEditor):
    ...
    class EntryRow(SoulstructBaseEditor.EntryRow):
        ...
        def __init__(self, editor: SoulstructTalkEditor, row_index: int, main_bindings: dict = None):
            ...
            self.row_box = editor.Frame(
                width=self.ENTRY_ID_WIDTH, height=self.ENTRY_ROW_HEIGHT,
        ...
        with self.set_master(sticky='nsew', row_weights=[0, 1], column_weights=[1], auto_rows=0):
            ...
            with self.set_master(sticky='nsew', row_weights=[1], column_weights=[0, 1], auto_columns=0):
                ...
                with self.set_master(
                    ...
                    with self.set_master(sticky='nsew', row_weights=[1], column_weights=[1, 1], pady=10,
                                         auto_columns=0):
                        self.compile_button = self.Button(
                            text="Save & Compile", font_size=10, bg="#222", width=20, padx=5,
                            command=self.compile_selected, state="disabled", sticky='e',
                        ...
                        self.reload_button = self.Button(
                            text="Reload Script", font_size=10, bg="#222", width=20, padx=5,
    ...
    def select_entry_row_index(self, row_index, set_focus_to_text=False, edit_if_already_selected=True,
