...
class EVSInstructionCompiler(_BaseCompiler):
    ...
    def IfPlayerHasRing(self, condition: int, rune: AccessoryTyping, including_storage: bool = False):
        return self.IfPlayerItemState(condition, True, rune, ItemType.Ring, including_storage)
    ...
    def IfPlayerDoesNotHaveRing(self, condition: int, ring: AccessoryTyping, including_storage: bool = False):
        return self.IfPlayerItemState(condition, False, ring, ItemType.Ring, including_storage)
