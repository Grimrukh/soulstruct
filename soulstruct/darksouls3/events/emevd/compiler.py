...
def IfActionButton(
    ...
    if boss_version:
        if line_intersects is None:
            ...
            return COMPILER.compile("IfActionButtonBossLineIntersect", **kwargs, line_intersects=line_intersects)
    else:
        if line_intersects is None:
            return COMPILER.compile("IfActionButtonBasic", **kwargs)
        else:
            return COMPILER.compile("IfActionButtonBasicLineIntersect", **kwargs, line_intersects=line_intersects)
