...
EMEDF = {
    ...
    (2003, 63): {
        ...
        "partials": {
            "EnableNetworkConnectedFlagRange": dict(state=FlagState.On),
            "DisableNetworkConnectedFlagRange": dict(state=FlagState.Off),
            "ToggleNetworkConnectedFlagRange": dict(state=FlagState.Change),
        },
    },
    (2003, 64): {
