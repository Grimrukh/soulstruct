__all__ = [
    ...
    "HOST",
    "CLIENT",
    "TRYING_TO_CREATE_SESSION",
    "TRYING_TO_JOIN_SESSION",
    "LEAVING_SESSION",
...
TRYING_TO_CREATE_SESSION = BooleanTestCompiler(
    compile_instruction=compile_instruction,
    if_true="IfTryingToCreateSession",
    skip_if_true="SkipLinesIfTryingToCreateSession",
    end_if_true="EndIfTryingToCreateSession",
    restart_if_true="RestartIfTryingToCreateSession",
)


TRYING_TO_JOIN_SESSION = BooleanTestCompiler(
    compile_instruction=compile_instruction,
    if_true="IfTryingToJoinSession",
    skip_if_true="SkipLinesIfTryingToJoinSession",
    end_if_true="EndIfTryingToJoinSession",
    restart_if_true="RestartIfTryingToJoinSession",
)


LEAVING_SESSION = BooleanTestCompiler(
    compile_instruction=compile_instruction,
    if_true="IfLeavingSession",
    skip_if_true="SkipLinesIfLeavingSession",
    end_if_true="EndIfLeavingSession",
    restart_if_true="RestartIfLeavingSession",
)


FAILED_TO_CREATE_SESSION = BooleanTestCompiler(
    compile_instruction=compile_instruction,
    if_true="IfFailedToCreateSession",
    skip_if_true="SkipLinesIfFailedToCreateSession",
    end_if_true="EndIfFailedToCreateSession",
    restart_if_true="RestartIfFailedToCreateSession",
)


IN_OWN_WORLD = BooleanTestCompiler(
    compile_instruction=compile_instruction,
    if_true="IfPlayerInOwnWorld",
    if_false="IfPlayerNotInOwnWorld",
    end_if_true="EndIfPlayerInOwnWorld",
    end_if_false="EndIfPlayerNotInOwnWorld",
    restart_if_true="RestartIfPlayerInOwnWorld",
    restart_if_false="RestartIfPlayerNotInOwnWorld",
)
...
def AttackedWithDamageType(
    ...
    return compile_instruction("IfAttackedWithDamageType", condition, attacked_entity, attacker, damage_type)


@no_skip_or_negate_or_return
def ActionButtonParamActivated(action_button_id: int, entity: CoordEntityTyping, condition: int):
    return compile_instruction("IfActionButtonParamActivated", condition, action_button_id, entity)
...
def PlayerArmorInRange(
    ...
    return compile_instruction(
        "IfPlayerArmorInRange", condition, armor_type, required_armor_range_first, required_armor_range_last
    )


@no_skip_or_negate_or_return
def CharacterDrawGroupEnabled(character: CharacterTyping, condition: int):
    return compile_instruction("IfCharacterDrawGroupEnabled", condition, character)


@no_skip_or_negate_or_return
def CharacterDrawGroupDisabled(character: CharacterTyping, condition: int):
    return compile_instruction("IfCharacterDrawGroupDisabled", condition, character)
