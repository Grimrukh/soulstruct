...
def Constructor():
    ...
    # --- Label 0 --- #
    DefineLabel(0)
    RunCommonEvent(20005920, args=(0, 15305300, 10020000, 10020010), arg_types="Biii")
    ...
    # --- Label 1 --- #
    DefineLabel(1)
    RunCommonEvent(20005920, args=(1, 15305300, 10020001, 10020011), arg_types="Biii")
    Goto(Label.L9)

    # --- Label 2 --- #
    DefineLabel(2)
    RunCommonEvent(20005920, args=(2, 15305300, 10020002, 10020012), arg_types="Biii")
    Goto(Label.L9)

    # --- Label 3 --- #
    DefineLabel(3)
    RunCommonEvent(20005920, args=(3, 15305300, 10020003, 10020013), arg_types="Biii")
    Goto(Label.L9)

    # --- Label 4 --- #
    DefineLabel(4)
    RunCommonEvent(20005920, args=(4, 15305300, 10020004, 10020014), arg_types="Biii")
    Goto(Label.L9)

    # --- Label 5 --- #
    DefineLabel(5)
    RunCommonEvent(20005920, args=(5, 15305300, 10020005, 10020015), arg_types="Biii")
    Goto(Label.L9)
