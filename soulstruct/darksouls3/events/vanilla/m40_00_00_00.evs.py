...
def Event_14005102():
    ...
    CreateObjectVFX(4001101, vfx_id=101, dummy_id=840080)
...
def Event_14000121(_, flag: int, item: int, obj: int, target_entity: int, action_button_id: int, animation: int):
    ...
    CreateObjectVFX(obj, vfx_id=201, dummy_id=840066)
    End()
    ...
    EnableObject(obj)
    CreateTemporaryVFX(vfx_id=840065, anchor_entity=obj, dummy_id=201, anchor_type=CoordEntityType.Object)
    CreateObjectVFX(obj, vfx_id=201, dummy_id=840066)
...
def Event_14000130():
    ...
    if FlagEnabled(6010):
        return
    CreateObjectVFX(4001200, vfx_id=90, dummy_id=63)
    AND_1.Add(PlayerInOwnWorld())
...
def Event_14005441():
    ...
    CreateObjectVFX(4001500, vfx_id=200, dummy_id=800022)
    CreateObjectVFX(4001501, vfx_id=200, dummy_id=800022)
    CreateObjectVFX(4001502, vfx_id=200, dummy_id=800022)
    CreateObjectVFX(4001503, vfx_id=200, dummy_id=800022)
    CreateObjectVFX(4001510, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001511, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001512, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001513, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001514, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001515, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001516, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001517, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001518, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001519, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001520, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001521, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001522, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001523, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001524, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001525, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001526, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001527, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001528, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001529, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001530, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001531, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001532, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001533, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001534, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001535, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001536, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001537, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001538, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001539, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001540, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001541, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001542, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001543, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001544, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001545, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001546, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001547, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001548, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001549, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001550, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001551, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001552, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001553, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001554, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001555, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001556, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001557, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001558, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001559, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001560, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001561, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001562, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001563, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001564, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001565, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001566, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001567, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001568, vfx_id=200, dummy_id=839010)
    CreateObjectVFX(4001569, vfx_id=200, dummy_id=839010)
...
def Event_14005461():
    ...
    if OR_1:
        return
    CreateObjectVFX(4001461, vfx_id=90, dummy_id=62)
...
def Event_14005810():
    ...
    SetLockOnPoint(character=4000800, lock_on_dummy_id=221, state=False)
...
def Event_14005811():
    ...
    if FlagEnabled(14000802):
        return
    Move(PLAYER, destination=4000800, destination_type=CoordEntityType.Character, dummy_id=100, short_move=True)
...
def Event_14005812():
    ...
    SetLockOnPoint(character=4000800, lock_on_dummy_id=221, state=True)
    EnableFlag(14005802)
...
def Event_14005820():
    ...
    CommonFunc_20005820(0, flag=14000800, obj=4001800, dummy_id=3, left=14000801)
...
def Event_14005840():
    ...
    DisableAI(4000830)
    SetLockOnPoint(character=4000830, lock_on_dummy_id=221, state=False)
...
def Event_14000859():
    ...
    CommonFunc_20005820(0, flag=14000830, obj=4001800, dummy_id=3, left=14000831)
