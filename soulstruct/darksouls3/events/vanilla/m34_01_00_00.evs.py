...
def Constructor():
    ...
    CommonFunc_20005341(0, flag=13410200, character=3410200, item_lot_param_id=13210000)
    CommonFunc_20005341(0, flag=13410201, character=3410210, item_lot_param_id=13101000)
    ...
    CommonFunc_20005341(0, flag=13410205, character=3410370, item_lot_param_id=21505000)
    CommonFunc_20005341(0, flag=13410206, character=3410371, item_lot_param_id=21505010)
    CommonFunc_20005341(0, flag=13410207, character=3410372, item_lot_param_id=21505020)
    CommonFunc_20005120(0, character=3410372, radius=5.0)
    CommonFunc_20005341(0, flag=13410208, character=3410373, item_lot_param_id=21505030)
    CommonFunc_20005341(0, flag=13410209, character=3410374, item_lot_param_id=21505040)
    CommonFunc_20005120(0, character=3410374, radius=5.0)
    CommonFunc_20005341(0, flag=13410210, character=3410375, item_lot_param_id=21505050)
    CommonFunc_20005120(0, character=3410375, radius=5.0)
    CommonFunc_20005341(0, flag=13410211, character=3410376, item_lot_param_id=21505060)
    CommonFunc_20005341(0, flag=13410212, character=3410377, item_lot_param_id=21505070)
    Event_13415830()
    Event_13415840()
    Event_13415841()
    Event_13415831()
...
def Event_13415833():
    ...
    CommonFunc_20005810(0, 13410830, 3411830, 3412831, 10000)
