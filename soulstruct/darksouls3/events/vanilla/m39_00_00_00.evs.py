...
def Constructor():
    ...
    CommonFunc_20005341(0, flag=13900192, character=3900192, item_lot=58600)
    Event_13905900()
    CommonFunc_20005119(
        0,
        character=3900200,
    ...
    CommonFunc_20005350(0, character=3900259, item_lot=20601010, flag=53900920)
    ...
    CommonFunc_20005341(0, flag=13900340, character=3900340, item_lot=21508000)
    CommonFunc_20005341(0, flag=13900341, character=3900341, item_lot=21508010)
    CommonFunc_20005341(0, flag=13900342, character=3900342, item_lot=21508020)
    CommonFunc_20005341(0, flag=13900343, character=3900343, item_lot=21508030)
    ...
    CommonFunc_20005341(0, flag=13900373, character=3900373, item_lot=20400020)
    Event_13905380()
    Event_13905381()
...
def Event_13905860():
    ...
    OR_4.Add(CharacterIsHuman(PLAYER))
    OR_4.Add(CharacterIsHollow(PLAYER))
