...
def Event_13105812():
    ...
    MAIN.Await(HealthRatioLessThanOrEqual(3100800, value=0.0))
...
def Event_13105742(_, character: int, character_1: int):
    ...
    MAIN.Await(HealthRatioEqual(3100831, value=0.0))
...
def Event_13105743(
    ...
    if FlagEnabled(flag_1):
        return
    AND_2.Add(HealthRatioGreaterThan(character, value=0.8999999761581421))
    SkipLinesIfConditionFalse(2, AND_2)
    AND_1.Add(HealthRatioLessThan(character, value=0.699999988079071))
    Goto(Label.L20)
    AND_3.Add(HealthRatioGreaterThan(character, value=0.699999988079071))
    SkipLinesIfConditionFalse(2, AND_3)
    AND_1.Add(HealthRatioLessThan(character, value=0.6000000238418579))
    Goto(Label.L20)
    AND_4.Add(HealthRatioGreaterThan(character, value=0.6000000238418579))
    SkipLinesIfConditionFalse(2, AND_4)
    AND_1.Add(HealthRatioLessThan(character, value=0.5))
    Goto(Label.L20)
    AND_5.Add(HealthRatioGreaterThan(character, value=0.5))
    SkipLinesIfConditionFalse(2, AND_5)
    AND_1.Add(HealthRatioLessThan(character, value=0.4000000059604645))
    Goto(Label.L20)
    AND_6.Add(HealthRatioGreaterThan(character, value=0.4000000059604645))
    SkipLinesIfConditionFalse(2, AND_6)
    AND_1.Add(HealthRatioLessThan(character, value=0.30000001192092896))
    Goto(Label.L20)
    AND_7.Add(HealthRatioGreaterThan(character, value=0.30000001192092896))
    SkipLinesIfConditionFalse(2, AND_7)
    AND_1.Add(HealthRatioLessThan(character, value=0.20000000298023224))
    Goto(Label.L20)
    AND_8.Add(HealthRatioGreaterThan(character, value=0.20000000298023224))
    SkipLinesIfConditionFalse(2, AND_8)
    AND_1.Add(HealthRatioLessThan(character, value=0.10000000149011612))
    Goto(Label.L20)
    AND_9.Add(HealthRatioGreaterThan(character, value=0.10000000149011612))
    ...
    AND_15.Add(HealthRatioNotEqual(character, value=0.0))
