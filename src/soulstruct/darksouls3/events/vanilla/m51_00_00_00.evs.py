...
def Event_15105315(_, character: int, character_1: int, special_effect: int, special_effect_1: int):
    ...
    OR_8.Add(AND_8)
    OR_8.Add(CharacterIsHuman(PLAYER))
    OR_8.Add(CharacterIsHollow(PLAYER))
    OR_8.Add(CharacterIsWhitePhantom(PLAYER))
