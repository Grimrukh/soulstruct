...
class ATK_PARAM_ST(ParamRow):
    ...
    AttackPowerForEffects: int = ParamField(
        int8, "atkPow_forSfxSe", ATKPARAM_SFX_SE_ATK_POW, default=0,
        tooltip="TODO",
    )
    AttackDirectionForEffects: int = ParamField(
        int8, "atkDir_forSfxSe", ATKPARAM_SFX_SE_ATK_DIR, default=0,
    ...
    IsChargeAttack: bool = ParamField(
        uint8, "isChargeAtk:1", ATK_PARAM_BOOL, bit_count=1, default=False,
        tooltip="TODO",
    )
    SharesHitList: bool = ParamField(
        uint8, "isShareHitList:1", ATK_PARAM_BOOL, bit_count=1, default=False,
        tooltip="TODO",
    )
    CollidesWithObjects: bool = ParamField(
        uint8, "isCheckObjPenetration:1", ATK_PARAM_BOOL, bit_count=1, default=False,
        tooltip="Value might be inverted.",
    )
    _BitPad0: int = ParamBitPad(uint8, "pad:2", bit_count=2)
    ...
    AppearAISoundID: int = ParamField(
        int32, "appearAiSoundId", game_type=AISoundParam, default=0,
        tooltip="TODO",
    )
    HitAISoundID: int = ParamField(
        int32, "hitAiSoundId", game_type=AISoundParam, default=0,
        tooltip="TODO",
    )
