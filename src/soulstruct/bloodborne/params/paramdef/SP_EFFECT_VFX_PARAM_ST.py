...
class SP_EFFECT_VFX_PARAM_ST(ParamRow):
    ...
    TransformBodyArmor: bool = ParamField(
        uint8, "transformArmor:1", SP_EFFECT_BOOL, bit_count=1, default=False,
    ...
    TransformHandArmor: bool = ParamField(
        uint8, "transformGauntlet:1", SP_EFFECT_BOOL, bit_count=1, default=False,
        tooltip="TODO",
    )
    TransformHeadArmor: bool = ParamField(
        uint8, "transformHelmet:1", SP_EFFECT_BOOL, bit_count=1, default=False,
        tooltip="TODO",
    )
    TransformLegsArmor: bool = ParamField(
        uint8, "transformLeggings:1", SP_EFFECT_BOOL, bit_count=1, default=False,
        tooltip="TODO",
    )
    TransformPriority: int = ParamField(
        uint8, "transformPriority:3", bit_count=3, default=0,
        tooltip="TODO",
    )
    TransformWeaponID: int = ParamField(
        int32, "transformWeaponId", game_type=WeaponParam, default=-1,
        tooltip="TODO",
    )
