...
class EQUIP_PARAM_GOODS_ST(ParamRow):
    ...
    FragmentCount: int = ParamField(
        int32, "fragmentNum", default=0,
        tooltip="TODO",
    )
    ...
    UseableByPathOfTheDragon: bool = ParamField(
        uint8, "vowType5:1", EQUIP_BOOL, bit_count=1, default=False,
    ...
    UseableByChaosServant: bool = ParamField(
        uint8, "vowType9:1", EQUIP_BOOL, bit_count=1, default=False,
    ...
    UseMaxBulletCount: bool = ParamField(
        uint8, "useBulletMaxNum:1", EQUIP_BOOL, bit_count=1, default=False,
        tooltip="TODO",
    )
    UseHealingMaxCount: bool = ParamField(
        uint8, "useHpCureMaxNum:1", EQUIP_BOOL, bit_count=1, default=False,
        tooltip="TODO",
    )
    AutoReplenishes: bool = ParamField(
        uint8, "isAutoReplenish:1", EQUIP_BOOL, bit_count=1, default=False,
        tooltip="TODO",
    )
    ...
    _BitPad0: int = ParamBitPad(uint8, "pad0:3", bit_count=3)
    ...
    RequiredBloodtinge: int = ParamField(
        uint8, "properMagic", default=0,
        tooltip="TODO",
    )
    RequiredArcane: int = ParamField(
    ...
    BulletCost: int = ParamField(
        uint8, "bulletConsumeNum", default=0,
        tooltip="TODO",
    )
    UseLimitCategory2: int = ParamField(
        uint8, "useLimitCategory2", SP_EFFECT_USELIMIT_CATEGORY, default=0,
        tooltip="TODO",
    )
    _Pad1: bytes = ParamPad(2, "pad1[2]")
    ReplaceItemIDBySpecialEffect: int = ParamField(
        int32, "replaceItemId_bySpEffect", default=-1,
        tooltip="TODO",
    )
    ReplaceTriggerSpecialEffect: int = ParamField(
        int32, "replaceTriggerSpEffectId", game_type=SpecialEffectParam, default=-1,
        tooltip="TODO",
    )
