...
class NPC_THINK_PARAM_ST(ParamRow):
    ...
    CanNavigateOrdinaryEdges: bool = ParamField(
        uint8, "enableNaviFlg_Edge_Ordinary:1", bit_count=1, default=True,
        tooltip="TODO",
    )
    _BitPad0: int = ParamBitPad(uint8, "enableNaviFlg_reserve0:1", bit_count=1)
    _Pad0: bytes = ParamPad(3, "enableNaviFlg_reserve1[3]")
    DarkSightDistance: int = ParamField(
        uint16, "eyeDist_forDark", default=0,
        tooltip="TODO",
    )
    DarkBattleStartDistance: int = ParamField(
        uint16, "battleStartDist_forDark", default=0,
        tooltip="TODO",
    )
    VeryDarkSightDistance: int = ParamField(
        uint16, "eyeDist_forPitchDark", default=0,
        tooltip="TODO",
    )
    VeryDarkStartDistance: int = ParamField(
        uint16, "battleStartDist_forPitchDark", default=0,
        tooltip="TODO",
    )
    ...
    TargetArriveDistance: float = ParamField(
        float32, "target_ArriveDist", default=0.0,
        tooltip="TODO",
    )
    PointArriveDistance: float = ParamField(
        float32, "point_ArriveDist", default=0.0,
        tooltip="TODO",
    )
    ChangeStateActionToFind: int = ParamField(
        uint8, "changeStateAction_ToFind", NPC_THINK_CHANGE_STATE_ACTION, default=0,
        tooltip="TODO",
    )
    ChangeStateActionToCaution: int = ParamField(
        uint8, "changeStateAction_ToCaution", NPC_THINK_CHANGE_STATE_ACTION, default=0,
        tooltip="TODO",
    )
    ChangeStateActionToBattle: int = ParamField(
        uint8, "changeStateAction_ToBattle", NPC_THINK_CHANGE_STATE_ACTION, default=0,
        tooltip="TODO",
    )
    ...
    DisableLocalSteering: int = ParamField(
        uint8, "disableLocalSteering", default=0,
        tooltip="TODO",
    )
    ...
    InterestGoalAction: int = ParamField(
        uint8, "goalAction_ToInterest", NPC_THINK_GOAL_ACTION, default=0,
        tooltip="TODO",
    )
    InterestGoalID: int = ParamField(
        int32, "goalID_ToInterest", default=0,
        tooltip="TODO",
    )
    ChangeStateActionToInterest: int = ParamField(
        uint8, "changeStateAction_ToInterest", NPC_THINK_CHANGE_STATE_ACTION, default=0,
        tooltip="TODO",
    )
