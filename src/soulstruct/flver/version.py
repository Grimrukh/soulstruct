...
class FLVERVersion(IntEnum):
    ...
    def use_normal_w_bones(self):
        """From Bloodborne onwards, vertices in static FLVER meshes store their singular bone indices in the fourth
        8-bit component of the 'normal_w' vertex array, rather than having a full useless four-bone `bone_indices`
