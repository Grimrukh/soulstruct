...
class ITEMLOT_PARAM_ST(ParamRow):
    ...
    Item1Flag: int = ParamField(
        uint32, "getItemFlagId01", game_type=Flag, default=0,
    ...
    Item2Flag: int = ParamField(
        uint32, "getItemFlagId02", game_type=Flag, default=0,
        tooltip="Flag that will be enabled when this exact item slot is dropped (and presumably picked up). Never "
                "used.",
    )
    Item3Flag: int = ParamField(
        uint32, "getItemFlagId03", game_type=Flag, default=0,
        tooltip="Flag that will be enabled when this exact item slot is dropped (and presumably picked up). Never "
                "used.",
    )
    Item4Flag: int = ParamField(
        uint32, "getItemFlagId04", game_type=Flag, default=0,
        tooltip="Flag that will be enabled when this exact item slot is dropped (and presumably picked up). Never "
                "used.",
    )
    Item5Flag: int = ParamField(
        uint32, "getItemFlagId05", game_type=Flag, default=0,
        tooltip="Flag that will be enabled when this exact item slot is dropped (and presumably picked up). Never "
                "used.",
    )
    Item6Flag: int = ParamField(
        uint32, "getItemFlagId06", game_type=Flag, default=0,
        tooltip="Flag that will be enabled when this exact item slot is dropped (and presumably picked up). Never "
                "used.",
    )
    Item7Flag: int = ParamField(
        uint32, "getItemFlagId07", game_type=Flag, default=0,
        tooltip="Flag that will be enabled when this exact item slot is dropped (and presumably picked up). Never "
                "used.",
    )
    Item8Flag: int = ParamField(
        uint32, "getItemFlagId08", game_type=Flag, default=0,
        tooltip="Flag that will be enabled when this exact item slot is dropped (and presumably picked up). Never "
                "used.",
    )
    ItemFlag: int = ParamField(
        uint32, "getItemFlagId", game_type=Flag, default=0,
        tooltip="Flag enabled when any item from this item lot is picked up.",
    )
    FirstCumulativeFlag: int = ParamField(
        uint32, "cumulateNumFlagId", game_type=Flag, default=0,
    ...
    Item1LuckEnabled: bool = ParamField(
        uint16, "enableLuck01:1", ITEMLOT_ENABLE_LUCK, bit_count=1, default=False,
    ...
    Item2LuckEnabled: bool = ParamField(
        uint16, "enableLuck02:1", ITEMLOT_ENABLE_LUCK, bit_count=1, default=False,
        tooltip="If True, increased player luck will *reduce* the chance points of this slot. Usually used on the "
                "empty item slot so that rarer items have a relatively better chance of dropping.",
    )
    Item3LuckEnabled: bool = ParamField(
        uint16, "enableLuck03:1", ITEMLOT_ENABLE_LUCK, bit_count=1, default=False,
        tooltip="If True, increased player luck will *reduce* the chance points of this slot. Usually used on the "
                "empty item slot so that rarer items have a relatively better chance of dropping.",
    )
    Item4LuckEnabled: bool = ParamField(
        uint16, "enableLuck04:1", ITEMLOT_ENABLE_LUCK, bit_count=1, default=False,
        tooltip="If True, increased player luck will *reduce* the chance points of this slot. Usually used on the "
                "empty item slot so that rarer items have a relatively better chance of dropping.",
    )
    Item5LuckEnabled: bool = ParamField(
        uint16, "enableLuck05:1", ITEMLOT_ENABLE_LUCK, bit_count=1, default=False,
        tooltip="If True, increased player luck will *reduce* the chance points of this slot. Usually used on the "
                "empty item slot so that rarer items have a relatively better chance of dropping.",
    )
    Item6LuckEnabled: bool = ParamField(
        uint16, "enableLuck06:1", ITEMLOT_ENABLE_LUCK, bit_count=1, default=False,
        tooltip="If True, increased player luck will *reduce* the chance points of this slot. Usually used on the "
                "empty item slot so that rarer items have a relatively better chance of dropping.",
    )
    Item7LuckEnabled: bool = ParamField(
        uint16, "enableLuck07:1", ITEMLOT_ENABLE_LUCK, bit_count=1, default=False,
        tooltip="If True, increased player luck will *reduce* the chance points of this slot. Usually used on the "
                "empty item slot so that rarer items have a relatively better chance of dropping.",
    )
    Item8LuckEnabled: bool = ParamField(
        uint16, "enableLuck08:1", ITEMLOT_ENABLE_LUCK, bit_count=1, default=False,
        tooltip="If True, increased player luck will *reduce* the chance points of this slot. Usually used on the "
                "empty item slot so that rarer items have a relatively better chance of dropping.",
    )
    ...
    GameClearOffset: int = ParamField(
        int8, "GameClearOffset", ITEMLOT_ROUND_COUNT, default=-1,
        tooltip="TOOLTIP-TODO",
    )
    CanExecByFriendlyGhost: bool = ParamField(
        uint8, "canExecByFriendlyGhost:1", BOOL_CIRCLECROSS_TYPE, bit_count=1, default=False,
        tooltip="TOOLTIP-TODO",
    )
    CanExecByHostileGhost: bool = ParamField(
        uint8, "canExecByHostileGhost:1", BOOL_CIRCLECROSS_TYPE, bit_count=1, default=False,
        tooltip="TOOLTIP-TODO",
    )
    PAD1: int = ParamField(
        uint8, "PAD1:6", bit_count=6, default=0,
        tooltip="TOOLTIP-TODO",
    )
    PAD2: int = ParamField(
        uint16, "PAD2", default=0,
        tooltip="TOOLTIP-TODO",
    )
