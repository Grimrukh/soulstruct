...
class ACTIONBUTTON_PARAM_ST(ParamRow):
    ...
    Category: int = ParamField(
        uint8, "category", ACTION_BUTTON_CATEGORY, default=0,
        tooltip="TOOLTIP-TODO",
    )
    ...
    _BitPad0: int = ParamBitPad(uint8, "padding5:1", bit_count=1)
    IsInvalidForRide: bool = ParamField(
        uint8, "isInvalidForRide:1", BOOL_YESNO_TYPE, bit_count=1, default=False,
        tooltip="TOOLTIP-TODO",
    )
    IsGrayoutForRide: bool = ParamField(
        uint8, "isGrayoutForRide:1", BOOL_YESNO_TYPE, bit_count=1, default=False,
        tooltip="TOOLTIP-TODO",
    )
    IsInvalidForCrouching: bool = ParamField(
        uint8, "isInvalidForCrouching:1", BOOL_YESNO_TYPE, bit_count=1, default=False,
        tooltip="TOOLTIP-TODO",
    )
    IsGrayoutForCrouching: bool = ParamField(
        uint8, "isGrayoutForCrouching:1", BOOL_YESNO_TYPE, bit_count=1, default=False,
        tooltip="TOOLTIP-TODO",
    )
    _BitPad1: int = ParamBitPad(uint8, "padding4:3", bit_count=3)
    TextId: int = ParamField(
        int32, "textId", default=-1,
        tooltip="TOOLTIP-TODO",
    )
    InvalidFlag: int = ParamField(
        uint32, "invalidFlag", default=0,
        tooltip="TOOLTIP-TODO",
    )
    GrayoutFlag: int = ParamField(
        uint32, "grayoutFlag", default=0,
        tooltip="TOOLTIP-TODO",
    )
    OverrideActionButtonIdForRide: int = ParamField(
        int32, "overrideActionButtonIdForRide", default=-1,
        tooltip="TOOLTIP-TODO",
    )
