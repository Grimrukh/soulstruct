...
class HIT_MTRL_PARAM_ST(ParamRow):
    ...
    DisableFallDamage: bool = ParamField(
        uint8, "disableFallDamage:1", bit_count=1, default=False,
        tooltip="TOOLTIP-TODO",
    )
    IsHardnessForSoundReverb: bool = ParamField(
        uint8, "isHardnessForSoundReverb:1", bit_count=1, default=False,
        tooltip="TOOLTIP-TODO",
    )
    HardnessType: int = ParamField(
        uint8, "hardnessType", HMP_HARDNESS_TYPE, default=0,
        tooltip="TOOLTIP-TODO",
    )
    _Pad0: bytes = ParamPad(6, "pad2[6]")
    SpEffectIdOnHit0ClearCount2: int = ParamField(
        int32, "spEffectIdOnHit0_ClearCount_2", default=-1,
        tooltip="TOOLTIP-TODO",
    )
    SpEffectIdOnHit0ClearCount3: int = ParamField(
        int32, "spEffectIdOnHit0_ClearCount_3", default=-1,
        tooltip="TOOLTIP-TODO",
    )
    SpEffectIdOnHit0ClearCount4: int = ParamField(
        int32, "spEffectIdOnHit0_ClearCount_4", default=-1,
        tooltip="TOOLTIP-TODO",
    )
    SpEffectIdOnHit0ClearCount5: int = ParamField(
        int32, "spEffectIdOnHit0_ClearCount_5", default=-1,
        tooltip="TOOLTIP-TODO",
    )
    SpEffectIdOnHit0ClearCount6: int = ParamField(
        int32, "spEffectIdOnHit0_ClearCount_6", default=-1,
        tooltip="TOOLTIP-TODO",
    )
    SpEffectIdOnHit0ClearCount7: int = ParamField(
        int32, "spEffectIdOnHit0_ClearCount_7", default=-1,
        tooltip="TOOLTIP-TODO",
    )
    SpEffectIdOnHit0ClearCount8: int = ParamField(
        int32, "spEffectIdOnHit0_ClearCount_8", default=-1,
        tooltip="TOOLTIP-TODO",
    )
    SpEffectIdOnHit1ClearCount2: int = ParamField(
        int32, "spEffectIdOnHit1_ClearCount_2", default=-1,
        tooltip="TOOLTIP-TODO",
    )
    SpEffectIdOnHit1ClearCount3: int = ParamField(
        int32, "spEffectIdOnHit1_ClearCount_3", default=-1,
        tooltip="TOOLTIP-TODO",
    )
    SpEffectIdOnHit1ClearCount4: int = ParamField(
        int32, "spEffectIdOnHit1_ClearCount_4", default=-1,
        tooltip="TOOLTIP-TODO",
    )
    SpEffectIdOnHit1ClearCount5: int = ParamField(
        int32, "spEffectIdOnHit1_ClearCount_5", default=-1,
        tooltip="TOOLTIP-TODO",
    )
    SpEffectIdOnHit1ClearCount6: int = ParamField(
        int32, "spEffectIdOnHit1_ClearCount_6", default=-1,
        tooltip="TOOLTIP-TODO",
    )
    SpEffectIdOnHit1ClearCount7: int = ParamField(
        int32, "spEffectIdOnHit1_ClearCount_7", default=-1,
        tooltip="TOOLTIP-TODO",
    )
    SpEffectIdOnHit1ClearCount8: int = ParamField(
        int32, "spEffectIdOnHit1_ClearCount_8", default=-1,
        tooltip="TOOLTIP-TODO",
    )
    ReplaceMateiralIdRain: int = ParamField(
        int16, "replaceMateiralId_Rain", default=-1,
        tooltip="TOOLTIP-TODO",
    )
    _Pad1: bytes = ParamPad(2, "pad4[2]")
    SpEffectIdforWet00: int = ParamField(
        int32, "spEffectId_forWet00", default=-1,
        tooltip="TOOLTIP-TODO",
    )
    SpEffectIdforWet01: int = ParamField(
        int32, "spEffectId_forWet01", default=-1,
        tooltip="TOOLTIP-TODO",
    )
    SpEffectIdforWet02: int = ParamField(
        int32, "spEffectId_forWet02", default=-1,
        tooltip="TOOLTIP-TODO",
    )
    SpEffectIdforWet03: int = ParamField(
        int32, "spEffectId_forWet03", default=-1,
        tooltip="TOOLTIP-TODO",
    )
    SpEffectIdforWet04: int = ParamField(
        int32, "spEffectId_forWet04", default=-1,
        tooltip="TOOLTIP-TODO",
    )
