...
from .enums.m31_04_00_00_enums import *
...
def Event_31042310(_, character: Character | int):
    """Event 31042310"""
...
def Event_31042849():
    ...
    CommonFunc_9005811(0, flag=31040800, asset=Assets.AEG099_002_9000, vfx_id=5, right=0)
    CommonFunc_9005822(
        0,
        flag=31040800,
