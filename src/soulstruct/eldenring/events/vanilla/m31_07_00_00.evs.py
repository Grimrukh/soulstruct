...
def Event_31072213(_, character: uint, region: Region | int):
    """Event 31072213"""
...
def Event_31072220(_, character: Character | int):
    """Event 31072220"""
...
def Event_310722205(_, character: Character | int):
    """Event 310722205"""
    if ThisEventSlotFlagEnabled():
        return
    AddSpecialEffect(character, 8081)
...
def Event_31072225(_, character: Character | int):
    """Event 31072225"""
    if ThisEventSlotFlagEnabled():
        return
...
def Event_310722300(_, character: Character | int, seconds: float):
    """Event 310722300"""
    if ThisEventSlotFlagEnabled():
        return
    AddSpecialEffect(character, 8081)
...
def Event_31042849():
    ...
    CommonFunc_9005811(0, flag=31070800, asset=Assets.AEG099_001_9000, vfx_id=5, right=0)
    CommonFunc_9005822(
        0,
        flag=31070800,
