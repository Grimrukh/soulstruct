...
from .enums.m30_11_00_00_enums import *
...
def Event_30110790(_, asset: Asset | int, flag: Flag | int):
    """Event 30110790"""
...
def Event_30112849():
    ...
    CommonFunc_9005811(0, flag=30110800, asset=Assets.AEG099_001_9000, vfx_id=3, right=0)
    CommonFunc_9005822(
        0,
        flag=30110800,
...
def Event_30112900(_, tutorial_param_id: int, flag: Flag | int, flag_1: Flag | int):
    """Event 30112900"""
