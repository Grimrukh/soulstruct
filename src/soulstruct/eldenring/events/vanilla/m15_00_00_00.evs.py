...
def Event_15002200(_, character: Character | int, asset: Asset | int):
    """Event 15002200"""
    if ThisEventSlotFlagEnabled():
        return
...
def Event_15002310(_, character: Character | int, character_1: Character | int):
    """Event 15002310"""
...
def Event_15002344(_, character: Character | int, entity: uint):
    """Event 15002344"""
...
def Event_15002849():
    ...
    CommonFunc_9005811(0, flag=15000800, asset=Assets.AEG099_003_9000, vfx_id=5, right=0)
    CommonFunc_9005822(
        0,
        flag=15002800,
...
def Event_15002899():
    ...
    CommonFunc_9005811(0, flag=15000850, asset=Assets.AEG099_003_9001, vfx_id=3, right=15000851)
    CommonFunc_9005811(0, flag=15000850, asset=Assets.AEG099_003_9002, vfx_id=3, right=0)
    CommonFunc_9005822(
        0,
        flag=15000850,
...
def Event_15000702(_, asset: Asset | int, asset_1: Asset | int):
    """Event 15000702"""
    DisableAsset(asset)
...
def Event_15000712(_, asset: Asset | int):
    """Event 15000712"""
    DisableAsset(asset)
...
def Event_15000715():
    ...
    OR_1.Add(EntityWithinDistance(entity=Assets.AEG099_060_9002, other_entity=ALL_PLAYERS, radius=5.0))
    OR_1.Add(EntityWithinDistance(entity=Assets.AEG099_060_9003, other_entity=ALL_PLAYERS, radius=12.0))
    AND_1.Add(OR_1)
    AwaitConditionTrue(AND_1)
