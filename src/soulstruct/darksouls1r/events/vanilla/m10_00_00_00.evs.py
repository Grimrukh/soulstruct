...
def Event_11005390():
    ...
    FaceEntity(PLAYER, target_entity=1002997)
    ForceAnimation(PLAYER, 7410)
    Restart()


@ContinueOnRest(11005391)
def Event_11005391():
    """Event 11005391"""
    AND_1.Add(FlagDisabled(2))
...
def Event_11005034():
    ...
    FaceEntity(6591, target_entity=1002997)
