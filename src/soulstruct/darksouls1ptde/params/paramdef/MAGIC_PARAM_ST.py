...
class MAGIC_PARAM_ST(ParamRow):
    ...
    HasSpecialEffectType: int = ParamField(
        uint8, "hasSpEffectType", SP_EFFECT_TYPE, default=0,
    ...
    UseableByWarriorsOfSunlight: bool = ParamField(
        uint8, "vowType3:1", MAGIC_BOOL, bit_count=1, default=True,
    ...
    UseableByDarkwraith: bool = ParamField(
        uint8, "vowType4:1", MAGIC_BOOL, bit_count=1, default=True,
    ...
    UseableByPathOfTheDragon: bool = ParamField(
        uint8, "vowType5:1", MAGIC_BOOL, bit_count=1, default=True,
    ...
    UseableByGravelordServant: bool = ParamField(
        uint8, "vowType6:1", MAGIC_BOOL, bit_count=1, default=True,
    ...
    UseableByWhitePhantoms: bool = ParamField(
        uint8, "enable_white:1", MAGIC_BOOL, bit_count=1, default=True,
    ...
    UseableByBlackPhantoms: bool = ParamField(
        uint8, "enable_black:1", MAGIC_BOOL, bit_count=1, default=True,
    ...
    UseableByDarkmoonBlade: bool = ParamField(
        uint8, "vowType8:1", MAGIC_BOOL, bit_count=1, default=True,
    ...
    UseableByChaosServant: bool = ParamField(
        uint8, "vowType9:1", MAGIC_BOOL, bit_count=1, default=True,
