...
class SP_EFFECT_PARAM_ST(ParamRow):
    ...
    EnemyHearingPercentageReduction: int = ParamField(
        int32, "hearingSearchEnemyCut", default=0,
    ...
    SpecialState: int = ParamField(
        uint8, "stateInfo", SP_EFFECT_TYPE, default=0,
    ...
    EffectDurationMultiplierType: int = ParamField(
        uint8, "lifeReductionType", SP_EFFECT_TYPE, default=0,
    ...
    CanAffectSelf: bool = ParamField(
        uint8, "effectTargetSelf:1", SP_EFFECT_BOOL, bit_count=1, default=True,
        tooltip="Effect will target self.",
    )
    CanAffectAlly: bool = ParamField(
        uint8, "effectTargetFriend:1", SP_EFFECT_BOOL, bit_count=1, default=True,
        tooltip="Effect will target self.",
    )
    CanAffectEnemy: bool = ParamField(
        uint8, "effectTargetEnemy:1", SP_EFFECT_BOOL, bit_count=1, default=True,
        tooltip="Effect will target enemies.",
    )
    CanAffectPlayer: bool = ParamField(
        uint8, "effectTargetPlayer:1", SP_EFFECT_BOOL, bit_count=1, default=True,
        tooltip="Effect will target player characters.",
    )
    CanAffectAI: bool = ParamField(
        uint8, "effectTargetAI:1", SP_EFFECT_BOOL, bit_count=1, default=True,
        tooltip="Effect will target non-player characters.",
    )
    CanAffectPlayers: bool = ParamField(
        uint8, "effectTargetLive:1", SP_EFFECT_BOOL, bit_count=1, default=True,
        tooltip="Effect will target humans.",
    )
    CanAffectPhantoms: bool = ParamField(
        uint8, "effectTargetGhost:1", SP_EFFECT_BOOL, bit_count=1, default=True,
        tooltip="Effect will target phantoms (white or black).",
    )
    CanAffectWhitePhantoms: bool = ParamField(
        uint8, "effectTargetWhiteGhost:1", SP_EFFECT_BOOL, bit_count=1, default=True,
        tooltip="Effect will target white phantoms.",
    )
    CanAffectBlackPhantoms: bool = ParamField(
        uint8, "effectTargetBlackGhost:1", SP_EFFECT_BOOL, bit_count=1, default=True,
        tooltip="Effect will target white phantoms.",
    )
    CanAffectAttacker: bool = ParamField(
        uint8, "effectTargetAttacker:1", SP_EFFECT_BOOL, bit_count=1, default=True,
    ...
    _BitPad0: int = ParamBitPad(uint8, "pad_2:4", bit_count=4)
    AffectsCharactersWithNoCovenant: bool = ParamField(
        uint8, "vowType0:1", SP_EFFECT_BOOL, bit_count=1, default=True,
        tooltip="Determines if this special effect will affect characters with no covenant.",
    )
    AffectsWayOfWhite: bool = ParamField(
        uint8, "vowType1:1", SP_EFFECT_BOOL, bit_count=1, default=True,
    ...
    AffectsPrincessGuard: bool = ParamField(
        uint8, "vowType2:1", SP_EFFECT_BOOL, bit_count=1, default=True,
    ...
    AffectsWarriorOfSunlight: bool = ParamField(
        uint8, "vowType3:1", SP_EFFECT_BOOL, bit_count=1, default=True,
    ...
    AffectsDarkwraith: bool = ParamField(
        uint8, "vowType4:1", SP_EFFECT_BOOL, bit_count=1, default=True,
    ...
    AffectsPathOfTheDragon: bool = ParamField(
        uint8, "vowType5:1", SP_EFFECT_BOOL, bit_count=1, default=True,
    ...
    AffectsGravelordServant: bool = ParamField(
        uint8, "vowType6:1", SP_EFFECT_BOOL, bit_count=1, default=True,
    ...
    AffectsForestHunter: bool = ParamField(
        uint8, "vowType7:1", SP_EFFECT_BOOL, bit_count=1, default=True,
    ...
    AffectsDarkmoonBlade: bool = ParamField(
        uint8, "vowType8:1", SP_EFFECT_BOOL, bit_count=1, default=True,
    ...
    AffectsChaosServant: bool = ParamField(
        uint8, "vowType9:1", SP_EFFECT_BOOL, bit_count=1, default=True,
    ...
    AffectsCovenant10: bool = ParamField(
        uint8, "vowType10:1", SP_EFFECT_BOOL, bit_count=1, default=True,
        tooltip="Determines if this special effect will affect characters in unused covenant.",
    )
    AffectsCovenant11: bool = ParamField(
        uint8, "vowType11:1", SP_EFFECT_BOOL, bit_count=1, default=True,
        tooltip="Determines if this special effect will affect characters in unused covenant.",
    )
    AffectsCovenant12: bool = ParamField(
        uint8, "vowType12:1", SP_EFFECT_BOOL, bit_count=1, default=True,
        tooltip="Determines if this special effect will affect characters in unused covenant.",
    )
    AffectsCovenant13: bool = ParamField(
        uint8, "vowType13:1", SP_EFFECT_BOOL, bit_count=1, default=True,
        tooltip="Determines if this special effect will affect characters in unused covenant.",
    )
    AffectsCovenant14: bool = ParamField(
        uint8, "vowType14:1", SP_EFFECT_BOOL, bit_count=1, default=True,
        tooltip="Determines if this special effect will affect characters in unused covenant.",
    )
    AffectsCovenant15: bool = ParamField(
        uint8, "vowType15:1", SP_EFFECT_BOOL, bit_count=1, default=True,
        tooltip="Determines if this special effect will affect characters in unused covenant.",
    )
