...
class BULLET_PARAM_ST(ParamRow):
    BulletAttack: int = ParamField(
        int32, "atkId_Bullet", game_type=AttackParam, default=0,
    ...
    OwnerSpecialEffect: int = ParamField(
        int32, "spEffectIDForShooter", game_type=SpecialEffectParam, default=0,
    ...
    BulletOnHit: int = ParamField(
        int32, "HitBulletID", game_type=BulletParam, default=-1,
