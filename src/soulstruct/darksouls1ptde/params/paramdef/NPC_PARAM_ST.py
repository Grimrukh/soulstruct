...
class NPC_PARAM_ST(ParamRow):
    ...
    SpecialEffectID5: int = ParamField(
        int32, "spEffectID5", game_type=SpecialEffectParam, default=0,
    ...
    SpecialEffectID6: int = ParamField(
        int32, "spEffectID6", game_type=SpecialEffectParam, default=0,
    ...
    SpecialEffectID7: int = ParamField(
        int32, "spEffectID7", game_type=SpecialEffectParam, default=0,
    ...
    DebugBehaviorR1: int = ParamField(
        int32, "dbgBehaviorR1", default=0,
        tooltip="TODO",
    )
    DebugBehaviorL1: int = ParamField(
        int32, "dbgBehaviorL1", default=0,
        tooltip="TODO",
    )
    DebugBehaviorR2: int = ParamField(
        int32, "dbgBehaviorR2", default=0,
        tooltip="TODO",
    )
    DebugBehaviorL2: int = ParamField(
        int32, "dbgBehaviorL2", default=0,
        tooltip="TODO",
    )
    DebugBehaviorRL: int = ParamField(
        int32, "dbgBehaviorRL", default=0,
        tooltip="TODO",
    )
    DebugBehaviorRR: int = ParamField(
        int32, "dbgBehaviorRR", default=0,
        tooltip="TODO",
    )
    DebugBehaviorRD: int = ParamField(
        int32, "dbgBehaviorRD", default=0,
        tooltip="TODO",
    )
    DebugBehaviorRU: int = ParamField(
        int32, "dbgBehaviorRU", default=0,
        tooltip="TODO",
    )
    DebugBehaviorLL: int = ParamField(
        int32, "dbgBehaviorLL", default=0,
        tooltip="TODO",
    )
    DebugBehaviorLR: int = ParamField(
        int32, "dbgBehaviorLR", default=0,
        tooltip="TODO",
    )
    DebugBehaviorLD: int = ParamField(
        int32, "dbgBehaviorLD", default=0,
        tooltip="TODO",
    )
    DebugBehaviorLU: int = ParamField(
        int32, "dbgBehaviorLU", default=0,
        tooltip="TODO",
    )
    ...
    TeamType: int = ParamField(
        uint8, "teamType", NPC_TEMA_TYPE, default=0,
    ...
    _BitPad1: int = ParamBitPad(uint8, "pad3:4", bit_count=4)
