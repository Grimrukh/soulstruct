...
class GAME_AREA_PARAM_ST(ParamRow):
    ...
    HumanityDropPoint1: int = ParamField(
        uint16, "humanityDropPoint1", default=65535,
    ...
    HumanityDropPoint2: int = ParamField(
        uint16, "humanityDropPoint2", default=65535,
    ...
    HumanityDropPoint3: int = ParamField(
        uint16, "humanityDropPoint3", default=65535,
    ...
    HumanityDropPoint4: int = ParamField(
        uint16, "humanityDropPoint4", default=65535,
    ...
    HumanityDropPoint5: int = ParamField(
        uint16, "humanityDropPoint5", default=65535,
    ...
    HumanityDropPoint6: int = ParamField(
        uint16, "humanityDropPoint6", default=65535,
    ...
    HumanityDropPoint7: int = ParamField(
        uint16, "humanityDropPoint7", default=65535,
    ...
    HumanityDropPoint8: int = ParamField(
        uint16, "humanityDropPoint8", default=65535,
    ...
    HumanityDropPoint9: int = ParamField(
        uint16, "humanityDropPoint9", default=65535,
    ...
    HumanityDropPoint10: int = ParamField(
        uint16, "humanityDropPoint10", default=65535,
